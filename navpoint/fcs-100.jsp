...
<section  ><%-- Widget fcs.pages.clients@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesclients10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.clients@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesclients10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesclients10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/clients_cs_t_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesclients10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.clients@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <span>Clients</span></div>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.clients@12 (type=tooltwist.fcs.widgets.ContentSliderWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesclients12ContentSlider";
	String snippetVar_ipp = "4";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.clients@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.clients@12 (type=tooltwist.fcs.widgets.ContentSliderWidget)", e);
}
%>
</div>
<div  class="advanceRichtext"><div class="pressRelease"><ul class="paginable-container"><li class="paginable-item"><div class="pressCont"><h3>Harbor-UCLA Saves More Lives with Expansion</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">By balancing the goals of enhancing patient care through new facilities while complying with environmental regulations that apply to new construction, FCS helped Harbor-HCLA Medical Center's Expansion Project with affordable expert services that allow them to plan for enhanced patient care through better organization, ultimately leading to increased profitability.</p></div><a href=/ttsvr/fcs/pdf/casestudies/FCS_CS_UCLA_022114.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>SaaS/Cloud Computing Firm Benefits from FCS Utility Management Solution</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">A major global cloud computing company needed a utility management solution to help them gain insight into their carbon footprint though a GHG Inventory. They turned to FCS’ professional, reliable, and experienced team of experts with a proven track record in handling multiple-process requirements.</p></div><a href=/ttsvr/fcs/pdf/casestudies/casestudy_saascloud122013a.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Helps Expand Mobile Network</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">For the massive upgrade of 500+ telecommunications facilities in the LA Metro Area to augment coverage for a cellular provider, FCS was chosen based on our history of thorough environmental documentation, cost-effective solutions and vast knowledge of current regulations.</p></div><a href=/ttsvr/fcs/pdf/casestudies/FCS_Casestudy_LTE_112513-web.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>Cavium, Inc. Receives Sustainability Makeover</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">Cavium, Inc. chose FCS to assist in understanding, responding and improving their environmental performance, increasing their CDP score and implementing a Sustainable Management Program that would pull all of its processes and initiatives together under one cohesive strategy.</p></div><a href=/ttsvr/fcs/pdf/casestudies/sustainability-case-study-110613.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>Virgin Atlantic Receives Feedback to Improve CDP Scores</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">With FCS' Scoring Assessment services, Virgin Atlantic Airways (VAA) improved their questionnaire responses for CDP's Supply Chain Program. FCS provided VAA with a report that gave them insights on how to improve their CDP score.</p></div><a href=/ttsvr/fcs/pdf/casestudies/Virgin_Atlantic_casestudy_101813.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Helps Improve Road Safety Conditions</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">A client proposed to improve safety conditions on an East-West Southern California highway with a project designed to improve safety, reduce accident rates, allow sufficient sight distances, and renew any deteriorated asphalt pavement. By conducting on-site surveys and providing Environmental Impact Reports (EIR), FCS helped the client achieve California Environmental Quality Act (CEQA) compliance and gain approval from the California Department of Fish and Wildlife (CDFW) in order to proceed with their plans.</p></div><a href=/ttsvr/fcs/pdf/casestudies/FCS_Helps_Improve_Road_Safety_Conditions_110413.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Helps to Expand Youth Educational Facility</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">An organization selected FCS to obtain the environmental analyses and design the impact mitigation measures they needed for their largest school building expansion and development program to date. FCS successfully helped them save more than $50,000 and reduce their future expenses.</p></div><a href=/ttsvr/fcs/pdf/casestudies/FCS_Helps_to_Expand_Youth_Education_Facility_110413.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>Zoning Changes Help Maximize Property Potential</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">FCS provided California Environmental Quality Act (CEQA) documents and conducted a creek habitat evaluation to support the company's application for a land use and zoning modification. With FCS' quick turnaround for all supporting evaluations and documents, the company was able to overcome the challenges set by the City of San Jose's adoption of a General Plan Update.</p></div><a href=/ttsvr/fcs/pdf/casestudies/Zoning_Changes_Help_Maximize_Property_Potential_10-31.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Assists in Proposing New Telecommunications Towers</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">A private company's proposed project involved adding 200 new poles along Highway 1 and faced the major challenge of obtaining NEPA (National Environmental Policy Act) and CEQA (California Environmental Quality Act) clearance in the most cost-effective way. They looked to FCS for our high quality, economical prices and long history of working together.</p></div><a href=/ttsvr/fcs/pdf/casestudies/nepa_and_ceqa_compliance-case-study.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Helps Real Estate Services Firm Implement Sustainable Management System</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">A leading real estate services company began the process of developing a corporate-wide Sustainability Management System (SMS) to improve their public standing as a corporation committed to environmental stewardship. In order to quickly and efficiently achieve this, the firm needed the help of a trusted and experienced team, so they chose FCS.</p></div><a href=/ttsvr/fcs/pdf/casestudies/real_estate-casestudy-101813.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FCS Helps Pave the Road to Success</h3><div class="row"><p class="news col-lg-12 col-md-12 col-sm-12 col-xs-3">A private company was able to achieve jurisdictional approval to build their telecommunication towers along the 241 Toll Road between Irvine and Los Angeles, California. FCS conducted and documented pre-construction surveys on-site which allowed them to identify important natural species and cultural resources that may have been affected by the construction of the company's telecommunication towers. FCS also consulted with the United States Fish and Wildlife Service (USFWS) and the Office of Historic Preservation (OHP) to minimize the impact on the natural and cultural resources of the site. With FCS' assessments and consultation with local, state, and federal organizations, the company was able to implement the enhancement of their wireless coverage on the site.</p></div><a href=/ttsvr/fcs/pdf/casestudies/FCS_Helps_Pave_the_Road_to_Success_110813.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>LADWP Partners with FCS</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/ladwp_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">FCS served as on-call cultural resource for environmental compliance services and produced documents such as pre-construction recommendations and project-specific mitigation arrangements for the Los Angeles Department of Water and Power (LADWP). Through FCS' direct project management, local presence, and all-inclusive expertise, LADWP's projects were able to fulfill crucial CEQA and NEPA requirements. LADWP continues to partner with FCS in local, state and federal standards compliance.</p></div><a href=/ttsvr/fcs/pdf/casestudies/ladwp_partners_with_fcs_10-31-13.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>LADWP Paves the Road for Future Development</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/ladwp_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">The Los Angeles Department of Water & Power (LADWP) needed to assess the site where they would conduct a repair of the Toluca-Hollywood Transmission Road, but before these projects could take place, the LADWP needed a trusted, experienced company to efficiently assess the area for construction.</p></div><a href=/ttsvr/fcs/pdf/casestudies/Case_Study_Los_Angeles_Department_of_Water_and_Power-Toluca-Hollywood_Road_Repairs_052113.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>FirstCarbon Solutions to Provide Environmental Services to Hollywood Central Park Project</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/hollywood_central_park_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">With this one project, Los Angeles will address the economy, the environment, the health of its residents and their quality of life. Los Angeles will become the leader in sustainable cities and livable communities. We are proud to have the forward-thinking FirstCarbon Solutions as our partner to lead the project's EIR process," Goldman said.</p></div><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>Baystate Health</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/baystate_health_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">Baystate Health engaged FirstCarbon Solutions to prepare a comprehensive baseline GHG inventory for calendar year 2009 encompassing all of Baystate Health's locations based on sound principles and leading protocols. FirstCarbon Solutions prepared the inventory based on guidance provided in The Greenhouse Gas Protocol (WRI/WBCSD, 2004).</p></div><a href=/ttsvr/fcs/pdf/casestudies/baystatehealth.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>California State Energy Efficiency Appliance Rebate Program</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/soc_energy_com_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">FirstCarbon Solutions provided project management, strategic sourcing, and document management services for California's Cash for Appliances Rebate program. The program is funded through SEEARP funds administered by American Recovery and Reinvestment Act (ARRA), as part of the federal stimulus to promote spending.</p></div><a href=/ttsvr/fcs/pdf/casestudies/firstcarbonsolutions%20casestudy_cec.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>M.E. Heuck Takes the Carbon Out of Cookware</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/heuck_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">FirstCarbon Solutions' customers face various challenges - from implementing comprehensive sustainability programmes to providing product certifications for supply chain mandates and/or to promote their products and brands as being sustainable. Many organizations today are preparing their products to be "carbon neutral" to gain an edge in a highly competitive consumer market.</p></div><a href=/ttsvr/fcs/pdf/casestudies/meheuck.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li><li class="paginable-item"><div class="pressCont"><h3>Southern California Association of Governments Geared Up for a Greener and More Sustainable Region</h3><div class="row"><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src=/ttsvr/fcs/images/clients/sc_association_of_gov_logo_clients.jpg alt="" class="img-thumbnail" /></div><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">As part of its planning initiatives to encourage a more sustainable region, Southern California Association of Governments (SCAG) is striving to estimate energy and water consumption within the six counties and 190 cities of Southern California.</p></div><a href=/ttsvr/fcs/pdf/casestudies/scag.pdf class="btn btn-info btn-sm news" target="_blank">Download PDF <span class="glyphicon glyphicon-download-alt"></span></a><div class="clearB"></div></div></li></ul></div></div>
</div>
