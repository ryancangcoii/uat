...
<section  ><%-- Widget fcs.pages.newsAndEvents@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <span>News and Events</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>News &amp; Events in Environmental and Energy Management</h1>
<p>There always seems to be something going on at FirstCarbon Solutions. To keep up to date on what's happening in the industry and with FirstCarbon Solutions, subscribe to the monthly GreenWatch newsletter.</p></div></div>
<div  class="advanceRichtext"><div class="pressRelease">
<div class="pressCont">
            <div class="row">
            <a href="/ttsvr/n/fcs-104" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/newsAndEventsThumb/thumb-events.png" alt="" /></a>
            <h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">News</h3>
            <p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">We're in the news! Read all about it.</p>
            </div>
            <a href="/ttsvr/n/fcs-104" class="btn btn-info btn-sm news">Go to News page<span class="glyphicon glyphicon-chevron-right"></span></a>
            <div class="clearB"></div>
</div>
  
  <div class="pressCont">
            <div class="row">
            <a href="/ttsvr/n/fcs-105" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/newsAndEventsThumb/thumb-press_release.png" alt="" /></a>
            <h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Press Releases</h3>
            <p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">Learn more about FirstCarbon Solutions by reading our latest press releases.</p>
            </div>
            <a href="/ttsvr/n/fcs-105" class="btn btn-info btn-sm news">Go to Press Releases page<span class="glyphicon glyphicon-chevron-right"></span></a>
            <div class="clearB"></div>
</div>
  
  <div class="pressCont">
            <div class="row">
            <a href="/ttsvr/n/fcs-106" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/newsAndEventsThumb/thumb-webinarandpresentation.png" alt=""  /></a>
            <h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Events</h3>
            <p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">To schedule a meeting with FirstCarbon Solutions personnel at the next industry event, contact us today. FirstCarbon Solutions consultants and industry experts will be attending or exhibiting at the following trade shows and conferences in your and other regions.</p>
            </div>
            <a href="/ttsvr/n/fcs-106" class="btn btn-info btn-sm news">Go to Events page<span class="glyphicon glyphicon-chevron-right"></span></a>
            <div class="clearB"></div>
</div>
  
  <div class="pressCont">
            <div class="row">
            <a href="/ttsvr/n/fcs-107" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/newsAndEventsThumb/thumbnails-news.png" alt="" /></a>
            <h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Webinars and Presentations</h3>
            <p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">FirstCarbon Solutions not only hosts webinars on various topics, but we also participate as industry experts in online sessions and podcasts hosted by other organizations.</p>
            </div>
            <a href="/ttsvr/n/fcs-107" class="btn btn-info btn-sm news">Go to Webinars and Presentations page<span class="glyphicon glyphicon-chevron-right"></span></a>
            <div class="clearB"></div>
</div>
...
<div  class="sec2RightCont col-lg-3 col-sh col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>NEWS AND EVENTS</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/e84ba65b-1ab8-4990-95fa-f45a87118ada" method="POST" role="form" novalidate>
