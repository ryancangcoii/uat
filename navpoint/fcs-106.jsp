...
<%
	String jspName = "fcs-106";
	JspHelper jh = JspHelper.getJspHelper(pageContext, jspName);
	WbdProductionHelper productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12 = null;
try {
	Properties productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12Params = new Properties();
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12Params.setProperty("navpointId", "fcs-106");
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12Params.setProperty("pageDataSection", "eventsSeminar");
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12 = new tooltwist.fcs.productionHelpers.EventsSeminarsProductionHelper(productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12Params);
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12", e);
}

	WbdProductionHelper productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13 = null;
try {
	Properties productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13Params = new Properties();
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13Params.setProperty("navpointId", "fcs-106");
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13Params.setProperty("pageDataSection", "eventsSeminarPriorTo");
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13 = new tooltwist.fcs.productionHelpers.EventsSeminarsProductionHelper(productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13Params);
	productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13", e);
}
...
<section  ><%-- Widget fcs.pages.newsAndEvents_eventsAndSeminars@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_eventsAndSeminars10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_eventsAndSeminars@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_eventsAndSeminars10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_eventsAndSeminars10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_eventsAndSeminars10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_eventsAndSeminars@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <span>Events and Seminars</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Events and Seminars</h1></div></div>
<div  ><%-- Widget fcs.pages.newsAndEvents_eventsAndSeminars@12 (type=tooltwist.fcs.widgets.EventsUpcomingWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_12;
	String snippetVar_pageDataSection = "eventsSeminar";
	String snippetVar_navpointId = "fcs-106";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_eventsAndSeminars@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_eventsAndSeminars@12 (type=tooltwist.fcs.widgets.EventsUpcomingWidget)", e);
}
%>
</div>
<div  class="event-seminars"><%-- Widget fcs.pages.newsAndEvents_eventsAndSeminars@13 (type=tooltwist.fcs.widgets.EventsPriorToWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_fcs_pages_newsAndEvents_eventsAndSeminars_13;
	String snippetVar_pageDataSection = "eventsSeminarPriorTo";
	String snippetVar_navpointId = "fcs-106";
	String snippetVar_widgetName = "@13";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_eventsAndSeminars@13";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
	...
	<%@page import="tooltwist.ecommerce.RoutingUIM"%>
     ...
     <%  } %> 		
          	<tbody>
            	<tr>
              		<td width="15%"><%= event.getEventDate() %></td>
              		<td><a href="#" data-toggle="modal" data-target="#priorToEventsModal<%=counter%>"><%= event.getEventTitle() %></a></td>
              		<td><%= event.getEventTopic() %></td>
              		<td><%= event.getEventType() %></td>
              		<td><%= event.getEventLocation() %></td>
            	</tr>
	...
	<!-- Modal -->
	<div class="modal fade eventsModal" id="priorToEventsModal<%=counter%>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  		<div class="modal-dialog modal-lg">
    		<div class="modal-content">
      			<div class="modal-header">
         			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	  					...
	  					<div class="row">
	    					...
	    					<div class=" col-lg-6 col-md-6">
	      						<div class="esr-bio">
	        						<div class="esr-bio-heading clearfix">
	        							<%  if (speaker.getSpeakerPhoto() != "") { %> 
	          							<img src="<%= speaker.getSpeakerPhoto() %>" class="pull-left">
	          							<%  } %>
	          							<div class="esr-bio-details pull-left">
	            							<p>Speaker:</p>
	            							<p><%= speaker.getSpeakerName() %></p>
	            							<p><%= speaker.getSpeakerPosition() %></p>
	          							</div>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_eventsAndSeminars@13 (type=tooltwist.fcs.widgets.EventsPriorToWidget)", e);
}
%>
</div>
</div>
