...
<section  ><%-- Widget fcs.pages.newsAndEvents_webinars@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_webinars10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_webinars@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_webinars10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_webinars10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_webinars10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_webinars@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <span>Webinars and Presentations</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Webinars and Presentations from FirstCarbon Solutions &ndash; Environmental Sustainability Experts for Industry &amp; Business</h1>
<p>FirstCarbon Solutions not only hosts webinars on various topics, but we also participate as industry experts in online sessions and podcasts hosted by other organizations.</p>
<p>Below are some on demand webinars that are available for your review and download.</p></div></div>
<div  class="advanceRichtext"><ul class="paginable-container"><li class="paginable-item"><h3>LCF-CSR EXPO 2012 Transforming the Business of Giving Back</h3><p>Learn more about the impact and benefits of effective sustainability programs, otherwise known as social impact management plans (SIMP's), to businesses and organizations. </p><a href="lcf-csr-expo-2012-transforming-the-business-of-giving" class="btn btn-info btn-sm dl">DOWNLOAD THE PRESENTATION  <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Sustainabilitylive! 2012 Seminar Programme - Demand for Carbon Transparency in Global Supply Chains</h3><p>Identify, track and manage supply chain emissions efficiently and make significant improvements in your business' sustainability.</p><a href="sustainabilitylive-2012-seminar-programme-demand-for-carbon-transparency-in-global-supply-chains" class="btn btn-info btn-sm dl">DOWNLOAD THE PRESENTATION  <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>What Should We Be Measuring & Reporting for Sustainability?</h3><p>Learn the ins and outs of the Global Reporting Initiative and find out techniques on how to collect good quality data.</p><a href="what-should-we-be-measuring-reporting-for-sustainability" class="btn btn-info btn-sm dl">WATCH THE WEBINAR RECORDING <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>CDP Supply Chain Report Launch and Roundtable: Realizing & Demonstrating Value</h3><p>Are you wondering how companies are using emissions data from their supply chain? Know this and more from the CDP 2012 Supply Chain Roundtable.</p><a href="cdp-supply-chain-report-launch-and-roundtable-realizing-demonstrating-value" class="btn btn-info btn-sm dl">WATCH THE WEBINAR RECORDING <span class="glyphicon glyphicon-download-alt"></span></a><hr></li></ul></div>
</div>
