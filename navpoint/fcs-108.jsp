...
<section  ><%-- Widget fcs.pages.resources@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/resource_.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.resources@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <span>Resources</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental and Energy Management Resources for Business</h1>
<p>Learn more about FirstCarbon Solutions clients, products, services, and activities. Feel free to email and print any page in our Resource Center.</p></div></div>
<div  class="advanceRichtext"><div class="pressRelease"><div class="pressCont"><div class="row"><a href="/ttsvr/n/fcs-109" target="_blank" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/resourcesThumbs/thumb-blog.png" alt="" /></a><h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">FCS Blog</h3><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">Read the insights and perspectives of our subject matter experts on energy and water management, environmental planning, regulatory compliance, carbon accounting and more.</p></div><a href="/ttsvr/n/fcs-109" target="_blank" class="btn btn-info btn-sm news">Go to our Blog<span class="glyphicon glyphicon-chevron-right"></span></a><div class="clearB"></div></div><div class="pressCont"><div class="row"><a href="/ttsvr/n/fcs-110" target="_blank" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/resourcesThumbs/thumb-newsletters.png" alt="" /></a><h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Newsletters</h3><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">FirstCarbon Solutions delivers monthly industry updates in our GreenWatch newsletter to help you stay on top of the latest trends and initiatives in sustainability and energy management from around the world. Let us know if you would like to be added to our mailing list.</p></div><a href="/ttsvr/n/fcs-110" target="_blank" class="btn btn-info btn-sm news">Go to Newsletters page<span class="glyphicon glyphicon-chevron-right"></span></a><div class="clearB"></div></div><div class="pressCont"><div class="row"><a href="/ttsvr/n/fcs-111" target="_blank" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/resourcesThumbs/thumb-brochures.png" alt="" /></a><h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Brochures</h3><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">Learn more about how FirstCarbon Solutions services and solutions can drive bottom line value for your organization by lowering costs, optimizing resource use, and driving operational efficiencies.  You can also read some of our clients' case studies.</p></div><a href="/ttsvr/n/fcs-111" target="_blank" class="btn btn-info btn-sm news">Go to Brochures page<span class="glyphicon glyphicon-chevron-right"></span></a><div class="clearB"></div></div><div class="pressCont"><div class="row"><a href="/ttsvr/n/fcs-112" target="_blank" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/resourcesThumbs/thumb-videos.png" alt="" /></a><h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Videos</h3><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">View the FirstCarbon Solutions corporate video here plus other videos featuring the company and its clients and services.</p></div><a href="/ttsvr/n/fcs-112" target="_blank" class="btn btn-info btn-sm news">Go to Videos page<span class="glyphicon glyphicon-chevron-right"></span></a><div class="clearB"></div></div><div class="pressCont"><div class="row"><a href="/ttsvr/n/fcs-113" target="_blank" class="col-lg-2 col-md-2 col-sm-3 col-xs-3"><img src="/ttsvr/fcs/images/resourcesThumbs/thumb-rwp.png" alt="" /></a><h3 class="col-lg-10 col-md-10 col-sm-9 col-xs-0">Reports and White Papers</h3><p class="news col-lg-10 col-md-10 col-sm-9 col-xs-0">Keep on top of various industry trends and regulatory changes that concern your organization. Download our reports and white papers and gain insights on how issues may affect your business and your bottom line.</p></div><a href="/ttsvr/n/fcs-113" target="_blank" class="btn btn-info btn-sm news">Go to Reports and White Papers page<span class="glyphicon glyphicon-chevron-right"></span></a><div class="clearB"></div></div></div></div>
</div>
