...
<section  ><%-- Widget fcs.pages.resources_newsletters@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>GreenWatch Newsletter, Carbon Consulting, Sustainability Consulting</h1>
<p>GreenWatch Newsletter, Carbon Consulting, Sustainability Consulting FirstCarbon Solutions (FCS) helps you stay in the loop with the latest news and trends on sustainability with our e-Newsletter, GreenWatch.</p>
<p>When you subscribe to GreenWatch, you&rsquo;ll receive monthly &ldquo;need-to-know&rdquo; industry updates that help you stay on top of the latest trends and initiatives in Sustainability and Energy Management from around the world.</p>
<p>Get started today! Complete the form to subscribe.</p>
<hr class="line-green line-dotted" />
<h3>FirstCarbon Solutions GreenWatch Newsletter</h3>
<ul class="greenwatch-newsletter">
<li><a href="/ttsvr/resources/newsletters/march-2014-how-leading-financial-firms-make-it-into-the-world-s-100-most-sustainable-companies"><strong>MAR 2014</strong> - How Leading Financial Firms Make It Into the World&rsquo;s 100 Most Sustainable Companies</a></li>
<li><a href="/ttsvr/resources/newsletters/february-2014-how-can-smes-manage-supply-chain-pressures-to-gain-competitive-advantage"><strong>FEB 2014</strong> - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a></li>
<li><a href="/ttsvr/resources/newsletters/january-2014-constructing-sustainable-business-models"><strong>JAN 2014</strong> - Constructing Sustainable Business Models</a></li>
</ul>
<hr class="line-green line-dotted" /><!--<p>
  <button class="btn btn-yellow">View older issues here.</button>
</p> --></div></div>
</div>
