...
<section  ><%-- Widget fcs.pages.resources_brochures@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_brochures10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/resource_brochures.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_brochures@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_brochures10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_brochures10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_brochures.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_brochures10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_brochures@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <span>Brochures</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting Solutions &amp; Services - Brochures from FirstCarbon Solutions</h1>
<p>Learn more about how FirstCarbon Solutions' environmental consulting services and solutions can drive bottom-line value for your organization by lowering costs, optimizing resource use, and driving operational efficiencies. Once you've finished with the brochures, you can also read some of our clients' case studies.</p></div></div>
<div  class="advanceRichtext"><%-- Widget fcs.pages.resources_brochures@13 (type=tooltwist.fcs.widgets.ContentSliderWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_brochures13ContentSlider";
	String snippetVar_ipp = "5";
	String snippetVar_widgetName = "@13";
	String snippetVar_widgetPath = "fcs.pages.resources_brochures@13";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_brochures@13 (type=tooltwist.fcs.widgets.ContentSliderWidget)", e);
}
%>
</div>
<div  class="advanceRichtext"><ul class="paginable-container"><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/fcscompany_profile_december2013.pdf" target="_blank">FCS Corporate Profile (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/fcscompany_profile_december2013.pdf" title="FCS Corporate Profile (PDF)" target="_blank"><img src="/ttsvr/fcs/images/brochures-company-profile-dec13.png" alt="If you need a simple one page overview of FirstCarbon Solutions, then this datasheet is all you need."></a><p class="brochure-details">If you need a simple one page overview of FirstCarbon Solutions, then this datasheet is all you need.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/firstcarbonsolutions_overview_brochure_global_120413.pdf" target="_blank">FCS Overview (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/firstcarbonsolutions_overview_brochure_global_120413.pdf" title="FCS Overview (PDF)" target="_blank"><img src="/ttsvr/fcs/images/overview thumbs.jpg" alt="For organizations looking to improve compliance processes or reviewing environmental and sustainability programs, FirstCarbon Solutions delivers fully integrated consulting and data management solutions to meet your needs in an ever-changing world that increasingly demands sustainable business practices."></a><p class="brochure-details">For organizations looking to improve compliance processes or reviewing environmental and sustainability programs, FirstCarbon Solutions delivers fully integrated consulting and data management solutions to meet your needs in an ever-changing world that increasingly demands sustainable business practices.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/soq_environmental-022514_updated.pdf" target="_blank">FCS Environmental Services Statement of Qualifications (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/soq_environmental-022514_updated.pdf" title="FCS Environmental Services Statement of Qualifications (PDF)" target="_blank"><img src="/ttsvr/fcs/images/brochures-SOQ-environmental.png" alt="With a wide range of service areas, our global company brand, and a network of teaming partners, FCS will provide you with the innovative and comprehensive solutions that best address your unique needs and challenges."></a><p class="brochure-details">With a wide range of service areas, our global company brand, and a network of teaming partners, FCS will provide you with the innovative and comprehensive solutions that best address your unique needs and challenges.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/fcscdp_launchflyer_web_1213b.pdf" target="_blank">FCS' CDP Services (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/fcscdp_launchflyer_web_1213b.pdf" title="FCS' CDP Services (PDF)" target="_blank"><img src="/ttsvr/fcs/images/cdp-launch-flyer.png" alt="If carbon accounting and reporting are priorities for you, and you do not have the resources to properly manage them, FirstCarbon Solutions (FCS) can help. Our CDP experts can lead you through the entire process and help you choose the solution that's right for you."></a><p class="brochure-details">If carbon accounting and reporting are priorities for you, and you do not have the resources to properly manage them, FirstCarbon Solutions (FCS) can help. Our CDP experts can lead you through the entire process and help you choose the solution that's right for you.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/FCS_Energy_Management_Services_Brochure.pdf" target="_blank">FCS Energy Management Services (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/FCS_Energy_Management_Services_Brochure.pdf" title="FCS Energy Management Services (PDF)" target="_blank"><img src="/ttsvr/fcs/images/energy-thumbs.jpg" alt="If carbon accounting and reporting are priorities for you, and you do not have the resources to properly manage them, FirstCarbon Solutions (FCS) can help. Our CDP experts can lead you through the entire process and help you choose the solution that's right for you."></a><p class="brochure-details">If carbon accounting and reporting are priorities for you, and you do not have the resources to properly manage them, FirstCarbon Solutions (FCS) can help. Our CDP experts can lead you through the entire process and help you choose the solution that's right for you.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/fcs_datasheet_sustainabilityworkbench_nov_2013.pdf" target="_blank">FCS Sustainability Workbench Datasheet (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/fcs_datasheet_sustainabilityworkbench_nov_2013.pdf" title="FCS Sustainability Workbench Datasheet (PDF)" target="_blank"><img src="/ttsvr/fcs/images/brochures-swb2.png" alt="Simplify your company's reporting requirements with Sustainability Workbench. Easily monitor and manage your energy, sustainability and supply chain data in real time. Download the datasheet for more information."></a><p class="brochure-details">Simplify your company's reporting requirements with Sustainability Workbench. Easily monitor and manage your energy, sustainability and supply chain data in real time. Download the datasheet for more information.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/fcs_datasheet_ghgtrack_oct_2013.pdf" target="_blank">FCS ghgTrack Datasheet (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/fcs_datasheet_ghgtrack_oct_2013.pdf" title="FCS ghgTrack Datasheet (PDF)" target="_blank"><img src="/ttsvr/fcs/images/brochures-ghgtrack-datasheet2.png" alt="Are you looking for a complete carbon footprint management tool for your organization? Then ghgTrack is all you need. With ghgTrack, you have the capability to monitor your environmental metrics in real time in the format you want with customizable dashboards and data entry pages. Download the datasheet to know more."></a><p class="brochure-details">Are you looking for a complete carbon footprint management tool for your organization? Then ghgTrack is all you need. With ghgTrack, you have the capability to monitor your environmental metrics in real time in the format you want with customizable dashboards and data entry pages. Download the datasheet to know more.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/ghgtrack_app_note_111413.pdf" target="_blank">FCS Application Note (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/ghgtrack_app_note_111413.pdf" title="FCS Application Note (PDF)" target="_blank"><img src="/ttsvr/fcs/images/brochures-ghgtrack.png" alt="Many organizations today are taking a serious look at their sustainability issues. Whether driven by current and future government regulations, internal reporting, becoming more cost-efficient by monitoring power consumption or just creating a green corporate culture, FirstCarbon Solutions ghgTrack software is ideal for meeting their goals. This datasheet presents the comprehensive reports available in FirstCarbon Solutions ghgTrack, a robust greenhouse gas (GHG) report-tracking tool that enables organizations of any size to report and manage their data seamlessly."></a><p class="brochure-details">Many organizations today are taking a serious look at their sustainability issues. Whether driven by current and future government regulations, internal reporting, becoming more cost-efficient by monitoring power consumption or just creating a green corporate culture, FirstCarbon Solutions ghgTrack software is ideal for meeting their goals. This datasheet presents the comprehensive reports available in FirstCarbon Solutions ghgTrack, a robust greenhouse gas (GHG) report-tracking tool that enables organizations of any size to report and manage their data seamlessly.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/fcs_onesheet_green_real_estate_121113_us.pdf" target="_blank">Green Real Estate (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/fcs_onesheet_green_real_estate_121113_us.pdf" title="Green Real Estate (PDF)" target="_blank"><img src="/ttsvr/fcs/images/greenreonepager.png.jpg" alt="FirstCarbon Solutions green real estate solutions leverage our environmental expertise, software technology, carbon asset management, sourcing capabilities, and in-depth knowledge of the real-estate market."></a><p class="brochure-details">FirstCarbon Solutions green real estate solutions leverage our environmental expertise, software technology, carbon asset management, sourcing capabilities, and in-depth knowledge of the real-estate market.</p></div></div></li><li class="paginable-item"><div class="brochure"><div class="brochure-heading"><a href="/ttsvr/fcs/pdf/brochures/FCS_Energy_Management_Services_Brochure.pdf" target="_blank">ADEC Group Information Security & Controls (PDF)</div><div class="brochure-body"><a class="brochure-img" href="/ttsvr/fcs/pdf/brochures/FCS_Energy_Management_Services_Brochure.pdf" title="ADEC Group Information Security & Controls (PDF)" target="_blank"><img src="/ttsvr/fcs/images/energy-thumbs.jpg" alt="<ul class='brochure-details'>
<li>Security Standards & Best Practices</li>
<li>Security for Human & Physical Resources</li>
<li>Communications & Operations Management</li> 
<li>Access Control</li>
<li>Information Security</li>
<li>Development & Maintenance</li>
<li>Business Continuity Management</li>
<li>Compliance</li>
</ul>"></a><p class="brochure-details"><ul class='brochure-details'>
<li>Security Standards & Best Practices</li>
<li>Security for Human & Physical Resources</li>
<li>Communications & Operations Management</li> 
<li>Access Control</li>
