...
<section  ><%-- Widget fcs.pages.resources_videos@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_videos10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/resource_videos.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_videos@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_videos10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_videos10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_videos.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_videos10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_videos@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <span>Videos</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Consulting &amp; Sustainability Videos from FirstCarbon</h1></div></div>
<div  class="advanceRichtext"><div class="videoClips"><h3>Sustainability Solutions Anywhere in the World</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal0"><img src=/ttsvr/fcs/images/videoThumbs/company-video-thumb.png alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">To help create sustainable communities, FirstCarbon Solutions (FCS) delivers sustainability solutions worldwide. Discover the benefits of sustainability for your community and how a global environmental company like FCS can help you achieve them by watching this video.</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal0 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">Sustainability Solutions Anywhere in the World</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=148542100%2" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&vid=10&pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=614196105" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=537395846" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&vid=10&pid=2" name="flashvars"></object></object></div><p>To help create sustainable communities, FirstCarbon Solutions (FCS) delivers sustainability solutions worldwide. Discover the benefits of sustainability for your community and how a global environmental company like FCS can help you achieve them by watching this video.</p></div></div></div></div></div><div class="videoClips"><h3>FirstCarbon Solutions’ CDP Services Transforms Businesses</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal1"><img src=/ttsvr/fcs/images/videoThumbs/cdpvideo-thumb.jpg alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">FirstCarbon Solutions (FCS) transforms businesses around the world using a unique approach in helping companies improve their CDP performance and disclosures. Only FCS combines reliable consultations with scoring expertise to help supply chains become greener and improve companies’ access to capital in an increasingly low-carbon landscape. Watch the video to find out more about how FCS can help businesses improve their CDP performance.</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal1 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">FirstCarbon Solutions’ CDP Services Transforms Businesses</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=574684486" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=8&amp;pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=292661400" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=1050585318" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=8&amp;pid=2" name="flashvars"></object></object></div><p>FirstCarbon Solutions (FCS) transforms businesses around the world using a unique approach in helping companies improve their CDP performance and disclosures. Only FCS combines reliable consultations with scoring expertise to help supply chains become greener and improve companies’ access to capital in an increasingly low-carbon landscape. Watch the video to find out more about how FCS can help businesses improve their CDP performance.</p></div></div></div></div></div><div class="videoClips"><h3>Hollywood Central Park Freeway Project</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal2"><img src=/ttsvr/fcs/images/videoThumbs/hcp-video-thumb.jpg alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">With this one project, Los Angeles will address the economy, the environment, the health of its residents and their quality of life. Los Angeles will become the leader in sustainable cities and livable communities. We are proud to have the forward-thinking FirstCarbon Solutions as our partner to lead the project’s EIR process,” said Laurie Goldman, President of Friends of Hollywood Central Park (FHCP).</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal2 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">Hollywood Central Park Freeway Project</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=1232514499" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=8&amp;pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=343186125" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=1949071556" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=8&amp;pid=2" name="flashvars"></object></object></div><p>With this one project, Los Angeles will address the economy, the environment, the health of its residents and their quality of life. Los Angeles will become the leader in sustainable cities and livable communities. We are proud to have the forward-thinking FirstCarbon Solutions as our partner to lead the project’s EIR process,” said Laurie Goldman, President of Friends of Hollywood Central Park (FHCP).</p></div></div></div></div></div><div class="videoClips"><h3>California's Carbon Emissions Cap-and-Trade Program</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal3"><img src=/ttsvr/fcs/images/videoThumbs/bdl.png alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">California is testing the nation’s 1st full scale carbon market designed to reduce GHG emissions. In his interview with the New York Times*, Chris Easter shares his insight on the cap-and-trade program and how it heads off climate change. 

<small>*This video, which may be accessed on The New York Times’ website, was downloaded from The New York Times’ YouTube account.</small></p><div class="clearB"></div><hr /><div class="modal fade" id=myModal3 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">California's Carbon Emissions Cap-and-Trade Program</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=337698605" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=7&amp;pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=677023875" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=745608189" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=7&amp;pid=2" name="flashvars"></object></object></div><p>California is testing the nation’s 1st full scale carbon market designed to reduce GHG emissions. In his interview with the New York Times*, Chris Easter shares his insight on the cap-and-trade program and how it heads off climate change. 

<small>*This video, which may be accessed on The New York Times’ website, was downloaded from The New York Times’ YouTube account.</small></p></div></div></div></div></div><div class="videoClips"><h3>FirstCarbon on CNBC - Environment-friendly Bottles</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal4"><img src=/ttsvr/fcs/images/videoThumbs/cnbc-thumb.jpg alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">Plastic is the largest consumer of fossil fuels, right behind energy production and transportation. Plant-based material may be a better alternative, requiring less energy and emitting less greenhouse gases. See how Supply Chain and Life Cycle Assessment can help you optimize the use of your resources.</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal4 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">FirstCarbon on CNBC - Environment-friendly Bottles</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="380" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-4445535100%00" id="cnbcplayer"><param value="application/x-shockwave-flash" name="type"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="best" name="quality"><param value="noscale" name="scale"><param value="transparent" name="wmode"><param value="#000000" name="bgcolor"><param value="lt" name="salign"><param value="startTime=000" name="flashVars"><param value="endTime=000" name="flashVars"><param value="http://plus.cnbc.com/rssvideosearch/action/player/id/3000083864/code/cnbcplayershare" name="movie"> <embed width="100%" height="350" type="application/x-shockwave-flash" src="http://plus.cnbc.com/rssvideosearch/action/player/id/3000083864/code/cnbcplayershare" salign="lt" scale="noscale" wmode="transparent" quality="best" bgcolor="#000000" allowscriptaccess="always" allowfullscreen="true" pluginspage="http://www.macromedia.com/go/getflashplayer" name="cnbcplayer"></object></div><p>Plastic is the largest consumer of fossil fuels, right behind energy production and transportation. Plant-based material may be a better alternative, requiring less energy and emitting less greenhouse gases. See how Supply Chain and Life Cycle Assessment can help you optimize the use of your resources.</p></div></div></div></div></div><div class="videoClips"><h3>FirstCarbon Solutions - Run your business. Leave Sustainability to Us.</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal5"><img src=/ttsvr/fcs/images/videoThumbs/default.jpg alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">FirstCarbon Solutions - Run your business. Leave Sustainability to Us.] From manufacturers and real estate companies to healthcare and financial institutions, FirstCarbon Solutions helps our clients, and we'll help you, build the strategy you need to be more profitable and competitive now and down the road.</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal5 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">FirstCarbon Solutions - Run your business. Leave Sustainability to Us.</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=712537151" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=4&amp;pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=829889099" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=352446198" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=4&amp;pid=2" name="flashvars"></object></object></div><p>FirstCarbon Solutions - Run your business. Leave Sustainability to Us.] From manufacturers and real estate companies to healthcare and financial institutions, FirstCarbon Solutions helps our clients, and we'll help you, build the strategy you need to be more profitable and competitive now and down the road.</p></div></div></div></div></div><div class="videoClips"><h3>What Should We Be Measuring and Reporting for Sustainability</h3><div class="col-lg-2 col-md-3 noPadLeft"><a href="#" data-toggle="modal" data-target="#myModal6"><img src=/ttsvr/fcs/images/videoThumbs/awd.png alt="" class="img-responsive" /></a></div><p class="col-lg-10 col-md-9">What Should We Be Measuring and Reporting for Sustainability] FirstCarbon Solutions collaborates with clients to leverage energy management and sustainability and supply chain programs to achieve their bottom line goals. Reducing energy and consumption costs, slashing resource use and outputs, and operating more efficiently and competitively provide a direct and immediate path to greater profitability.</p><div class="clearB"></div><hr /><div class="modal fade" id=myModal6 tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title" id="myModalLabel">What Should We Be Measuring and Reporting for Sustainability</h4></div><div class="modal-body"><div class="videoEmbed"><object width="100%" height="350" name="player" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="player"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=475326288" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=5&amp;pid=2" name="flashvars"><object width="100%" height="350" data="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=996936074" type="application/x-shockwave-flash"><param value="http://www.firstcarbonsolutions.com/components/com_allvideoshare/player.swf?random=525728210" name="movie"><param value="opaque" name="wmode"><param value="true" name="allowfullscreen"><param value="always" name="allowscriptaccess"><param value="base=http://www.firstcarbonsolutions.com/&amp;vid=5&amp;pid=2" name="flashvars"></object></object></div><p>What Should We Be Measuring and Reporting for Sustainability] FirstCarbon Solutions collaborates with clients to leverage energy management and sustainability and supply chain programs to achieve their bottom line goals. Reducing energy and consumption costs, slashing resource use and outputs, and operating more efficiently and competitively provide a direct and immediate path to greater profitability.</p></div></div></div></div></div></div>
</div>
