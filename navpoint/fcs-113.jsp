...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <span>Reports and White Papers</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Reports and White Papers from FirstCarbon Solutions &ndash; Environmental Sustainability Consultants</h1>
<p>FirstCarbon Solutions produces special reports and white papers about various industry issues and regulatory updates, and our team of experts have written articles featured in a variety of publications. Below are our latest papers and articles, which you can download in a PDF format.</p></div></div>
<div  class="advanceRichtext"><%-- Widget fcs.pages.resources_reportsAndWhitePapers@13 (type=tooltwist.fcs.widgets.ContentSliderWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers13ContentSlider";
	String snippetVar_ipp = "6";
	String snippetVar_widgetName = "@13";
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers@13";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers@13 (type=tooltwist.fcs.widgets.ContentSliderWidget)", e);
}
%>
</div>
<div  class="advanceRichtext"><ul class="paginable-container"><li class="paginable-item"><h3>Intelligent Site Selection</h3><p>A checklist for minimizing costs and avoiding delays in site selection.</p><a href="intelligent-site-selection" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Carbon Accounting Methods for Estimating Scope 3 Emissions</h3><p>Create a comprehensive greenhouse gas (GHG) inventory by measuring emissions across your entire value chain. Download this white paper for you to gain helpful insights on how you can start tracking GHGs from the most expansive of sources—your Scope 3 emissions.</p><a href="carbon-accounting-methods-for-estimating-scope-3-emissions" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Utility Energy Data Management</h3><p>Learn how to reduce your energy consumption, gain control of your energy spending and increase productivity and profitability.</p><a href="utility-energy-data-management" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Species Calendar</h3><p>This simple calendar details survey protocol guidelines for some of the most common focused surveys in Southern California to help you stay ahead of the windows.</p><a href="species-calendar-download-for-survey-season" class="btn btn-info btn-sm dl">Download the Calendar <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Mastering 'Big Data' in Environmental Sustainability</h3><p>Get insights and guidance to wade through the big data challenge. The white paper explores the key components for successfully managing environmental sustainability data, from defining and narrowing the universe of data for your company to the tools to help manage and apply those data.</p><a href="mastering-big-data-in-environmental-sustainability" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Snapshot on the UK Mandatory Greenhouse Gas Disclosure</h3><p>The UK will soon be implementing new regulations in 2013, requiring greenhouse gas emissions to be reported.</p><a href="snapshot-on-the-uk-mandatory-greenhouse-gas-disclosure" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>California Community-Wide Greenhouse Gas Baseline Inventory Protocol White Paper</h3><p>Read on to find out more about creating GHG baseline inventories around cities and counties in California. The white paper discusses in detail geographic/jurisdictional boundary delineation, GHG sources to measure, as well as tools and methods to use in creating a GHG baseline inventory.</p><a href="california-community-wide-greenhouse-gas-baseline-inventory-protocol" class="btn btn-info btn-sm dl">Download the White Paper <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Summer 2009 Edition of the Association of Environmental Professionals Environmental Monitor</h3><p>Read the full version of the Summer 2009 Edition of the AEP's Environmental Monitor to understand more about California GHG thresholds and stormwater runoff.</p><a href="summer-2009-edition-of-the-association-of-environmental-professionals-environmental-monitor" class="btn btn-info btn-sm dl">Download the Article <span class="glyphicon glyphicon-download-alt"></span></a><hr></li><li class="paginable-item"><h3>Fall 2009 Edition of the Association of Environmental Professionals Environmental Monitor</h3><p>Find out how to incorporate climate change risks in your CEQA documents by reading this white paper.</p><a href="fall-2009-edition-of-the-association-of-the-environmental-professionals-environmental-monitor" class="btn btn-info btn-sm dl">Download the Article <span class="glyphicon glyphicon-download-alt"></span></a><hr></li></ul></div>
</div>
