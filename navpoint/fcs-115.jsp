...
<section  ><%-- Widget fcs.pages.newsAndEvents_webinars_lcf@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_webinars_lcf10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_webinars_lcf@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_webinars_lcf10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_webinars_lcf10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_webinars_lcf10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_webinars_lcf@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-107">Webinars and Presentations</a> &raquo; <span>LCF-CSR EXPO 2012 Transforming the Business of Giving </span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>LCF-CSR EXPO 2012 Transforming the Business of Giving Back</h1>
<p>With the rising environmental costs, governments and regulatory bodies have stepped up the implementation of measures to encourage businesses and organizations to address sustainability issues, and achieve the triple bottom line of people, planet and profitability.</p>
<p>For the last few years, the number of businesses injecting sustainability and energy efficiency into their corporate agenda has dramatically increased. In a study conducted by Ernst &amp; Young, environmental and social proposals increased by 30 percent in 2011, accounting for 40 percent of all shareholders' resolutions reaching proxy ballot. This is proof of the many tangible benefits that a comprehensive social impact management plan (SIMP) can bring for a company, foremost of which is reducing costs, managing risks, and higher ROI's.</p>
<p>However, balancing sustainability and financial profitability is still a dilemma for most organizations. James Donovan, President &amp; CEO of FirstCarbon Solutions, presented valuable insights and expert knowledge on the impacts and benefits of effective SIMP's to participating companies during the <strong>11th CSR Expo held at the SM Convention Center in Manila, Philippines. </strong></p>
<p><a href="/ttsvr/fcs/pdf/brochures/managing_and_reporting_on_social_impact.pdf" target="_blank">Download the presentation here.</a></p></div></div>
</div>
