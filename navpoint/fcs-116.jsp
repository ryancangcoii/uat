...
<section  ><%-- Widget fcs.pages.newsAndEvents_webinars_sustainabilitylive@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_webinars_sustainabilitylive10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_webinars_sustainabilitylive@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_webinars_sustainabilitylive10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_webinars_sustainabilitylive10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_webinars_sustainabilitylive10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_webinars_sustainabilitylive@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-107">Webinars and Presentations</a> &raquo; <span>Sustainabilitylive! 2012 Seminar Programme - Demand for Carbon Transparency in Global Supply Chains</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainabilitylive! 2012 Seminar Programme - Demand for Carbon Transparency in Global Supply Chains</h1>
<p>According to 2008 McKinsey Quarterly report, 40-60% of a company's carbon footprint resides within the supply chain. CDP's 2011 Supply Chain Report noted that more than 50% of an average corporation's carbon emissions are outside its four walls.</p>
<p>Businesses today are not only looking to reduce their carbon footprint, they are examining the green credentials of their suppliers. Therefore, identifying, tracking and managing supply chain emissions is critical.</p>
<p>The <a href="https://www.cdproject.net/en-US/Programmes/Pages/CDP-Supply-Chain.aspx" target="_blank">Carbon Disclosure Project (CDP) Supply Chain programme</a> offers a practical scoring system enabling industry benchmarking and removing existing complexities related to supplier carbon data collection.</p>
<p>The benefits of supplier scoring include a comparable metric for them to analyze and prioritize risk in the supply chain and the ability to highlight areas for improvement and share best practices.</p>
<p>Carbon reporting across the supply chain is becoming more common &ndash; and in some cases expected. The time has come for organizations to prepare themselves with the right systems and processes to meet this new requirement.</p>
<p>This presentation is for participants who are interested in learning how to provide and assess the information necessary for effective carbon management along the supply chain.As CDP's Supply Chain partner, FirstCarbon Solutions has a unique perspective on the importance of supply chain transparency and will enable participants to learn the supplier requirements to provide accurate data to customers, including the back office processing necessary to fully disclose an accurate carbon footprint, and how, with this information, customers can make significant improvements in supply chain sustainability.</p>
<p><a href="/ttsvr/fcs/pdf/brochures/charles_hansard_wed_firstcarbon_solutions_final.pdf" target="_blank">Download Presentation here</a></p>
<p><strong>About the Speaker </strong><br /> Charles Hansard has 15 years in the environmental sector. With a degree from Cranfield University, Charles worked for Veolia Environmental Services running four waste incinerators where he pioneered the UK's first Waste Incinerator Ash Recycling plant taking in 120,000 tons of ash, removing all ferrous and non-ferrous metals, and converting the remaining ash into aggregate for roads. In addition, Charles worked for Hanson Recycled Aggregates.</p>
<p>Before joining FirstCarbon Solutions, Charles was the Director at Biofriendly Europe, a company specializing in combustion catalysts to improve efficiency in large generating engines, ship engines, and coal fired power stations.</p></div></div>
</div>
