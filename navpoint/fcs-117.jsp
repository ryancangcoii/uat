...
<section  ><%-- Widget fcs.pages.newsAndEvents_webinars_whatShouldWe@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_webinars_whatShouldWe10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_webinars_whatShouldWe@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_webinars_whatShouldWe10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_webinars_whatShouldWe10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_webinars_whatShouldWe10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_webinars_whatShouldWe@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-107">Webinars and Presentations</a> &raquo; <span>What Should We Be Measuring & Reporting for Sustainability?</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>What Should We Be Measuring &amp; Reporting for Sustainability?</h1>
<p>With sustainability reporting becoming the norm for large organizations, sustainability directors are faced with the question of what data to report on, and how to reliably measure it. In this webinar we will explore the Global Reporting Initiative, and how to collect good quality data.</p>
<p>With presenters Kye Gbangbola, Total Eco Management and Charles Hansard, FirstCarbon Solutions and hosted by <a href="http://www.firstcarbonsolutions.com/">2degrees</a>, download this webinar to:</p>
<ul>
<li>Learn why good reporting on sustainability is important and useful to an organization's bottom line.</li>
<li>Clarify what data is pertinent in reporting for sustainability and where to find it.</li>
<li>Discover the best methods to reliably measure this data.</li>
<li>Find out what is involved in the Global Reporting initiative.</li>
</ul></div></div>
</div>
