...
<section  ><%-- Widget fcs.pages.newsAndEvents_webinars_cdpSupplyChain@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_webinars_cdpSupplyChain10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_webinars_cdpSupplyChain@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_webinars_cdpSupplyChain10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_webinars_cdpSupplyChain10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_webinars_cdpSupplyChain10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_webinars_cdpSupplyChain@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-107">Webinars and Presentations</a> &raquo; <span>CDP Supply Chain Report Launch and Roundtable: Realizing & Demonstrating Value</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CDP Supply Chain Report Launch and Roundtable: Realizing &amp; Demonstrating Value</h1>
<p>Watch playback of the CDP 2012 Supply Chain Roundtable to understand how companies are using emissions data from their supply chain, hear about new business opportunities and learn more about why action on carbon emissions should be at the heart of every business strategy.</p>
<p>A select group of high profile executives from the members of CDP Supply Chain, including Chet Chaffee from FirstCarbon Solutions, gathered to share their experiences and best practice in rising to current challenges as well as their aspirations for new development in this area of carbon management. This year the focus of the report and roundtable event was on the shift in procurement models in response to gains made in response to climate change. Companies are realizing opportunities and mitigating risk from climate change in their own operations and they're asking their suppliers to follow suit.</p>
<p>The event, which took place across five cities, also launched the CDP Supply Chain 2012 Global Report. The report analyzes the responses from over 1800 suppliers across a wide range of sectors and geographic locations.</p></div></div>
</div>
