...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_CarbonAccountingMethodsEstimatingScope3Emissions@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Carbon Accounting Methods for Estimating Scope 3 Emissions</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Carbon Accounting Methods for Estimating Scope 3 Emissions</h3>
<p>As the effects of climate change become more pronounced, governments, corporations and individuals are becoming more concerned with their own contributions to climate change. Many are actively engaging in discussions on managing climate change and measuring their "carbon footprint", or greenhouse gas (GHG) emissions resulting from products or activities, to identify strategies to reduce their climate impacts.</p>
<p>The Greenhouse Gas Protocol (GHG Protocol) is the accounting tool used for companies around the world to understand, quantify, and manage greenhouse gas emissions. It provides standards and guidance to prepare a GHG emissions inventory and is classified into three "scopes", based on their sources:</p>
<ul>
<li>Scope 1 emissions include direct GHG emissions from sources that are owned or controlled by the entity. For example, emissions from fossil fuels burned on-site, and emissions from entity-owned or entity-leased vehicles are Scope 1.</li>
<li>Scope 2 emissions include indirect GHG emissions from the generation of purchased electricity, heating and cooling, or steam generated off-site. In addition, the transmission and distribution (T&amp;D) losses associated with certain purchased utilities are included in Scope 2.</li>
<li>Scope 3 emissions are indirect GHG emissions from sources not owned or directly controlled by the entity, but related to the entity's activities. For example, employee travel and commuting, T&amp;D losses associated with purchased electricity, contracted solid waste disposal, contracted wastewater treatment, leased space, vendor supply chains, and use of sold products are Scope 3.</li>
</ul>
