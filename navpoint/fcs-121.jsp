...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_UtilityEnergyDataManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_UtilityEnergyDataManagement10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_UtilityEnergyDataManagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_UtilityEnergyDataManagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_UtilityEnergyDataManagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_UtilityEnergyDataManagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_UtilityEnergyDataManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Utility Energy Data Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Utility Energy Data Management</h3>
<p>The energy industry and, more specifically, those employing utility services are in the process of an information and efficiency revolution. For example, the US and Canadian combined gas and electric efficiency program budgets reached $9.1 billion in 2011, an increase of 21 percent, up from $7.5 billion in 2010. Internal and external pressures are placing increased demands on corporate CEOs, real estate owners and energy management executives. The ability to collect and disseminate information, and take advantage of every opportunity to increase energy savings is becoming so critical that it is influencing productivity and profitability.</p>
<p>Companies that understand and set energy objectives, measure and report energy consumption, analyze the data, and modify their existing energy culture quickly benefit from these cost-saving measures, resulting in a substantial competitive advantage.</p>
<p><img class="img-responsive" src="../fcs/images/utility-01.png" alt="" /></p>
<p>Energy is costly for businesses. In fact, according to ENERGY STAR&reg;, US businesses spend $107.9 billion annually powering commercial building space. Add industrial facilities and the total cost of power for commercial and industrial facilities rises to $202.3 billion. For many commercial operators, utility expenses can be their third-largest budget line item, often trailing labor and materials. The US Department of Energy (DOE) estimates that commercial facilities account for up to 50 percent of electricity use, nearly 30 percent of which is wasted through controllable inefficiencies such as:</p>
<ul>
<li>inaccurate data accumulation caused by enlisting too many different third-parties</li>
<li>office use and behavior of tenants</li>
<li>difficult data gaps created by multiple types of Business Management Systems (BMS) deployed throughout a portfolio</li>
<li>lack of a baseline due to incomplete historical data.</li>
</ul>
<p>&nbsp;</p>
<p>To view the full white paper, please complete the form on the right.</p></div></div>
</div>
<div  class="sec2RightCont col-sh  col-lg-3 col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>DOWNLOAD THE FULL WHITE PAPER</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/b1a7724b-b8a5-465a-9df1-55eaa02e5268" method="POST" role="form" novalidate>
