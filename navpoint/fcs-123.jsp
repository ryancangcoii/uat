...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_MasteringBigDataEnvironmentalSustainability@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Mastering ‘Big Data’ in Environmental Sustainability</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Mastering &lsquo;Big Data&rsquo; in Environmental Sustainability</h3>
<p>1.8 trillion gigabytes.</p>
<p>Can you imagine handling all this data, finding what you really need and make sense of it all?</p>
<p>But wait, there&rsquo;s more. Big Data is growing. At its current pace, by 2016, the amount of data out there would have grown to 800% its size in 2012. At this rate, it&rsquo;s pretty easy to get swallowed up.</p>
<div class="text-center">
<h3>Data Volume Growth in the Next Five Years</h3>
<img class="img-responsive inline-block" src="../fcs/images/graphs-whitepaper.jpg" alt="" /></div>
<p>This white paper provides topline insights and guidance&nbsp;by showing&nbsp;key components to <strong>successfully manage&nbsp;environmental sustainability data</strong> - from defining and&nbsp;narrowing this universe of data to the&nbsp;tools that will help you manage and apply them.</p>
<p>To download the full white paper, please complete the form on the right.</p></div></div>
</div>
