...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_SnapshotUKMandatoryGreenhouseGasDisclosure@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Snapshot on the UK Mandatory Greenhouse Gas Disclosure</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Snapshot on the UK Mandatory Greenhouse Gas Disclosure</h3>
<p>For decades, the UK has been at the forefront of leading European&nbsp;environmental policy. With the announcement that UK-listed&nbsp;companies will soon be required to disclose greenhouse gas (GHG)&nbsp;emissions starting from 2013, the UK will maintain this leadership&nbsp;role.</p>
<p>The UK Government has officially acknowledged the reality of&nbsp;climate change and, in January 2012, it published a UK-wide&nbsp;Climate Change Risk Assessment to be able to form a National&nbsp;Adaptation Program. No room for delayed action as scientists and&nbsp;public opinion have been crying out.</p>
<p>In particular, the UK Government has acknowledged the economic&nbsp;implications that energy security risks pose. When we look at the&nbsp;country&rsquo;s energy mix, it is primarily made of fossil fuels, consisting&nbsp;of the following:</p>
<div class="text-center"><img class="img-responsive inline-block" src="../fcs/images/piechart-whitepaper.jpg" alt="" /></div>
<p>The very source of electricity coupled with business dependence on&nbsp;large fixed or natural assets (e.g. infrastructure and/or materials)&nbsp;and on long and complex supply chains (e.g. products and raw&nbsp;materials) determines the vulnerability of the UK&rsquo;s diverse&nbsp;business sectors and industries.</p>
