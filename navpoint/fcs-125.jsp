...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_CaliforniaCommunityWideGreenhouseGasBaselineInventoryProtocol@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>California Community-Wide Greenhouse Gas Baseline Inventory Protocol</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>California Community-Wide Greenhouse Gas Baseline Inventory Protocol</h3>
<p>The amendments to the CEQA Guidelines for greenhouse gas emissions adopted by the Natural Resources Agency gave way to the tiered and streamlined analysis of GHG emissions. This prompted cities and counties in California to create their own greenhouse gas inventories. However, cities and counties around California needed some guidelines before creating their own GHG inventories.</p>
<p>The California Community-Wide Greenhouse Gas Baseline Inventory Protocol white paper serves as a substantial guide for all cities and counties so that GHG reports from all over the state can be standardized. It contains detailed discussions on geographic/jurisdictional boundary delineation, GHG sources to measure, as well as tools and methods to use in creating a GHG inventory.</p>
<p>The white paper showcases tools and methods for measuring and monitoring greenhouse gases from mobile and stationary sources as well as those from the water, solid waste, electricity, and agriculture sectors.&nbsp; Chapters on geographic/jurisdictional delineation and carbon sequestration of natural lands include discussion on quantifying methods for use in creating comprehensive GHG inventories.</p>
<p>With GHG baseline inventories, you can create a complete plan to reduce GHGs, project future emissions, perform gap analyses, identify targets, strategize your reductions, and then monitor your GHG emissions.</p>
<p>To get a free copy of your guide to creating GHG baseline inventories download the full white paper by filling out the form on the right side of this webpage.</p></div></div>
</div>
