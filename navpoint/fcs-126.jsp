...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_Summer2009EditionAssociationEnvironmentalProfessionalEnvironmentalMonitor@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Summer 2009 Edition of the Association of Environmental Professionals Environmental Monitor</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Summer 2009 Edition of the Association of Environmental Professionals Environmental Monitor</h3>
<p>In its summer 2009 edition, The Environmental Monitor featured information on California greenhouse gas thresholds and stormwater runoff.</p>
<p>This white paper includes an article which elaborates on the inception of greenhouse gas thresholds for use in CEQA documents. The article discusses how air districts as well as cities and counties in California conceptualized their respective GHG thresholds. A checklist of guide questions for incorporating greenhouse gas emissions into CEQA documents is also included in the article.</p>
<p>The white paper also contains an article on stormwater runoff, particularly on an approach for evaluating its long-term impacts and identifying mitigation measures for development projects.&nbsp; The article explains in detail the NPDES permit requirements for development projects. A section on BMP and performance standard requirements for regulated development projects discusses hydromodification control requirements and water quality management planning. The article also has helpful discussions on preparing impacts analysis for an EIR and identifying measures for mitigating the effects of stormwater runoff.</p>
<p>An informative annotated bibliography listing books and periodical articles on environmental planning can also be seen in this white paper.</p>
<p>To read about GHG thresholds and stormwater runoff in detail, download your full version of this white paper by filling out the form on the right side of this webpage.</p></div></div>
</div>
