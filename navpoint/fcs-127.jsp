...
<section  ><%-- Widget fcs.pages.resources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_reports_whitepapers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_reportsAndWhitePapers_Fall2009EditionAssociationEnvironmentalProfessionalsEnvironmentalMonitor@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-113">Reports and White Papers</a> &raquo; <span>Fall 2009 Edition of the Association of the Environmental Professionals Environmental Monitor</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Fall 2009 Edition of the Association of the Environmental Professionals Environmental Monitor</h3>
<p>This white paper highlights the important considerations for incorporating climate change risks while preparing CEQA documents.</p>
<p>Recommendations for addressing climate change risks from the California Climate Change Adaption Strategy Discussion Draft (Draft CAS) are briefly discussed in this white paper.</p>
<p>A helpful summary of addressing potential climate risks in CEQA documents presented in tabular form is included in this excerpt from the fall 2009 Environmental Monitor.</p>
<p>Download a full version of this white paper by filling out the form on the right side of the webpage.</p></div></div>
</div>
