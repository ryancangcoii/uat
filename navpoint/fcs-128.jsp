...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_CDPFCSPIISLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_CDPFCSPIISLCCP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_CDPFCSPIISLCCP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_CDPFCSPIISLCCP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_CDPFCSPIISLCCP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_CDPFCSPIISLCCP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_CDPFCSPIISLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<address>Steve Fiore SS|PR Ph: +1-847-415-9329 Email: <a href="mailto:sfiore@sspr.com">sfiore@sspr.com</a></address></div>
<div class="col-sm-6 col-md-6 col-lg-6"><address>Penny Cross Communications Director Ph: +44 (0) 20 7415 7083 +44 7919 074 92<br /> Email: <a href="mailto:penny.cross@cdp.net">penny.cross@cdp.net</a></address></div>
</div>
