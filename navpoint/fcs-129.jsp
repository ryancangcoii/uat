...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSCEOEHIMOAPB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSCEOEHIMOAPB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSCEOEHIMOAPB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSCEOEHIMOAPB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSCEOEHIMOAPB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSCEOEHIMOAPB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSCEOEHIMOAPB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solution&rsquo;s CEO Elected to HIMOAP Board</h1>
<p>Manila, Philippines, December 3, 2013 &ndash; ADEC Group Global President and FirstCarbon Solutions (FCS) Chief Executive Officer James M. Donovan was elected to the Board of Trustees of the Healthcare Information Management Outsourcing Association of the Philippines (HIMOAP) yesterday, December 2, 2013.</p>
<p>The top executive of FCS and ADEC Group, a leading provider of business and knowledge process outsourcing solutions, was voted as one of HIMOAP&rsquo;s trustees along with other leaders of the Health Information Management (HIM) industry.</p>
<p>The HIMOAP Board of Trustees is made up of 9 representatives from member companies elected by the body&rsquo;s members. Seven of the slots are reserved for representatives of HIM providers while the other two are for officials of HIM training institutions.</p>
<p>In his letter to the members, Mr. Donovan said that ADEC Group is the only Philippine-based BPO firm to have expanded worldwide: &ldquo;ADEC Group has grown into a global enterprise with over 5,500 professionals located across Australia, North America, Africa and Asia. To date, it is the only domestic BPO company that has grown organically from the Philippines as a BPO brand.&rdquo;</p>
<p>PharmaKPO, a member of ADEC Group and a member of HIMOAP, was established in 2011 as a joint venture with global pharmaceutical leader Zuellig Pharma. PharmaKPO&rsquo;s healthcare solutions services and ADEC Group&rsquo;s BPO capabilities puts Mr. Donovan in a position to share valuable expertise towards achieving the HIMOAP&rsquo;s objectives.</p>
<p>Prior to his election to the HIMOAP Board, Mr. Donovan served as a panelist in the 4<sup>th</sup> Healthcare Information Management Outsourcing Services Congress (HIMOSC).</p>
<p>In the HIMOAP-sponsored Congress, Mr. Donovan discussed important topics from the sector&rsquo;s role in the local and global economy, and how to make the HIM industry more attractive to foreign investors.&nbsp;&nbsp; He stressed that aspiring and current industry players should have the capability to handle Big Data to remain competitive in the future of healthcare outsourcing.</p>
