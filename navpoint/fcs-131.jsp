...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSONSJOFHBAC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSONSJOFHBAC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSONSJOFHBAC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSONSJOFHBAC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSONSJOFHBAC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSONSJOFHBAC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSONSJOFHBAC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Opens New San Jose Office to Further Help Bay Area Clients</h1>
<h3>Improve Sustainability and Operate More Efficiently</h3>
<p><em>San Jose Becomes the Second Location Providing Sustainability and Environmental Services to the San Francisco Bay Area</em></p>
<p><strong>IRVINE, CA - </strong>(November 5, 2013) &ndash;<a href="../">FirstCarbon Solutions</a> (FCS), a pioneer and industry leader in <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/sustainability">environmental sustainability business solutions</a>, today announced the opening of a new office located in San Jose, California. The location was strategically chosen, as both San Jose and neighboring San Francisco are consistently ranked as high-growth areas for a wide variety of tech, financial, and service businesses. FCS is currently hiring experienced staff members for the new office location.</p>
<p>The San Jose office will enable FCS to offer its cost-effective <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/sustainability">sustainability solutions</a> to clients throughout the Bay Area that want to run their business more profitably and sustainably. It is complemented by FCS&rsquo; current East Bay office in Walnut Creek, with both locations offering FCS&rsquo; key environmental and sustainability services including <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/environmental">environmental planning</a>, <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/environmental/cultural-resources-management">cultural</a> and <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/environmental/natural-resources-management">natural resource management</a>, <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/environmental/environmental-compliance">compliance</a>, <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/entitlements-permitting">permitting</a>, <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/environmental/air-traffic-and-noise-assessments">air and noise services</a>, <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/energy">energy</a> and <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/sustainability/carbon-management">carbon management</a>, supply chain and <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessments</a>, and <a href="https://www.firstcarbonsolutions.com/solutions/by-service/software">software</a> and <a href="https://www.firstcarbonsolutions.com/solutions/by-service/data-processing">data processing services</a>.</p>
<p>&ldquo;Sustainability is becoming a core concern for businesses and governments that want to reduce their impact while maintaining growth and improved efficiency,&rdquo; said Robert Francisco, president, FCS. &ldquo;We chose San Jose for our latest Bay Area location because it is a strong growth market with a wealth of companies that truly care about aiding the environment through sound resource management. San Jose joins our other <a href="https://www.firstcarbonsolutions.com/about-us/contact-us">offices throughout the world</a>, which all work together to help our corporate, government, and institutional clients manage their sustainability and environmental practices more effectively and efficiently.&rdquo;</p>
<p>The new office location:</p>
<address>FirstCarbon Solutions<br />2540 N. First Street, Suite 290<br /> San Jose, CA 95131</address>
