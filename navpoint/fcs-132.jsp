...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSOKOSSEAA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSOKOSSEAA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSOKOSSEAA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSOKOSSEAA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSOKOSSEAA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSOKOSSEAA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSOKOSSEAA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Opens Kenya Office to Support Sustainability Efforts across Africa</h1>
<p style="text-align: left;" align="center"><em>New Nairobi location will meet the pressing need for cost-effective environmental best practices in developing African nations.</em></p>
<p><strong>NAIROBI, KENYA and IRVINE, CALIFORNIA - </strong>(October 28, 2013) &ndash; In conjunction with its participation in the Global South-South Development Expo (GSSD) 2013, <a href="http://www.firstcarbonsolutions.com/">FirstCarbon Solutions</a>, a pioneer and industry leader in <a href="../by-focus/sustainability">environmental sustainability business solutions</a>, today announced the opening of a new office in Nairobi, Kenya. The new location provides services and strategic support to organizations across Africa facing unique sustainability challenges.</p>
<p>The FirstCarbon Solutions (FCS) global team will offer a variety of services through its new Nairobi location, including <a href="../by-focus/environmental">environmental planning</a>, <a href="../by-focus/environmental/natural-resources-management">resource management</a>, environmental and <a href="../by-focus/energy">energy management</a>, <a href="../by-focus/supply-chain">supply chain</a> and <a href="../by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessments</a>, and program management and infrastructure support.</p>
<p>Hosted by the United Nations Environment Programme, the GSSD Expo&rsquo;s overarching theme, &ldquo;<em>Building Inclusive Green Economies: South-South Cooperation for Sustainable Development and Poverty Eradication</em>&rdquo; is aligned with FCS&rsquo; sustainability goals worldwide. FCS will be showcasing its environmental projects and results with public and private organizations around the globe.</p>
<p>&ldquo;Sustainable growth in emerging African economies is crucial to creating a healthier future for the region,&rdquo; said James Donovan, CEO, FirstCarbon Solutions. &ldquo;Leveraging our technical expertise in professional services, software and business process outsourcing, FCS is committed to providing customized end-to-end solutions to allow African businesses and governmental organizations alike to make real progress, reduce costs, improve operational efficiencies and optimize resources.&rdquo;</p>
<p>With solutions that are well proven in other parts of the world, FCS provides the means by which sustainable change can be achieved in the developing world.</p>
<p>The GSSD will be held at the United Nations Office at Nairobi from 28 October to 01 November, 2013.</p>
