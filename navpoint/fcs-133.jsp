...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSERCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSERCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSERCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSERCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSERCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSERCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSERCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Expands Regulatory Compliance Services</h1>
<p><em>Leader In Environmental and Sustainability Business Solutions Improves Services to Support Complex, Multijurisdictional Projects and Helps Organizations Cost-Effectively Navigate Regulatory Landscape</em></p>
<p>IRVINE, CA (July 31, 2013) &ndash; In an effort to help organizations overcome the challenges of sustainability in an increasingly regulated environment, FirstCarbon Solutions (FCS), a pioneer and industry leader in environmental and sustainability business solutions, today announced it is expanding its regulatory compliance services. As part of the expansion, FCS is now able to assist both public and private organizations in developing strategies, ensuring compliance with natural resource regulations, and implementing associated policies, guidelines, executive orders, and state and local permitting requirements.&nbsp;</p>
<p>As a result of this service expansion, FCS&rsquo;s nationwide team of expert professionals is able to manage large-scale projects that require environmental planning, permitting or compliance services.&nbsp; These services include, but are not limited to, comprehensive natural community assessments, wetland delineation and mitigation, water quality assessment and testing, vegetation mapping/identification/restoration, wildlife surveys, cultural resource assessments, and construction monitoring.</p>
<p>Regulatory issues can be both confusing and time consuming, and the continuous changes in guidance, case law or administration make the process even more complex.&nbsp; As a company at the forefront of sustainability and environmental solutions, FCS provides services to help organizations navigate the regulatory landscape. Facing a complex, overlapping set of regulations that may have conflicting obligations and restrictions, project proponents need to wade through seemingly arbitrary compliance mandates across federal, state, and local permitting requirements, including the National Environmental Policy Act (NEPA), Clean Water Act, the Endangered Species Act, Coastal Zone Management Act, and the National Historic Preservation Act.&nbsp; For long linear projects such as power transmission, oil &amp; gas, water, or transportation projects, even compliance with statewide regulations may vary depending on the regional or district office of the regulatory authority.</p>
<p>&ldquo;At FCS, we are thoroughly familiar with the regulations, the process and the regulatory agencies,&rdquo; said Robert A. Francisco, President, FCS. &ldquo;With our regulatory compliance service expansion, we will now be able to participate in even more complex, linear and/or regional projects that cross multiple jurisdictions.&rdquo;</p>
<p>As the only company to have in-depth, broad environmental and sustainability expertise combined with extensive data processing capabilities that can be rapidly mobilized to augment or free up internal resources, FCS enables organizations to focus on their core activities and more strategic initiatives.</p>
<p>According to Francisco, FCS&rsquo;s regulatory specialists help organizations navigate through the often-complicated compliance process as accurately and efficiently as possible, balancing the need for local development while making a difference by protecting the natural environment. &ldquo;Our compliance experts are the eyes and ears of public and private organizations, ensuring that today&rsquo;s executives understand the current environment and where trends are taking us,&rdquo; he said. &ldquo;We can help directly link a company&rsquo;s compliance programs to profitability and business efficiency; providing a clear picture of an organization&rsquo;s environmental performance can be used not only for reporting but also for optimizing operations and resource efficiency to reduce costs and risks.&rdquo;</p>
<p>A member of ADEC Group, a global enterprise with more than 5,000 employees and operations in North America, Europe, Asia and Australia, FCS&rsquo; regulatory specialists have decades of experience within government and industry. They routinely work with clients and regulatory agencies to minimize permitting timeframes and hurdles to &nbsp;streamline the approval process, frequently interfacing with the U.S. Army Corps of Engineers, U.S. Environmental Protection Agency, the U.S. Fish and Wildlife Service, the National Marine Fisheries Service, state and local departments of environmental protection, environmental conservation, and natural resources.</p>
