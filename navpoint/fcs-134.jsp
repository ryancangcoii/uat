...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSEPCDPESSC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSEPCDPESSC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSEPCDPESSC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSEPCDPESSC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSEPCDPESSC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSEPCDPESSC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSEPCDPESSC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Expands its Partnership with CDP, Enhancing Sustainability Scoring Capabilities</h1>
<p><em>In addition, FirstCarbon Solutions now recognized as official CDP Silver Carbon Calculation Partner, Gold Consultancy Partner and Response Checker</em></p>
<p>IRVINE, CA and LONDON, UK (June 25, 2013) - <a href="http://www.firstcarbonsolutions.com/">FirstCarbon Solutions</a> (FCS) and <a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx">CDP</a>, today announce their expanded partnership to increase services that measure supply chain carbon management and extend sustainability scoring to CDP&rsquo;s climate change program in the Nordic and Benelux regions, Australia, New Zealand and India.&nbsp; FCS, a pioneer and industry leader in <a href="https://www.firstcarbonsolutions.com/solutions/by-focus/sustainability">environmental sustainability solutions</a> for business, and CDP, an international not-for-profit organization that works with the world&rsquo;s largest investors and corporations to motivate companies and cities to disclose their impacts on the environment and take action to reduce them, have been working together since 2011.</p>
<p>As the exclusive <a href="http://www.firstcarbonsolutions.com/cdp">scoring partner</a> of CDP&rsquo;s supply chain program, FCS reviews and scores thousands of responses provided by participating suppliers. Leveraging its proven <a href="http://www.firstcarbonsolutions.com/solutions/by-service/data-processing">sustainability reporting systems and data management</a> and <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting-beyond-inventory">carbon accounting</a> expertise, FCS has built a system based on <a href="https://www.cdproject.net/en-US/Pages/guidance-climate-change.aspx#scoring">CDP&rsquo;s global methodology</a> to evaluate and score CDP responses in a comprehensive, standardized way. These scores allow the 65 members of <a href="https://www.cdproject.net/en-US/Programmes/Pages/CDP-Supply-Chain.aspx#membership">CDP&rsquo;s supply chain program</a> &ndash; including multinationals like Unilever, The Coca-Cola Company, and Walmart &ndash; to benchmark environmental performance, examine practices and develop year-on-year performance improvements.</p>
<p>&ldquo;Transparency is critical to reducing emissions, driving operational efficiencies and reinforcing the business case for sustainability at scale,&rdquo; said James Donovan, chief executive officer of FCS. &ldquo;As we extend our partnership with CDP, we look forward to bringing additional insights and analysis to the global market through our proven data management and carbon management expertise that will significantly benefit companies in terms of increased scores and reduced environmental impact.&rdquo;</p>
<p>This partnership extension also includes FCS acknowledgement as a CDP Silver Carbon Calculation Partner, Gold Consultancy Partner and CDP Response Check provider. As a Silver Carbon Calculation Partner, FCS is featured as a leading service provider of enterprise-wide carbon calculation tools that help support the disclosure process for the thousands of companies reporting to CDP. As a Gold Consultancy Partner, FCS continues to demonstrate a commitment to working with CDP to encourage high quality disclosure of climate change related data from global corporations.&nbsp; Exclusive to CDP Consultancy Partners, FCS will provide CDP Response Check, a high-level &lsquo;checking&rsquo; service for CDP-responding companies that have completed their 2013 CDP response. &rdquo;<em>This will prove a useful additional check for some of the thousands of companies that report through CDP,&rdquo; said Topping. </em></p>
<p>&ldquo;Sustainability is an increasingly important topic to the business and investor communities around the world,&rdquo; said Robert Francisco, President, FCS. &ldquo;By expanding our relationship for the 2013 disclosure period, it allows both organizations to provide more insight and better service to the global sustainability community, and ultimately will provide the information companies need to reduce risk and their environmental impacts.&rdquo;</p>
<p><em>About CDP</em></p>
<p><em>CDP is an international, not-for-profit organization providing the only global system for companies and cities to measure, disclose, manage and share vital environmental information.&nbsp; CDP works with market forces, including 722 institutional investors with assets of US$87 trillion, to motivate companies to disclose their impacts on the environment and natural resources and take action to reduce them.&nbsp; CDP now holds the largest collection globally of primary climate change, water and forest risk commodities information and puts these insights at the heart of strategic business, investment and policy decisions.&nbsp; Please visit <a href="http://www.cdp.net" target="_blank">www.cdp.net</a> or follow us <a href="https://twitter.com/CDP" target="_blank">@CDP</a> to find out more.</em></p>
...
<div class="col-sm-6 col-md-6 col-lg-6">
<p>For CDP</p>
<address>Penny Cross <br />Communications Director <br />Ph: +44 (0) 20 7415 7083 <br />+44 7919 074 92<br />Email: <a href="mailto:penny.cross@cdp.net">penny.cross@cdp.net</a></address></div>
</div>
