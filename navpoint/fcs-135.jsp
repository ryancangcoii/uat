...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSTBDEEACEF2013@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSTBDEEACEF201310BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSTBDEEACEF2013@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSTBDEEACEF201310BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSTBDEEACEF201310BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSTBDEEACEF201310BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSTBDEEACEF2013@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Talks Big Data and Energy Efficiency at the ACEF 2013</h1>
<p>FirstCarbon Solutions CEO James Donovan is slated to deliver his presentation entitled <em>Defining &ldquo;Big Data&rdquo; in the Environmental World</em> at the Asia Clean Energy Forum (ACEF) 2013. The forum is set take place on June 26-28 at the Asian Development Bank (ADB) Headquarters, Mandaluyong City.</p>
<p>The 8<sup>th</sup> ACEF will open with the main theme &ldquo;Unlocking Asia&rsquo;s Clean Energy Future&rdquo; and has categorized the presentations into six thematic tracks: Policy and Regulatory Dialogue, Accelerating Energy Efficiency, Promoting Renewable Energy, Catalyzing Clean Energy Finance, Maximizing Energy Access, and Emerging Clean Energy Technologies.</p>
<p>Over 800 participants composed of representatives from governments, national and multinational banks, carbon and clean energy investment funds, project developers and service providers, environmental regulators, development partners, the academe, the civil society, and other international organizations are expected at the ACEF 2013.</p>
<p>FirstCarbon Solutions will present in a session called Mining for Energy Efficiency through Data Collection on June 26, 4:00-5:30 PM. The presentation will highlight the capabilities of FirstCarbon Solutions in providing energy management consultancy, data processing, and software to help organizations achieve energy efficiency.</p>
<p>ACEF 2013 is organized by the Asian Development Bank (ADB) in cooperation with the United States Agency for International Development (USAID).</p>
<p>Read more about ACEF 2013 by visiting <a href="http://www.asiacleanenergyforum.org/" target="_blank">http://www.asiacleanenergyforum.org/</a>.</p></div></div>
</div>
