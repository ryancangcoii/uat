...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSSFPEISSNC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSSFPEISSNC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSSFPEISSNC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSSFPEISSNC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSSFPEISSNC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSSFPEISSNC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSSFPEISSNC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Sponsors First PEISS National Convention</h1>
<p>FirstCarbon Solutions will sponsor the First National Convention on the Philippine Environmental Impact Survey (EIS) System which will take place at the Manila Hotel on June 19-21, 2013. The event is organized by the Pollution Control Association of the Philippines, Inc. (PCAPI) with the cooperation of the Environmental Management Bureau (EMB) of the Department of Environment and Natural Resources (DENR).</p>
<p>Around 300 attendees comprised of Environmental Impact Assessments (EIA) preparers, Multi-Partite Team (MMT) members, Pollution Control Officers, as well as representatives from the academe, government agencies, local government units, various industry associations, donor agencies, and other services providers are expected to participate in the convention.</p>
<p>The convention aims to depict the current landscape of EIA practices in the Philippines. Through paper presentations, panel reactions/discussions, product and service exhibits, and sponsorships, the convention intends to illustrate the challenges and gaps in the Philippine EIS System. Key stakeholders and sectors are also expected to highlight their experiences and share their best practices and insights on good EIA practices.</p>
<p>EMB Director <strong>Atty. Juan Miguel Cuna</strong>, Asian Environmental Compliance and Enforcement Network (AECEN) Secretariat <strong>Dr. Peter King</strong>, and International Association for Impact Assessment (IAIA) Former President and Board Member <strong>Dr. Richard Morgan</strong> are invited as key speakers for the event.</p>
<p>FirstCarbon Solutions will share an overview of the benefits of its products and services to help advance the technical expertise of the PCAPI members and the PEISS convention participants. With its sponsorship of the event, FirstCarbon Solutions will showcase the data gathering, management, and analysis capabilities of Sustainability WorkBench, to put across how it can help create high quality EIA. By sponsoring the first ever national PEISS convention, FirstCarbon Solutions aims to help institutionalize careers in environment and sustainability with the help of its services, products, and capabilities.</p></div></div>
</div>
