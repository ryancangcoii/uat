...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSEUSSCSTSEGTI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSEUSSCSTSEGTI10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSEUSSCSTSEGTI@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSEUSSCSTSEGTI10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSEUSSCSTSEGTI10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSEUSSCSTSEGTI10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSEUSSCSTSEGTI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Expands U.S. Sustainability Consulting Service Territory to Support Ever-Growing Telecommunications Industry</h1>
<p><em>Pioneer and Industry Leader In Environmental and Sustainability Business Solutions Offers Rapid, Cost-Effective Solutions to Wireless Carriers</em></p>
<p><strong>IRVINE, CA (June 3, 2013) &ndash; </strong>FirstCarbon Solutions (FCS), a pioneer and industry leader in environmental and sustainability business solutions, today announced it is expanding its wireless telecommunications consulting service to a national practice. FCS has been delivering services to clients from the western U.S. for nearly 15 years and will now provide a national footprint by delivering services throughout Hawaii, the mid-west and east coast of the U.S.</p>
<p>With unmatched expertise in compliance and back-office data processing, FCS provides technical advice and support to help wireless telecommunications carriers streamline their facility expansion and upgrade process. FCS helps many of the world&rsquo;s leading tier-one telecommunications companies &ndash; &nbsp;including T-Mobile West, LLC, AT&amp;T Mobility, LLC, Sprint Nextel, NextG Networks/Crown Castle, Verizon Wireless, Mobilitie, and American Tower Corporation &ndash; comply with regulations, from the Federal Communication Commission (FCC) to the National Environmental Policy Act (NEPA) and Migratory Bird Protection Act through services including:</p>
<ul>
<li>Phase I Environmental Site Assessments</li>
<li>Limited Phase II Site Assessments</li>
<li>Archaeological Surveys, Testing and Monitoring</li>
<li>Architectural Historical Assessments</li>
<li>Biological Resources Impact Analysis</li>
<li>Focused Biological Surveys and Monitoring</li>
<li>Federal and State Agency Consultation</li>
<li>Native American and Native Hawaiian Tribal Nations Consultation</li>
<li>Asbestos/Lead Based Paint Sampling</li>
<li>Noise Studies</li>
<li>Arborist Studies</li>
<li>Wetland Delineation/Assessment</li>
<li>Software Tracking and Reporting</li>
<li>Business Process Outsourcing Support</li>
</ul>
<p>By providing leading compliance services and performing various technical studies, FCS consultants and specialists help telecommunications carriers secure approvals and meet certification requirements from regulatory agencies for wireless network build-out and upgrade projects.</p>
<p>&ldquo;For more than a decade, Terracon has relied on FCS to support our environmental consulting work related to proposed construction at telecommunications facilities throughout California and the surrounding states,&rdquo; said Craig S. Pruett, Principal and Telecommunications Sector Lead, Terracon. &ldquo;FCS consistently delivers quality due diligence and NEPA support, on time and on budget.&rdquo;</p>
<p>As a member of the ADEC Group, a global enterprise with more than 5,000 employees and operations in North America, Europe, Asia and Australia, FCS is the only company to have in depth, broad environmental and sustainability expertise combined with extensive back office processing capabilities that can be rapidly mobilized to augment internal resources, allowing organizations to focus on their core activities and more strategic initiatives.</p>
<p>&ldquo;Now more than ever, today&rsquo;s leading telecommunications carriers are integrating a broader range of sustainability practices into their strategies because they recognize that it&rsquo;s good for their business, their communities and the environment,&rdquo; Robert A. Francisco, FCS President said. &ldquo;Now, as carriers continue to pursue expansion and efficiency goals in a highly competitive industry, they will be able to truly benefit from our U.S. territory expansion.&rdquo;</p>
<p>In addition to rapid, cost-effective compliance solutions, FCS has developed software products such as Sustainability Workbench to ensure that today&rsquo;s telecommunications carriers succeed in their sustainability and energy management initiatives. FCS also provides integrated services to support broader regulatory compliance efforts: from environmental impact assessments, and cultural and natural resources management to environmental compliance, and entitlements and permitting services. In addition, FCS energy consultants provide energy management services, data processing services and effective supplier scorecards for maximum ROI.</p>
