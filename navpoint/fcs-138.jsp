...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSCGLCFPTRSFO@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSCGLCFPTRSFO10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSCGLCFPTRSFO@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSCGLCFPTRSFO10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSCGLCFPTRSFO10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSCGLCFPTRSFO10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSCGLCFPTRSFO@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions and Compass Group Launch Carbon FOODPrint Toolkit to Redefine Sustainability within Foodservice Operations</h1>
<p style="text-align: left;"><em><br />Unique Web-Based Tool Design Helps Chef and Managers <br /><em>Measure, Manage and Reduce Energy, Water and Resource Use </em></em></p>
<p><strong>IRVINE, CA and CHARLOTTE, NC </strong>(March 27, 2013) &ndash; <a href="http://www.firstcarbonsolutions.com">FirstCarbon Solutions</a>, a pioneer and industry leader in environmental sustainability business solutions, and <a href="http://www.compass-usa.com/">Compass Group</a>, the world&rsquo;s leading food and support services company, announced the launch of the software tool being used to support Compass Group&rsquo;s <a href="http://balance.compass-usa.com/Pages/Carbon-Foodprint.aspx">Carbon FOODprint</a>&trade; toolkit.&nbsp; This unique, web-based tool, powered by FirstCarbon Solutions, is designed to help Compass Group&rsquo;s food operations staff lower their environmental impact and operational costs. Early Carbon FOODPrint adopters to date include well-known companies, such as SAP, and colleges, including Auburn University and Green Mountain College.</p>
<p>An easy-to-use toolkit, Carbon FOODPrint allows chefs and managers to create customized strategies to reduce their operations&rsquo; carbon footprints by decreasing waste disposal, and energy and water use. Foodservice managers can make up to 185 strategic choices in four key areas, including menu engineering, kitchen services, site equipment and facilities. Developed by FirstCarbon Solutions and hosted as part of its Sustainability Workbench platform, the web-based software application is an integral part of the Carbon FOODprint toolkit.&nbsp; This online technology allows cafes to benchmark and measure the improvements made throughout the caf&eacute;, which can be shared with clients for annual reports, sustainability indexes, and disclosure to public programs such as the Carbon Disclosure Project (CDP).</p>
<p>To develop the strategic planning portion of the Carbon FOODprint toolkit, Compass Group partnered with key players who could provide specific contributions in their area of expertise, such as the Green Restaurant Association, the Environmental Defense Fund, and the Food Service Technology&nbsp;Center (supported by Pacific Gas &amp; Electric). In &ldquo;Phase 2&rdquo; of this project, Compass Group teamed with FirstCarbon Solutions, to enhance the toolkit with sustainability metrics in a robust and user-friendly software platform, with cutting-edge dashboard applications for food service industry clients.</p>
<p>Marc Zammit, Vice President of Sustainability Initiatives at Compass Group, said the web-based tool was created in response to his clients&rsquo; growing interest in having a strategic planning tool to measure, manage, and lower their operation costs and food service carbon footprint.</p>
<p>&ldquo;With Carbon FOODPrint, we now have an opportunity to provide our clients with cost effective solutions to lower the environmental impact of their food services,&rdquo; Zammit said.&nbsp; &ldquo;Commercial food service is a resource intense operation, and our onsite teams will use this scalable toolkit to make their operation more sustainable by minimizing carbon impact, while at the same time implementing best practices that lower operational costs&nbsp;in the areas of menuing, energy, water and waste. Supported by FirstCarbon Solutions software, managers will now have the information they need to make the best choices for their business, their clients and the environment.&rdquo;</p>
<p>As part of the design and collaboration with Compass Group, FirstCarbon Solutions collected thousands of pieces of data on the production, packaging, and transport of individually purchased food items, serving materials, and cleaning chemicals required to manage a foodservice operation &ldquo;from cradle to customer.&rdquo; The Toolkit couples this information with site-specific operational data from individual cafes to provide up-to-date dashboards on the carbon, energy, water, and wastes associated with all aspect of a food service operation (facilities, kitchen operations, kitchen services, and menu engineering).</p>
<p>&ldquo;Compass Group&rsquo;s Carbon FOODprint proves the point that sustainability and profitability are not mutually exclusive,&rdquo; said Robert Francisco, President, FirstCarbon Solutions. &ldquo;With this innovative technology developed by FirstCarbon Solutions, Compass Group will help redefine sustainability within foodservice operations by providing cafes unprecedented visibility into the impact their operations have on the environment and helping teams create behavioral changes that will have long-term impacts and improvements.&rdquo;</p>
<p>Chet Chaffee, FirstCarbon Solutions Director of Supply Chain and Life Cycle Assessment added, &ldquo;The software platform that FirstCarbon Solutions Group developed in support of the Carbon FOODPrint toolkit benchmarks the carbon, energy, water and waste footprints of each participating unit, and provides insights on where to make changes to maximize sustainable efficiencies across the operation. To my knowledge, such a comprehensive, systematic and technically sound program, that considers all these aspects of food operations, has never been tackled before.&rdquo;</p>
<p>Carbon FOODprint toolkit is currently generally available to all 9,900 Compass Group cafes in the United States.</p>
<p><em>About Compass Group, North America</em></p>
<p><em>Based in Charlotte NC, Compass Group North America is the leading foodservice management and support services company with $12 billion USD (&pound;7.5 billion) in revenues in 2012. With over 500,000 associates worldwide, its parent company, UK-based Compass Group PLC had revenues of &pound;16.9 billion in the fiscal year ending September 30, 2012.</em></p>
...
<div class="row">
<div class="col-sm-12 col-md-12 col-lg-12">Press Contacts:</div>
<div class="col-sm-6 col-md-6 col-lg-6">
<p>For FirstCarbon Solutions</p>
<address>Steve Fiore <br /> SS|PR <br /> Ph: +1-847-415-9329 <br /> Email: <a href="mailto:sfiore@sspr.com">sfiore@sspr.com</a></address></div>
<div class="col-sm-6 col-md-6 col-lg-6">
<p>For Compass Group:</p>
<address>Veronica Ospina <br />Compass Group North America <br />704/328-4291<br />Email: <a href="mailto:veronica.ospina@compass-usa.com">veronica.ospina@compass-usa.com</a></address></div>
</div>
