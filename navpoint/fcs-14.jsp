...
<section  ><%-- Widget fcs.pages.InnerPageTemplate@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesInnerPageTemplate10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/dummyImage.jpg";
	String snippetVar_text1 = "<h1>Global</h1>";
	String snippetVar_text2 = "<h2>partner program</h2>";
	String snippetVar_text3 = "<h3>creating new revenue streams</h3>";
	...
	String snippetVar_widgetPath = "fcs.pages.InnerPageTemplate@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesInnerPageTemplate10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesInnerPageTemplate10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/dummyImage.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesInnerPageTemplate10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.InnerPageTemplate@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><p>FirstCarbon Solutions Global Partner Program creates a global network of contractors and companies that specialize in energy data management, environmental services, sustainability solutions and other business support services. If you&rsquo;re a private contractor, a consultancy firm, a software vendor or a professional group seeking to expand your menu of services or update your solutions to better meet market dynamics and demands, our programs help you create new revenue streams for energy efficiency and environmental advocacy.</p>
<p>Specifically, FirstCarbon Solutions Global Partner Program is eager to work with companies and organizations around the globe who have expertise and professional experience in:</p>
<ul>
<li>Environmental Sustainability</li>
<li>Environmental Compliance and Planning Services Franchise Licensing, Entitlements and Permitting</li>
<li>Energy Rebates and Incentives</li>
<li>Energy Reduction and Utility Audits</li>
<li>Carbon Accounting and Management</li>
<li>Natural Resources (Cultural, Biological)</li>
<li>Supply Chain and Life Cycle Assessments</li>
<li>Telecommunications/cell site NEPA/FCC compliance</li>
<li>Verification and Certification</li>
</ul>
<p>A new frontier for business opportunities and growth FirstCarbon Solutions Global Partner Program takes partnership to a whole new level by giving you exciting opportunities for growth and expansion. By joining our partner network, you get our commitment to helping you offer the best possible solutions to your clients and to expanding your revenue opportunities. With a strong and dynamic workforce of 5,000 employees and professionals, 30 years of business process outsourcing experience, robust infrastructure &amp; training as well as development programs, our partners can expect a productive and invaluable partnership that will take your company to new heights.</p>
<p>Contact us today to know more about our <a href="../partners/become-a-partner">Global Partner Program</a>.</p></div></div>
</div>
