...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_MCTGSCINRCDP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_MCTGSCINRCDP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_MCTGSCINRCDP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_MCTGSCINRCDP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_MCTGSCINRCDP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_MCTGSCINRCDP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_MCTGSCINRCDP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Major Climate Threat to Global Supply Chains Identified by New Research from the Carbon Disclosure Project</h1>
<p><strong>New York&nbsp;22nd January 2013:&nbsp;</strong>Seventy percent of companies believe that climate change has the potential to affect their revenue significantly, a risk which is intensified by a chasm between the sustainable business practices of multinational corporations and their suppliers, according to <a href="https://www.cdproject.net/CDPResults/CDP-Supply-Chain-Report-2013.pdf" target="_blank">research</a>&nbsp;published today by the Carbon Disclosure Project (CDP) and <a href="http://www.accenture.com/" target="_blank">Accenture</a>&nbsp;(NYSE:ACN).</p>
<p>&ldquo;Reducing risk and driving <a href="https://www.cdproject.net/CDPResults/CDP-Supply-Chain-Report-2013.pdf" target="_blank">business value</a>&rdquo; is based on information from 2,415 companies, including 2,363 suppliers and 52 major purchasing organizations who are CDP Supply Chain program members. These members include Dell, L&rsquo;Oreal and Walmart and represent a combined spending power of c. US$1 trillion. The research marks CDP&rsquo;s most comprehensive annual update on the impact of climate change on corporate supply chains.</p>
<p>Climate change presents near-term risks to businesses, according to the report. Fifty-one percent of the risks that disclosing companies associate with drought or extreme rain are already having an adverse effect on company operations, or are expected to within five years, say those businesses. Additionally, the destructive nature of extreme weather is likely a catalyst for company action on climate change, with physical climate risk identified in the report as a greater driver of investment than climate policy. Of the 678 companies investing in emissions reduction initiatives, three quarters (73%) say they feel that climate change presents a physical risk to their operations; just 13% identify regulation as a sole driver.</p>
<p>Most of the positive actions responding companies say they have taken in response to climate change are attributable to organizations that have been using CDP&rsquo;s unique global system for at least two years demonstrating that customer pressure is driving change. However, the report identifies a performance gap between companies and their suppliers and claims that this is intensifying climate risk in the global supply chain models.</p>
<p>Suppliers are significantly less prepared than their clients in responding to climate change, potentially threatening customer relationships and heightening supply chain vulnerability. Suppliers demonstrate a lower level of ambition to mitigate climate change risk, with just 38% setting emission reductions targets in comparison to 92% of purchasing companies. Similarly, at 27%, the percentage of suppliers investing in activities to reduce emissions is less than half that of CDP member companies (69%).</p>
<p>Unsurprisingly, CDP members are more likely to yield results from their environmentally sustainable business practices than suppliers, according to the survey. They are more than twice as likely to accomplish year-on-year emissions reductions (63% vs 29%) and are better positioned to capitalize on the financial benefits of carbon management. While 73% of members are achieving monetary savings, such as reduced energy costs from emission reductions activities, only 29% of suppliers are enjoying such returns.</p>
<p>Paul Simpson, CDP&rsquo;s chief executive officer says: &ldquo;This research illuminates fragility in the global supply chain model. The marked difference in the sustainable actions of companies and their suppliers highlights a missed opportunity for suppliers to reduce energy costs and risks. The 61% of suppliers that failed to provide information through CDP are an even greater concern since they and their clients are unable to make a full assessment of the substantial climate risks or opportunities they face.&rdquo;</p>
<p>The analysis of the information, processed through CDP&rsquo;s unique global system for natural capital disclosure &ndash; now the largest and most comprehensive in the world &ndash; demonstrates the attractive returns that leading companies are enjoying from addressing supply chain sustainability. The 29% of suppliers that have reduced their emissions have saved some $13.7bn as a result. This implies aggregate potential savings of all 2,363 suppliers could reach three times that figure if the remaining proportion of suppliers were to achieve reductions at that rate.</p>
<p>&ldquo;This report provides clear evidence that those who are most transparent about their climate change risks are more likely to achieve the greatest emissions reductions&rdquo;, says Gary Hanifan, global sustainability lead for supply chain, Accenture. &ldquo;And they are also more likely to enjoy monetary savings as a result of their responses to climate change risks. But the return on investment by the most proactive companies will not reach its full potential unless those companies can encourage their suppliers to follow their lead.&rdquo;</p>
<p>The report is freely available from the CDP and Accenture websites. It provides advice on how companies can use data, process and governance to create a more sustainable supply chain and capitalize on the correlations between climate risk, performance and accountability to realize financial benefit. The report also includes supplier scoring data provided by the CDP Supply Chain scoring partner FirstCarbon Solutions. Scores are available by region and sector and show that European and Asian companies are still outperforming companies in North America.</p>
<p><em>About CDP</em></p>
...
<p><em>CDP Supply Chain member companies</em></p>
<p><em>Accenture, Acer Inc., Amdocs Ltd., AT&amp;T Inc., Banco Bradesco S/A, Bank of America, Braskem S/A, British Sky Broadcasting, BT Group, City of Denver, Colgate Palmolive Company, Dell Inc., Diageo Plc., Domtar Inc., EADS N.V., Eaton Corporation, Eletropaulo Metropolitana Eletricidade de S&atilde;o Paulo S/A, Elopak, Endesa, Eni SpA, FIBRIA Celulose, Ford Motor Company, Goldman Sachs Group,, Groupe Steria, Imperial Tobacco Group, Jaguar Land Rover Ltd, Johnson &amp; Johnson, Johnson Controls, JT International SA, Juniper Networks, KAO Corporation, Kimberly-Clark Corporation, KPMG UK, L&rsquo;Oreal, Marfrig Alimentos, MetLife, Inc., Microsoft Corporation, National Australia Bank, National Grid, Nestle, Nokia-Siemens Networks, PepsiCo, Philips Electronics N.V., Reckitt Benckiser, Rexam, S.C. Johnson &amp; Son, Inc., SAB Miller, Starwood Hotels &amp; Resorts Worldwide, Inc., Suzano Pulp and Paper, The Coca-Cola Company, Unilever, Vale, Vodafone Group, Walmart.</em></p>
<p><em>About Accenture</em></p>
<p>bal management consulting, technology services and outsourcing company, with 259,000 people serving clients in more than 120 countries. Combining unparalleled experience, comprehensive capabilities across all industries and business functions, and extensive research on the world&rsquo;s most successful companies, Accenture collaborates with clients to help them become high-performance businesses and governments. The company generated net revenues of US $27.9 billion for the fiscal year ended Aug. 31, 2012. Its home page is <a href="http://www.accenture.com">www.accenture.com</a>.</p>
<p>For further information on CDP, press enquiries, interviews or images, please contact:</p>
<address>Catherine von Altheer<br /> Ph: +44 (0)20 7970 5682 / +44 (0) 7794 430962 <br /> Email: <a href="mailto:catherine.vonaltheer@cdproject.net">catherine.vonaltheer@cdproject.net</a></address>
