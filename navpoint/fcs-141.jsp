...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSAGSACECS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSAGSACECS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSAGSACECS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSAGSACECS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSAGSACECS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSAGSACECS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSAGSACECS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Awarded GSA Contract for &lsquo;Energy Consulting Services&rsquo;</h1>
<p>Schedule # GS-21F-0127Y Will Help FirstCarbon Solutions Streamline, Expedite Procurement Process, Allowing For More Efficient Work with Local, State and Federal Governments</p>
<p><strong>IRVINE, CA</strong>-(September 12, 2012)<strong>&ndash;</strong>FirstCarbon Solutions, a pioneer and industry leader in <a href="/ttsvr/">environmental sustainability solutions </a>for business, today announced that it has been awarded its second U.S. General Services Administration (GSA) contract (Schedule 03FAC Contract) for &ldquo;<a href="/ttsvr/solutions/by-focus/energy">Energy Consulting Services</a>&rdquo; under Special Identification Number (SIN) 872 211.&nbsp;</p>
<p><br />Effective July 6, 2012, FirstCarbon Solutions&rsquo; new five-year GSA contract (GS-21F-0127Y) provides local, state and federal governments with expedited access to services including expert advice, assistance, and guidance on energy-related projects or initiatives to assist agencies, activities and organizations in adhering to energy legislation and policy. In addition, state and local governments have access to FirstCarbon Solutions&rsquo; 03FAC Contract as part of the Disaster Recovery Purchasing Program.</p>
<p>According to James M. Donovan, President and CEO of FirstCarbon Solutions, GSA estimates that approximately $50 billion a year in spending (or 10 percent of overall federal procurement spending) is done through GSA Schedules. GSA Schedules are fast, easy, and effective contracting vehicles that establish long-term, federal government-wide contracts with commercial companies to provide access to millions of commercial products and services at volume discount pricing.</p>
<p>&ldquo;FirstCarbon Solutions is pleased to have our <a href="/ttsvr/solutions/by-service/consulting">energy and carbon consulting services</a> made available through the GSA Schedule,&rdquo; said Donovan. &ldquo;This opportunity provides FirstCarbon Solutions with increased visibility among our government clients and eliminates many steps so federal agencies are able to quickly find the expert service they need, hassle-free. There is no need to negotiate contracts or rates. Ultimately, this opportunity streamlines the entire procurement process.&rdquo;&nbsp;</p>
<p>In July 2011, FirstCarbon Solutions was awarded a GSA Information Technology (IT) 70 Schedule Contract for its <a href="/ttsvr/solutions/by-service/software">carbon accounting and sustainability reporting software</a> (under SIN 132 32 Term Software Licenses) and related services (under SIN 132 34 Software Maintenance). This original contract helped establish documentation for FirstCarbon Solutions as a Federal Supply Schedule Contractor for its <a href="/ttsvr/solutions/by-service/software">carbon accounting and sustainability reporting software</a> services.</p>
