...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_CDPTFCSESSPINDACHR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_CDPTFCSESSPINDACHR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_CDPTFCSESSPINDACHR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_CDPTFCSESSPINDACHR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_CDPTFCSESSPINDACHR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_CDPTFCSESSPINDACHR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_CDPTFCSESSPINDACHR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Disclosure Project Taps FirstCarbon Solutions to Expand Sustainability Scoring Partnership to Investors in the Nordic / DACH Regions</h1>
<p>FirstCarbon Solutions will deliver vital information to signatory investors of the Carbon Disclosure Project oncorporate performance in emissions management.</p>
<p><strong>IRVINE, CA and LONDON, UK - (August 01, 2012)</strong> - FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, today announced an extension of its ongoing partnership with the Carbon Disclosure Project(CDP). As part of this expanded relationship with CDP, FirstCarbon Solutions will score submissions from major companies in the Nordic region and in the DACH region of Germany, Austria and Switzerland on their greenhouse gas emissions management efforts.The scored submissions, from several hundred of the largest companies in those regions, including Adidas AG, Metro AG, EVN Group, and Adecco S.A., will be delivered to more than 600 institutions that have invested in these companies and have requested the submissions.</p>
<p>Investors sign the information request to gain access to an independent, global source of year-on-year information that supports long-term objective analysis. This includes evidence and insight into companies' greenhouse gas emissions, and strategies for managing climate change and related risks.CDP, an independent not-for-profit organization, is focused on helping companies and cities measure, disclose, manage and share information on environmental risk and opportunity, all with the goal of preventing dangerous climate change and protecting our natural resources.</p>
<p>FirstCarbon Solutions processes the climate change information submitted by the companies and then creates disclosure scores and performance bands. The scores are designed to determine the quality of disclosure and the level of climate change performance.Leveraging its proven sustainability reporting systems and data management and carbon accounting expertise, FirstCarbon Solutions has built a system based on CDP's global scoring methodology to evaluate the responses in a comprehensive, standardized way.</p>
<p>The scores will be shared through Bloomberg, Google Finance, and in country-specific, publicly-accessible reporting sites. Upon request, FirstCarbon Solutions will provide each of the submitting companies a more detailed summary of their scores and will offer, as a value-added service, additional insights into the scoring of their submission via telephone.</p>
<p>"The CDP scores play a vital part for investors and the participating companies in highlighting best performing companies regarding their transparency and emissions management - in particular since they are visible on Bloomberg as well as on the German stock exchange webpage," said Steven Tebbe, Managing Director, CDP Europe. "That is why we're pleased to be partnering with FirstCarbon Solutions in the Nordic and DACH Region, as they have proven their capability under the supply chain program since 2011."</p>
<p>"Having CDP approach FirstCarbon Solutions with the opportunity to extend our relationship to become the sustainability scoring partner for their investor program in the Nordic and DACH Region is a testament to the great partnership and working synergies we formed over the past year," said James Donovan, President and CEO of FirstCarbon Solutions. "With extensive experience in processing large amounts of sustainability metrics and our subject matter expertise in carbon management, FirstCarbon Solutions is uniquely qualified to interpret the CDP reporting data and provide insightful reports and consultation to the Nordic and DACH companies with the goal of helping them improve their sustainability activities and drive efficiencies throughout their supply chains."</p>
