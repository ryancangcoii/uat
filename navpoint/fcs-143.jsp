...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_CDPRPFCMSCM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_CDPRPFCMSCM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_CDPRPFCMSCM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_CDPRPFCMSCM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_CDPRPFCMSCM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_CDPRPFCMSCM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_CDPRPFCMSCM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Disclosure Project Renews Partnership with FirstCarbon to Measure Supply Chain Carbon Management</h1>
<p>FirstCarbon Solutions to deliver vital information to organizations working with the Carbon Disclosure Project that will help benchmark carbon emissions and drive supply chain emissions management.</p>
<p><strong>IRVINE, CA and LONDON, UK - (July 31, 2012)</strong> - FirstCarbon Solutions, a pioneer and industry leader in <a href="http://www.firstcarbonsolutions.com">environmental sustainability solutions</a> for business, today announced an expanded partnership with the <a href="https://www.cdproject.net">Carbon Disclosure Project</a> (CDP). FirstCarbon Solutions will score companies&rsquo; submissions on their greenhouse gas emissions and <a href="../by-focus/entitlements-permitting">carbon management strategies </a>to CDP Supply Chain, a program that works with global corporations to measure and understand the impacts of climate change across their supply chains. CDP, an independent, not-for-profit organization, is focused on helping companies and cities measure, disclose, manage and share information on environmental risk and opportunity, all with the goal of preventing dangerous climate change and protecting our natural resources.</p>
<p>Climate change and <a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">sustainability reporting</a> transparency is increasingly important to consumers, shareholders and other stakeholders. But creating an accurate and comprehensive carbon management inventory is challenging, especially since, according to CDP in their 2011 Supply Chain Report,more than half of an average corporation&rsquo;s total carbon emissions comes from the supply chain rather than operations within its own four walls. The CDP Supply Chain program takes aim at that challenge, moving beyond the measurement of direct greenhouse gas emissions to include climate change risks and opportunities across the supply chain.</p>
<p>As <a href="/ttsvr/cdp">CDP Supply Chain&rsquo;s scoring partner</a>, FirstCarbon Solutions evaluates information provided by participating suppliers,which is used to determine the company&rsquo;s disclosure and performance score. The scoring methodology is standard across all CDP programs and is developed by CDP with consultation from scoring partners, responding companies, and others. These scores allow the 54CDP Supply Chain members - including Vodafone, Pepsico,Walmart and their suppliers -to benchmark performance, examine practices and develop year-on-year performance improvements based on the <a href="/ttsvr/solutions/by-focus/supply-chain/supplier-scorecards">sustainability scorecards</a> developed by FirstCarbon.</p>
<p>FirstCarbon Solutions will score responses from thousands of suppliers in the coming months to determine the quality of disclosure and the level of climate change performance.Upon request, FirstCarbon Solutions will provide participating suppliers a summary reportwith more details regarding their score and will offer, as a value-added service, additional insights and analysis into the scoring of their submission.</p>
<p>&ldquo;FirstCarbon Solutions has proven to be a valuable partner to CDP by providing scores to thousands of companies and customized feedback on those scores,&rdquo; says Dexter Galvin, Head of CDP Supply Chain. &ldquo;This clearly demonstrates both their data processing capability as well as their subject matter expertise in corporate climate change strategy.&rdquo;</p>
<p>&ldquo;This marks the second year that FirstCarbon Solutions will be involved in the CDP Supply Chain project, which continues to expand and have a positive impact on climate change,&rdquo; says James Donovan, President and CEO of FirstCarbon Solutions. &ldquo;Today, more companies are pursuing strategies and <a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">CSR reporting</a> practices to reduce greenhouse gas emissions. Our proven data management and carbon accounting expertise provides CDP Supply Chain participants with standard, practical scoring information that is easy to use and digest and fosters the transparency required for effective carbon management across the supply chain.&rdquo;</p>
