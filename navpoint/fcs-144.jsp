...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCCCFAFT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCCCFAFT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCCCFAFT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCCCFAFT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCCCFAFT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCCCFAFT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCCCFAFT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Completes Carbon Footprint Assessments for First Title</h1>
<p><strong>DEPOSIT, NY and LONDON, UK</strong> - (May 22, 2012) &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, today announced a services agreement with UK-based First Title to benchmark and actively monitor First Title&rsquo;s greenhouse gas (GHG) footprint and energy usage with FirstCarbon&rsquo;s ghgTrack&trade; carbon management software. Services have been deployed within enact, the property services division of First Title that is one of the largest direct conveyancing companies in the United Kingdom.</p>
<p>enact&rsquo;s current and prospective clients, who are typically financial services institutions, are requesting information about the company&rsquo;s sustainability initiatives and progress in actively reducing its carbon footprint. As a result, enact needed to accurately measure and monitor its carbon footprint in order to reduce emissions and also ensure the company was able to quickly and comprehensively respond to business inquiries. While enact has in place an environmental policy with a goal of reducing electrical and natural resources usage, they needed to improve their data collection, analysis and transparency to set and meet specific goals.</p>
<p>&ldquo;Our existing and prospective clients are increasingly asking that we report sustainability information as part of their information gathering procedures,&rdquo; said Helen Pullin, Organisation Improvement Manager at First Title. &ldquo;Working with FirstCarbon Solutions and their innovative ghgTrack&trade; software gives us the ability to answer clients&rsquo; questions more directly, making us a better partner and putting us in an improved position to retain their business.&rdquo;</p>
<p>ghgTrack&trade; is an Internet-based software suite that features an intuitive dashboard which provides First Title and enact management with clear graphical summaries of their greenhouse gas (GHG) emissions and carbon footprints. It features baseline data and year-over-year information that allows them to closely view and manage their progress in meeting emissions goals. Custom metrics can be defined and imported in order to manage other environmentally-focused goals such as recycling or improved water usage.</p>
<p>&ldquo;At enact, we expect to see a containment of our carbon-related costs during 2012 as we review the ghgTrack-supplied data and implement some changes to our practices,&rdquo; said Bev Mayo, Managing Director of enact. &ldquo;In 2013 we will be proactively measuring our carbon performance metrics to ensure we are on the right track for sustainability.&rdquo;</p>
<p>&ldquo;We look forward to guiding First Title towards improved environmental sustainability, which also results in considerable cost savings,&rdquo; said James Donovan, CEO of ADEC Group and FirstCarbon Solutions. &ldquo;Companies in various industries are now confronted with potential clients that demand accurate, complete sustainability data. This is a significant task for most companies to manage internally, and FirstCarbon Solutions provides a versatile, no-hassle environmental data management solution that is cost effective and presents large amounts of data in a way that enables actionable decisions.&rdquo;</p>
<p>As a member of ADEC Group, a global enterprise with more than 5,000 employees and operations in North America, Europe, Asia and Australia, FirstCarbon Solutions is the only company to have environmental expertise combined with sustainability software and extensive back office processing capabilities that can be rapidly mobilised to augment or free-up internal resources, allowing organisations to focus on their core activities and more strategic initiatives.</p>
<p><em>About First Title</em></p>
<p><em>First Title is part of the First American Financial Corporation, which is a leading global provider of title insurance for residential and commercial real estate transactions. First American Financial Corporation (NYSE: FAF) is a leading provider of title insurance to the real estate and mortgage industries, and traces its heritage back to 1889. First American and its affiliated companies also provide title and other real property records and images; valuation products and services; home warranty products; property and casualty insurance; and banking, trust, and investment advisory services. With revenues of approximately $3.9 billion in 2010, the company offers its products and services directly and through its agents and partners in all 50 states and abroad.</em></p>
