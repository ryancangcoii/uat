...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSMSSM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSMSSM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSMSSM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSMSSM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSMSSM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSMSSM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSMSSM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Selected by Mahindra Satyam for Sustainability Monitoring</h1>
<p><strong>HYDERABAD, IN and LONDON, UK - (May 16, 2012) -</strong> FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, today announced a services agreement with Mahindra Satyam, a leading technology outsourcing firm that provides services to Fortune 500 companies around the globe. Through this partnership, Mahindra Satyam will offer FirstCarbon Solutions' sustainability and environmental consulting solutions and software services initially in the United Kingdom with plans to expand into other areas in which Mahindra Satyam operates.</p>
<p>In addition to offering its existing UK -based clients seamless access to FirstCarbon Solutions' sustainability and environmental outsourcing solutions, Mahindra Satyam is expected to attract new business with these sustainability capabilities. Mahindra Satyam recognizes the importance businesses and governments are placing on improving their sustainability performance and reducing their environmental impacts. As a result, Mahindra Satyam has turned to another recognized industry leader to support their ability to deliver those solutions in a cost-effective, high-quality manner.</p>
<p>From a software perspective, FirstCarbon Solutions is providing Mahindra Satyam clients with Sustainability Workbench, a data management platform that automates data recording and properly set goals through use and consumption baselines. As a web-based platform, Sustainability Workbench gives Mahindra Satyam clients the ability to access secure energy, sustainability, and supply chain data from any location. FirstCarbon Solutions' simple and customizable internet-based suite ghgTrack&trade; will be integrated into the Sustainability Workbench platform, allowing Mahindra Satyam clients to monitor and accurately report many environmental metrics including waste recycling, water usage, and several others.</p>
<p>"Businesses and Organizations worldwide are recognizing the growing importance of improving their sustainability performance and reducing activities leading to environmental hazards. We are pleased to partner with FirstCarbon as their sustainability portfolio of services and solutions like Sustainability Workbench and Life Cycle Assessments will complement our wide range of sustainability solutions. This partnership will bring sustainable business practices to our customers and make them more competitive apart from making them compliant to environmental mandates such as Carbon Reduction Commitment Scheme (CRC)", said Venkat Narayanan, Senior Vice President and Head of Strategic Initiatives, Mahindra Satyam.</p>
<p>"We look forward to working with Mahindra Satyam in extending FirstCarbon Solutions' fully integrated, cost-effective environmental consulting services to its worldwide customer base," said James Donovan, CEO of ADEC Group and FirstCarbon Solutions. "FirstCarbon Solutions combines its extensive sustainability reporting, data and software expertise with Mahindra Satyam's recognized outsourcing solutions to help the evolving global market balance sustainability performance, environmental compliance and impacts, and increased profitability."</p>
<p>With more than 32,000 global employees, Mahindra Satyam provides business intelligence, operations management, product lifecycle management, and myriad other services to companies throughout the world. It is a part of the $14.4 billion Mahindra Group, a global industrial federation of companies.</p>
...
<p><em>About Mahindra Satyam</em></p>
<p><em>Mahindra Satyam is a leading global business and information technology services company that leverages deep industry and functional expertise, leading technology practices, and an advanced, global delivery model to help clients transform their highest-value business processes and improve their business performance. The company's professionals excel in enterprise solutions, supply chain management, client relationship management, business intelligence, business process quality, engineering and product lifecycle management, and infrastructure services, among other key capabilities.</em></p>
<p><em>Mahindra Satyam is part of the $14.4 billion Mahindra Group, a global federation of companies and one of the top 10 business houses based in India. The group focuses on enabling people to rise. Mahindra operates in the key industries that drive economic growth, enjoying a leadership position in tractors, utility vehicles, information technology, vacation ownership, rural and semi-urban financial services, etc. Mahindra has a significant and growing presence amongst others, in the automotive industry, agribusiness, aerospace, automotive components, consulting services, defence, energy, industrial equipment, logistics, real estate, retail, steel and two wheelers.</em></p>
<p><em>Mahindra Satyam development and delivery centers in the US, Canada, Brazil, the UK, Hungary, Egypt, UAE, India, China, Malaysia, Singapore, and Australia serve numerous clients, including many Fortune 500 organizations.</em></p>
<p><em>For more information, see <a href="http://www.mahindrasatyam.com">www.mahindrasatyam.com</a><br /> Follow us on Twitter: <a href="http://twitter.com/mahindra_satyam">http://twitter.com/mahindra_satyam</a><br /> For clarifications, write to us at: <a href="mailto:MediaRelations@mahindrasatyam.com">MediaRelations@mahindrasatyam.com</a></em></p>
...
<p><em>For additional information, visit <a href="http://www.adec-group.com/">www.adec-group.com</a>.</em></p></div></div>
</div>
