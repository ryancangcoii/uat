...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSAMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSAMBA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSAMBA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSAMBA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSAMBA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSAMBA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSAMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions to Acquire Michael Brandman Associates</h1>
<p><em>Environmental companies converge to offer worldwide clients greater opportunities to reduce costs and risk, optimize natural resource use, maximize revenue opportunities and improve operational efficiencies</em></p>
<p><strong>DEPOSIT, NY and IRVINE, CA - (April 17, 2012) &ndash;</strong> FirstCarbon Solutions, a pioneer and industry leader in environmental and sustainability solutions for business, today announced plans to acquire privately-held Michael Brandman Associates. The strategic convergence will broaden the opportunity for FirstCarbon Solutions and Michael Brandman Associates to provide even more comprehensive and integrated environmental sustainability services to companies and governments worldwide. In addition, the integration will offer both current and future clients greater opportunities to reduce costs and risk, optimize resource use, maximize revenue opportunities and improve operational efficiencies in highly-regulated global environments.</p>
<p>Based in California, Michael Brandman Associates is a comprehensive environmental planning services firm that provides thousands of public agencies and private clients with contract environmental services, including disciplinary specialties such as environmental and sustainability planning, regulatory compliance, natural resource management, cultural resources management, restoration planning and monitoring, air quality and climate change services and water resource management.</p>
<p>As a member of the ADEC Group, a global enterprise with more than 5,000 employees and operations in North America, Europe, Asia and Australia, FirstCarbon Solutions is the only company to have environmental expertise combined with sustainability software and extensive back office processing capabilities that can be rapidly mobilized to augment or free-up internal resources, allowing organizations to focus on their core activities and more strategic initiatives.</p>
<p>&ldquo;FirstCarbon Solutions combines its extensive sustainability reporting, data and software expertise with Michael Brandman Associates&rsquo; comprehensive environmental consulting solutions to provide fully integrated, expanded service offerings to customers , as well to the continually evolving, global market,&rdquo; said James Donovan CEO of ADEC Group and FirstCarbon Solutions.&ldquo;With access to Michael Brandman Associates in-depth environmental expertise as part of the acquisition, organizations will be able to efficiently and cost-effectively collect the needed information, properly calculate and analyze the data, develop and implement appropriate plans, and comply with ever-evolving local, state and federal regulations across a much broader spectrum of environmental areas &ndash; all from one fully integrated company.&rdquo;</p>
<p><strong>Michael Brandman, Ph.D., President and CEO</strong> of Michael Brandman Associates, said &ldquo;the combination of data, software and subject matter expertise is a key factor regarding connecting sustainability, reducing costs and supporting economic development.&rdquo;</p>
<p>&ldquo;Michael Brandman Associates and FirstCarbon Solutions share a common belief in the game-changing impact of merging extensive data, software and environmental expertise to provide fully integrated service offerings,&rdquo; added Brandman. &ldquo;We believe the time is now, and the acquisition will significantly accelerate this unique industry innovation as we look at the future.&rdquo;&nbsp;</p>
<p>&ldquo;Together, FirstCarbon Solutions and Michael Brandman Associates will continue to be responsive to our clients while expanding our solutions to meet their needs and the needs of the ever-changing, global market,&rdquo; Donovan said. &ldquo;This will be accomplished with a broader and deeper set of cost-effective solutions focused on achieving a balance between sustainability, environmental compliance and profitability attainment.&rdquo;</p>
<p>&ldquo;Now more than ever, organizations around the globe are integrating a broader range of sustainability practices into their strategies because they recognize that it&rsquo;s good for business,&rdquo; stated Brent Peich, Senior Analyst at Verdantix, an independent analyst firm focusing on energy, environment and sustainability. &ldquo;FirstCarbon Solutions takes an integrated approach to environmental data management across software, services, and business process practices. Its acquisition of Michael Brandman Associates represents a welcome acknowledgment of the fact that such management extends beyond software and data processing capabilities to include in-the-field technical and regulatory expertise.&rdquo;</p>
...
<p><em>About Michael Brandman Associates</em></p>
<p><em>Michael Brandman Associates is a recognized pioneer in helping clients achieve project objectives while ensuring environmental compliance at the local, state, and federal level. The firm has prepared over 25,000 environmental documents for more than 8,000 clients. Headquartered in California, Michael Brandman Associates has 30 years&rsquo; experience providing cost-effective environmental consulting services in the western United States. With over 65 employees who possess 15 years of experience on average, Michael Brandman Associates has proven expertise in a wide range of disciplines including air, water, noise, California Environmental Quality Act/National Environmental Policy Act (CEQA/NEPA), planning, permitting, and biology and cultural resources. For more information visit <a href="http://www.brandman.com">www.brandman.com</a></em></p></div></div>
</div>
