...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSAGSAITS70CGS35F0350X@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Awarded GSA IT Schedule 70 Contract &nbsp;GS-35F-0350X</h1>
<p><strong>DEPOSIT, N.Y., July 13, 2011 (8AM EST)</strong> &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental business intelligence, today announced that it has been awarded the U.S. General Services Administration (GSA) Information Technology (IT) Schedule 70 for Term Software Licenses and Software Maintenance. Effective April 21, 2011, this contract establishes documentation for FirstCarbon Solutions as a Federal Supply Schedule Contractor.</p>
<p>Federal agencies and state and local government entities (under the provisions of the Cooperative Purchasing Program) can order FirstCarbon Solutions&rsquo; ghgTrack&trade; software to manage and report greenhouse gas emissions. FirstCarbon Solutions&rsquo; complementary suite of compliance software solutions including Associated Health &amp; Safety, Audit &amp; Corrective Action and Environmental Compliance modules, in addition to a contracted hourly rate for software implementation, are available on its GSA contract. The GSA Multiple Award Schedule (MAS) vendor program streamlines administrative requirements and expedites the procurement process, allowing FirstCarbon Solutions to work more efficiently with federal, state and local governments.</p>
<p>&ldquo;Becoming an authorized vendor allows FirstCarbon Solutions to better serve and expand our offerings for various governmental agencies and municipalities,&rdquo; said Shawn McGowan, General Manager for FirstCarbon Solutions. &ldquo;Our suite of sustainability software solutions and services are designed to reduce the challenges associated with implementing and tracking environmental management initiatives. FirstCarbon Solutions understands the unique needs of government agencies and the importance of using data-driven insights to develop sustainability plans.&rdquo;</p>
<p>FirstCarbon Solutions offers a full suite of products and services for state governments, municipalities and utilities -- ranging from energy and water inventory analyses and compliance data management/reporting to supply chain carbon and energy accounting. FirstCarbon Solutions provides government agencies the maximum flexibility to adapt to their future needs, source energy data at a granular level and align data collection methodologies to established protocols. FirstCarbon Solutions&rsquo; mission is to help organizations monitor, manage and report environmental data and cost effectively manage sustainability programs.</p>
...
<address>Kristina Long<br /> Cohn &amp; Wolfe<br /> (415) 365-8556 <br /> <a href="mailto:kristina.long@cohnwolfe.com">kristina.long@cohnwolfe.com</a><br /> <a href="mailto:firstcarbon@cohnwolfe.com">firstcarbon@cohnwolfe.com</a></address>
