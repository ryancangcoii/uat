...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_CEMECEMETSFRCF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_CEMECEMETSFRCF10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_CEMECEMETSFRCF@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_CEMECEMETSFRCF10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_CEMECEMETSFRCF10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_CEMECEMETSFRCF10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_CEMECEMETSFRCF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Centre for Engineering and Manufacturing Excellence (CEME) Takes Step Forward to Reduce its Carbon Footprint</h1>
<p><strong>WEST CHESTER, Pa., April 12, 2011</strong> &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental business intelligence, announced today that it will provide its ghgTrack&trade; software to manage and report greenhouse gas emissions for First American Title Insurance Company&rsquo;s Santa Ana, Calif., corporate headquarters.</p>
<p>First American will use ghgTrack software to collect data on direct and indirect sources of greenhouse gas emissions and calculate carbon dioxide equivalent (CO2e) values. The data will be used to provide stakeholders with auditable greenhouse gas reports and establish baseline measurements as a first step in the company&rsquo;s program to reduce emissions. First American chose FirstCarbon Solutions based on its ability to connect greenhouse gas reporting with long-term business goals and its expertise in federal and state emissions regulations.</p>
<p>&ldquo;First American is committed to reducing our environmental impact; however, we realize that we can&rsquo;t reduce what we can&rsquo;t measure,&rdquo; said Dennis Gilmore, chief executive officer of First American Financial Corporation, the parent company for First American Title Insurance Company. &ldquo;With ghgTrack software, we will be able to measure our greenhouse gas emissions and connect sustainability programs to our bottom line.&rdquo;</p>
<p>&ldquo;Organizations that fall outside of the compliance-driven, smokestack industry require a customized solution in order to efficiently track and report greenhouse gas emissions,&rdquo; said Jim Donovan, chief executive officer of FirstCarbon Solutions. &ldquo;ghgTrack software is a flexible, easy-to-use tool for helping clean industries manage environmental programs. FirstCarbon Solutions is one of a few vendors that can accurately measure the return on investment of sustainability programs.&rdquo;</p>
<p>FirstCarbon Solutions provides an end-to-end environmental management solution that helps companies quickly identify and collect the data necessary to accurately and cost effectively calculate a carbon footprint. For organizations not yet subject to carbon and other regulations, but where sustainability metrics have a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and other resources and transforms that cost into business opportunity.</p>
...
<p><em>About First American Title Insurance Company</em></p>
<p><em>First American Title Insurance Company, the largest subsidiary of First American Financial Corporation (NYSE: FAF), traces its history to 1889. One of the largest title insurers in the nation, the company offers title services through its direct operations and an extensive network of agents throughout the United States and abroad. The company has its headquarters in Santa Ana, Calif. Information about First American Financial Corporation&rsquo;s subsidiaries and an archive of its press releases can be found on the Internet at www.firstam.com.</em></p>
<p>Media Contacts:</p>
<p>Cohn &amp; Wolfe:<br /> Bryan Pope<br /> Cohn &amp; Wolfe<br /> (415) 365-8538 <br /> <a href="mailto:bryan.pope@cohnwolfe.com">bryan.pope@cohnwolfe.com</a><br /> Carrie Navarifar<br /> Media Relations Manager<br /> First American Financial Corporation<br /> 714-250-3298</p></div></div>
</div>
