...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_SSFCSEDCR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_SSFCSEDCR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_SSFCSEDCR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_SSFCSEDCR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_SSFCSEDCR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_SSFCSEDCR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_SSFCSEDCR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Seven Selects FirstCarbon Solutions for Environmental Data Collection and Reporting</h1>
<p><strong>(PRWEB UK) April 26, 2011</strong> &ndash; Seven, the award-winning, multi-channel customer engagement agency, today announced it has selected FirstCarbon Solutions ghgTrack&trade; software to manage carbon emissions across its offices and publishing sites. Seven will also use this software to track employee volunteer activities and other sustainability metrics.</p>
<p>Although Seven does not need to legally report its emissions, as part of its environmental strategy it is committed to supporting the sustainable development of the digital and printed communications industry.</p>
<p>FirstCarbon Solutions ghgTrack software will help Seven easily collect data on scope 1, 2 and 3 emission sources and automatically calculate carbon dioxide equivalent (CO2e) values based on established Carbon Reduction Commitment (CRC) greenhouse gas protocols. The software will be used to calculate emissions across offices, as well as our publishing operations.</p>
<p>Sophie Finch, Production Director at Seven, said: &ldquo;As we work with our clients to deliver creative customer engagement programs through print and digital media, we&rsquo;re dedicated to conducting our business in a sustainable way. FirstCarbon Solutions ghgTrack software will enable us to easily track the associated carbon output without taking up internal resources. This platform allows us to capture and report data in detail, so stakeholders can manage environmental risk.&rdquo; Seven will use the auditable reports generated by the FirstCarbon Solutions ghgTrack, to continue to monitor carbon emissions and environmental risk over time. It will make this data available to stakeholders, and eventually hopes to generate lifecycle assessments for individual magazines.</p>
<p>&ldquo;Implementing a carbon reporting system often presents considerable challenges for organisations,&rdquo; said Charles Hansard, Director of Business Development Europe, FirstCarbon Solutions. &ldquo;FirstCarbon Solutions works with customers to accurately capture data at the most granular level. Data serves as the building block for sustainability initiatives and reduction targets. We&rsquo;re proud to partner with organisations like Seven in order to help reduce emissions and environmental risk.&rdquo;</p>
<p>Seven is committed to the principles of sustainable development and corporate responsibility. In all of our business operations we recognise our obligation to improve our environmental performance and contribute positively to the local and wider community in which we operate.</p>
<p><em>About Seven</em></p>
<ul>
<li><em>Seven is an award-winning, multi-channel strategic content agency. </em></li>
<li><em>Experts in creating intelligent, relevant and effective content across multiple channels, including magazines, websites, social media, interactive ezines, video, iPhone and iPad apps. Clients of Seven include Virgin, Sainsbury&rsquo;s, CIMA, English Heritage, Grant Thornton, Guardian Media Group, Lloyds Banking Group, New Look and Waterstone&rsquo;s.</em></li>
<li><em>For further information: <a href="http://www.seven.co.uk">http://www.seven.co.uk</a> or contact Shareena Ali, PR Manager, <a href="mailto:Shareena.ali@seven.co.uk">Shareena.ali@seven.co.uk</a> 020 7775 5549.</em></li>
</ul>
