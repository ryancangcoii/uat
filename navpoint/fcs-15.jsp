...
<section  ><%-- Widget fcs.pages.aboutus@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>About Us</h1>
<h5>Energy Management &amp; Energy Sustainability Consultants for Business &amp; Industry</h5>
<p>FirstCarbon Solutions (FCS) advances sustainable practices around the world and helps organizations responsibly grow and operate their businesses. Seamlessly delivering fully integrated, cost-effective <a href="/ttsvr/solutions/by-service/consulting">consulting</a>, <a href="/ttsvr/solutions/by-service/data-processing">data management</a> and <a href="/ttsvr/solutions/by-service/software">software solutions</a>, FCS helps clients save time, reduce costs, optimize resource use, and drive operational efficiencies in a world where sustainability matters. With more than 30 years of environmental and sustainability consulting experience, FCS has <a href="/ttsvr/solutions/about-us/contact-us">offices</a> throughout Asia, Europe, Africa, Australia and North America to ensure we meet our clients' ever-evolving <a href="/ttsvr/solutions/by-focus/environmental">environmental</a> and <a href="/ttsvr/solutions/by-focus/entitlements-permitting">compliance</a> needs in energy, air and carbon management; <a href="/ttsvr/solutions/by-focus/environmental/environmental-assessments">environmental assessments</a> and planning; supply and <a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessments</a>; <a href="/ttsvr/solutions/by-focus/entitlements-permitting">permitting and compliance</a>; <a href="/ttsvr/solutions/by-service/software">software</a> and <a href="/ttsvr/solutions/by-service/data-processing">data processing</a>.</p>
<p><strong>Find out more about FCS: <br /> <a href="/ttsvr/about-us/milestones">Milestones</a> | <a href="/ttsvr/about-us/certifications">Certifications</a> | <a href="/ttsvr/about-us/management-team">Management Team</a> | <a href="/ttsvr/about-us/careers">Careers</a> | <a href="/ttsvr/about-us/contact-us">Contact Us</a> </strong></p></div></div>
</div>
