...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSEOPSEMUS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSEOPSEMUS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSEOPSEMUS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSEOPSEMUS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSEOPSEMUS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSEOPSEMUS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSEOPSEMUS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Expands Offerings to Postsecondary Education Market (US)</h1>
<p><strong>WEST CHESTER, Pa., March 15, 201</strong>1 &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental business intelligence, today announced the rollout of the FirstCarbon Solutions University Licensing Program to help colleges and universities achieve sustainability goals and implement environmental initiatives. The program offers accredited universities a 20 percent discount on</p>
<p>FirstCarbon Solutions ghgTrack&trade; software and Professional Services.</p>
<p>FirstCarbon Solutions ghgTrack software is an affordable, customizable and feature-rich solution that allows universities to manage greenhouse gas emissions and other sustainability data across multiple facilities and campuses. The Internet-based software also includes a suite of graphical user interface dashboards and customizable metrics to allow convenient access to granular data. In addition, universities can benefit from FirstCarbon Solutions&rsquo; Professional Services that include energy management and efficiency, life cycle assessments (LCAs), green real estate certification and data management sourcing.</p>
<p>&ldquo;FirstCarbon Solutions is dedicated to providing organizations a cost-effective solution to collect and report environmental data and manage sustainability programs,&rdquo; said Dailey Tipton, Global Leader, Sales and Marketing, FirstCarbon Solutions. &ldquo;We are proud to offer our technology and service offerings at a discounted rate for universities to measure and report their sustainability efforts, as well as an opportunity to engage students in emissions reduction programs.&rdquo;</p>
<p><strong>FirstCarbon Solutions ghgTrack and Professional Services Pricing and Availability</strong></p>
<p>The FirstCarbon Solutions University Licensing Program is available today for accredited universities. ghgTrack software licenses are purchased on a per site, not per user, basis. Pricing is based on a tiered structure that reflects data and reporting requirements. Contact FirstCarbon Solutions at <a href="mailto:usa@firstcarbonsolutions.com">usa@firstcarbonsolutions.com</a> for discounted pricing details. For more information, visit: "Universities: Achieve efficiency and leadership"</p>
...
<p>Media Contacts:</p>
<p>Bryan Pope<br /> Cohn &amp; Wolfe<br /> (415) 365-8538 <br /> <a href="mailto:bryan.pope@cohnwolfe.com">bryan.pope@cohnwolfe.com</a></p></div></div>
</div>
