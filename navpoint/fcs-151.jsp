...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_MEHCSFCSLCAACNC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_MEHCSFCSLCAACNC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_MEHCSFCSLCAACNC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_MEHCSFCSLCAACNC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_MEHCSFCSLCAACNC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_MEHCSFCSLCAACNC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_MEHCSFCSLCAACNC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>M.E. Heuck Co. Selects FirstCarbon Solutions for Life Cycle Analysis to Achieve CarbonNeutral&reg; Certification</h1>
<p><strong>WEST CHESTER, Pa., Jan. 19, 2011</strong> &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental management optimization, today announced that M.E. Heuck Co., a leading distributor of houseware products, has selected FirstCarbon Solutions for conducting the Life Cycle Analysis (LCA) of its product manufacturing and supply chain to support a CarbonNeutral&reg; Certification, which is awarded by The CarbonNeutral Company.</p>
<p>M.E. Heuck Co. turned to FirstCarbon Solutions to help its new brand of cookware and kitchen gadgets, ZEROCA, receive certification as the First CarbonNeutral kitchenware product line. FirstCarbon Solutions began by assessing the business case for certification and looking closely at costs and technical requirements to help M.E. Heuck determine that the project was feasible both from a cost and execution standpoint.</p>
<p>The program involved an independent assessment of the CO2 emissions produced from manufacturing and distribution followed by an offset-inclusive carbon management program. This means that every metric ton of CO2 that ZEROCA produces is matched by an equivalent, guaranteed CO2 reduction through a carbon offset project.The FirstCarbon Solutions team of experts conducted an in-depth analysis of ZEROCA&rsquo;s manufacturing process and its entire supply chain. For each manufacturing operation, FirstCarbon Solutions identified and processed data on energy usage, raw material usage, packaging, and solid waste and transportation emissions from both internal and external sources. A preliminary greenhouse gas (GHG) inventory and carbon footprint per unit measure was calculated to allow M.E. Heuck to assess the costs and invest in carbon offset projects both in the US and China to offset an equivalent amount of CO2 emissions. M.E. Heuck has reduced its GHG emissions in accordance with The CarbonNeutral Protocol, the global standard for CarbonNeutral certification.</p>
<p>&ldquo;FirstCarbon Solutions has helped us successfully achieve our goals in manufacturing the First CarbonNeutral line of cookware and kitchen gadgets in the market, ZEROCA, while satisfying the certification requirements in a cost-effective manner,&rdquo; said Chris McCarthy, President, M.E. Heuck Co. &ldquo;We&rsquo;re now able to develop our own calculations on total cost of carbon offsets in order to maintain carbon neutrality. Working with FirstCarbon Solutions has enabled us to more clearly define the return on investment (ROI) of our sustainability programs.&rdquo;</p>
<p>&ldquo;FirstCarbonSolutions&rsquo; customers face various challenges from implementing comprehensive sustainability programs to providing product certifications for its new line of sustainable cookware and kitchen gadget products,&rdquo; said Dailey Tipton, global leader, sales and marketing, FirstCarbon Solutions. &ldquo;Our work with M.E. Heuck illustrates the power and cost efficiency of our energy management solutions.&rdquo;</p>
<p>FirstCarbon Solutions provides an end-to-end environmental management solution that helps companies quickly identify and collect the necessary data and accurately calculate a carbon footprint without draining an organization's internal resources. For organizations not yet subject to carbon and other regulations, but where sustainability metrics have a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and other resources, and transforms that cost into business opportunity.</p>
...
<p><em>About The CarbonNeutral Company</em></p>
<p><em>The CarbonNeutral Company (www.carbonneutral.com) is a world leading provider of carbon reduction solutions. It has worked with over 300 major businesses and thousands of small and medium sized companies in 32 countries to develop offset inclusive carbon reduction programmes. Since 1997, it has purchased carbon credits from over 200 projects in 24 countries.</em></p>
<p><em>CarbonNeutral&reg; is the registered trademark of The CarbonNeutral Company and is a global standard to certify that businesses have measured and reduced their CO2 emissions to net zero for their company, products, operations or services. Permission to display the CarbonNeutral&reg; mark is only given to clients whose carbon reduction programme is implemented in accordance with The CarbonNeutral Protocol. The Protocol assures quality of offset projects, carbon footprint assessments and communication and is regularly reviewed by an Independent Advisory Group. The company&rsquo;s &lsquo;audit trail&rsquo; includes an annual independent verification of CarbonNeutral programmes &ndash; from contracts with carbon offset partners through to contracts with clients and everything in between.</em></p>
<p><em>The CarbonNeutral Company has offices in New York, London and Singapore. The CarbonNeutral Company is a founding member of The International Carbon Reduction and Offset Alliance (ICROA), which provides leadership and a unified voice advocating for rigorous industry standards <a href="http://www.icroa.org">www.icroa.org</a>.</em></p>
<div class="row"><br />
<div class="col-sm-12 col-md-12 col-lg-12">Media Contacts:</div>
<div class="col-sm-6 col-md-6 col-lg-6"><br />
<p>For FirstCarbon Solutions</p>
<p>Byron Rashed <br /> FirstCarbon Solutions <br /> (949) 643-0733 <br /> <a href="mailto:brashed@firstcarbonsolutions.com">brashed@firstcarbonsolutions.com</a></p>
</div>
<div class="col-sm-6 col-md-6 col-lg-6"><br />
<p>Cohn &amp; Wolfe:</p>
<p>Bryan Pope <br />Cohn &amp; Wolfe <br />(415) 365-8538 <br /><a href="mailto:bryan.pope@cohnwolfe.com">bryan.pope@cohnwolfe.com</a></p>
</div>
</div>
