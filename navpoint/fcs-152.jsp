...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSDEIA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSDEIA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSDEIA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSDEIA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSDEIA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSDEIA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSDEIA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Delivers Environmental Intelligence and Analytics</h1>
<p><strong>WEST CHESTER, Pa., Jan. 10, 2011</strong> &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental management optimization, offers a suite of environmental intelligence and analytics solutions designed to help organizations meet sustainability objectives.</p>
<p>For regulated industries struggling with how to assure compliance with new environmental reporting requirements, FirstCarbon Solutions provides an end-to-end environmental management solution that helps companies quickly identify and collect the necessary data and accurately calculate a carbon footprint without draining an organization's internal resources. For organizations not yet subject to carbon and other regulations, but where sustainability metrics have a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and other resources, and transforms that cost into business opportunity. In November 2010, FirstCarbon Solutions established FirstCarbon Energy Solutions, a subsidiary dedicated to providing a suite of services to help organizations improve energy savings programs.</p>
<p>In a recent news article<sup>1</sup>, Forrester Research, Inc. cites FirstCarbon Solutions as one of the vendors that offers ECEM software but primarily use it as &ldquo;platforms for offering ECEM as a fully outsourced service. Forrester terms this platform-based environmental intelligence/analytics and consulting services..." Forrester "foresees platform-based services as a new trend emerging for both software vendors and service providers to tap into new revenue opportunities, especially with the rising sophistication of platforms and the skills required to leverage them."</p>
<p>"FirstCarbon Solutions offers one of the most advanced and flexible energy management solutions on the market today, said Jim Donovan, CEO of FirstCarbon Solutions. &ldquo;From office park to smokestack, we provide the scale, expertise and cost-efficiencies needed to help our clients meet and manage sustainability objectives over time. As Forrester cites, FirstCarbon Solutions offers ECEM software as platforms for offering ECEM as a fully-outsourced service. Many of our clients also choose to implement our software as a standalone solution.</p>
<p>For more information on FirstCarbon Solutions and FirstCarbon Energy Solutions, please visit:<br /> <a href="http://www.firstcarbonsolutions.com/">http://www.firstcarbonsolutions.com/</a> and <a href="http://www.firstcarbonenergy.com/.">http://www.firstcarbonenergy.com/.</a></p>
<p><sup>1</sup> The Continuing Evolution of Carbon and Energy Management Software, GreenBiz.com, December 1, 2010</p>
