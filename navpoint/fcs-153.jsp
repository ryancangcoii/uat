...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_ESTCFSPVSGRS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_ESTCFSPVSGRS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_ESTCFSPVSGRS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_ESTCFSPVSGRS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_ESTCFSPVSGRS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_ESTCFSPVSGRS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_ESTCFSPVSGRS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CDP and FirstCarbon Solutions Publish Inaugural Index of Suppliers Leading in Climate Change Performance</h1>
<p><em>Supplier Leadership Index is newest way to benchmark best practices and for CDP Supply Chain Program Members to evaluate suppliers</em></p>
<p>IRVINE, CA and LONDON, UK (January 21, 2014) &ndash; <a href="http://www.firstcarbonsolutions.com/" target="_blank">FirstCarbon Solutions</a> (FCS), a pioneer in environmental and sustainability business solutions, and&nbsp; <a href="http://www.cdp.net" target="_blank">CDP</a>, the leading NGO providing the only global environmental disclosure system, today announced the debut publication of the Supplier Climate Performance Leadership Index (SCPLI), a new evaluation and benchmarking tool for CDP supply chain members and suppliers.</p>
<p>Compiled by FCS on behalf of CDP, the index is based on supply chain program data from 2,868 suppliers that are disclosing climate change data at the request of CDP&rsquo;s <a href="https://www.cdp.net/en-US/Programmes/Pages/CDP-Supply-Chain.aspx#members" target="_blank">64 supply chain members</a>, which represent a combined spending power of nearly US$1.15 trillion. The 79 companies included in the index demonstrate strong and transparent climate strategies and emissions reduction programs.</p>
<p>"Suppliers have been asking for a way to benchmark their climate change performance since FCS became the <a href="http://www.firstcarbonsolutions.com/solutions/by-focus/cdp" target="_blank">exclusive scoring partner for the CDP</a> Supply Chain program in 2011," says Robert Francisco, president of FirstCarbon Solutions. &ldquo;With the launch of the Supplier Leadership Index, FCS and CDP recognize the top 3% of suppliers who are committed to integrating climate resiliency programs into their overall business strategies which leads to unprecedented operational efficiencies, cost savings, revenue opportunities, and positive planet stewardship."</p>
<p>These leading suppliers demonstrate a number of defining characteristics in their CDP survey responses, including:</p>
<ul>
<li>Board-level oversight on climate planning along with monetary incentives for emission reductions</li>
<li>Substantive detail on how climate change is integrated into risk management and corporate strategy planning</li>
<li>Scope 1 and Scope 2 reduction targets</li>
<li>Evidence of Scope 1 &amp; Scope 2 emissions reduction activities that delivered significant results</li>
<li>Independent third-party assurance of Scope 1, Scope 2 and Scope 3 emissions</li>
</ul>
<p>&ldquo;Introducing a supplier performance leadership index into CDP's supply chain program will drive best practice. We have great insights into the fact that big multinational purchasers - namely our members - are increasingly demanding that their suppliers take action on mitigating climate change risks. Suppliers need to improve their levels of sustainability to differentiate themselves from their competitors or they will lose business&rdquo; said Nigel Topping, Executive Director, CDP.&rdquo;</p>
<p>The full supply chain report, including names of companies featured in the SCPLI and the methodology used, can be found at <a href="https://www.cdp.net/en-US/Pages/cdp-supply-chain-broadcast-2014.aspx" target="_blank">https://www.cdp.net/en-US/Pages/cdp-supply-chain-broadcast-2014.aspx</a>.</p>
<p><em>About CDP</em></p>
...
<br /><address>Steve Fiore <br /> SS|PR <br /> Ph: +1-847-415-9329 <br /> Email: <a href="mailto:sfiore@sspr.com">sfiore@sspr.com</a></address></div>
<br />
<div class="col-sm-6 col-md-6 col-lg-6"><br />
<p>For CDP</p>
<br /><address>Penny Cross <br />Communications Director <br />Ph: +44 (0) 20 7415 7083 <br />+44 7919 074 92<br />Email: <a href="mailto:penny.cross@cdp.net">penny.cross@cdp.net</a></address></div>
</div>
