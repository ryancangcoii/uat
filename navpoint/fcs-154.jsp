...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FSEESS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FSEESS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FSEESS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FSEESS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FSEESS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FSEESS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FSEESS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Establishes Energy Services Subsidiary</h1>
<p><strong>WEST CHESTER, Pa., Nov. 10, 2010</strong> &ndash; FirstCarbon Solutions, a pioneer and industry leader in environmental management optimization, today announced that it has established FirstCarbon Energy Solutions, a subsidiary dedicated to providing a suite of services to help organisations improve energy savings programmes .</p>
<p>FirstCarbon Energy Solutions will offer third-party verification services for Energy Service Companies (ESCOs), in order to give ESCOs the confidence to deliver energy efficiency reviews that stand up to outside scrutiny. As a third-party quality assurance organisation, FirstCarbon Energy Solutions will audit and verify energy savings to validate a project&rsquo;s success, delivering a clear value proposition for ESCOs and their customers.</p>
<p>In addition, FirstCarbon Energy Solutions will provide rebate processing services to utilities and municipalities in order to provide cost-effective solutions, reduce costs and conserve budget-constrained resources. FirstCarbon Energy Solutions will work with customers to oversee all rebate call center operations, document management, reporting and payment processing. Backed by FirstCarbon Solutions&rsquo; parent company, ADEC Solutions, FirstCarbon Energy Solutions maintains more than 5,000 sourcing professionals on five continents to provide organisations with expert data management and reporting critical to all successful rebate programmes .</p>
<p><strong>"FirstCarbon Energy Solutions services are designed to address the uncertainty and complexity that surround energy savings verification and rebate program support,&rdquo; <em>said James Donovan, CEO of FirstCarbon Solutions.</em></strong> "Municipalities that rely on our data management services and ESCOs that rely on our expertise in energy savings verification have one thing in common: both trust FirstCarbon Energy Solutions to enhance energy savings programmes .&rdquo;</p>
<p>For more information on FirstCarbon Energy Solutions, please visit: <a href="http://www.firstcarbonenergy.com/">http://www.firstcarbonenergy.com/</a></p>
