...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSRAGGVBCARB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSRAGGVBCARB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSRAGGVBCARB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSRAGGVBCARB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSRAGGVBCARB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSRAGGVBCARB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSRAGGVBCARB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Receives Accreditation as a Greenhouse Gas Verification Body from California Air Resources Board (CARB)</h1>
<p><strong>WEST CHESTER, Pa., June 21, 2010</strong> - FirstCarbon Solutions, a pioneer and industry leader in environmental management optimization, today announced that it has been accredited by the California Air Resources Board (CARB) as a greenhouse gas verification body for the state's AB 32 program. Under Executive Order H-10-196, FirstCarbon Solutions is certified to verify greenhouse gas inventories for approximately 700 facilities that are currently required to report. FirstCarbon Solutions' Verification Services is comprised of seasoned, accredited staff to help customers with their AB 32 challenges.</p>
<p>On December 6, 2007, pursuant to the California Global Warming Solutions Act of 2006, CARB approved the Mandatory Reporting of Greenhouse Gas Emissions regulation. The regulation requires reporting and third-party verification of greenhouse gas (GHG) emissions. Facilities subject to mandatory reporting are required to have their GHG emissions verified beginning in 2010, for their 2009 reported emissions. Facilities are subject to either annual or triennial verification.</p>
<p>"The accreditation from California Air Resources Board further validates FirstCarbon Solutions' expertise in GHG emissions reporting and verification," said Dailey Tipton, vice president, sales and marketing, FirstCarbon Solutions. "Beyond verification, FirstCarbon Solutions excels at helping organisations convert environmental data across their operations into a business advantage. Whether an organisation falls within the threshold for mandatory reporting, or it is simply interested in maximising sustainability initiatives, FirstCarbon Solutions can help."</p>
<p>FirstCarbon Solutions combines environmental consulting and GHG emissions management software (FirstCarbon Solutions ghgTrack&trade;) to allow organisations to optimise their sustainability initiatives. For regulated industries struggling with how to assure compliance with new environmental reporting requirements, FirstCarbon Solutions provides an end-to-end environmental management solution that helps companies quickly identify and collect the necessary data and accurately calculate a carbon footprint without draining an organisation's internal resources. For organisations not yet subject to carbon regulation, but where carbon has a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and transforms that cost into business opportunity.</p>
