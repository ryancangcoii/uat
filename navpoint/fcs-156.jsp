...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSJSCSRGCSRCSRM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSJSCSRGCSRCSRM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSJSCSRGCSRCSRM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSJSCSRGCSRCSRM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSJSCSRGCSRCSRM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSJSCSRGCSRCSRM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSJSCSRGCSRCSRM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Joins Singapore Compact to Support the Region's Growing Corporate Social Responsibility (CSR) Movement</h1>
<p><strong>SINGAPORE, June 10, 2010</strong> - FirstCarbon Solutions, a pioneer and industry leader in environmental management optimization, today announced that it is joining Singapore Compact, a national society dedicated to furthering Corporate Social Responsibility (CSR) initiatives in Singapore. Singapore Compact, a participant in the UN Global Compact, is a dynamic network of stakeholders whose vision is to advance sustainability issues for global good.</p>
<p>In addition, FirstCarbon Solutions has officially opened its Singapore office. FirstCarbon Solutions Singapore will enable businesses in the region to meet the challenges of their sustainability programmes by combining environmental consulting and GHG emissions management software into customised solutions.</p>
<p>"We're proud to join the Singapore Compact and team up with fellow stakeholders to advance sustainability initiatives in the Asia-Pacific region," said James Donovan, CEO, FirstCarbon Solutions. "As a leader in environmental management optimization, FirstCarbon Solutions sees this network, and our recently launched offering in the region, as an opportunity to help organisations in Singapore achieve CSR goals while realizing business advantage."</p>
<p>FirstCarbon will partake in Singapore Compact's mission to further the CSR movement in Singapore through ongoing dialogues, training, collaboration and practical project implementation conducted by highly accredited CSR training institutes.</p>
<p>The FirstCarbon Solutions Singapore office is located at 16 Collyer Quay #10-00, Singapore. For more information on FirstCarbon Solutions, please visit&nbsp;<a href="http://www.firstcarbonsolutions.com">www.firstcarbonsolutions.com</a></p>
