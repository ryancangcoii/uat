...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSDRPSCECCAP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSDRPSCECCAP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSDRPSCECCAP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSDRPSCECCAP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSDRPSCECCAP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSDRPSCECCAP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSDRPSCECCAP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Deliver Rebate Processing Support for California Energy Commission Cash for Appliances Program</h1>
<p><strong>WEST CHESTER, Pa., May 11, 2010</strong> - FirstCarbon Solutions, a pioneer in environmental management optimization, today announced that it is providing data management support for California Energy Commission's Cash for Appliances rebate program.</p>
<p>FirstCarbon Solutions is overseeing customer call center support, evaluating rebate applications, and working to process and approve applications in a timely and cost-effective manner. Applications will then be distributed to Energy Commission for payment processing and issuing.</p>
<p>Since April 22, California consumers have been able to trade in appliances such as old refrigerators, clothes washing machines, and room air conditioners for new energy efficient models. The Cash for Appliances rebate program will offer rebate incentives from the $35.2 million in federal stimulus funding California received from the federal American Recovery and Reinvestment Act of 2009 (ARRA).FirstCarbon Solutions was selected as a result of a competitive bid solicitation based on the overall quality of service and efficiency the company delivers to its customers. The Energy Commission will benefit from a cost-effective program that decreases operating costs for the State of California while conserving budget-constrained resources and keeping the majority of funds within the state.</p>
<p>"Processing data for sustainability programmes poses many challenges for organisations," said Dailey Tipton, vice president, sales and marketing, FirstCarbon Solutions. "Whether it's a customer rebate program from a state energy office or a company trying to create an accurate and verifiable carbon footprint, success begins with effectively managing data. The Energy Commission's effort to improve California's long-term energy efficiency goals is the latest example of the kinds of sustainability initiatives FirstCarbon Solutions can support."</p>
<p>FirstCarbon Solutions combines environmental consulting and GHG emissions management software to allow organisations to optimise their sustainability initiatives. For regulated industries struggling with how to assure compliance with new environmental reporting requirements, FirstCarbon Solutions provides the an end-to-end environmental management solution that helps companies quickly identify and collect the necessary data and accurately calculate a carbon footprint without draining an organisation's internal resources. For organisations not yet subject to carbon regulation, but where carbon has a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and transforms that cost into business opportunity.</p>
<p>The California Cash for Appliances website - www.cash4appliances.org - explains the rebate program and offers information such as the forms that consumers are required to fill out once the new efficient appliance is purchased. This will help consumers find eligible appliances and fill out forms correctly, delivering and installing energy efficient appliances and recycling old models to California certified recyclers. The website also lists the partner retailers who have signed on to the program, including "Platinum Partner" stores, which offer a full-service to consumers.</p>
