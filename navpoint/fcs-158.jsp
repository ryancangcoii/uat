...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSOSO@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSOSO10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSOSO@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSOSO10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSOSO10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSOSO10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSOSO@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions opens Singapore office</h1>
<p>FirstCarbon Solutions, a pioneer in environmental management optimization, has announced the opening of its Singapore office. FirstCarbon Solutions will enable businesses in Singapore to meet the challenges of their sustainability programmes by combining environmental consulting and GHG emissions management software into customised solutions.</p>
<p>Singapore has a thriving economy based on electronics, chemicals, financial services, manufacturing, and life sciences. FirstCarbon Solutions Singapore brings its expertise in Business Process Outsourcing (BPO) to process sustainability data along with FirstCarbon Solutions ghgTrack&trade; Software as a Service (SaaS) to transform raw data into measureable CO2e emissions and carbon credits trading.</p>
<p>Sam Chong has been appointed Managing Director of FirstCarbon Solutions Singapore. Mr. Chong will be responsible for overseeing sales and consulting services in Singapore and Malaysia. Mr. Chong has extensive experience as an entrepreneur having co-founded his own company, TVC Pte Ltd, in 1995 to provide value added services in telecommunication. He successfully raised seed funding for TVC in 1995 and venture capital funding from 3i plc, the largest venture capital fund in Europe in 1997. Prior to that he held positions as General Manager and Regional Sales Director at Cylink Corporation, a company based in San Jose, and Atlas Telecoms, a company based in Portland, respectively. Mr. Chong holds a Bachelors Degree in Electrical Engineering (Hons) from the National University of Singapore.</p>
<p>In addition, Akash Mittal, will join FirstCarbon Solutions Singapore as Technology Consultant. Mr. Mittal will be responsible for technical support of FirstCarbon Solutions customers in the region. Mr. Mittal, has over 22 years in the information technology field in Asia Pacific and has demonstrated outstanding problem-solving abilities with a range of leading companies including TVC Pte Ltd. This, combined with a strong understanding of technology, telecommunications and wide area networks, has enabled him to lead much of the development of TVC's innovative applications. Prior to joining TVC, Mr. Mittal, as Communications Engineer and Technology Officer for J.P. Morgan Chase in India and Singapore, was responsible for a wide range of functions including: installation and maintenance of data networks; information risk management; planning, installation, upgrading and maintenance of the bank's Asia Pacific network. Mr. Mittal has a bachelor's degree in engineering from Shivaji University, India, and a First Class MBA with Distinction from the University of Bombay, India.</p>
<p>The FirstCarbon Solutions Singapore office is located at 16 Collyer Quay #10-00, Singapore. For more information on FirstCarbon Solutions, please visit www.firstcarbonsolutions.com.</p></div></div>
</div>
