...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FSLEGSPEMOS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FSLEGSPEMOS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FSLEGSPEMOS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FSLEGSPEMOS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FSLEGSPEMOS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FSLEGSPEMOS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FSLEGSPEMOS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Launches Enhanced ghgTrack&trade; Software to its Portfolio of Environmental Management Outsourcing Services</h1>
<p><strong>NEW YORK, April 13, 201</strong>0 - FirstCarbon Solutions, a pioneer in environmental management sourcing (EMO), today announced the first release of ghgTrack&trade; software and services under the FirstCarbon Solutions banner. The ghgTrack software solution became part of the FirstCarbon Solutions portfolio of environmental management sourcing services through the company's acquisition of Enverity Corporation in 2009.</p>
<p>FirstCarbon Solutions ghgTrack software and services combine an affordable, customizable and feature-rich solution enabling both regulated and non-regulated industries to manage greenhouse gas emissions and other sustainability data. FirstCarbon Solutions Internet-based ghgTrack software includes a suite of new graphical user interface dashboards and customizable metrics for organisations large and small.</p>
<p>New features of FirstCarbon Solutions ghgTrack software include:</p>
<ul>
<li class="first">Custom Metrics for Additional Environmental Sustainability Goals: Users can define and import custom metrics - from water consumption to recycling initiatives - and schedule and manage tasks for regulatory and related reporting.</li>
<li>New Dashboards for Visualizing GHG Emissions: The ghgTrack dashboard provides a graphical summary of an organisation's GHG emissions and carbon footprint, allowing them to easily make decisions based on key performance indicators. The dashboard includes baseline comparisons, year-over-year; interactive views of emissions by classification; facility totals and thresholds, as well as open or overdue tasks.</li>
<li>Custom Filters to Meet Demands of Multiple Stakeholders: Each dashboard can be filtered based on the needs of individual business units or facilities and can be further refined based on time or emissions type.</li>
<li class="last">Methodology Tracking for Standards-based Reporting: ghgTrack helps guide users through the process of defining methodology for calculating GHG inventory, satisfying multiple international standards that require that methodology be documented and maintained over time.</li>
</ul>
<p><strong>A Spectrum of Options Depending on organisational Requirements</strong></p>
<p>Working with FirstCarbon Solutions, companies have a range of options available to them, from equipping internal environmental and related staff with technology and consulting solutions to completely sourcing data management-related sustainability initiatives.</p>
<p>"Managing GHG emissions has quickly become a business imperative for organisations, and needs vary greatly from the smokestack to the office park," said Dailey Tipton, vice president, sales and marketing, FirstCarbon Solutions. "However, no matter the size of your organisation, collecting, reporting and managing GHG begins with the data."</p>
<p>FirstCarbon Solutions is the first company to combine environmental consulting and GHG emissions management software into customised solutions that allow organisations to outsource their sustainability initiatives. For regulated industries struggling with how to assure compliance with new environmental reporting requirements, FirstCarbon Solutions provides the only fully outsourced end-to-end environmental management solution that helps companies quickly identify and collect the necessary data and accurately calculate a carbon footprint without draining an organisation's internal resources. For organisations not yet subject to carbon regulation, but where carbon has a material impact on business operations, FirstCarbon Solutions quantifies the cost of carbon and transforms that cost into business opportunity.</p>
<p>"Managing sustainability data is a massive undertaking for organisations, and that's where FirstCarbon Solutions comes in," added Tipton. "ghgTrack offers organisations a cost-effective software solution that's easy-to-use and robust enough to meet data-intensive demands as requirements grow. organisations that choose to partner with FirstCarbon Solutions for environmental management sourcing services are able to focus on their core business strategy, leaving grappling with data to us."</p>
<p><strong>ghgTrack Pricing and Availability</strong></p>
<p>Licenses are purchased on a per site, not per user, basis. Pricing is based on a tiered structure that reflects data and regulatory requirements. Monthly subscriptions can start as low as $500 per month per site. ghgTrack software is available immediately.</p>
