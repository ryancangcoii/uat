...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSSMPCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSSMPCT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSSMPCT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSSMPCT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSSMPCT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSSMPCT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSSMPCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Sponsors Manila Polo Club Tournament</h1>
<p><strong><img class="pull-right ml15" src="../fcs/images/plo-club-1.png" alt="" />Forbes Park, Makati City - March 21, 2010</strong> -- FirstCarbon Solutions , a global carbon management firm, was the major event sponsor of the prestigious Manila Polo Club&rsquo;s (MPC) President's Cup, the closing tournament of MPC's polo-playing season.</p>
<p>The well-attended event was held at the Enrique Zobel Field of the MPC, with highlights consisting of a low-goal and a high-goal match, both of which were triumphant victories for the two FirstCarbon Solutions Teams.The Red FirstCarbon Solutions Team, composed of Adrian Garcia, Fila&rsquo;s Butch Albert, FirstCarbon Solutions Lorna Lopez, Daryl Matti and Miguel Camara, defeated MPC&rsquo;s Yellow Team (comprised of Alberto Lopez, Gabby Roque, Santi Juban, Marco Estella and Jun Beltran) by a score of 8-4 in the exciting low-goal match.</p>
<p><img class="pull-left mr15" src="../fcs/images/plo-club-02.png" alt="" />The fast-paced high-goal match, undeterred by a strengthening drizzle, saw the White FirstCarbon Solutions Team beat the Blue MPC Team by a score of 8-4. The White FirstCarbon Solutions Team was led by FirstCarbon Solutions Group CEO James Donovan, Anthony Garcia, Jun Eusebio, and Jerome Hernandez, while Matt Hime, Antonio Veloso, Sonny Borromeo, and Jun Juban made up the MPC Blue Team.</p>
<p>Launched in 2009, FirstCarbon Solutions (FCS) employs a cutting-edge software called Solution ghgTrack to measure a company&rsquo;s carbon footprint. The company also offers carbon advisory services, emissions trading, and comprehensive management services&mdash; the first of its kind in the Philippines. For more information, log on to&nbsp;www.firstcarbonsolutions.com.he annual MPC event was co-sponsored by the American Eye Center, Arya Residences, Philippine Wine Merchants and Collezione 2. FirstCarbon Solutions, on its first year of sponsorship, is tying up with large Philippine corporations to help manage their sustainability programmes.</p></div></div>
</div>
