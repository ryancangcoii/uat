...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSAGOAGEC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSAGOAGEC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSAGOAGEC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSAGOAGEC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSAGOAGEC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSAGOAGEC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSAGOAGEC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Acquires Global Outsourcing Advisory Group and Enverity Corp.</h1>
<p><strong>EUEC 2010, Phoenix - February 1, 2010</strong> - FirstCarbon Solutions (www.firstcarbonsolutions.com), a pioneer in environmental management outsourcing, today announces its acquisitions of Global Sourcing Advisory Group (GSAG), a top sourcing advisory firm, and Enverity Corp., a leading environmental software provider. FirstCarbon Solutions is exhibiting (booth 917) and speaking at the Energy &amp; Environment Conference (EUEC) 2010, Feb. 1-3, 2010.</p>
<p>FirstCarbon Solutions is the first company to combine environmental consulting, software and carbon trading into customised solutions that allow clients to outsource their sustainability initiatives. The acquisitions of GSAG and Enverity expand the company's offerings in the carbon management industry, while leveraging its existing expertise in outsourcing.</p>
<p>"Reporting and improving a company's carbon footprint can be a massive undertaking, much like driving business results and preparing a corporate financial statement," said FirstCarbon Solutions CEO Jim Donovan. "Environmental management sourcinglets companies focus on their core businesses instead of struggling to master sustainability."</p>
<h3>GSAG Is Now Part of FirstCarbon Solutions</h3>
<p>With the acquisition of New York-based GSAG (www.gsadvisory.com), voted one of the world's best sourcingadvisors in 2009 (<a href="http://bit.ly/9dxOHN">http://bit.ly/9dxOHN</a>), FirstCarbon Solutions gains additional expertise in project managing large-scale sourcingprogrammes . The company will leverage GSAG's proprietary methodology to provide fiduciary oversight and management accountability that enables companies to align their sourcingprogrammes with their entire operations."GSAG's business advisory services help companies determine which parts of their environmental management processes to outsource and which to keep in-house," said John Stacey, president, GSAG, and executive vice president, FirstCarbon Solutions. "Then we focus on execution, putting the right services, software and carbon-management offerings in place to meet each client's needs."</p>
<h3>FirstCarbon Solutions Acquires Enverity and its ghgTrack Software</h3>
<p>The company also acquires Enverity Corp., an environmental software firm based in the San Francisco Bay area. With this acquisition, FirstCarbon Solutions now offers environmental compliance and environmental management tools, as well as Enverity's ghgTrack (www.ghgtrack.com) software solution, which helps calculate, manage and report greenhouse gas emissions.</p>
<p>"As part of FirstCarbon Solutions, ghgTrack software developers have unprecedented access to environmental experts," said Eric van Gestel, former Enverity CEO and FirstCarbon Solutions' vice president, software products. "We're turning that insider's perspective into innovative features, such as a library of emission sources that takes the guesswork out of GHG calculations and reports that facilitate third-party verifications."</p>
<h3>FirstCarbon Solutions Experts Speak at EUEC 2010</h3>
<p><strong>Carbon management and sustainability experts from FirstCarbon Solutions (booth 917) are speaking at EUEC:</strong></p>
<p>U.S. Climate Change Policy: Implications for Competitive Strategies<br />Mike Radcliffe, Director, Sustainable Strategies<br />Feb. 1, 3:30 p.m.</p>
<p>Greenhouse Gas Compliance and the Art of Predicting the World Series Champion<br />Eric van Gestel, Vice President, Software Products<br />Feb. 2, 7:30 a.m.</p>
<p>Sustainability Indexing: Brand Value, Reputation and the "Wall of Noise"<br />Chet Chaffee, Vice President, Life Cycle Assessment<br />Feb. 2, 1 p.m.</p>
<p>Environmental Health and Safety: a New Engine for Business Value<br />Dailey Tipton, Vice President, Sales and Marketing<br />Feb. 3, 10 a.m.</p>
<p>The GHG-Data Tsunami: The Hidden Challenge Facing Organisations<br />Jim Donovan, CEO<br />Feb. 3, 1 p.m.</p>
