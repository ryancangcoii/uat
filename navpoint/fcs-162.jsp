...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FCSAISO140012004EMC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FCSAISO140012004EMC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FCSAISO140012004EMC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FCSAISO140012004EMC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FCSAISO140012004EMC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FCSAISO140012004EMC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FCSAISO140012004EMC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions Achieves ISO 14001:2004 Environmental Management Certification</h1>
<p><strong>(The Philippines - Dec. 8, 2009)</strong> FirstCarbon, through its parent company ADEC Solutions (www.adec-solutions.com), received ISO 14001:2004 certification. This globally accepted standard for environmental management systems indicates that FirstCarbon Solutions has identified the environmental impact of its operations, adheres to regulatory requirements and takes a systematic approach to continuously improving its performance.</p>
<p>"At FirstCarbon, we practice what we preach in our own business environment, holding ourselves to the highest standard of environmental management," says Jim Donovan, FirstCarbon Solutions CEO.</p>
<p>The ISO 14001:2004 certification enabled FirstCarbon to develop and implement policies and objectives in compliance with physical and legal requirements, including:</p>
<ul>
<li>energy conservation</li>
<li>proper handling of hazardous materials</li>
<li>supplier compliance on use of environmentally-friendly substances</li>
<li>off-site tree planting projects</li>
<li>reducing FirstCarbon's carbon footprint through the use of LED lighting, inverter-type air-conditioning and other low-carbon technologies.</li>
</ul>
<p>FirstCarbon Solutions ISO 14001:2004 accreditation underscores its commitment to embed corporate social responsibility into its core policies and to apply these learnings and business processes to its clients' sustainability challenges.</p></div></div>
</div>
