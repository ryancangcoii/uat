...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CSUBDLBP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CSUBDLBP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CSUBDLBP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CSUBDLBP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CSUBDLBP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CSUBDLBP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CSUBDLBP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-104">News</a> &raquo; <span>Corporate Sustainability Using 'Big Data' to Look at the Big Picture</span></div>
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CSUBDLBP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Corporate Sustainability Using ‘Big Data’ to Look at the Big Picture";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/newsThumbs/environmental_managers0.png";
	String snippetVar_date = "Wednesday, March 05, 2014";
	String snippetVar_excerpt = "Enabling better decisions by providing investors, companies, and governments with high-quality information on how companies are managing their response to climate change and mitigating the risks from...";
	String snippetVar_content = "<p>  <img src=\"/ttsvr/fcs/images/newsThumbs/environmental_managers0.png\">  Enabling better decisions by providing investors, companies, and governments with high-quality information on how companies are managing their response to climate change and mitigating the risks from natural resource constraints has never been more important.   <br>    <br>  Stakeholders today want more than the philanthropic mission–vision statements of a company. They want real statistics, real facts, and most important of all, real results in terms of corporate social responsibility. In other words, they need accurate “big data” inclusive of a company’s environmental sustainability information.  <br>    <br>  Determining what “big data,” or information, is most important and where to find it is the first step. Whether for reporting or other purposes, success requires identifying your own needs, as well as your critical stakeholders and their priority needs, then addressing areas of overlap.   <br>    <br>  This article was written by Dr. Chet Chaffee, Director of Sustainability at FirstCarbon Solutions, and published in EM Magazine. Click to read the full article: Corporate Sustainability Using ‘Big Data’ to Look at the Big Picture.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CSUBDLBP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CSUBDLBP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
