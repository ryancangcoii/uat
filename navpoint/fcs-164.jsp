...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ISLCCPMID@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ISLCCPMID10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ISLCCPMID@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ISLCCPMID10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ISLCCPMID10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ISLCCPMID10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ISLCCPMID@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ISLCCPMID@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Index of Suppliers Leading in Climate Change Performance Makes Its Debut";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/supply-chain-brain2.jpg";
	String snippetVar_date = "Thursday, January 23, 2014";
	String snippetVar_excerpt = "FirstCarbon Solutions, active in environmental and sustainability business solutions, and CDP, an NGO provider of a global environmental disclosure system, announced the debut publication of the Supplier Climate Performance Leadership...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/supply-chain-brain2.jpg\">FirstCarbon Solutions, active in environmental and sustainability business solutions, and CDP, an NGO provider of a global environmental disclosure system, announced the debut publication of the Supplier Climate Performance Leadership Index, a new evaluation and benchmarking tool for CDP supply chain members and suppliers.<br>To read the full article from the SupplyChainBrain website, please <a href=\"http://www.supplychainbrain.com/content/single-article-page/article/index-of-suppliers-leading-in-climate-change-performance-makes-its-debut/\" target=\"_blank\">click here</a>.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ISLCCPMID@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ISLCCPMID@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
