...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FFGBG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FFGBG10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FFGBG@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FFGBG10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FFGBG10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FFGBG10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FFGBG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-103">News and Events</a> &raquo; <a href="/ttsvr/n/fcs-104">News</a> &raquo; <span>Filipino Firms Go Big Global</span></div>
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FFGBG@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Filipino Firms Go Big Global";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/themanilatimes.png";
	String snippetVar_date = "Sunday, January 26, 2014";
	String snippetVar_excerpt = "It was through the rosy economic period of 1996 that James “Jim” M. Donovan found himself in Manila for a World Bank project. At that time, the Philippines was being...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/themanilatimes.png\">It was through the rosy economic period of 1996 that James “Jim” M. Donovan found himself in Manila for a World Bank project. At that time, the Philippines was being touted as the next emerging tiger of Asia for the more than encouraging economic figures the country was then churning out. Like most investment bankers, Donovan was eager to check out the prospects for the Philippines and as fate would have it, he met Carol Esguerra who also happened to be participating at the same World Bank project at that time. From the beginning, he said, they started looking at the capability of the Philippines to see where it was being applied.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FFGBG@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FFGBG@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
