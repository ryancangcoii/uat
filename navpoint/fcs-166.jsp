...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPFCSPISLCCP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPFCSPISLCCP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPFCSPISLCCP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPFCSPISLCCP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP and FirstCarbon Solutions Publish an Index of Suppliers Leading Climate Change Performance";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sensorssystems.png";
	String snippetVar_date = "Friday, March 21, 2014";
	String snippetVar_excerpt = "FirstCarbon Solutions (FCS), a pioneer in environmental and sustainability business solutions, and CDP, the leading NGO providing the only global environmental disclosure system, today announced the debut publication of the...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sensorssystems.png\">FirstCarbon Solutions (FCS), a pioneer in environmental and sustainability business solutions, and CDP, the leading NGO providing the only global environmental disclosure system, today announced the debut publication of the Supplier Climate Performance Leadership Index (SCPLI), a new evaluation and benchmarking tool for CDP supply chain members and suppliers.<br /><br />Compiled by FCS on behalf of CDP, the index is based on supply chain program data from 2,868 suppliers that are disclosing climate change data at the request of CDP\'s 64 supply chain members, which represent a combined spending power of nearly US$1.15 trillion. The 79 companies included in the index demonstrate strong and transparent climate strategies and emissions reduction programs.<br /><br />To read the full article from Sensors and Systems, please <a href=\"http://www.sensorsandsystems.com/news/top-stories/corporate-news/32812-cdp-and-firstcarbon-solutions-publish-an-index-of-suppliers-leading-climate-change-performance.html\" target=\"_blank\">click here</a>.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSPISLCCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
