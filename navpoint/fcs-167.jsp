...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_IIPSLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_IIPSLCCP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_IIPSLCCP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_IIPSLCCP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_IIPSLCCP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_IIPSLCCP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_IIPSLCCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_IIPSLCCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Inaugural Index Published of Suppliers Leading in Climate Change Performance";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/canadianmanufactoring.png";
	String snippetVar_date = "Tuesday, January 21, 2014";
	String snippetVar_excerpt = "IRVINE, CA and LONDON, UK—FirstCarbon Solutions (FCS) and Carbon Disclosure Project have announced the debut publication of the Supplier Climate Performance Leadership Index (SCPLI), a new evaluation and benchmarking tool...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/canadianmanufactoring.png\">IRVINE, CA and LONDON, UK—FirstCarbon Solutions (FCS) and Carbon Disclosure Project have announced the debut publication of the Supplier Climate Performance Leadership Index (SCPLI), a new evaluation and benchmarking tool for CDP supply chain members and suppliers.<br /><br />Compiled by FCS on behalf of CDP, the index is based on supply chain program data from 2,868 suppliers that are disclosing climate change data at the request of CDP’s 64 supply chain members, representing a combined spending power of nearly US$1.15 trillion. The 79 companies included in the index demonstrate strong and transparent climate strategies and emissions reduction programs.<br /><br />To read the full article from CanadianManufacturing.com, please <a href=\"http://www.canadianmanufacturing.com/purchasing-and-procurement/sustainability/inaugural-index-published-of-suppliers-leading-in-climate-change-performance-130232\" target=\"_blank\">click here</a>.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_IIPSLCCP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_IIPSLCCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
