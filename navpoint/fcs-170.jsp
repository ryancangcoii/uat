...
<section  ><%-- Widget fcs.pages.aboutus_contactus_la@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_contactus_la10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_contactus_la@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_contactus_la10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_contactus_la10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_contactus_la10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_contactus_la@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-17">Contact Us</a> &raquo; <span>LA2013</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Now we're even CLOSER to your sustainability goals</h1>
<p><img class="pull-left mr15 mb15" src="/ttsvr/fcs/images/la-img3.jpg" alt="" /> With the opening of our new office in Los Angeles, FirstCarbon Solutions (FCS) solidifies our presence in the city to benefit businesses and organizations looking for innovative, cost-effective sustainability and environmental solutions. Located at 11755 Wilshire Boulevard, Suite 1660, the new office further establishes our unwavering commitment to support the LA community to:</p>
<ul class="inline-block">
<li>pursue sustainable practices</li>
<li>improve efficiencies</li>
<li>achieve profitability goals</li>
<li>balance growth and development with the environment.</li>
</ul>
<p>&gt;For over 30 years, FCS has been a dependable consultant for many of LA's hallmark projects for clients including Caltrans 7, Los Angeles Unified School District (LAUSD), City of Simi Valley, Crown Castle, <a class="hover1" href="/ttsvr/fcs/pdf/LADWP_Partners_with_FCS_PDF_10.312013.pdf" target="_blank">Los Angeles Department of Water and Power (LADWP)</a>, City of La Verne, Alcatel-Lucent, City of Commerce and more. Our most recent accomplishment has raised the bar of community impact even higher, with the award of the <a class="hover1" href="/ttsvr/fcs/pdf/fcscshcp-0713a_072313_newfcslalaunch.pdf" target="_blank">Hollywood Central Park EIR</a>.</p>
<p>With our new LA office, <a class="hover1" href="/ttsvr/fcs/pdf/FCSLALaunchManagementTeam_072613.pdf" target="_blank">FCS' team</a> of dedicated experts and resources are readily available to support you in carrying out every step of your initiatives in:</p>
<p class="clearfix"><img class="pull-left mb15 mr15" src="/ttsvr/fcs/images/bulb.png" alt="" /> <span class="inline-block mt15">environmental planning</span></p>
<p class="clearfix"><img class="pull-left mb15 mr15" src="/ttsvr/fcs/images/building-permit.png" alt="" /> <span class="inline-block mt15">resource management, compliance and permitting</span></p>
<p class="clearfix"><img class="pull-left mb15 mr15" src="/ttsvr/fcs/images/boxes.png" alt="" /> <span class="inline-block mt15">sustainability supply chain management, including life cycle assessments and energy management.</span></p>
<p>If you are looking to improve your sustainability and profitability performance, while at the same time improving your environmental&nbsp;footprint, look no further. Join your fellow Los Angeles businesses and organizations to achieve unprecedented value with FCS.</p>
<p><a class="btn btn-yellow" href="/request-a-consultation-with-la-office">Request a Meeting</a></p></div></div>
</div>
