...
<section  ><%-- Widget fcs.pages.aboutus_contactus_sanjose@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_contactus_sanjose10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_contactus_sanjose@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_contactus_sanjose10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_contactus_sanjose10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_contactus_sanjose10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_contactus_sanjose@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-17">Contact Us</a> &raquo; <span>SANJOSE2013</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Now we're even CLOSER to your sustainability goals</h1>
<p><img class="pull-left mr15 mb15" src="/ttsvr/fcs/images/sanjose-img.jpg" alt="" /> With the opening of our new office in San Jose CA, FirstCarbon Solutions (FCS) solidifies our presence in the South Bay to benefit businesses and organizations looking for innovative, cost-effective sustainability and environmental solutions.&gt;</p>
<p>Located at 2540 N. First Street, Suite 290, the new office further establishes our unwavering commitment to support the South Bay community to:</p>
...
<p>For over 30 years, FCS has been a dependable consultant for many of San Jose's hallmark projects for clients including <a href="/ttsvr/fcs/pdf/sustainability-case-study-110613.pdf" target="_blank">Cavium Networks</a>, City of Milpitas, County of Santa Clara, KB Home, SyWest Development, City of San Jose and more.</p>
<p>With our new San Jose office, <a href="/ttsvr/fcs/pdf/fcssanjoselaunchmanagementteam.pdf" target="_blank">FCS' team</a> of dedicated experts and resources are readly available to support you in carrying out every step of your initiatives in:</p>
