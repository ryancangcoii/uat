...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MICROSOFTBMW@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MICROSOFTBMW10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MICROSOFTBMW@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MICROSOFTBMW10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MICROSOFTBMW10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MICROSOFTBMW10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MICROSOFTBMW@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MICROSOFTBMW@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Microsoft, BMW Among Top Supply Chain Climate Performers";
	...
	String snippetVar_excerpt = "Air France, BMW, Hewlett-Packard and Microsoft are among 79 companies leading in climate change performance, according to a new evaluation and benchmarking tool created for CDP supply chain members and suppliers. The Supplier Climate Performance Leadership...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">  Air France, BMW, Hewlett-Packard and Microsoft are among 79 companies leading in climate change performance, according to a new evaluation and benchmarking tool created for CDP supply chain members and suppliers.<br /><br />The Supplier Climate Performance Leadership Index, which was compiled by environmental consulting and software firm FirstCarbon Solutions on behalf of CDP, debuted today. The index is based on supply chain program data from 2,868 suppliers that are disclosing climate change data at the request of CDP’s 64 supply chain members.<br /><br /><i>To read the full article from Environmental Leader, please <a href=\"http://www.environmentalleader.com/2014/01/21/microsoft-bmw-among-top-supply-chain-climate-performers/\" target=\"_blank\">click here</a>.</i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MICROSOFTBMW@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MICROSOFTBMW@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
