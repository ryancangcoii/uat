...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPFCSPUBLISH10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPFCSPUBLISH10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPFCSPUBLISH10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPFCSPUBLISH10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP and FirstCarbon Solutions Publish Inaugural Index of Suppliers Leading in Climate Change Performance";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sacramentobee.jpg";
	String snippetVar_date = "Monday, January 20, 2014";
	String snippetVar_excerpt = "IRVINE, Calif. and LONDON, Jan. 21, 2014 -- /PRNewswire/ -- FirstCarbon Solutions (FCS), a pioneer in environmental and sustainability business solutions, and CDP, the leading NGO providing the only global environmental disclosure system, today...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sacramentobee.jpg\">  IRVINE, Calif. and LONDON, Jan. 21, 2014 --&nbsp;/PRNewswire/ --&nbsp;FirstCarbon Solutions&nbsp;(FCS), a pioneer in environmental and sustainability business solutions, and&nbsp;CDP, the leading NGO providing the only global environmental disclosure system, today announced the debut publication of the Supplier Climate Performance Leadership Index (SCPLI), a new evaluation and benchmarking tool for CDP supply chain members and suppliers.  <br>  <br>  Compiled by FCS on behalf of CDP, the index is based on supply chain program data from 2,868 suppliers that are disclosing&nbsp;climate change&nbsp;data at the request of CDP\'s&nbsp;64 supply chain members, which represent a combined spending power of nearly US$1.15 trillion. The 79 companies included in the index demonstrate strong and transparent climate strategies and emissions reduction programs.  <br>  <br>  <i>    To read the full article from The Sacramento Bee,     <a href=\"“http://www.sacbee.com/2014/01/20/6087825/cdp-and-firstcarbon-solutions.html”\">      please click here.       </a>      </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSPUBLISH@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
