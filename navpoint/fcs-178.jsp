...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_BRIGHTENUPDAYS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_BRIGHTENUPDAYS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_BRIGHTENUPDAYS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_BRIGHTENUPDAYS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Brighten Up Your Holidays Sustainably with LED Lights";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sb_logo.jpg\"";
	String snippetVar_date = "Monday, December 16, 2013";
	String snippetVar_excerpt = "It all started with candles. The tradition of an illuminated holiday tree emerged around the 18th century, when wax candles were used to festoon the branches of fresh evergreens. Candles. The...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sb_logo.jpg\">￼It all started with candles. The tradition of an illuminated holiday tree emerged around the 18th century, when wax candles were used to festoon the branches of fresh evergreens. Candles.<br /><br />The notion is somewhat terrifying today. But even those incandescent bulbs of childhood had their safety and practical drawbacks. The large glass bulbs would shatter; the colored paint would chip and fade. And the occasional ornament would melt or worse if hung too close to a hot colored bulb.<br /><br /><i>To read the full article from SustainaBlog, please<a href=“http://sustainablog.org/2013/12/led-holiday-lights/” target=“_blank”> click here.</a></i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_BRIGHTENUPDAYS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
