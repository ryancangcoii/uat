...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_WHYRECYCLEHELPFUL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_WHYRECYCLEHELPFUL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_WHYRECYCLEHELPFUL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_WHYRECYCLEHELPFUL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Why Recycling Isn\'t As Helpful As You Think";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/mainst.jpg\"";
	String snippetVar_date = "Tuesday, December 10, 2013";
	String snippetVar_excerpt = "NEW YORK (MainStreet) — Many common environmental practices have trade-offs that most consumers are not aware of that deplete additional valuable energy resources. Some environmental practices such as plant-based bottles are...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/mainst.jpg\">  NEW YORK (MainStreet) — Many common environmental practices have trade-offs that most consumers are not aware of that deplete additional valuable energy resources.  <br>  <br>  Some environmental practices such as plant-based bottles are actually less helpful for the environment, because it requires additional water to produce the plant-based materials, said Chet Chaffee, director of sustainability at FirstCarbon Solutions, which works with its clients to reduce their carbon footprint.  <br>  <br>  <i>    To read the full article from Main Street, please    <a href=\"http://www.mainstreet.com/article/smart-spending/why-recycling-isnt-helpful-you-think?page=1\" target=\"“_blank”\">      click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_WHYRECYCLEHELPFUL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
