...
<section  ><%-- Widget fcs.pages.aboutus_certificates@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_certificates10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_certificates@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_certificates10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_certificates10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_certificates10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_certificates@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <span>Certifications</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Certifications - EMS, ISMS, QMS and More</h1>
<p>If you&rsquo;re looking for assurances that your sustainability and energy solutions partner takes advantage of certified business practices, look no further. FirstCarbon Solutions, as one of the five companies within<a href="http://www.adec-group.com/" target="_blank">ADEC Group</a>, has access to industry certifications and accreditations acknowledging the Group&rsquo;s commitment and adherence to recognized best practices.</p>
<p><img style="width: 100px;" src="http://cdn.firstcarbonsolutions.com/images/cdp_logo2.png" alt="" border="0" /></p>
<h4>CDP Accredited Provider</h4>
<ul>
<li>Global scoring partner for supply chain since 2011</li>
<li>Scoring partner for investor programs since 2012</li>
<li>Climate- and water-related strategy and action</li>
<li>Gold Consultancy Partner across all countries of operation</li>
<li>Silver Software Partner</li>
<li>Response Check Consultant</li>
<li>Accredited Effective May 2013</li>
</ul>
<h3>ISO 14001:2004 Certification</h3>
<h4>Environmental Management System (EMS)</h4>
<ul>
<li>Identification and analysis of environmental aspects</li>
<li>Establishment of objectives, targets and programs</li>
<li>Management and reduction of environmental impacts</li>
<li>Compliance to applicable legal and environmental regulatory requirements</li>
<li>AMDATEX Certified December 2009</li>
</ul>
<h3>ISO/IEC 27001:2005 Certification</h3>
<h4>Information Security Management System (ISMS)</h4>
<p>For the provision of business process sourcing (BPO) services, including the following IT-enabled activities:</p>
<ul>
<li>Data receipt/downloading</li>
<li>Data research, evaluation, analysis, and abstracting</li>
<li>Data conversion/entry and data uploading</li>
<li>AMDATEX Certified March 2007</li>
<li>ADEC Solutions-USA certified as of April 2012, Certification No. IS 569643</li>
</ul>
<h3>ISO 9001:2008 Certification</h3>
<h4>Quality Management System (QMS)</h4>
<ul>
<li>For the provision of global business process sourcing services</li>
<li>AMDATEX certified as of November 2005</li>
<li>ADEC Solutions-USA certified as of September 2009, Certification No. FS 552080</li>
</ul>
<div>
<h3>GSA Contract for <em>ghgTrack&trade; </em>(GS-35F-0350X)</h3>
<ul>
<li>Provides license for <em>ghgTrack</em>&trade; and the software implementation</li>
<li>Bug fixes, upgrades to functionality and usability</li>
<li>Customer service</li>
<li>Addresses Software Maintenance as a Service</li>
<li>Effective: April 21, 2011 - April 20, 2016</li>
</ul>
<div>
<h3>GSA Contract for Consulting Services(GS-21F-0127Y)</h3>
<ul>
<li>Provide expert advice, assistance, guidance or counseling on energy related projects</li>
<li>Assist agencies in adhering to energy legislation and policy</li>
<li>Effective: July 6, 2012 - July 5, 2017</li>
</ul>
</div>
</div>
<h3>Payment Card Industry Data Security Standard</h3>
<ul>
<li>Payment Card Industry Data Security Standard for Organizations that process credit card information.</li>
<li>The standard covers items such as maintaining a secure network, protection of cardholder data, maintain a vulnerability management program, maintain information security policies, etc.</li>
<li>ADEC Solutions-USA certified as of 2005</li>
<li>AMDATEX certified as of October 2010</li>
</ul></div></div>
</div>
<div  class="sec2RightCont col-sh  col-lg-3 col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>CERTIFICATIONS</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/2b6316ce-962d-46ce-9a5a-672eee5599c8" method="POST" role="form" novalidate>
