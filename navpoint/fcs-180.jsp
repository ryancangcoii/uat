...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_SPORTSFACILITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_SPORTSFACILITY10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SPORTSFACILITY@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_SPORTSFACILITY10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_SPORTSFACILITY10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_SPORTSFACILITY10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SPORTSFACILITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_SPORTSFACILITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Sports Facilities Look to a Greener Playbook";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/buildings.jpg\"";
	String snippetVar_date = "Monday, December 09, 2013";
	String snippetVar_excerpt = "The FIFA World Cup is one of the largest sporting events on the planet – a symbol of global passion and national spirit. It also has a massive carbon footprint, thanks to...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/buildings.jpg\">  The FIFA World Cup is one of the largest sporting events on the planet – a symbol of global passion and national spirit. It also has a&nbsp;massive&nbsp;carbon footprint, thanks to human migration to and within the host cities as well as the consumption of arenas themselves. These structures accommodate tens of thousands of fans at a time and literally light up the night.  <br>  <br>  Stadium venues and their energy excesses are a part of sports culture, but they can have significant environmental impacts on surrounding communities and landscapes. At capacity, a sports facility becomes home to the population of a small city, with upwards of 70,000 fans at a typical NFL game. That density creates environmental problems related to water and power consumption, resource conservation, and greenhouse gas emissions. Indeed, most of these venues were constructed long before the topics of climate change or LEED were part of our lexicon.  <br>  <br>  <i>    To read the full article from Buildings.com, please    <a href=\"http://www.buildings.com/buzz/buildings-buzz/entryid/194/sports-facilities-look-to-a-greener-playbook.aspx\" target=\"“_blank”\">      click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SPORTSFACILITY@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SPORTSFACILITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
