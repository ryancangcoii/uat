...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ANCADECGROUP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ANCADECGROUP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ANCADECGROUP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ANCADECGROUP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ANCADECGROUP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ANCADECGROUP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ANCADECGROUP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ANCADECGROUP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "ADEC Group and FCS CEO Interviewed at ANC";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/fcs-interviewed-at-anc0.jpg\"";
	String snippetVar_date = "Tuesday, November 26, 2013";
	String snippetVar_excerpt = "Winners and organizer of Asia CEO Awards during the Mornings@ANC interview: (from left to right) ADEC Group and FirstCarbon Solutions Global Chief Executive Officer James M. Donovan along with Thomson-Reuters...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/fcs-interviewed-at-anc0.jpg\">  Paki fix James “picture &amp; caption”.    <br>    <br>  Manila, Philippines, November 26, 2013 – ADEC Group and FirstCarbon Solutions (FCS) Global Chief Executive Officer James M. Donovan was interviewed live on Mornings@ANC on Monday, November 25, after receiving the Asia CEO Awards leadership citation.    <br>    <br>  Mr. Donovan was invited to the morning news and talk show after winning the KPMG Executive Leadership Team of the Year honor in the Asia CEO Awards 2013 along with ADEC Group’s Global Chief Finance Officer Carol S. Esguerra.    <br>    <br>  During the interview, he was asked what it took to achieve “great leadership” and steer the Group towards success. In his response, Mr. Donovan emphasized that the success of the group is founded on Philippine talent.    <br>    <br>  “It wasn’t that tough, with the capabilities we have in the Philippines. We just needed to put a framework in which we could properly position Philippine talent to bring into the global marketplace.”    <br>    <br>  Mr. Donovan said that from 2 people, ADEC Group has now grown into an enterprise with 5,500 professionals. This expansion was achieved in a relatively short period, prompting him to quip that it was an “18-year overnight success”.    <br>    <br>  From its humble beginnings, ADEC Group now has operations in 5 continents “using Philippine talent to basically either acquire or build companies” in those markets.    <br>    <br>  Mr. Donovan also stressed the importance of sustainable practices as part of corporate future during the interview. “We have to, as professionals, find out what matters and how to build sustainability and environment into people’s business processes.”    <br>    <br>  Extending his thoughts and prayers towards the victims of Super Typhoon Haiyan which pummeled the Central Philippines and left more than 7,000 dead, Mr. Donovan said that the country is “at the forefront of climate change”. Global and Philippine corporations should adopt practices that are environmentally-friendly and sustainable.    <br>    <br>  He believes that climate resiliency will eventually become “more and more part of [today’s] world” and the management of this adversity should be the goal of communities, governments and corporations, worldwide.    <br>    <br>  True to this objective, ADEC Group Member Company, FirstCarbon Solutions (FCS), champions sustainability in business operations and was developed in the Philippines. It is now headquartered in California and ADEC Group aims to further its business globally by re-deploying Philippine talent to aid other countries attain such goals.    <br>    <br>  Through Filipino professional capacity, Mr. Donovan aims to forward sustainability from the Philippines, into the global arena.    <br>    <br>  Paki fix James “video”.    <br>    <br>  About FirstCarbon Solutions    <br>    <br>  FCS advances sustainable practices around the world and helps organizations responsibly grow and operate their businesses. Seamlessly delivering fully integrated, cost-effective consulting, data management and software solutions, FCS helps clients save time, reduce costs, optimize resource use, and drive operational efficiencies in a world where sustainability matters. With more than 30 years of environmental and sustainability consulting experience, FCS has offices throughout Asia, Europe, Africa, Australia and North America to ensure we meet our clients’ ever-evolving environmental and compliance needs in energy, air and carbon management; environmental assessments and planning; supply and life cycle assessments; permitting and compliance; software and data processing.    <br>    <br>  FirstCarbon Solutions is a member of ADEC Group, a global provider of onshore managed services and offshore outsourcing solutions for governments and businesses worldwide.    <br>    <br>    <i>    For additional information, visit         <a href=\"http://www.adec-group.com/\" target=\"“_blank”\">      www.adec-group.com.        </a>        <i>          </i>      </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ANCADECGROUP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ANCADECGROUP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
