...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FIRSTCARBONOPENSNAIROBI10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FIRSTCARBONOPENSNAIROBI10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FIRSTCARBONOPENSNAIROBI10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FIRSTCARBONOPENSNAIROBI10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Opens Regional Office in Nairobi";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/nairobibusinessmonthly_logo.jpg\"";
	String snippetVar_date = "Friday, November 01, 2013";
	String snippetVar_excerpt = "In conjunction with its participation in the Global South-South Development Expo (GSSD) 2013, FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability business solutions, has announced the opening of...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/nairobibusinessmonthly_logo.jpg\">  In conjunction with its participation in the Global South-South Development Expo (GSSD) 2013, FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability business solutions, has announced the opening of a new office in Nairobi.  <br>  <br>  The new location will provide services and strategic support to organizations across Africa facing unique sustainability challenges.  <br>  <br>  <i>    To read the full article from Nairobi Business Monthly, please    <a href=\"http://nairobibusinessmonthly.com/firstcarbon-opens-regional-office-nairobi/\" target=\"“_blank”\">      click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSNAIROBI@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
