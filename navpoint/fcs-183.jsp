...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FIRSTCARBONOPENSKENYA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FIRSTCARBONOPENSKENYA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FIRSTCARBONOPENSKENYA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FIRSTCARBONOPENSKENYA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Opens Kenya Office";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ccbj_logo.jpg\"";
	String snippetVar_date = "Friday, November 01, 2013";
	String snippetVar_excerpt = "Looking to serve the sustainable development needs of the emerging economies in Africa, sustainability software provider FirstCarbon Solutions (FCS; Irvine, CA) has opened up an office in Nairobi, Kenya. The...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/ccbj_logo.jpg\">  Looking to serve the sustainable development needs of the emerging economies in Africa, sustainability software provider FirstCarbon Solutions (FCS; Irvine, CA) has opened up an office in Nairobi, Kenya. The FirstCarbon team in Nairobi will provide a range of services, including environmental planning, resource management, energy management, supply chain management, life-cycle assessment, and infrastructure support, to resource companies and other entities throughout Africa.  <br>  <br>  <i>    To read the full article from Climate Change Business Journal, please    <a href=\"http://www.climatechangebusiness.com/Climate_Change_Weekly_News_November_1_2013#11\" target=\"“_blank”\">      click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONOPENSKENYA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
