...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FIRSTCARBONSOLUTIONKENYA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FIRSTCARBONSOLUTIONKENYA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FIRSTCARBONSOLUTIONKENYA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FIRSTCARBONSOLUTIONKENYA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Opens Kenya Office to Support Sustainability Efforts Across Africa";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/news-coverage-images.heraldonlinelogo0.png\"";
	String snippetVar_date = "Monday, October 28, 2013";
	String snippetVar_excerpt = " NAIROBI, KENYA AND IRVINE, CALIF., OCT. 28, 2013 — /PRNewswire/ -- In conjunction with its participation in the Global South-South Development Expo (GSSD) 2013, FirstCarbon Solutions, a pioneer and...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/news-coverage-images.heraldonlinelogo0.png\">AIROBI, KENYA AND IRVINE, CALIF., OCT. 28, 2013 — /PRNewswire/ -- In conjunction with its participation in the Global South-South Development Expo (GSSD) 2013, FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability business solutions, today announced the opening of a new office in Nairobi, Kenya. The new location provides services and strategic support to organizations across Africa facing unique sustainability challenges.<br /><br />The FirstCarbon Solutions (FCS) global team will offer a variety of services through its new Nairobi location, including environmental planning, resource management, environmental and energy management, supply chain and life cycle assessments, and program management and infrastructure support. <br /><br />This article is from Heraldonline.com</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FIRSTCARBONSOLUTIONKENYA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
