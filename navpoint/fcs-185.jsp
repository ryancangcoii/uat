...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MARINEHARVESTGROUPCLIMATE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MARINEHARVESTGROUPCLIMATE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MARINEHARVESTGROUPCLIMATE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MARINEHARVESTGROUPCLIMATE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Marine Harvest Group Recognised for its Climate Change Transparency";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/fish-update-logo.png\"";
	String snippetVar_date = "Tuesday, October 15, 2013";
	String snippetVar_excerpt = "Marine Harvest Group has achieved a top position in the Carbon Disclosure Project\'s (CDP) Nordic 260 Climate Disclosure Leadership Index (CDLI). This annual index, compiled by First Carbon Solutions on behalf...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/fish-update-logo.png\">  Marine Harvest Group has achieved a top position in the Carbon Disclosure Project\'s (CDP) Nordic 260 Climate Disclosure Leadership Index (CDLI).  <br>  <br>  This annual index, compiled by First Carbon Solutions on behalf of CDP, highlights those companies listed on the Nordic stock exchanges that have displayed a strong approach to the disclosure of information on climate change.  <br>  <br>  <i>    To read the full article from FISHupdate.com, please    <a href=\"http://www.fishupdate.com/news/archivestory.php/aid/20270/Marine_Harvest_Group_Recognised_for_its_Climate_Change_Transparency.html\" target=\"“_blank”\">      click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MARINEHARVESTGROUPCLIMATE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
