...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CORPORATESUSTAINABILITYBIG10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CORPORATESUSTAINABILITYBIG10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CORPORATESUSTAINABILITYBIG10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CORPORATESUSTAINABILITYBIG10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Corporate Sustainability: The Big Picture";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader.gif\"";
	String snippetVar_date = "Tuesday, October 08, 2013";
	String snippetVar_excerpt = "Many leading global companies - including those in Australia and New Zealand - are seriously embracing sustainability practices. Their leaders understand that this approach is not simply a reporting exercise,...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sustainability-matters.jpg\">  Many leading global companies - including those in Australia and New Zealand - are seriously embracing sustainability practices. Their leaders understand that this approach is not simply a reporting exercise, but that full and transparent disclosure to all stakeholders is crucial for success in today’s competitive market.  <br>  <br>  <i>    To read the full article from sustainabilitymatters.net.au, please    <a href=\"http://www.sustainabilitymatters.net.au/articles/63062-Corporate-sustainability-the-big-picture\" target=\"“_blank”\">      click here.     </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CORPORATESUSTAINABILITYBIG@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
