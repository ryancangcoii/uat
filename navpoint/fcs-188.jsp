...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_TRANSPARENTDISCLOUSURE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_TRANSPARENTDISCLOUSURE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_TRANSPARENTDISCLOUSURE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_TRANSPARENTDISCLOUSURE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Transparent Disclosure to Stakeholders Critical for Corporations Today";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader.gif\"";
	String snippetVar_date = "Wednesday, August 21, 2013";
	String snippetVar_excerpt = "Many leading global companies today are embracing sustainability practices as they understand that this method is not simply a reporting exercise; they realize that full and transparent disclosure...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">Many leading global companies today are embracing sustainability practices as they understand that this method is not simply a reporting exercise; they realize that full and transparent disclosure to all stakeholders is crucial for success.<br /><br />These companies are not only integrating sustainability themes into their overall corporate mission, vision and values, but they also are incorporating sustainability directly into their brand and customer value propositions.<br /><br /><i>To read the full article from Environmental Leader, please click<a href=http://www.environmentalleader.com/2013/08/21/transparent-disclosure-to-stakeholders-critical-for-corporations-today/ target=“_blank”> here. </a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TRANSPARENTDISCLOUSURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
