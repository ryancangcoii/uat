...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MORECOWBELL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MORECOWBELL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MORECOWBELL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MORECOWBELL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MORECOWBELL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MORECOWBELL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MORECOWBELL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MORECOWBELL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "More Cowbell—Or Less? Climate Strategies Point Opposite Ways";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sb_logo.jpg\"";
	String snippetVar_date = "Thursday, August 15, 2013";
	String snippetVar_excerpt = "More Cowbell—Or Less? Climate Strategies Point Opposite Ways At the intersection of cattle and climate change, two rival visions for the future have emerged: One with more cows, one with fewer. The...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/cnbc-logo.jpg\">  At the intersection of cattle and climate change, two rival visions for the future have emerged: One with more cows, one with fewer.  <br>  <br>  The test-tube burger that debuted last week inspired visions of a future in which meat is readily available without livestock\'s nasty byproducts—manure and methane. Mark Post, the Dutch physiologist behind the petri patty, said reduced methane emissions—and thus less cooking of the climate—was one desirable aspect of his pursuit.  <br>  <br>  But earlier this year, one Zimbabwean scientist-farmer made a big stir—his TED Talk YouTube video just passed the half-million mark—with quite the opposite vision: Allan Savory suggests a world in which&nbsp;more&nbsp;herds of animals graze, fertilize and rejuvenate land turned barren by desertification. Such revitalized land can absorb a lot of carbon dioxide, the primary greenhouse gas.  <br>  <br>  <i>    To read the full article from CNBC, please click    <a href=\"http://www.cnbc.com/id/100943924\" target=\"“_blank”\">      &nbsp;here.     </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MORECOWBELL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MORECOWBELL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
