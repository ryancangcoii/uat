...
<section  ><%-- Widget fcs.pages.partners@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagespartners10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.partners@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagespartners10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagespartners10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/partners_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagespartners10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.partners@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <span>Partners</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Global Partner Program</h1>
<h5>Creating new revenue streams</h5>
<p>FirstCarbon Solutions Global Partner Program creates a global network of contractors and companies that specialize in energy data management, environmental services, sustainability solutions and other business support services. If you&rsquo;re a private contractor, a consultancy firm, a software vendor or a professional group seeking to expand your menu of services or update your solutions to better meet market dynamics and demands, our programs help you create new revenue streams for energy efficiency and environmental advocacy.</p>
...
<p><a class="btn btn-primary btn-lg yellow" href="/ttsvr/partners/become-a-partner">Contact us today to know more about our <br />Global Partner Program</a></p></div></div>
</div>
