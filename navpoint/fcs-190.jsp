...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_DOYOULIVEONE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_DOYOULIVEONE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_DOYOULIVEONE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_DOYOULIVEONE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_DOYOULIVEONE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_DOYOULIVEONE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_DOYOULIVEONE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_DOYOULIVEONE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Do You Live in One of the Energy Efficient Cities?";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/mslogo1.jpg\"";
	String snippetVar_date = "Thursday, August 01, 2013";
	String snippetVar_excerpt = "Do You Live in One of the Energy Efficient Cities? NEW YORK (MainStreet)—Managing the amount of energy used in office buildings is becoming easier to monitor with innovative technology that can give...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/mslogo1.jpg\">  NEW YORK (MainStreet)—Managing the amount of energy used in office buildings is becoming easier to monitor with innovative technology&nbsp;that can give updates as often as every 15 minutes.    <br>    <br>  Programs in cities throughout the U.S. are working to create more sustainable offices by&nbsp;reducing the amount of energy being consumed&nbsp;and to spur more efforts by residents.    <br>    <br>  In 2011, Charlotte, N.C. started an effort to be more sustainable. Using new data and software, office managers can monitor the water, air and waste being used in office buildings with real-time data. The goal is to reduce the energy use in Charlotte\'s uptown by 20% over five years by partnering with Duke Energy, Cisco Systems and Verizon involving a network of 70 buildings.    <br>    <br>    <i>    To read the full article from The Main Street, please click <a href=\"http://www.mainstreet.com/article/smart-spending/do-you-live-one-energy-efficient-cities\" target=\"“_blank”\">here.        </a>        <i>          </i>      </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_DOYOULIVEONE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_DOYOULIVEONE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
