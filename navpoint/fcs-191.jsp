...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_SUPPLYCHAINCARBON10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_SUPPLYCHAINCARBON10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_SUPPLYCHAINCARBON10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_SUPPLYCHAINCARBON10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Supply Chain Analysis is Essential to Reducing Carbon Footprint";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/corp-logo.png\"";
	String snippetVar_date = "Thursday, July 18, 2013";
	String snippetVar_excerpt = "There\'s simply no question that companies must assess, evaluate and optimize their supply chain operations in order to reduce their carbon footprint. In fact, government...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/corp-logo.png\">There\'s simply no question that companies must assess, evaluate and optimize their supply chain operations in order to reduce their carbon footprint. In fact, government and industry are strongly urging the issue; today\'s customers like green business; and optimized supply chains with smaller carbon footprints are more efficient, less costly and less likely to experience sudden changes in energy and fuel prices.<br /><br />Identifying, tracking and managing supply chain emissions is essential to optimization efforts, with the primary goal of detecting inefficiencies in fuel, electricity and water consumption and then correcting those inefficiencies to help eliminate waste and reduce costs. In addition, companies need to be aware of various reporting requirements, identify opportunities for improvement and reducing costs.<br /><br /><i>To read the full article from Corp Magazine, please click<a href=http://www.corpmagazine.com/technology/green/itemid/10516 target=“_blank”> here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SUPPLYCHAINCARBON@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
