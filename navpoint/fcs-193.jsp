...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPEXTENDSFCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPEXTENDSFCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPEXTENDSFCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPEXTENDSFCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP Extends Partnership with FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sustainabilityreportlogo.png\"";
	String snippetVar_date = "Friday, June 28, 2013";
	String snippetVar_excerpt = "CDP will expand its partnership with FirstCarbon Solutions (FCS) to Australia, New Zealand, the Nordics and Benelux regions and India, bring extended services measuring supply chain...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sustainabilityreportlogo.png\">  CDP will expand its partnership with FirstCarbon Solutions (FCS) to Australia, New Zealand, the Nordics and Benelux regions and India, bring extended services measuring supply chain carbon management and sustainability scoring to those countries.  <br>  <br>  FCS is the scoring partner for CDP\'s supply chain program and has built a system based on CDP\'s methodology to evalute and score CDP responses in a comprehensive, standardised fashion. The scores allow the 65 members of the CDP supply chain program to benchmark environmental performance, examine practices and develop year-on-year performance improvements.  <br>  <br>  <i>    To read the full article from The Sustainability Report, please click    <a href=\"http://www.thesustainabilityreport.com.au/cdp-extends-partnership-with-firstcarbon-solutions/3971/\" target=\"“_blank”\">      here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPEXTENDSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
