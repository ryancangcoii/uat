...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_TWOMAJORINTERNATIONALSCCM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_TWOMAJORINTERNATIONALSCCM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_TWOMAJORINTERNATIONALSCCM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_TWOMAJORINTERNATIONALSCCM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Two Major International Firms Partner to Measure Supply Chain Carbon Management";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/supplychain-logo.png\"";
	String snippetVar_date = "Wednesday, June 26, 2013";
	String snippetVar_excerpt = "First Carbon Solutions, (FCS) and CDP have announced their expanded partnership to increase services that measure supply chain carbon management and extend sustainability scoring to CDP’s climate change...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/supplychain-logo.png\">First Carbon Solutions, (FCS) and CDP have announced their expanded partnership to increase services that measure supply chain carbon management and extend sustainability scoring to CDP’s climate change program in the Nordic and Benelux regions, Australia, New Zealand and India. <br /><br />FCS, an early player in the discipline of environmental sustainability, and CDP, an international not-for-profit organization that works with the world’s largest investors and corporations to motivate companies and cities to disclose their impacts on the environment and take action to reduce them, have been working together since 2011.<br /><br /><i>To read the full article from Supply Chain Management Review, please click<a href=http://www.scmr.com/article/two_major_international_firms_partner_to_measure_supply_chain_carbon_managm/ target=“_blank”> here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TWOMAJORINTERNATIONALSCCM@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
