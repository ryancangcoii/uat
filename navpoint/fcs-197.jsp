...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSCDPEXPANDPARTNERSHIP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSCDPEXPANDPARTNERSHIP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSCDPEXPANDPARTNERSHIP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSCDPEXPANDPARTNERSHIP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions, CDP Expand Partnership";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sb_logo.jpg\"";
	String snippetVar_date = "Tuesday, June 25, 2013";
	String snippetVar_excerpt = " Environmental software firm FirstCarbon Solutions and CDP have expanded their partnership to increase services that measure supply chain carbon management and extend sustainability scoring to CDP’s climate change program...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">  Environmental software firm FirstCarbon Solutions and CDP have expanded their partnership to increase services that measure supply chain carbon management and extend sustainability scoring to CDP’s climate change program in the Nordic and Benelux regions, Australia, New Zealand and India.  <br>  <br>  The two organizations have been working together since 2011.  <br>  <br>  As the exclusive&nbsp;scoring partner&nbsp;of CDP’s supply chain program, FCS reviews and scores thousands of responses provided by participating suppliers. These scores allow the 65 members of CDP’s supply chain program - including multinationals like Unilever, the Coca-Cola Company, and Walmart - to benchmark environmental performance, examine practices and develop year-on-year performance improvements, the organizations say.  <br>  <br>  <i>    To read the full article from Environmental Leader, please click    <a href=\"http://www.environmentalleader.com/2013/06/25/firstcarbon-solutions-cdp-expand-partnership/\" target=\"“_blank”\">      here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCDPEXPANDPARTNERSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
