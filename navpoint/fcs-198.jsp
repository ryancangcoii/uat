...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PLANNEDONGOINGRESEARCH10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PLANNEDONGOINGRESEARCH10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PLANNEDONGOINGRESEARCH10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PLANNEDONGOINGRESEARCH10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Planned, Ongoing, or Recently Completed Projects and Research";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ce-news.png\"";
	String snippetVar_date = "Monday, June 17, 2013";
	String snippetVar_excerpt = "Hidden dune filters treat coastal stormwater runoff Researchers from North Carolina State University have developed low-cost stormwater filtration systems that are concealed beneath sand dunes and filter out most of...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/ce-news.png\">  Hidden dune filters treat coastal stormwater runoff Researchers from North Carolina State University have developed low-cost stormwater filtration systems that are concealed beneath sand dunes and filter out most of the bacteria that can lead to beach closures. The researchers designed and built two such systems in Kure Beach, N.C., that consist of large, open-bottomed chambers that effectively divert the stormwater into dunes, which serve as giant sand filters. The systems are built under dunes that are covered with vegetation. The researchers then launched a three-year study to see how the filters would perform. The dune infiltration systems reduced the concentration of bacteria in stormwater runoff by 96 percent.    <br>    <br>    <i>    To read the full article from CE News, please        <a href=\"http://www.cenews.com/magazine-article----planned__ongoing__or_recently__completed_projects_and_research-9321.html\" target=\"“_blank”\">      click here.        </a>        <i>          </i>      </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PLANNEDONGOINGRESEARCH@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
