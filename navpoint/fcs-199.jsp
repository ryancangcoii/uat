...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSEVERGROWING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSEVERGROWING10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSEVERGROWING@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSEVERGROWING10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSEVERGROWING10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSEVERGROWING10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSEVERGROWING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSEVERGROWING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Expands Sustainability Consulting to Support Ever-Growing Telecommunications Industry";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sacramentobee.jpg\"";
	String snippetVar_date = "Thursday, June 06, 2013";
	String snippetVar_excerpt = "IRVINE, Calif., June 3, 2013 -- /PRNewswire/ -- FirstCarbon Solutions (FCS), a pioneer and industry leader in environmental and sustainability business solutions, today announced it is expanding its wireless telecommunications...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sacramentobee.jpg\">IRVINE, Calif., June 3, 2013 -- /PRNewswire/ -- FirstCarbon Solutions (FCS), a pioneer and industry leader in environmental and sustainability business solutions, today announced it is expanding its wireless telecommunications consulting service to a national practice. FCS has been delivering services to clients from the western U.S. for nearly 15 years and will now provide a national footprint by delivering services throughout Hawaii, the mid-west and east coast of the U.S.<br /><br />With unmatched expertise in compliance and back-office data processing, FCS provides technical advice and support to help wireless telecommunications carriers streamline their facility expansion and upgrade process.  FCS helps many of the world\'s leading tier-one telecommunications companies –  including T-Mobile West, LLC, AT&T Mobility, LLC, Sprint Nextel, NextG Networks/Crown Castle, Verizon Wireless, Mobilitie, and American Tower Corporation – comply with regulations, from the Federal Communication Commission (FCC) to the National Environmental Policy Act (NEPA) and Migratory Bird Protection Act.<br /><br /><i>This article is from The Sacramento Bee.</i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSEVERGROWING@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSEVERGROWING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
