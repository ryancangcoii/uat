...
<section  ><%-- Widget fcs.pages.aboutus_managementteam@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_managementteam10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_managementteam@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_managementteam10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_managementteam10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_managementteam10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_managementteam@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <span>Management Team</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Management</h1>
<h5>Team for FirstCarbon's Environmental Consulting Services</h5>
<p>In addition to the <a href="http://www.adec-group.com/about-us/management-team">executive team at ADEC Group</a>, FirstCarbon Solutions is comprised of experts in environmental, sustainability, and energy management who collaborate with clients to develop the solutions that drive the highest return on investment.</p>
<p><img class="pull-left mr15" src="../fcs/images/robert_francisco-2013.jpg" alt="" /></p>
<h3 class="wth-line">Robert Francisco<br /><span class="position">President, North America</span></h3>
<p>When not trekking across the Himalayas, hiking the Pacific Crest Trail or exploring some other far off the beaten path destination, Robert oversees and leads the North American operations of FirstCarbon Solutions (FCS). In this role he partners with other country leaders in addition to the office of ADEC Group &mdash; a company which FCS is a part.</p>
<p>Robert has spent most of his technical career focusing on water issues in the U.S. and California. Robert has worked on some of the most complicated and controversial wetland issues in the Western U.S. with an emphasis in wetland mitigation/restoration and regulatory compliance as implemented through the Clean Water Act, Fish and Game Code, and Regional Water Quality Control Board regulations. He has also focused on both federal and state endangered species issues for over 2 decades.</p>
<p>Prior to leading FCS North America, Robert was the Chief Operating Officer for Michael Brandman Associates (MBA), which FCS acquired in 2012. Before MBA, Robert was the Northern California Regional Director and Principal for Jones &amp; Stokes Associates (Now ICF/Jones &amp; Stokes). He has also served as the head of the regulatory compliance group, while maintaining his field biology and wetland ecology skills.</p>
<p>Robert has a Bachelor degree from Sacramento State University in Environmental Studies with a minor in Biological Science. After a dishwashing job in high school, Robert served his country as a Sergeant in the First Battalion, Fifth Division of the United States Marine Corps where he was an infantry platoon leader.</p>
<div class="space">&nbsp;</div>
<p><img class="pull-left mr15" src="../fcs/images/michelle_hincks-2013.jpg" alt="" /></p>
<h3 class="wth-line">Michele B. Hincks <br /><span class="position"> Vice President, Marketing and Communications</span></h3>
<p>Michele brings over 20 years marketing experience to the role of Vice President, Marketing and Communications where she leads the collective, global marketing efforts for FirstCarbon Solutions. And, with a personal goal to visit every continent and all 50 U.S. states, Michele has only 2 continents remaining (South America and Antarctica), but still has 15 U.S. states on her list.</p>
<p>While you&rsquo;d think her many years spent as a summer camp counselor would provide the foundation for a long career managing teams, Michele is actually a seasoned marketing executive with unique breadth and depth in all disciplines of marketing and is able to cultivate high performance marketing teams. Michele adeptly balances creative with analytical and strategic with tactical and has a proven track record helping companies increase brand recognition and grow revenue. Michele has led diverse teams across public relations, market research, product marketing, graphic design, digital marketing, inside sales, customer service and account management.</p>
<p>Michele brings extensive experience in environmental sustainability, business-to-business e-commerce and telecommunications services across areas including consumer marketing, enterprise software, and software as a service and has served in a variety of executive and marketing positions at AT&amp;T, Lucent, ChemConnect, Enviance, and NTN Buzztime.</p>
<p>Michele holds an M. B. A. in Marketing from Rutgers Graduate School of Management and a B.A. in Computer Science, graduating Cum Laude with a certification in Science Management from Rutgers University.</p>
<div class="space">&nbsp;</div>
<p><img class="pull-left mr15" src="../fcs/images/mary_bean-2013.jpg" alt="" /></p>
<h3 class="wth-line">Mary Bean, AICP <br /><span class="position"> Vice President, Professional Services, North America</span></h3>
<p>Responsible for ensuring high quality, cost-effective project delivery, Mary oversees FirstCarbon Solutions&rsquo; North American professional services team. As a former County planner from Santa Barbara, Mary brings more than 20 years of experience in land use planning, in both the public and private sectors and specializes in streamlining the environmental process through careful scrutiny and tailored analyses to produce concise and defensible documents. Mary is particularly effective in strategizing with clients about the most efficient approach to CEQA and/or NEPA clearance at the local, state, and national levels.</p>
<p>Mary spent a few years working in South Africa as it transitioned from the apartheid era into a true democracy. Her work focused on redevelopment and housing of residents living in apartheid townships, and directing community surveys for the government to identify the amount of federal support that could be provided to each family as they began to rebuild their lives.</p>
<p>Prior to Joining FirstCarbon Solutions, Mary was a principal at Circlepoint, where she lead the environmental services group, focusing on land use and transportation projects.</p>
<p>Mary is a member of several professional planning organizations, including American Planning Association, Association of Environmental Professionals, Women's Transportation Seminar, and the Urban Land Institute. By invitation she serves on panels to educate and inform planners about the ever changing landscape of CEQA regulations.</p>
<p>Mary earned a Bachelor's degree from the University of California, Santa Barbara, where she majored in Environmental Studies and Planning</p>
<div class="space">&nbsp;</div>
<p><img class="pull-left mr15" src="../fcs/images/jason_brandman-2013.jpg" alt="" /></p>
<h3 class="wth-line">Jason Brandman <br /><span class="position"> Vice President, Business Development, North America</span></h3>
<p>As Vice President of Business Development for FirstCarbon Solutions (FCS), Jason is responsible for working with clients around North America to provide them with solutions that meet their needs. With more than 26 years of experience, Jason has been providing his knowledge and expertise in planning, environmental impact assessment and public policy analysis for major corporations, attorneys, various business entities, and state, regional, and local jurisdictions throughout California and the western United States.</p>
<p>As a recognized leader in his field, Jason has worked on a wide range of complex and controversial projects including: downtown revitalization plans, major mixed-use developments, large to small scale residential developments, regional transportation corridor and utility transmission line studies, and commercial and industrial developments.</p>
<p>Jason is also a recognized expert in the management and analysis of Environmental Impact Reports, Environmental Impact Studies, Environmental Assessments, and Mitigated Negative Declarations, Specific Plans and water/wastewater resource and hazardous material studies, planning land use, aesthetic analysis, transportation/circulation, geology, hydrology, public services, utilities and cultural resources.</p>
<p>As an active speaker at seminars and conferences, Jason regularly provides informative presentations to public agencies, private organizations and the public at large.</p>
<p>Jason earned his Bachelor's degree in Urban Geography from California State University at Fullerton.</p>
<div class="space">&nbsp;</div>
<p><img class="pull-left mr15" src="../fcs/images/justin_holt-2013.jpg" alt="" /></p>
<h3 class="wth-line">Justin Holt <br /><span class="position"> General Manager, Australia</span></h3>
<p>Justin has 29 years combined professional services experience in Animal Husbandry and Business Management. Starting his career in animal management, Justin actively worked in professional zoos and wildlife parks with a specialization in aquarium technology including design, development and management of large scale, recycling filtration solutions supporting artificial ecosystems. Following that, Justin moved into business managed services where he has experience in sales, business development, operations and general management. For the last 8 years he has headed up regional management of all ADEC Groups business entities in Australia &amp; New Zealand covering Managed Services, Environmental Solutions and Education.</p></div></div>
</div>
