...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PROPERPLANNINGREDUCEIMPACT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PROPERPLANNINGREDUCEIMPACT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PROPERPLANNINGREDUCEIMPACT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PROPERPLANNINGREDUCEIMPACT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "How Proper Planning and a General Understanding of Bats Help Reduce Impacts";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/windpower.jpg\"";
	String snippetVar_date = "Thursday, May 30, 2013";
	String snippetVar_excerpt = "Unfortunately, the wind industry does not yet have a handle on the issue of the rising bat mortality rate. Researchers initially believed bat deaths at wind farms were the...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/windpower.jpg\">  Unfortunately, the wind industry does not yet have a handle on the issue of the rising bat mortality rate. Researchers initially believed bat deaths at wind farms were the same as birds, but autopsies have revealed a more complex situation. Currently, there is no quick fix to completely end bat fatalities, but understanding bat migration and roosting can lessen impacts.  <br>  <br>  Bats play a vital role in the earth’s ecosystems. Bats probably save farmers billions because they act as pollinators for various plants and remove pests from agricultural areas. The recent interest in creating more energy from wind has increased the impacts between bats and wind farms in the United States, Canada and Europe. Biologists have been working with state and federal agencies to determine the cause of bat deaths at wind farms and find a solution. The United States Fish and Wildlife Service and state agencies such as the California Department of Fish and Wildlife have published voluntary guidelines for conducting surveys at potential and existing wind farm facilities.  <br>  <br>  <i>    To read the full article from the Windpower Engineering&nbsp;website, please    <a href=\"http://www.windpowerengineering-digital.com/windpowerengineering/june_2013#pg63\" target=\"“_blank”\">      &nbsp;click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PROPERPLANNINGREDUCEIMPACT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
