...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPASSLAUCHESCFMT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPASSLAUCHESCFMT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPASSLAUCHESCFMT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPASSLAUCHESCFMT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Launches Carbon Footprint Measuring Tool";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/on-campus-hospitality.png\"";
	String snippetVar_date = "Saturday, May 18, 2013";
	String snippetVar_excerpt = "Compass Launches Carbon Footprint Measuring Tool In an effort to help its clients keep track of their carbon footprint in a more detailed way, Compass Group has added a new software...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/on-campus-hospitality.png\">In an effort to help its clients keep track of their carbon footprint in a more detailed way, Compass Group has added a new software tool to its “Carbon FOODprint Tool Kit.”<br><br> The web-based tool is designed to help Compass Group’s food operations staff lower their environmental impact and their operational costs. It allows chefs and managers to create customized strategies to reduce their operations’ carbon footprints by decreasing waste disposal, and energy and water use. Foodservice managers can make up to 185 strategic choices across five key areas, including menu engineering, kitchen operations, kitchen services, site equipment and facilities. Developed by FirstCarbon Solutions and hosted as part of its Sustainability Workbench platform, the web-based software application is an integral part of the Carbon FOODprint toolkit. This online technology allows cafes to benchmark and measure the improvements made throughout the café, which can be shared with clients for annual reports, sustainability indexes and disclosure to public programs, such as the Carbon Disclosure Project (CDP).<br><br> <i>To read the full article from On-Campus Hospitality, please<a href=\"http://cdn.firstcarbonsolutions.com/images/PDF/On-Campus_Hospitality_Article.pdf\" target=\"“_blank”\">&nbsp;click here.</a><i></i></i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSLAUCHESCFMT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
