...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COLLABORATIONTRENDS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COLLABORATIONTRENDS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COLLABORATIONTRENDS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COLLABORATIONTRENDS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Collaboration Is the Trend In Managing Today’s Sustainable Supply Chains";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/supply-chain-brain2.jpg\"";
	String snippetVar_date = "Friday, April 19, 2013";
	String snippetVar_excerpt = "There is only so much that a single organization is going to be able to achieve to improve the impact it has on the environment or society, without collaborating with...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/supply-chain-brain2.jpg\">There is only so much that a single organization is going to be able to achieve to improve the impact it has on the environment or society, without collaborating with the wider aspects of its supply chain.<br /><br />Historically, supply chain management used to be about getting the right product to the right customer at the right time. However, today it’s all about delivering on that promise with the right information. This includes data about where a product’s materials come from, how it’s made and how it’s delivered. By sharing this information, retailers enable customers to recognize which products are more environmentally friendly or socially conscious.<br /><br /><i>To read the full article from the SupplyChainBrain website, please<a href=http://www.supplychainbrain.com/content/index.php?id=5032&cHash=081010&tx_ttnews%5btt_news%5d=21759 target=“_blank”>  click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COLLABORATIONTRENDS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
