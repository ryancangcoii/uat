...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPASSGROUPADDS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPASSGROUPADDS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPASSGROUPADDS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPASSGROUPADDS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Group Adds Sustainability Software to the Menu";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/greenbiz_logo.jpg\"";
	String snippetVar_date = "Thursday, April 11, 2013";
	String snippetVar_excerpt = "Compass Group is spicing up its menu with a software application that helps chefs and kitchen managers decrease waste disposal and reduce their energy and water consumption. The $12 billion global food...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/greenbiz_logo.jpg\">  Compass Group&nbsp;is spicing up its menu with a software application that helps chefs and kitchen managers decrease waste disposal and reduce their energy and water consumption.  <br>  <br>  The $12 billion global food services management company uses a web-based tool called theCarbon FOODprint, which was developed by&nbsp;FirstCarbon Solutions&nbsp;and piloted in 12 locations over the past year before a general rollout in late March.   <br>  <br>  &nbsp;  <i>    To read the full article from the GreenBiz&nbsp;website, please    <a href=\"http://www.greenbiz.com/blog/2013/04/11/compass-group-adds-sustainability-software-menu?page=0%2C0&amp;mkt_tok=3RkMMJWWfF9wsRons6TIZKXonjHpfsX56uktX6O1lMI%2F0ER3fOvrPUfGjI4AS8pmI%2BSLDwEYGJlv6SgFSLHEMa5qw7gMXRQ%3D\" target=\"“_blank”\">      &nbsp;click here.    </a>    <i>    </i>  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSGROUPADDS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
