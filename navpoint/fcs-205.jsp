...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPASSPARTNERSFCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPASSPARTNERSFCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPASSPARTNERSFCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPASSPARTNERSFCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Partners With FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/food-management.jpg\"";
	String snippetVar_date = "Saturday, March 30, 2013";
	String snippetVar_excerpt = "FirstCarbon Solutions and Compass Group have announced the launch of the software tool being used to support Compass\'s Carbon FOODprint toolkit. The web-based tool is designed to help Compass food...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/food-management.jpg\">FirstCarbon Solutions and Compass Group have announced the launch of the software tool being used to support Compass\'s Carbon FOODprint toolkit. The web-based tool is designed to help Compass food operations staff lower their environmental impact and operational costs. Early Carbon FOODprint adopters include notable companies such as SAP and colleges like Auburn University and Green Mountain College.<br /><br />Carbon FOODprint allows chefs and managers to create customized strategies to reduce their operations\' carbon footprints by decreasing waste disposal and energy and water use. Foodservice managers can make up to 185 strategic choices in four key areas, including menu engineering, kitchen services, site equipment and facilities. Developed by FirstCarbon Solutions and hosted as part of its Sustainability Workbench platform, the web-based software application is an integral part of the Carbon FOODprint toolkit. It allows cafes to benchmark and measure the improvements made throughout the cafe, which can be shared with clients for annual reports, sustainability indexes, and disclosure to public programs such as the Carbon Disclosure Project (CDP).<br /><br /><i>To read the full article from the Food Management website, please<a href=http://food-management.com/contractors/compass-partners-firstcarbon-solutions target=“_blank”>  click here. </a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSPARTNERSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
