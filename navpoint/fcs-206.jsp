...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPASSGROUPFOODPRINT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPASSGROUPFOODPRINT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPASSGROUPFOODPRINT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPASSGROUPFOODPRINT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Group Launches Carbon FOODprint Toolkit";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sb_logo.jpg\"";
	String snippetVar_date = "Thursday, March 28, 2013";
	String snippetVar_excerpt = "Compass Group Launches Carbon FOODprint Toolkit  Program allows operators to keep track of sustainability metrics.Compass Group has partnered with FirstCarbon Solutions, which specializes in environmental sustainability business solutions, to launch software that will enhance Compass’ Carbon...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/food-service-director.jpg\">Program allows operators to keep track of sustainability metrics.Compass Group has partnered with FirstCarbon Solutions, which specializes in environmental sustainability business solutions, to launch software that will enhance Compass’ Carbon FOODprint Toolkit.<br /><br /><i>To read the full article from the Food Service Director website, please<a href=http://www.foodservicedirector.com/news/articles/compass-group-launches-carbon-foodprint-toolkit target=“_blank”> click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSGROUPFOODPRINT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
