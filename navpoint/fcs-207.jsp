...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ONLINETOOLSFOOD10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ONLINETOOLSFOOD10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ONLINETOOLSFOOD10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ONLINETOOLSFOOD10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Online Tool Measures Cafes’ Carbon ‘Foodprint’";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader.gif\"";
	String snippetVar_date = "Thursday, March 28, 2013";
	String snippetVar_excerpt = "Environmental software firm FirstCarbon Solutions and food service management company Compass Group have launched an online tool to help Compass Group chefs and managers reduce energy, water and resource use. To...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">Environmental software firm FirstCarbon Solutions and food service management company Compass Group have launched an online tool to help Compass Group chefs and managers reduce energy, water and resource use.<br /><br /><i>To read the full article from the Environmental Leader website, please<a href=https://www.environmentalleader.com/2013/03/28/online-tool-measures-cafes-carbon-foodprint/ target=“_blank”> click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ONLINETOOLSFOOD@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
