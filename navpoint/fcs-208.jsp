...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPASSLAUNCHESWEBTOOL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPASSLAUNCHESWEBTOOL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPASSLAUNCHESWEBTOOL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPASSLAUNCHESWEBTOOL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Group Launches Web Tool to Help Chefs Cut Carbon Footprint at Nearly 10,000 Locations";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sustainable-food-news.jpg\"";
	String snippetVar_date = "Wednesday, March 27, 2013";
	String snippetVar_excerpt = "Compass Group, the world’s largest foodservices management company, said Wednesday it will use new web-based software to cut the environmental impact and operational costs at nearly 10,000 U.S. locations by...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sustainable-food-news.jpg\">Compass Group, the world’s largest foodservices management company, said Wednesday it will use new web-based software to cut the environmental impact and operational costs at nearly 10,000 U.S. locations by managing energy and water use in their supply chains.<br /><br /><i>To read the full article from the Sustainable Food News website, please<a href=http://www.sustainablefoodnews.com/story.php?news_id=18905 target=“_blank”> click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPASSLAUNCHESWEBTOOL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
