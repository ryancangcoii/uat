...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSCGLAUNCHESFOODPRINT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSCGLAUNCHESFOODPRINT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSCGLAUNCHESFOODPRINT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSCGLAUNCHESFOODPRINT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions and Compass Group Launch Carbon FOODprint";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/hospitality-industry.jpg\"";
	String snippetVar_date = "Wednesday, March 27, 2013";
	String snippetVar_excerpt = "Unique, Web-Based Tool Design Helps Chef and Managers Measure, Manage and Reduce Energy, Water and Resource Use IRVINE, Calif. and CHARLOTTE, N.C., March 27, 2013 - FirstCarbon Solutions, a pioneer and...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/hospitality-industry.jpg\">Unique, Web-Based Tool Design Helps Chef and Managers Measure, Manage and Reduce Energy, Water and Resource Use<br /><br />IRVINE, Calif. and CHARLOTTE, N.C., March 27, 2013 - FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability business solutions, and Compass Group, the world’s leading food and support services company, today announced the launch of the software tool being used to support Compass Group’s Carbon FOODprint(TM) toolkit.  This unique, web-based tool, powered by FirstCarbon Solutions, is designed to help Compass Group’s food operations staff lower their environmental impact and operational costs. Early Carbon FOODprint adopters to date include well-known companies, such as SAP, and colleges, including Auburn University and Green Mountain College.<br /><br /><i>To read the full article from the Hospitality Industry website, please<a href=http://www.hospitality-industry.com/index.php/news/comments/firstcarbon_solutions_and_compass_group_launch_carbon_foodprint/ target=“_blank”>  click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCGLAUNCHESFOODPRINT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
