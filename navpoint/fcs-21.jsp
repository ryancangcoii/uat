...
<section  ><%-- Widget fcs.pages.aboutus_careers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <span>Careers</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Careers</h1>
<p>As an ADEC Group company, FirstCarbon Solutions is focused on improving the world we live in by advancing sustainable practices globally. And, it's our goal to improve the lives of all people we work with, whether they are clients, partners or colleagues.</p>
<p>By joining FirstCarbon Solutions, you will work with a group of highly skilled, technical team members that are focused on doing what it takes to meet our clients' needs. Hiring at all levels of the organization, including a robust intern program, FirstCarbon Solutions prides itself on offering unprecedented work/life balance with a flexible work schedule and other valuable benefits.</p>
<p>FirstCarbon Solutions is focused on advancing the skills and experiences of our staff and has opportunities that expand the globe. We are looking to grow our team with sharp, energetic, innovative professionals that are excited to come to work and share their ideas with co-workers, clients, and the blogosphere.</p>
<p>If you like doing a variety of different things, and, in some cases literally getting your hands dirty, then look no further than FirstCarbon Solutions.</p></div></div>
<div  class="advanceRichtext"><div class="table-responsive"><table class="table table-striped table-bordered"><thead><tr><td>DATE POSTED</td><td>LOCATION</td><td>POSITION</td></tr></thead><tbody><tr><td>Tuesday, January 21, 2014</td><td>USA - Northern California</td><td><a href="biologist-botanist">Biologist/Botanist</a></td></tr><tr><td>Saturday, March 15, 2014</td><td>USA - California</td><td><a href="archaeologist">Archaeologist</a></td></tr><tr><td>Tuesday, November 05, 2013</td><td>USA - California</td><td><a href="sustainability-business-leader">Sustainability Business Leader</a></td></tr><tr><td>Tuesday, September 24, 2013</td><td>USA - California (Irvine)</td><td><a href="environmental-analyst">Environmental Analyst</a></td></tr><tr><td>Tuesday, August 13, 2013</td><td>USA - California (Bay Area)</td><td><a href="project-manager">Project Manager</a></td></tr><tr><td>Tuesday, July 23, 2013</td><td>USA - California</td><td><a href="noise-analyst">Noise Analyst</a></td></tr><tr><td>Tuesday, July 23, 2013</td><td>USA - California (Bay Area)</td><td><a href="senior-project-manager">Senior Project Manager</a></td></tr><tr><td>Monday, May 13, 2013</td><td>USA - California (Sacramento)</td><td><a href="intern-program">Interns</a></td></tr></tbody></table></div></div>
</div>
