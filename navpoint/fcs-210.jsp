...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CARBONFOODPRINTSOFTWARE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CARBONFOODPRINTSOFTWARE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CARBONFOODPRINTSOFTWARE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CARBONFOODPRINTSOFTWARE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Carbon FOODprint Web-based Software Application";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/food-processing.jpg\"";
	String snippetVar_date = "Wednesday, March 27, 2013";
	String snippetVar_excerpt = "FirstCarbon Solutions and Compass Group have launched the software tool being used to support Compass Group’s Carbon FOODprint toolkit. This web-based tool, powered by FirstCarbon Solutions, is designed to help...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/food-processing.jpg\">FirstCarbon Solutions and Compass Group have launched the software tool being used to support Compass Group’s Carbon FOODprint toolkit. This web-based tool, powered by FirstCarbon Solutions, is designed to help lower environmental impact and operational costs.<br /><br /><i>To read the full article from the Food Processing website, please<a href=http://www.foodprocessing.com.au/products/59786-Carbon-FOODprint-web-based-software-application target=“_blank”>  click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CARBONFOODPRINTSOFTWARE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
