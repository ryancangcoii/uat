...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CGPWITHFCSTRACKINGTOOL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CGPWITHFCSTRACKINGTOOL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CGPWITHFCSTRACKINGTOOL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CGPWITHFCSTRACKINGTOOL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Compass Group Partners with FirstCarbon for Resource Tracking Tool";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/compass-logo.jpg\"";
	String snippetVar_date = "Tuesday, March 26, 2013";
	String snippetVar_excerpt = "Charlotte, N.C., and Irvine, Calif. — Charlotte-based food services company Compass Group has partnered with Irvine-based FirstCarbon Solutions to track its energy and resource usage.  The companies have rolled out Carbon FOODprint,...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/compass-logo.jpg\">Charlotte, N.C., and Irvine, Calif. — Charlotte-based food services company Compass Group has partnered with Irvine-based FirstCarbon Solutions to track its energy and resource usage.<br /><br /> The companies have rolled out Carbon FOODprint, a web-based application that helps Compass Group’s 9,900 U.S. cafes create customized strategies to lower environmental impact and operations costs in the areas of menu engineering, kitchen operations, kitchen services, site equipment and facilities.<br /><br /><i>To read the full article from the Restaurant Facility Business website, please<a href=http://www.restaurantfacilitybusiness.com/the-latest-news/533-compass-group-firstcarbon-partner-for-resource-tracking.html target=“_blank”> click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CGPWITHFCSTRACKINGTOOL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
