...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_HOWENVIROMENTALCOMPLIANCE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_HOWENVIROMENTALCOMPLIANCE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_HOWENVIROMENTALCOMPLIANCE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_HOWENVIROMENTALCOMPLIANCE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "How Environmental Compliance Reporting Reduces Business Risk";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sustainableplant_banner.jpg";
	String snippetVar_date = "Tuesday, March 12, 2013";
	String snippetVar_excerpt = "How Environmental Compliance Reporting Reduces Business Risk “Business risks come in three varieties: known risks, unknown risks, and unknown unknown risks,” asserts Kevin Shannon in a recent blog post for First...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/sustainableplant_banner.jpg\">“Business risks come in three varieties: known risks, unknown risks, and unknown unknown risks,” asserts Kevin Shannon in a recent blog post for First Carbon Solutions. By quantifying and reporting on environmental compliance, organizations can help themselves identify and thereby reduce their currently unknown risks.<br /><br /><i>To read the full article from Sustainable Plant, please<a href=http://www.sustainableplant.com/2013/03/how-environmental-compliance-reporting-reduces-business-risk/ target=“_blank”> click here.</a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HOWENVIROMENTALCOMPLIANCE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
