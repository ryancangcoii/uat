...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_HOLLYWOODCPAWARDSFCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_HOLLYWOODCPAWARDSFCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_HOLLYWOODCPAWARDSFCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_HOLLYWOODCPAWARDSFCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Hollywood Central Park Awards EIR to FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/La_Business_Journal_banner.jpg\"";
	String snippetVar_date = "Thursday, March 07, 2013";
	String snippetVar_excerpt = "The proposal to build a 44-acre park above the 101 Freeway in Hollywood has taken a crucial step forward. Friends of Hollywood Central Park, a non-profit organization orchestrating the park initiative,...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/La_Business_Journal_banner.jpg\">  The proposal to build a 44-acre park above the 101 Freeway in Hollywood has taken a crucial step forward.Friends of Hollywood Central Park, a non-profit organization orchestrating the park initiative, hired a team to conduct an environmental impact review (EIR) of the project, a necessary report required before any construction can begin.  <br>  <br>  The selection of FirstCarbon Solutions in Irvine was announced last month after a competitive bidding process. The proposed project would cap the 101 at street level on a one-mile stretch between Hollywood and Santa Monica boulevards, where the freeway dips below grade, and establish a green out-door park with community facilities such as a baseball diamond.  <br>  <br>  The concept was first evoked nearly 30 years ago, but got off the ground in 2006 when responsibility for its establishment shifted from the Hollywood Chamber of Commerce to Friends of Hollywood Central Park.  <br>  <br>  The EIR is funded by a $1.2 million donation from the Aileen Getty Foundation and $825,000 from the City of Los Angeles. The report will analyze the park\'s impact on the community, traffic, noise, air quality and other environmental issues. The review should begin nearly immediately and be completed within about one year, according to Robert A. Francisco, president of FirstCarbon Solutions. While environmental reviews can sometimes be problematic, Francisco said he thinks a park project will be low impact and embraced by most of the community. \"We aren\'t expecting a great deal of controversy and we think it\'s largely a great project for the community,” he said. \"It really enhances a city that\'s been bifurcated by a freeway and has limited park space.\"  <br>  <br>  <i>    This article was featured in the Los Angeles Business Journal in the issue for March 4-10, 2013, Volume 35, Number 9.  </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HOLLYWOODCPAWARDSFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
