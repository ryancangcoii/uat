...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ORANGECOUNTYGROWING10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ORANGECOUNTYGROWING10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ORANGECOUNTYGROWING10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ORANGECOUNTYGROWING10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Orange County is Growing Green Jobs";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/renewablesbiz.jpg\"";
	String snippetVar_date = "Saturday, March 02, 2013";
	String snippetVar_excerpt = "Orange County is Growing Green Jobs In the sleek Irvine office building of FirstCarbon Solutions, engineers, biologists, and mapping software specialists work in green jobs. They calculate the impact of housing...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/renewablesbiz.jpg\">In the sleek Irvine office building of FirstCarbon Solutions, engineers, biologists, and mapping software specialists work in green jobs. They calculate the impact of housing tracts, design wetlands, and measure air pollution as part of the fast-growing environmental consulting industry.<br /><br /><i>This article is from Orange Country.</i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ORANGECOUNTYGROWING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
