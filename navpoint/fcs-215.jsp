...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSSELECTEDENVIROMENTAL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSSELECTEDENVIROMENTAL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSSELECTEDENVIROMENTAL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSSELECTEDENVIROMENTAL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Selected To Prepare Environmental Studies For L.A.´s Groundbreaking Hollywood Central Park Project";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/envi-experts.jpg\"";
	String snippetVar_date = "Friday, March 01, 2013";
	String snippetVar_excerpt = "Pioneer and Industry Leader In Environmental and Sustainability Business Solutions To Provide Technical Expertise for Revolutionary Park Project LOS ANGELES and IRVINE, Calif., Feb. 27, 2013...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/envi-experts.jpg\">Don’t forget to pull the plug and turn out the lights! While the concept is known by different names – phantom load, vampire power, standby mode – at the end of the day, “phantom energy” does the same thing: it pulls unnecessary extra energy from the grid into commercial buildings when you aren’t looking.<br /><br />Many devices and gadgets, including computers, LCD monitors, copiers, printers, TVs, coffeemakers and vending machines, and central air fans, draw power even when they’re switched off or not in use … just by being plugged in. And though it may seem insignificant, this definitely adds up over time.<br /><br /><i>To read the full article from High Rise Facilities, please<a href=“http://highrisefacilities.com/power-reduce-phantom-energy-use/” target=“_blank”>   click here. </a><i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSSELECTEDENVIROMENTAL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
