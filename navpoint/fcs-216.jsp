...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_IRVINEFIRMEIR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_IRVINEFIRMEIR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_IRVINEFIRMEIR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_IRVINEFIRMEIR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Irvine Firm Lands EIR for Hollywood Central Park";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ocbg-logo.jpg\"";
	String snippetVar_date = "Thursday, February 28, 2013";
	String snippetVar_excerpt = "Irvine-based FirstCarbon Solutions has received a contract to provide environmental consulting services for the Hollywood Central Park project in Los Angeles. The project calls for the construction...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/ocbg-logo.jpg\">Irvine-based FirstCarbon Solutions has received a contract to provide environmental consulting services for the Hollywood Central Park project in Los Angeles.<br /><br />The project calls for the construction of a 44-acre park over a one-mile stretch of the Hollywood Freeway (101) between Hollywood and Santa Monica boulevards.<br /><br />“The freeway in that particular junction is actually lower than the surrounding landscape,” FirstCarbon Solutions’ President Robert Francisco said. “If you think about putting a deck over that, effectively creating a mile-long tunnel, and on top of that creating a zone of open space… it’s certainly a bold concept.”<br /><br /><i>To read the full article from Orange County Business Journal, please<a href=http://www.ocbj.com/news/2013/feb/27/irvine-firm-lands-eir-hollywood-central-park/ target=“_blank”> click here.</a><i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_IRVINEFIRMEIR@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
