...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSSTUDIESHCP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSSTUDIESHCP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSSTUDIESHCP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSSTUDIESHCP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions to Prepare Environmental Studies for Hollywood Central Park Project";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/azo-bldg.jpg\"";
	String snippetVar_date = "Thursday, February 28, 2013";
	String snippetVar_excerpt = "FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, and the Friends of Hollywood Central Park (FHCP), a non-profit organization dedicated to building...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/azo-bldg.jpg\">FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, and the Friends of Hollywood Central Park (FHCP), a non-profit organization dedicated to building the Hollywood Central Park, today announced that FirstCarbon Solutions has been selected to prepare the Environmental Impact Report (EIR) and other necessary studies for the groundbreaking and transformative Hollywood Central Park (HCP) project.<br /><br />Supporting one of the most dense and green space-starved neighborhoods in Los Angeles, HCP is a planned 44-acre street level urban park built over a one-mile stretch of the Hollywood Freeway (US 101).<br /><br />V<i> To read the full article from AZO Build, please<a href=http://www.azobuild.com/news.aspx?newsID=16458 target=“_blank”> click here.</a><i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSSTUDIESHCP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
