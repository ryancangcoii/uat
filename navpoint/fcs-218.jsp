...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_3STEPSINTELLIGENT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_3STEPSINTELLIGENT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_3STEPSINTELLIGENT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_3STEPSINTELLIGENT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "3 Steps to Intelligent Site Selection";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/greenbiz_banner.png\"";
	String snippetVar_date = "Tuesday, February 05, 2013";
	String snippetVar_excerpt = "3 Steps to Intelligent Site Selection  It used to be that executives scouting a location for a new office building, manufacturing plant or distribution center only needed to consider potential revenue, local tax incentives and regulatory...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/greenbiz_banner.png\">It used to be that executives scouting a location for a new office building, manufacturing plant or distribution center only needed to consider potential revenue, local tax incentives and regulatory issues.<br /><br />Today, however, as the United States gradually crawls out of a recession, organizations are starting to revisit their expansion plans. How they treat the local environment has become a key part of their site selection process. Why? Environmental concerns can directly affect a project’s overall costs and build schedule, public perception and workforce morale, as well as relationships with partners, government agencies and future generations.<br /><br />Conversely, the location choice for a new development project can have a colossal impact on local and global environments. Environmental consequences can surface in everything from a facility’s location to design, orientation, impact on the landscape and the building materials used.<br /><br /><i> To read the full article from GreenBiz, please click<a href=http://www.greenbiz.com/blog/2013/02/01/3-steps-intelligent-site-selection target=“_blank”> here.</a><i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_3STEPSINTELLIGENT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
