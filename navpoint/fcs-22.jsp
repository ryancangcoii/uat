...
<section  ><%-- Widget fcs.pages.partners_becomeApartner@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagespartners_becomeApartner10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.partners_becomeApartner@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagespartners_becomeApartner10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagespartners_becomeApartner10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/partners_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagespartners_becomeApartner10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.partners_becomeApartner@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-19">Partners</a> &raquo; <span>Become a Partner</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Work with some of the best people in the Environmental Consulting &amp; Sustainability industry</h1>
<p>If you are a contractor, a consultancy firm, a software vendor or a professional group specializing in energy, environmental, sustainability and other carbon management support services, you may want to consider joining FirstCarbon Solutions Global Partner Program.</p>
<p>As a channel partner, you will have the opportunity to be introduced to new companies and industries, enabling you to expand your geographic reach and client base and create new revenue streams. You will also have the chance to work with other organizations, allowing you to increase the services you offer to your clients by partnering with approved, pre-screened experts and professionals in FirstCarbon Solutions Global Partner Program. Subsequently, with new-found partnerships, you can develop innovative, integrated and cost-effective solutions that will broaden your existing services and bolster your market competitiveness.</p>
<h3>How to partner with us</h3>
<p>Take advantage of the opportunity to work with some of the best professionals in the sustainability field with potential to increase your sales revenue and operational income. Contact any member of our business development team to know more details of our Channel Partner Program.</p>
<p>Of course, if you&rsquo;re looking for an outsourcing partner to help reduce your operating costs, maximize resource use and improve operational efficiencies, we can also provide the support you need.</p></div></div>
</div>
<div  class="sec2RightCont col-sh  col-lg-3 col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>BECOME A PARTNER</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/23e67119-5e11-48fb-81ee-d9fd8687f06b" method="POST" role="form" novalidate>
