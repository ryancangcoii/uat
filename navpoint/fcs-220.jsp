...
<section  ><%-- Widget fcs.pages.aboutus_certificates_gsaContract@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_certificates_gsaContract10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_certificates_gsaContract@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_certificates_gsaContract10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_certificates_gsaContract10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_certificates_gsaContract10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_certificates_gsaContract@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>GSA Multiple Award Schedules Contract Holder</h1>
<p>Approximately $50 billion a year in spending or 10% of overall U.S. federal procurement spending is done through GSA Schedules. GSA Schedules are fast, easy, and effective contracting vehicles that establish long-term, federal government-wide contracts with commercial companies to provide access to millions of commercial products and services at volume discount pricing.</p>
<p>FirstCarbon Solution has recently become a &ldquo;GSA Multiple Award Schedules program or contract-holder&rdquo; having GSA contracts for ghgTrack&trade; and Energy Consulting Services.</p>
<p>If you are able to take advantage of U.S. GSA Schedules and you would like more information, please fill out the form on this page, and we&rsquo;ll get back to you.</p></div></div>
</div>
<div  class="sec2RightCont col-sh  col-lg-3 col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>GSA CONTACT US</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/55c25735-4294-48ec-8282-6ad0fb2d3add" method="POST" role="form" novalidate>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="howcanwehelpyou__c"></textarea>
  </div>
  <div class="checkbox">
    <label>
