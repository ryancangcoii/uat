...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MARKETSTAKESOFF10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MARKETSTAKESOFF10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MARKETSTAKESOFF10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MARKETSTAKESOFF10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "MARKETS: Calif. carbon trading takes off";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ClimateWire_banner.jpg\"";
	String snippetVar_date = "Thursday, January 31, 2013";
	String snippetVar_excerpt = "California\'s official carbon market kicked off this week with an uptick in trading, as businesses began accounting for their greenhouse gas emissions in earnest. No lawsuit against the program accompanied the...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/ClimateWire_banner.jpg\">California\'s official carbon market kicked off this week with an uptick in trading, as businesses began accounting for their greenhouse gas emissions in earnest.<br /><br />No lawsuit against the program accompanied the official start date of Jan. 1, as many had anticipated. Instead, appetite for California\'s carbon allowances grew, reflecting confidence in the burgeoning, first-in-the-nation econom ywide greenhouse gas market, traders said.<br /><br />In advance trading yesterday and Wednesday, about 450,000 credits representing 2013 allowances to be delivered in December of this year changed hands, compared to about 3.9 million allowances traded during the entire month of December 2012, according to Intercontinental Exchange. Prices are hovering around $15.50 to $16 per ton, up from around $12 to $13 one month ago.<br /><br />The prices in forward trading also are significantly higher than those fetched in November\'s inaugural state-run auction. The 23.1 million tons of 2013-vintage allowances put up for sale by the California Air Resources Board settled at $10.09 per ton. The next batch, up for sale in February, will start at $10.71, to reflect the rate of inflation and an automatic annual price increase.<br /><br />Brokers said that businesses facing a requirement to turn in allowances starting next year are getting into the market.<br /><br />\"Volumes and liquidity are definitely picking up; there\'s been a fair amount of buying for compliance,\" said John Battaglia, vice president of carbon emissions at Evolution Markets.<br /><br />He said threats of a lawsuit were not keeping buyers on the sidelines. \"People feel pretty confident that the program is here to stay,\" Battaglia said. \"Environmental programs are always going to have that risk [of a lawsuit] ... it\'s certainly present in most environmental markets.\"<br /><br />Environmental observers agreed. \"Buyers are picking up these assets because they know the market is real and they know this is a program that\'s going to last,\" said Derek Walker, the Environmental Defense Fund\'s associate vice president for U.S. climate.<br /><br />\"It\'s clear from the chamber lawsuit filed the night before the first auction that the litigation at this point is as much about trying to create uncertainty as it is trying to raise legitimate legal issues,\" Walker added, referring to a suit filed by the California Chamber of Commerce in Sacramento Superior Court on the eve of the November auction (<i><a href=http://www.eenews.net/climatewire/2012/11/14/archive/2 target=“_blank”> ClimateWire</a></i>, Nov. 14, 2012).<br /><br />A problem in the state-run auction also does not appear to have dampened demand. A Bloomberg story last month disclosing that utility Southern California Edison accidentally bought 1.61 million more allowances than it intended to hasn\'t appeared to hurt the market, Walker said.<br /><br />\"There seems to be a strong amount of activity since the first auction, and things seem to be moving along effectively,\" he said.<br /><br />But the value of California carbon could become more apparent after the second auction in February, one observer said.<br /><br />\"Just because of the quantities and scale of the hiccup ... it\'s possible it kind of skewed the results to make it more difficult to use that [November] sale as an indicator,\" said Chryss Meier, an air quality scientist with FirstCarbon Solutions, an energy consulting firm.<br /><br />Want to read more stories like this?<br /><br /><a href=http://www.eenews.net/trial/ target=“_blank”>Click here</a> to start a free trial to E&E -- the best way to track policy and markets.<br /><br />About ClimateWire<br /><br />ClimateWire is written and produced by the staff of E&E Publishing, LLC. It is designed to provide comprehensive, daily coverage of all aspects of climate change issues. From international agreements on carbon emissions to alternative energy technologies to state and federal GHG programs, ClimateWire plugs readers into the information they need to stay abreast of this sprawling, complex issue.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MARKETSTAKESOFF@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
