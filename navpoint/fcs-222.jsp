...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_BLAZINGTRAIL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_BLAZINGTRAIL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_BLAZINGTRAIL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_BLAZINGTRAIL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_BLAZINGTRAIL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_BLAZINGTRAIL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_BLAZINGTRAIL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_BLAZINGTRAIL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Blazing the Trail of Sustainability";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/capture.png\"";
	String snippetVar_date = "Monday, December 17, 2012";
	String snippetVar_excerpt = "Understanding the environmental impacts across your organization’s supply chain is imperative. There’s no question that companies must assess, evaluate and optimize their supply chain operations in order to reduce their...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/capture.png\">  Understanding the environmental impacts across your organization’s supply chain is imperative. There’s no question that companies must assess, evaluate and optimize their supply chain operations in order to reduce their carbon footprint. In fact, government and industry are strongly urging the issue. And there’s no denying that today’s customers like green business. Additionally, optimized supply chains with smaller carbon footprints are more efficient, less costly and less likely to experience sudden changes in energy and fuel prices.  <br>  <br>  Because of these factors, careful analysis of all trade-offs—which often are the norm, not the exception when it comes to supply chain operations optimization—throughout a supply chain is critical to ensuring overall success.  <br>  <br>  <i>    To read the full article from Supply and Demand Chain Executive, please click    <a href=\"http://www.sdcexec.com/article/10830823/blazing-the-trail-of-sustainability\" target=\"“_blank”\">      &nbsp;here.    </a>  </i>  </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_BLAZINGTRAIL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_BLAZINGTRAIL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
