...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ACCESSINGBALANCING10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ACCESSINGBALANCING10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ACCESSINGBALANCING10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ACCESSINGBALANCING10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Assessing and Balancing Trade-offs in Supply Chain Optimization";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/supply_chain_brain_0_logo.jpg\"";
	String snippetVar_date = "Friday, October 12, 2012";
	String snippetVar_excerpt = "Optimizing supply chain operations to cost less and be more effective has long been a top priority for businesses. Now, companies must consider new sustainability measures such as carbon. Identifying,...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/supply_chain_brain_0_logo.jpg\">Optimizing supply chain operations to cost less and be more effective has long been a top priority for businesses. Now, companies must consider new sustainability measures such as carbon. Identifying, tracking and managing supply chain emissions is quickly becoming essential to optimization efforts, with the primary goal of detecting inefficiencies in fuel, electricity and water consumption and then correcting those inefficiencies to help eliminate waste and reduce costs. But improving one benchmark in an optimization effort may adversely impact another. It\'s rare that everything aligns perfectly.<br /><br /><i>To read the full article from Supply Chain Brain, please click<a href=http://www.supplychainbrain.com/content/nc/general-scm/environmental/single-article-page/article/assessing-and-balancing-trade-offs-in-supply-chain-optimization/ target=“_blank”>  here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ACCESSINGBALANCING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
