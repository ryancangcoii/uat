...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CALIFORNIAREADIES10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CALIFORNIAREADIES10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CALIFORNIAREADIES10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CALIFORNIAREADIES10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "California Readies for Historic";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/awm.jpg\"";
	String snippetVar_date = "Wednesday, October 03, 2012";
	String snippetVar_excerpt = "The countdown is on for implementation of a controversial and pivotal part of California\'s Assembly Bill 32 (AB 32): Global Warming Solutions Act,1 a law that...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/awm.jpg\">The countdown is on for implementation of a controversial and pivotal part of California\'s Assembly Bill 32 (AB 32): Global Warming Solutions Act,1 a law that took effect in 2009 and institutes a mandate to reduce greenhouse gas (GHG) emissions by bringing the state\'s carbon dioxide equivalent (CO2e) emissions to 1990 levels by the year 2020. According to the Environmental Defense Fund, this reduction is equivalent to taking approximately 28 million cars off our roads and highways. The law\'s market-based cap-and-trade component, which was delayed, will now go into effect on January 1, 2013. For the first time, there will be a regulatory-driven, third-party-verified cap on GHG emissions in the United States.<br /><br /><i>Read the full article by Chris Easter <a href=http://cdn.firstcarbonsolutions.com/images/newsletter-brochures/california%20readies%20for%20historic%20assembly%20bill%2032%20ab%2032%20global%20warming%20solutions%20act.pdf target=“_blank”>here.</a></i> <br /><br />This article appears in the October 2012 issue of EM Magazine, a publication of the Air & Waste Management Association (A&WMA; www.awma.org). To obtain copies and reprints, please contact A&WMA directly at 1-412-232-3444.<br /><br /><strong>About the Author</strong><br>Chris Easter, LEED AP, is a vice president and director of the professional Services Group with FirstCarbon Solutions (www.firstcarbonsolutions.com). He is both a LEED AP and a Lead GHG Verifier for CalEPA\'s cap-and-trade program.</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CALIFORNIAREADIES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
