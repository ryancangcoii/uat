...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_GCCALIFORNIACHALLENGE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_GCCALIFORNIACHALLENGE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_GCCALIFORNIACHALLENGE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_GCCALIFORNIACHALLENGE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Global Carbon - California\'s Challenge";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/global-carbon.jpg\"";
	String snippetVar_date = "Friday, September 21, 2012";
	String snippetVar_excerpt = "Global Carbon - California\'s Challenge  California\'s emissions trading system begins in earnest in January -- and carbon market advocates and detracators across the US and beyond are watching... To read the full article from Environmental Finance,...";
	String snippetVar_content = "<img src=\"/ttsvr/fcs/images/news/global-carbon.jpg\"><p>  California\'s emissions trading system begins in earnest in January -- and carbon market advocates and detracators across the US and beyond are watching...  <br>  <br>  <i>    To read the full article from Environmental Finance, please&nbsp;click    <a href=\"http://www.firstcarbonsolutions.com/images/PDF/firstcarbon_globalcarbon9-12.pdf\" target=\"“_blank”\">      here.    </a>  </i>  </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_GCCALIFORNIACHALLENGE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
