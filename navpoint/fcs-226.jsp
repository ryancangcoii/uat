...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_HKJOCKEYCLUB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_HKJOCKEYCLUB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_HKJOCKEYCLUB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_HKJOCKEYCLUB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "HK Jockey Club taps services of FirstCarbon";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/logo-interaksyonnsp_169.png\"";
	String snippetVar_date = "Thursday, September 20, 2012";
	String snippetVar_excerpt = "MANILA - FirstCarbon Solutions Corporation on Thursday said it has been commissioned by the Hong Kong Jockey Club to improve its energy use efficiency. James M. Donovan, FirstCarbon Solutions chief executive...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/logo-interaksyonnsp_169.png\">MANILA - FirstCarbon Solutions Corporation on Thursday said it has been commissioned by the Hong Kong Jockey Club to improve its energy use efficiency.<br /><br />James M. Donovan, FirstCarbon Solutions chief executive officer, said HKJC tapped the company \"to monitor and manage its energy consumption and carbon emissions.”<br /><br /><i>To read the full article from InterAksyon, please<a href=http://www.interaksyon.com/business/43657/hk-jockey-club-taps-services-of-firstcarbon target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HKJOCKEYCLUB@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
