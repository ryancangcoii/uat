...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPFCSRENEWAL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPFCSRENEWAL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPFCSRENEWAL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPFCSRENEWAL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP, FirstCarbon Renew and Expand Contract";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ccbj_logo.jpg\"";
	String snippetVar_date = "Friday, August 03, 2012";
	String snippetVar_excerpt = "Based on the success of an initial collaboration launched last year, the Carbon Disclosure Project (CDP) and FirstCarbon Solutions have renewed and expanded a contract that lets FirstCarbon score corporate...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/ccbj_logo.jpg\">Based on the success of an initial collaboration launched last year, the Carbon Disclosure Project (CDP) and FirstCarbon Solutions have renewed and expanded a contract that lets FirstCarbon score corporate sustainability reports for CDP.<br /><br /><i>To read the full article from Climate Change Business Journal, please<a href=http://www.climatechangebusiness.com/Climate_Change_Weekly_News_August_3_2012#9 target=“_blank”>  click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPFCSRENEWAL@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
