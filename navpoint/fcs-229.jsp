...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PROJECTTOMEASURE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PROJECTTOMEASURE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PROJECTTOMEASURE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PROJECTTOMEASURE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Project to Measure Carbon Output of Supply Chains";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/proformative_logo.jpg\"";
	String snippetVar_date = "Thursday, August 02, 2012";
	String snippetVar_excerpt = "FirstCarbon Solutions recently announced it will evaluate data from more than 3,000 companies as part of its collaboration with the Carbon Disclosure Project. To read the full article from Proformative, please click...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/proformative_logo.jpg\">FirstCarbon Solutions recently announced it will evaluate data from more than 3,000 companies as part of its collaboration with the Carbon Disclosure Project.<br /><br /><i>To read the full article from Proformative, please<a href=http://www.proformative.com/news/1486482/project-measure-carbon-output-supply-chains target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PROJECTTOMEASURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
