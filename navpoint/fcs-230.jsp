...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CARBONDISCLOSURE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CARBONDISCLOSURE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CARBONDISCLOSURE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CARBONDISCLOSURE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Carbon Disclosure Project, FirstCarbon Solutions Partner for Supply Chain Scorecards";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader_logo.jpg\"";
	String snippetVar_date = "Wednesday, August 01, 2012";
	String snippetVar_excerpt = "The Carbon Disclosure Project has expanded its partnership with environmental consulting and software firm FirstCarbon Solutions, under which FirstCarbon processes the greenhouse gas emissions and carbon management data of global...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/environmental-leader_logo.jpg\">The Carbon Disclosure Project has expanded its partnership with environmental consulting and software firm FirstCarbon Solutions, under which FirstCarbon processes the greenhouse gas emissions and carbon management data of global corporations responding to the CDP Supply Chain program.<br /><br /><i>To read the full article from Environmental Leader, please<a href=http://www.environmentalleader.com/2012/08/01/carbon-disclosure-project-firstcarbon-solutions-partner-for-supply-chain-scorecards/ target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CARBONDISCLOSURE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
