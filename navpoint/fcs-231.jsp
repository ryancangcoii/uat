...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_NPTSUPPLYCHAIN10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_NPTSUPPLYCHAIN10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_NPTSUPPLYCHAIN10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_NPTSUPPLYCHAIN10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "New Project Tracks Supply Chain Emissions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/digitalsupplychain_logo.jpg\"";
	String snippetVar_date = "Wednesday, August 01, 2012";
	String snippetVar_excerpt = "A joint venture between FirstCarbon solutions and the Carbon Disclosure Project  To read the full article from Supply Chain Digital, please click here.";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/digitalsupplychain_logo.jpg\">A joint venture between FirstCarbon solutions and the Carbon Disclosure Project <br /><br /><i>To read the full article from Supply Chain Digital, please<a href=http://www.supplychaindigital.com/global_logistics/new-project-tracks-supply-chain-emissions target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NPTSUPPLYCHAIN@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
