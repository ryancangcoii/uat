...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPANDFCSPARTNERSHIP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPANDFCSPARTNERSHIP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPANDFCSPARTNERSHIP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPANDFCSPARTNERSHIP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP and FirstCarbon Solutions Expand Partnership";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/supplyanddemandchain_logo.jpg\"";
	String snippetVar_date = "Tuesday, July 31, 2012";
	String snippetVar_excerpt = "FirstCarbon Solutions extended its partnership with not-for-profit Carbon Disclosure Project (CDP) in order to score companies’ submissions on their greenhouse gas emissions and carbon management strategies to the CDP Supply...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/supplyanddemandchain_logo.jpg\">FirstCarbon Solutions extended its partnership with not-for-profit Carbon Disclosure Project (CDP) in order to score companies’ submissions on their greenhouse gas emissions and carbon management strategies to the CDP Supply Chain.<br /><br /><i>To read the full article from Supply & Demand Chain Executive, please<a href=http://www.sdcexec.com/news/10753789/cdp-and-firstcarbon-solutions-expand-partnership target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPANDFCSPARTNERSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
