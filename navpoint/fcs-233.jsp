...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_SCRCLIMATERISK@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_SCRCLIMATERISK10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SCRCLIMATERISK@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_SCRCLIMATERISK10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_SCRCLIMATERISK10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_SCRCLIMATERISK10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SCRCLIMATERISK@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_SCRCLIMATERISK@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Supply chain reporting on climate risks reaches new heights";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/greenbiz_logo.jpg\"";
	String snippetVar_date = "Monday, July 02, 2012";
	String snippetVar_excerpt = "It’s summer, and thousands of companies are busy completing the now-familiar annual report submittals about their carbon emissions and sustainability plans to the Carbon Disclosure Project (CDP). To read the full...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/greenbiz_logo.jpg\">It’s summer, and thousands of companies are busy completing the now-familiar annual report submittals about their carbon emissions and sustainability plans to the Carbon Disclosure Project (CDP).<br /><br /><i>To read the full article from GreenBiz.com, please<a href=http://www.greenbiz.com/blog/2012/07/02/supply-chain-reporting-climate-risks-reaches-new-heights target=“_blank”>  click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SCRCLIMATERISK@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SCRCLIMATERISK@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
