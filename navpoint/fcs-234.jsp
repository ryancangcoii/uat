...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_WATERENVIROSTEWARDSHIP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_WATERENVIROSTEWARDSHIP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_WATERENVIROSTEWARDSHIP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_WATERENVIROSTEWARDSHIP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Water, Environmental Stewardship and Their Impact on Site Selection";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news//ibbaseline_logo.jpg\"";
	String snippetVar_date = "Saturday, June 30, 2012";
	String snippetVar_excerpt = "Finding a location for a new office building, manufacturing plant or distribution center used to require location executives to mainly consider potential revenue, local tax incentives and the regulatory environment...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/ibbaseline_logo.jpg\">Finding a location for a new office building, manufacturing plant or distribution center used to require location executives to mainly consider potential revenue, local tax incentives and the regulatory environment in the selected area. As the country moves out of the recession, companies are beginning to revisit expansion plans to meet expected demand escalation and, through this process, are increasingly aware of how their treatment of the local ecology can alter their workforce’s morale, their public relations presence and relationship with governmental agencies.<br><br><i>To read the full article from Trade &amp; Industry Development, please<a href=\"http://www.tradeandindustrydev.com/Industry/Alternative%20Energy%20%2526%20Fuels/water-environmental-stewardship-and-their-impact-s-6635\" target=\"“_blank”\">&nbsp;click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_WATERENVIROSTEWARDSHIP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
