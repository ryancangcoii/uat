...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSCOMPLETESCFA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSCOMPLETESCFA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Completes Carbon Footprint Assessments for First Title";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news//bloomberg.jpg\"";
	String snippetVar_date = "Wednesday, May 23, 2012";
	String snippetVar_excerpt = "DEPOSIT, New York and LONDON, May 22, 2012 - UK-Based First Title Limited, a leading property service provider, uses FirstCarbon Solution\'s ghgTrack™ Web-Based Solution to Analyse Emissions and Provide...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/bloomberg.jpg\">DEPOSIT, New York and LONDON, May 22, 2012 - UK-Based First Title Limited, a leading property service provider, uses FirstCarbon Solution\'s ghgTrack™ Web-Based Solution to Analyse Emissions and Provide Dynamic Sustainability Metrics &amp; Reporting for Clients<br><br><i>To read the full article from Bloomberg, please<a href=\"http://www.bloomberg.com/article/2012-05-22/adOLfE3PgTzU.html\" target=\"“_blank”\"> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
