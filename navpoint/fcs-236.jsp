...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Completes Carbon Footprint Assessments for First Title";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news//istockanalyst.jpg\"";
	String snippetVar_date = "Wednesday, May 23, 2012";
	String snippetVar_excerpt = "DEPOSIT, New York and LONDON, May 22, 2012 /PRNewswire/ -- FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, today announced a services agreement with...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/istockanalyst.jpg\">DEPOSIT, New York and LONDON, May 22, 2012 /PRNewswire/ -- FirstCarbon Solutions, a pioneer and industry leader in environmental sustainability solutions for business, today announced a services agreement with UK-based First Title to benchmark and actively monitor First Title\'s greenhouse gas (GHG) footprint and energy usage with FirstCarbon\'s ghgTrack™ carbon management software.<br /><br /><i>To read the full article from iStockAnalyst,please<a href=http://www.istockanalyst.com/business/news/5855421/firstcarbon-solutions-completes-carbon-footprint-assessments-for-first-title target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
