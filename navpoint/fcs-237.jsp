...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE310BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE310BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE310BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE310BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Completes Carbon Footprint Assessments for First Title";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/insurance-technology.jpg\"";
	String snippetVar_date = "Tuesday, May 22, 2012";
	String snippetVar_excerpt = "DEPOSIT, New York and LONDON, May 22, 2012 (PR Newswire Europe via COMTEX) -- - UK-Based First Title Limited, a leading property service provider, uses FirstCarbon Solution\'s ghgTrack(TM) Web-Based...";
	String snippetVar_content = "<p>  <img src=\"/ttsvr/fcs/images/news/insurance-technology.jpg\">  DEPOSIT, New York and LONDON, May 22, 2012 (PR Newswire Europe via COMTEX) -- - UK-Based First Title Limited, a leading property service provider, uses FirstCarbon Solution\'s ghgTrack(TM) Web-Based Solution to Analyse Emissions and Provide Dynamic Sustainability Metrics &amp; Reporting for Clients DEPOSIT, New York and LONDON, May 22, 2012 /PRNewswire/  <br>  <br>  <i>    To read the full article from Insurance Technology, please    <a href=\"http://insurance-technology.tmcnet.com/news/2012/05/22/6316287.htm\" target=\"“_blank”\">      click here.    </a>  </i>  </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSCOMPLETESCFAFIRSTTITLE3@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
