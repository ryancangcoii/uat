...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MSPFCSUSTAINABILITY10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MSPFCSUSTAINABILITY10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MSPFCSUSTAINABILITY10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MSPFCSUSTAINABILITY10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Mahindra Satyam Partners With FirstCarbon On Sustainability";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/rttnews.png\"";
	String snippetVar_date = "Thursday, May 17, 2012";
	String snippetVar_excerpt = "Mahindra Satyam, erstwhile Satyam Computer Services Ltd., announced that it had selected FirstCarbon Solutions as a partner for its Sustainability Monitoring service offering. Through this partnership, Mahindra Satyam will offer FirstCarbon...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/rttnews.png\">Mahindra Satyam, erstwhile Satyam Computer Services Ltd., announced that it had selected FirstCarbon Solutions as a partner for its Sustainability Monitoring service offering.<br /><br />Through this partnership, Mahindra Satyam will offer FirstCarbon Solutions\' sustainability and environmental consulting solutions and software services initially in the UK with plans to expand into other areas in which Mahindra Satyam operates.<br /><br /><i>To read the full article from RTT News, please<a href=http://www.rttnews.com/1888392/mahindra-satyam-partners-with-firstcarbon-on-sustainability.aspx?type=in&utm_source=google&utm_campaign=sitemap target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MSPFCSUSTAINABILITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
