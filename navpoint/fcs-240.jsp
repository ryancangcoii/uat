...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRASPFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MAHINDRASPFCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRASPFCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MAHINDRASPFCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MAHINDRASPFCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MAHINDRASPFCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRASPFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRASPFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Mahindra Satyam Partners FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/business_line.jpg\"";
	String snippetVar_date = "Thursday, May 17, 2012";
	String snippetVar_excerpt = "Mahindra Satyam has tied up with FirstCarbon Solutions to offer sustainability monitoring services. FirstCarbon is an industry major in environmental sustainability solutions for businesses. To read the full article from Business Line,...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/business_line.jpg\">Mahindra Satyam has tied up with FirstCarbon Solutions to offer sustainability monitoring services.<br /><br />FirstCarbon is an industry major in environmental sustainability solutions for businesses.<br /><br /><i>To read the full article from Business Line, please<a href=http://www.thehindubusinessline.com/industry-and-economy/info-tech/article3428037.ece?homepage=true&ref=wl_home target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRASPFCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRASPFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
