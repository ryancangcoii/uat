...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MAHINDRAHARDENS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MAHINDRAHARDENS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MAHINDRAHARDENS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MAHINDRAHARDENS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Mahindra Satyam Hardens After Pact with FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/news-coverage-images.ise_logo0.jpg\"";
	String snippetVar_date = "Thursday, May 17, 2012";
	String snippetVar_excerpt = "Through the partnership with FirstCarbon Solutions, Mahindra Satyam will offer FirstCarbon Solutions\' sustainability and environmental consulting solutions and software services initially in the United Kingdom with plans to expand into...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/news-coverage-images.ise_logo0.jpg\">PAKI GAWA JAMES: ERROR…?</p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
