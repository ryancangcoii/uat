...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MAHINDRAHARDENSAFTERPACT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MAHINDRAHARDENSAFTERPACT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MAHINDRAHARDENSAFTERPACT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MAHINDRAHARDENSAFTERPACT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Mahindra Satyam Hardens After Pact with FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/capitalmarket_logo.jpg\"";
	String snippetVar_date = "Thursday, May 17, 2012";
	String snippetVar_excerpt = "Mahindra Satyam Hardens After Pact with FirstCarbon Solutions Through the partnership with FirstCarbon Solutions, Mahindra Satyam will offer FirstCarbon Solutions\' sustainability and environmental consulting solutions and software services initially in the...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/capitalmarket_logo.jpg\">Through the partnership with FirstCarbon Solutions, Mahindra Satyam will offer FirstCarbon Solutions\' sustainability and environmental consulting solutions and software services initially in the United Kingdom with plans to expand into other areas in which Mahindra Satyam operates. FirstCarbon Solutions, is a pioneer and industry leader in environmental sustainability solutions for business, Mahindra Satyam said in a statement.<br /><br /<i>To read the full article from Capital Market, please<a href=http://www.capitalmarket.co.in/cmedit/story2-0.asp?SNo=554705 target=“_blank”> click here.</a></i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAHARDENSAFTERPACT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
