...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MAHINDRAGREENTIEUP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MAHINDRAGREENTIEUP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MAHINDRAGREENTIEUP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MAHINDRAGREENTIEUP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Mahindra Green Tie-Up";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/techgoss_logo.jpg\"";
	String snippetVar_date = "Thursday, May 17, 2012";
	String snippetVar_excerpt = "Mahindra Green Tie-Up Leading IT and business company Mahindra Satyam has development and delivery centers in the US, Canada, Brazil, the UK, Hungary, Egypt, UAE, India, China, Malaysia, Singapore, and Australia...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/techgoss_logo.jpg\">Leading IT and business company Mahindra Satyam has development and delivery centers in the US, Canada, Brazil, the UK, Hungary, Egypt, UAE, India, China, Malaysia, Singapore, and Australia serving numerous clients, including many Fortune 500 organizations.<br /><br /><i>To read the full article from Techgoss, please<a href=http://www.techgoss.com/Story/4525S14-Mahindra-green-tieup.aspx target=“_blank”>  click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MAHINDRAGREENTIEUP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
