...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CANCARBONACCOUNTING10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CANCARBONACCOUNTING10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CANCARBONACCOUNTING10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CANCARBONACCOUNTING10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Can Carbon Accounting Survive Government’s Cold Shoulder?";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/techweekeurop.jpg\"";
	String snippetVar_date = "Wednesday, May 16, 2012";
	String snippetVar_excerpt = "Panic stories warned firms to invest in carbon accounting software or face extreme penalties from the CRC or similar schemes. Companies were warned not to rely on wonky Excel spreadsheets. To...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/techweekeurop.jpg\">Panic stories warned firms to invest in carbon accounting software or face extreme penalties from the CRC or similar schemes. Companies were warned not to rely on wonky Excel spreadsheets.<br /><br /><i>To read the full article from TechWeek Europe, please<a href=http://www.techweekeurope.co.uk/comment/carbon-accounting-government-privat-78283 target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CANCARBONACCOUNTING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
