...
<section  ><%-- Widget fcs.pages.solutions_industry@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_industry.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_industry.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/">Home</a> &raquo; <a href="/ttsvr/solutions">Solutions</a> &raquo; <span>By Industry</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><div class="wt12 wcGray3">
<h1>Sustainability Consultants for Industry</h1>
<h3>Targeted, integrated solutions that meet your industry-specific needs</h3>
<p>Do you need to keep up with emerging trends and regulatory changes affecting your industry? Do you want to cost-effectively improve your competitiveness? Are you looking for business solutions that account for your industry-specific needs? Then trust FirstCarbon Solutions to provide the <strong>energy, environmental and compliance solutions</strong> that meet your organization's unique needs.</p>
<p>FirstCarbon Solutions brings together a team of <strong>management professionals, environmental experts and technical consultants</strong> with extensive knowledge in the following industries to develop integrated and cost-effective solutions to improve your organization's sustainability performance and operational efficiency:</p>
<div class="row">
<div class="col-lg-4 col-md-4 col-sm-4">
<ul>
<li class="first"><a href="/ttsvr/solutions/by-industry/associations">Associations</a></li>
<li><a href="/ttsvr/solutions/by-industry/real-estate2">Commercial Real Estate</a></li>
<li><a href="/ttsvr/solutions/by-industry/consumer-products">Consumer Products</a></li>
<li><a href="/ttsvr/solutions/by-industry/developers">Developers</a></li>
<li><a href="/ttsvr/solutions/by-industry/education">Education</a></li>
<li><a href="/ttsvr/solutions/by-industry/finance">Finance</a></li>
<li><a href="/ttsvr/solutions/by-industry/food-products">Food Products</a></li>
<li><a href="/ttsvr/solutions/by-industry/government">Government</a></li>
<li class="last"><a href="/ttsvr/solutions/by-industry/healthcare">Healthcare</a></li>
</ul>
</div>
<div class="col-lg-4 col-md-4 col-sm-4">
<ul>
<li class="first"><a href="/ttsvr/solutions/by-industry/hospitality">Hospitality</a></li>
<li><a href="/ttsvr/solutions/by-industry/industrial">Industrial</a></li>
<li><a href="/ttsvr/solutions/by-industry/insurance">Insurance</a></li>
<li><a href="/ttsvr/solutions/by-industry/manufacturing">Manufacturing</a></li>
<li><a href="/ttsvr/solutions/by-industry/municipalities">Municipalities</a></li>
<li><a href="/ttsvr/solutions/by-industry/packaging">Packaging</a></li>
<li><a href="/ttsvr/solutions/by-industry/retail">Retail</a></li>
<li><a href="/ttsvr/solutions/by-industry/restaurants">Restaurants</a></li>
<li class="last"><a href="/ttsvr/solutions/by-industry/telecommunications">Telecommunications</a></li>
</ul>
</div>
</div>
<p>Whether you're a major retailer, a hospital or a manufacturing firm, FirstCarbon Solutions understands the issues and challenges you face, providing innovative strategies that address your unique requirements. With our strong consulting background, software solutions and expertise in data processing services, you are confident that you get the best available assistance for your organization.</p>
<h3>Overcome industry challenges with FirstCarbon Solutions</h3>
<p>Knowing your industry is not enough. That's why we examine, analyze and innovate to give you the best possible environmental sustainability solutions on data management, energy efficiency and regulatory compliance that meet your industry-specific needs for <strong>sustainable profitability and increased environmental performance</strong>. While challenges vary across industries, our consulting team is able to differentiate your requirements and is readily flexible to work in different settings, business environments and geographies.</p>
<p>Whatever industry you are from and whatever goals you have for your company, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p>
</div></div></div>
</div>
