...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PHPFCSMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PHPFCSMBA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PHPFCSMBA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PHPFCSMBA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PHPFCSMBA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PHPFCSMBA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PHPFCSMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PHPFCSMBA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Philippines’ FirstCarbon Solutions to acquire Michael Brandman Associates";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/dateline-philippines.png\"";
	String snippetVar_date = "Thursday, April 19, 2012";
	String snippetVar_excerpt = "Manila, Philippines–FirstCarbon Solutions, a pioneer and industry leader in environmental and sustainability business solutions, announced plans to acquire Michael Brandman Associates, a privately held company headquartered in California. The...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/dateline-philippines.png\">Manila, Philippines–FirstCarbon Solutions, a pioneer and industry leader in environmental and sustainability business solutions, announced plans to acquire Michael Brandman Associates, a privately held company headquartered in California. The strategic convergence will broaden the opportunity for both companies to provide comprehensive, integrated environmental sustainability services to companies and governments worldwide.<br /><br /> <i>This article was published on Dateline Philippines. </i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PHPFCSMBA@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PHPFCSMBA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
