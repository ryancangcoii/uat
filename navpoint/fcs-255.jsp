...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSTOACQUIREMBA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSTOACQUIREMBA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSTOACQUIREMBA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSTOACQUIREMBA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions to Acquire Michael Brandman Associates";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/green.png\"";
	String snippetVar_date = "Tuesday, April 17, 2012";
	String snippetVar_excerpt = "DEPOSIT, N.Y. and IRVINE, Calif., April 17, 2012 /PRNewswire via COMTEX/ -- FirstCarbon Solutions, a pioneer and industry leader in environmental and sustainability solutions for business, today announced plans to...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/green.png\">DEPOSIT, N.Y. and IRVINE, Calif., April 17, 2012 /PRNewswire via COMTEX/ -- FirstCarbon Solutions, a pioneer and industry leader in environmental and sustainability solutions for business, today announced plans to acquire privately-held Michael Brandman Associates. The strategic convergence will broaden the opportunity for FirstCarbon Solutions and Michael Brandman Associates to provide even more comprehensive and integrated environmental sustainability services to companies and governments worldwide. In addition, the integration will offer both current and future clients greater opportunities to reduce costs and risk, optimize resource use, maximize revenue opportunities and improve operational efficiencies in highly-regulated global environments.<br /><br /><i>To read the full article from Verdantix Blog, please<a href=http://green.tmcnet.com/news/2012/04/17/6264546.htm target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSTOACQUIREMBA@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
