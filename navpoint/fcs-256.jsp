...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MBAACQUIREFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MBAACQUIREFCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MBAACQUIREFCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MBAACQUIREFCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MBAACQUIREFCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MBAACQUIREFCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MBAACQUIREFCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MBAACQUIREFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Michael Brandman Associates acquired by FirstCarbon Solutions";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/businesslogo.jpg\"";
	String snippetVar_date = "Tuesday, April 17, 2012";
	String snippetVar_excerpt = "FirstCarbon Solutions Inc. has announced plans to acquire Irvine-based environmental planning services firm Michael Brandman Associates. To read the full article from Business Journal, please click here.    ";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/businesslogo.jpg\">FirstCarbon Solutions Inc. has announced plans to acquire Irvine-based environmental planning services firm Michael Brandman Associates.<i>To read the full article from Business Journal, please<a href=http://www.bizjournals.com/sacramento/news/2012/04/17/michael-brandman-assoc-first-carbon-acqu.html target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MBAACQUIREFCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MBAACQUIREFCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
