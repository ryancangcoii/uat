...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PUERTOPRINCESSAEYE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PUERTOPRINCESSAEYE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PUERTOPRINCESSAEYE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PUERTOPRINCESSAEYE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Puerto Princesa eyes ISO environment standard";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/loqal.j\"";
	String snippetVar_date = "Monday, April 16, 2012";
	String snippetVar_excerpt = "FirstCarbon Solutions is a pioneer and industry leader in environmental and sustainability solutions for business. To read the full article from loQal.ph, please click here.";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/loqal.jpg\">FirstCarbon Solutions is a pioneer and industry leader in environmental and sustainability solutions for business.<br /><br /><i>To read the full article from loQal.ph, please<a href=http://loqal.ph/science-and-education/2012/04/16/puerto-princesa-eyes-iso-environment-standard/ target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSAEYE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
