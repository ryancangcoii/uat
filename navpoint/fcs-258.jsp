...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_PUERTOPRINCESSABALANCE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_PUERTOPRINCESSABALANCE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_PUERTOPRINCESSABALANCE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_PUERTOPRINCESSABALANCE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Puerto Princesa Balances Development and Growth";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/business-mirror.jpg\"";
	String snippetVar_date = "Sunday, April 15, 2012";
	String snippetVar_excerpt = "Puerto Princesa Balances Development and GrowthPUERTO Princesa City recently forged ties with FirstCarbon Solutions, a pioneer and industry leader in environment and sustainability solutions for business, to boost its development...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/business-mirror.jpg\">PUERTO Princesa City recently forged ties with FirstCarbon Solutions, a pioneer and industry leader in environment and sustainability solutions for business, to boost its development goals, including balancing economic growth and sustainable development.<br /><br /><i>This article was published on Business Mirror.</i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_PUERTOPRINCESSABALANCE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
