...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_ENVIROFRIENDLYBOTTLE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_ENVIROFRIENDLYBOTTLE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_ENVIROFRIENDLYBOTTLE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_ENVIROFRIENDLYBOTTLE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Environmentally Friendly Bottles";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/cnbc-logo.jpg\"";
	String snippetVar_date = "Thursday, April 12, 2012";
	String snippetVar_excerpt = "To read the full article from CNBC, please click here.  ";
	String snippetVar_content = "<p>  <img src=\"/ttsvr/fcs/images/news/cnbc-logo.jpg\">  <i>To read the full article from CNBC, please<a href=\"http://video.cnbc.com/gallery/?video=3000083864&amp;play=1\" target=\"_blank\">      click here.</a>  </i>  </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_ENVIROFRIENDLYBOTTLE@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
