...
<section  ><%-- Widget fcs.pages.solutions_focus@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solutionbyfocus.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <span>By Focus</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Keep an eye on your goals with the best solutions at hand</h1>
<p>Do you feel the need to steer your organization to sustainability? Are you required to improve your energy footprint and environmental performance across your supply chain? Or are you working on a major development project? FirstCarbon Solutions combines years of consulting experience and technical background with expertise in back-office data processing to provide support services that bring you closer to your goals. We offer cost-effective and comprehensive solutions that are focused on:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/sustainability">Sustainability</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental">Environmental</a></li>
<li><a href="/ttsvr/solutions/by-focus/energy">Energy</a></li>
<li><a href="/ttsvr/solutions/by-focus/supply-chain">Supply Chain</a></li>
<li><a href="/ttsvr/solutions/by-focus/entitlements-permitting">Entitlements &amp; Permitting</a></li>
</ul>
<p>Our management specialists, technical experts and environmental consultants work with you to anticipate your requirements and provide the assistance you need to ensure you meet your bottom line. With us on board, we work with you to comply with the regulations that you are subject to, meet industry standards as well as deal with business trends and issues without losing sight of your short- and long-term goals.</p>
<h3>Form the best sustainability, environmental and energy team to focus on your needs</h3>
<p>With FirstCarbon Solutions, finding the right professionals to work with will be the least of your concerns. Our team consists of people who have worked with various companies from different industries. We also have the tools and the facilities that are essential to the success of your efforts.</p>
<p>If you are focused on improving your organization&rsquo;s sustainability or obtaining the necessary entitlements for your upcoming project, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p></div></div>
</div>
