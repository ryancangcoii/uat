...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSTREEPLANTING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSTREEPLANTING10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSTREEPLANTING@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSTREEPLANTING10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSTREEPLANTING10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSTREEPLANTING10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSTREEPLANTING@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSTREEPLANTING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Pushes Sustainable Resource Use, Joins Tree-planting";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/gma-pics.png\"";
	String snippetVar_date = "Tuesday, February 21, 2012";
	String snippetVar_excerpt = "FirstCarbon Solutions Pushes Sustainable Resource Use, Joins Tree-planting  ADEC Group member FirstCarbon Solutions, a global industry leader providing managed energy and sustainability services, demonstrated its continuing commitment to the sustainable use of resources and improving environmental performance by...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/gma-pics.png\">ADEC Group member FirstCarbon Solutions, a global industry leader providing managed energy and sustainability services, demonstrated its continuing commitment to the sustainable use of resources and improving environmental performance by taking part in an urban tree-planting initiative led by the Rotary Club of Mandaluyong East (RCME).<br><br><i>To read the full article from GMA News, please<a href=\"http://www.gmanetwork.com/news/story/248776/cbb/firstcarbon-solutions-pushes-sustainable-resource-use-joins-tree-planting\" target=\"“_blank”\"> click here. </a></i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSTREEPLANTING@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSTREEPLANTING@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
