...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_NALAGS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_NALAGS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NALAGS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_NALAGS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_NALAGS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_NALAGS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NALAGS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_NALAGS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "North America Lags on Supplier Emission Cuts";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader.gif\"";
	String snippetVar_date = "Wednesday, February 01, 2012";
	String snippetVar_excerpt = "To read the full article from Environmental and Energy Management News, please click here. ";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\"><i>To read the full article from Environmental and Energy Management News, please<a href=http://www.gmanetwork.com/news/story/248776/cbb/firstcarbon-solutions-pushes-sustainable-resource-use-joins-tree-planting target=“_blank”>  click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NALAGS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NALAGS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
