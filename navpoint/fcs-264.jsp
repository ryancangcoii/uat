...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <span> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Issue No. 40 : February 2014</h1>
<div class="space">&nbsp;</div>
<h2 class="mb15">Our Perspective</h2>
<h3><a href="how-can-smes-manage-supply-chain-pressures-to-gain-competitive-advantage/">How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a></h3>
<p><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-510178620-jpg/images/ourperspective.jpg" alt="" />Supply chain has become a crucial and important part of large corporations&rsquo; wider sustainability strategies when it comes to addressing a number of concerns that threaten business operations. As big businesses now thrive and reap the fruits of sustainability efforts, similar expectations have funnelled down to small and medium sized enterprises (SMEs). This is turn, has increased supply chain pressures that include resource depletion and their stakeholders&rsquo; growing concern over corporate ethics and policies. In addition, these companies are receiving external pressures from customers who now &ldquo;demand&rdquo; to know more about their business, products, services and even corporate social responsibility initiatives. <a href="how-can-smes-manage-supply-chain-pressures-to-gain-competitive-advantage/">Read More</a></p>
<div class="space">&nbsp;</div>
<h3 class="no-mb">Minimize costs and avoid delays in site selection. Download our whitepaper:</h3>
<p class="no-mt"><a href="/ttsvr/resources/reports-and-white-papers/intelligent-site-selection">Intelligent Site Selection</a></p>
<div class="space">&nbsp;</div>
<h2 class="mb15">Industry Updates</h2>
<h4><a href="the-five-csr-trends-to-watch-in-2014">The Five CSR Trends to Watch in 2014</a></h4>
<p>New materials, genetically modified organisms, climate change adaptation, employee engagement and social entrepreneurs - these are the five trends most likely to keep sustainability professionals awake at night over the coming 12 months. <a href="the-five-csr-trends-to-watch-in-2014">Read More</a></p>
<h4><a href="sustainability-local-sourcing-top-restaurant-trends">Sustainability, Local Sourcing Top Restaurant Trends</a></h4>
<p>Locally sourced food, sustainability and waste reduction will be among the top restaurant trends this year, according to a survey of about 1,300 US chefs. <a href="sustainability-local-sourcing-top-restaurant-trends">Read More</a></p>
<h4><a href="nyc-cuts-ghg-emissions-19">NYC Cuts GHG Emissions 19%</a></h4>
<p>New York City has reduced its greenhouse gas emissions 19 percent since 2005, Reuters reports. <a href="nyc-cuts-ghg-emissions-19">Read More</a></p>
<h4><a href="firms-must-close-csr-gap-to-grow-business">Firms 'Must Close CSR Gap to Grow Business'</a></h4>
<p>Companies that close the gap between consumer expectations and perceptions of their corporate social responsibility work can positively transform their brand, according to Craig Bida, executive vice president of cause branding and nonprofit marketing for Cone Communications. <a href="firms-must-close-csr-gap-to-grow-business">Read More</a></p>
<h4><a href="energy-efficiency-market-face-financing-big-data-challenges-in-2014">Energy Efficiency Market Face Financing, Big Data Challenges in 2014</a></h4>
<p>The efficiency industry, driven largely in 2013 by intelligent innovations such as energy management software and virtual audits, will face financing, big data, education and accountability hurdles this year, according to a survey of executives by GTM Research. <a href="energy-efficiency-market-face-financing-big-data-challenges-in-2014">Read More</a></p>
<h4><a href="sustainability-helps-smes-cut-costs-increase-profitability">Sustainability Helps SMEs Cut Costs, Increase Profitability</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-505449508-jpg/increase-profitability.jpg" alt="" /> A quarter of small businesses say sustainability ranks high on their priority list for 2014 and a third expect to increase their investment in sustainable business practices over the next five years, according to research by Lloyds Bank Commercial Banking. <a href="sustainability-helps-smes-cut-costs-increase-profitability">Read More</a></p>
<h4><a href="data-centers-becoming-more-efficient">Data Centers Becoming More Efficient</a></h4>
<p>Energy-efficient data centers will continue to demand attention in 2014, with high energy costs and government regulations and directives on measuring data center energy efficiency continuing to be prominent. <a href="data-centers-becoming-more-efficient">Read More</a></p>
<h4><a href="energy-efficiency-driving-innovation">Energy Efficiency Driving Innovation</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-502073914-jpg/energy-efficiency.jpg" alt="" align="left" />Emphasis on energy efficient products over the next decade is expected to drive an expanding use of digital power management in applications such as DC-DC converters, says Reinhold Theurer, vice president EMEA in Electronics Weekly. <a href="energy-efficiency-driving-innovation">Read More</a></p>
<h4><a href="china-to-link-credit-to-companies-environmental-records">China to Link Credit to Companies' Environmental Records</a></h4>
<p>Chinese companies are to be rated by the government on their environmental performance records which will, in turn, determine how they are treated under various social and financial aspects. <a href="china-to-link-credit-to-companies-environmental-records">Read More</a></p>
<h4><a href="sustainability-ranks-as-pressing-priority-for-smes-in-2014">Sustainability Ranks as Pressing Priority for SMEs in 2014</a></h4>
<p>A quarter of small and medium sized enterprises (SMEs) say sustainability will be one of their top three priorities this year, despite the fact many are struggling to move beyond implementing simple green measures. <a href="sustainability-ranks-as-pressing-priority-for-smes-in-2014">Read More</a></p>
<h4><a href="vietnam-to-steer-support-to-cities-under-climate-threat">Vietnam to Steer Support to Cities Under Climate Threat</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-446101007-jpg/extreme-weather-is-proving-costly-for-china.jpg" alt="" align="left" />A survey of the harshest effects of climate change on Vietnam's urban areas is scheduled to be completed by 2020 under a project recently approved by the country's Deputy Prime Minister, Hoang Trung Hai. <a href="vietnam-to-steer-support-to-cities-under-climate-threat">Read More</a></p>
<h4><a href="western-companies-suppliers-greening-asia-factories">Western Companies, Suppliers Greening Asia Factories</a></h4>
<p>In the last five years, Western companies and occasionally their Asian suppliers have begun to build green-certified or environmentally friendly factories in developing countries. <a href="western-companies-suppliers-greening-asia-factories">Read More</a></p>
<h4><a href="carbon-market-value-to-climb-15-in-2014">Carbon Market Value to Climb 15% in 2014</a></h4>
<p>The analysts attribute the increase to the European Union's plan to postpone sales of emissions permits. This may boost European carbon prices to 7.5 euros ($10) a metric ton - a more than 50 percent rise from today's price of less than 5 euros ($7). <a href="carbon-market-value-to-climb-15-in-2014">Read More</a></p>
<h4><a href="ca-carbon-market-well-constructed-strong">CA Carbon Market 'Well-Constructed, Strong'</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-505528853-jpg/images/CO2-emissions.jpg" alt="" />The first year of California's cap-and-trade program for greenhouse gas pollution shows the carbon market is well-constructed and strong while the state's economy continues to improve, according to analysis by Environmental Defense Fund. <a href="ca-carbon-market-well-constructed-strong">Read More</a></p>
<h4><a href="michigan-office-offering-energy-audits">Michigan Office Offering Energy Audits</a></h4>
<p>The Michigan Energy Office (MEO) has partnered with private-sector technical energy-saving experts throughout the state provide energy audits for qualified recipients. MEO pays for half of the audit cost. <a href="michigan-office-offering-energy-audits">Read More</a></p>
<h4><a href="predictions-made-for-high-performance-building">Predictions Made for High Performance Building</a></h4>
<p>Net-zero energy buildings are so 2013. Net-positive energy buildings are the future. That was among the predictions for 2014 made by green builder Hammer &amp; Hand for the US high performance building industry. <a href="predictions-made-for-high-performance-building">Read More</a></p>
<h4><a href="report-global-environmental-consultancy-market-tops-27bn">Report: Global Environmental Consultancy Market Tops $27bn</a></h4>
<p>The global environmental consultancy market expanded again last year, growing 3.6 per cent year-on-year to $27.4bn as analysts tipped the sector for further expansion over the next five years. <a href="report-global-environmental-consultancy-market-tops-27bn">Read More</a></p>
<h4><a href="csr-strategies-reap-financial-rewards">CSR Strategies Reap Financial Rewards</a></h4>
<p>Companies that introduce a sustainability strategy throughout their supply chain generally see a boost in their financial performance &mdash; but those that don&rsquo;t fully commit to the strategy generally see a decline in revenue, according to a study by Clark University researchers. <a href="csr-strategies-reap-financial-rewards">Read More</a></p>
<h4><a href="sustainability-reporting-changes-top-ey-s-2014-trends-list">Sustainability Reporting Changes Top EY's 2014 Trends List</a></h4>
<p>The forthcoming conflict minerals reporting deadlines and transition to the Global Reporting Initiative (GRI) G4 reporting are among the 2014 sustainability trends that Ernst &amp; Young&rsquo;s Climate Change and Sustainability Services group have identified for companies. <a href="sustainability-reporting-changes-top-ey-s-2014-trends-list">Read More</a></p>
<h4><a href="co2-emissions-expected-to-increase-in-2013">CO2 Emissions Expected to Increase in 2013</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-505528853-jpg/images/CO2-emissions.jpg" alt="" />The Energy Information Administration reports that once all data are in, energy-related carbon dioxide (CO2) emissions in 2013 are expected to be roughly 2 percent above the 2012 level. A small increase in coal consumption in the electric power sector is responsible. <a href="co2-emissions-expected-to-increase-in-2013">Read More</a></p>
<h4><a href="hsbc-2014-marks-start-of-new-economic-focus-on-climate">HSBC: 2014 Marks Start of New Economic Focus on Climate</a></h4>
<p>HSBC has said climate change will rise up the corporate finance agenda this year, highlighting three issues - impacts, carbon risk and green bonds - that will lend impetus to this. <a href="hsbc-2014-marks-start-of-new-economic-focus-on-climate">Read More</a></p>
<h4><a href="shanghai-environmental-spending-not-matching-economic-growth">Shanghai Environmental Spending not Matching Economic Growth</a></h4>
<p>Shanghai devoted a smaller share of its resources and has met a smaller proportion of its goals for environmental protection in the five years from 2008 to 2012, despite growing public dissatisfaction with the city's environment in recent years, the local statistics bureau said yesterday. <a href="shanghai-environmental-spending-not-matching-economic-growth">Read More</a></p>
<h4><a href="water-security-now-ranks-as-one-of-greatest-risks-to-civilisation">Water Security Now Ranks as One of Greatest Risks to Civilisation</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-507410826-jpg/images/water-security.jpg" alt="" /> Water is now one of the highest global risks, alongside the economy, unemployment, food shortages and extreme weather patterns, new research has found. <a href="water-security-now-ranks-as-one-of-greatest-risks-to-civilisation">Read More</a></p></div></div>
</div>
