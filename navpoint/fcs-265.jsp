...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <span>January 2014 - Constructing Sustainable Business Models</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Issue No. 39 : January 2014</h1>
<div class="space">&nbsp;</div>
<h2 class="mb15">Our Perspective</h2>
<h3><a href="constructing-sustainable-business-models">Constructing Sustainable Business Models</a></h3>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-453698425-jpg/Constructing-Sustainable-Business-Models.jpg-Sustainable-Business-Models.jpg" alt="" />Businesses are at the forefront of providing society&rsquo;s needs&mdash;from basic necessities such as food and shelter, to more extraneous demands like transportation and communication. As international organizations and governments set more stringent sustainability targets, and deadlines for achieving sustainability goals loom closer, all sectors of society must contribute to achieving local, national, and global sustainability targets, especially the business sector. Therefore, all businesses &mdash; both in developed and developing countries &mdash; are responsible for assuring that they provide society&rsquo;s needs in a sustainable manner. For businesses to become sustainable, they must look at their very foundation: their business model. <a href="constructing-sustainable-business-models">Read More</a></p>
<div class="space">&nbsp;</div>
<h3 class="no-mb">Download our whitepaper:</h3>
<p class="no-mt"><a href="/ttsvr/resources/reports-and-white-papers/mastering-big-data-in-environmental-sustainability">Mastering 'Big Data' in Environmental Sustainability</a></p>
<div class="space">&nbsp;</div>
<h2 class="mb15">Industry Updates</h2>
<h4><a href="frost-sullivan-what-s-hot-in-environmental-markets">Frost &amp; Sullivan: What&rsquo;s Hot in Environmental Markets?</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-444676471-jpg/Frost-and-sullivan-whats-hot-in-environmental-markets.jpg" alt="" />Urbanization and smart cities, the changing dynamics of unconventional gas, and opportunities generated from increased environmental awareness and legislation will be the key topics in 2014 and beyond, according to Frost &amp; Sullivan&rsquo;s predictions for the global energy and environment market. <a href="frost-sullivan-what-s-hot-in-environmental-markets">Read More</a></p>
<h4><a href="financial-decision-makers-need-climate-information-to-manage-risks">Financial Decision Makers Need Climate Information to Manage Risks</a></h4>
<p>Maximizing returns on financial investments depends on understanding and accounting for weather and climate risks, according to a study by the American Meteorological Society (AMS) Policy Program. <a href="financial-decision-makers-need-climate-information-to-manage-risks">Read More</a></p>
<h4><a href="climate-change-losses-cost-200-billion-over-last-decade">Climate Change Losses Cost $200 Billion Over Last Decade</a></h4>
<p>Economic losses from extreme weather events have risen from an annual global average of about $50 billion in the 1980s to close to $200 billion over the last decade, according to the report released by the World Bank. <a style="color: #0091b5; font-family: Arial, Helvetica, sans-serif; font-size: 13px;" href="climate-change-losses-cost-200-billion-over-last-decade">Read More</a></p>
<h4><a href="90-firms-responsible-for-two-thirds-of-emissions">90 Firms Responsible for Two-Thirds of Emissions</a></h4>
<p>Just 90 companies, including ChevronTexaco, ExxonMobil and BP, are responsible for causing almost two-thirds of all man-made global emissions during the industrial era, according to research by the Climate Accountability Institute. <a href="90-firms-responsible-for-two-thirds-of-emissions">Read More</a></p>
<h4><a href="typhoon-haiyan-must-spur-action-at-un-climate-talks">Typhoon Haiyan Must Spur Action at UN Climate Talks</a></h4>
<p>Governments across the world were told that Typhoon Haiyan, which hit the Philippines in November 2013, must act as a "wake-up call" on the dangers of climate change. <a href="typhoon-haiyan-must-spur-action-at-un-climate-talks">Read More</a></p>
<h4><a href="sustainability-leads-to-cost-savings-revenue-growth">Sustainability Leads to Cost Savings, Revenue Growth</a></h4>
<p>Sustainability programs are producing cost savings, revenue growth, competitive advantage and environmental benefits across corporate America, writes Harold L. Sirkin, a senior partner of the Boston Consulting Group (BCG). <a href="sustainability-leads-to-cost-savings-revenue-growth">Read More</a></p>
<h4><a href="water-risks-to-us-companies-are-becoming-more-acute-deloitte">Water Risks to US Companies are Becoming more Acute: Deloitte</a></h4>
<p>Water security risks are increasing and will significantly impact business continuity if left unaddressed, according to the CDP U.S. Water Report 2013, prepared by Deloitte. Even as water risks become more acute, the majority of Standard &amp; Poor&rsquo;s 500 index (S&amp;P 500) companies facing water risks lack strategic plans to adequately address these risks. <a href="water-risks-to-us-companies-are-becoming-more-acute-deloitte">Read More</a></p>
<h4><a href="nyc-restaurants-divert-2-500-tons-of-food-waste">NYC Restaurants Divert 2,500 Tons of Food Waste</a></h4>
<p>New York City restaurants have diverted more than 2,500 tons of food waste from landfills in the past six months, the Associated Press reports. <a href="nyc-restaurants-divert-2-500-tons-of-food-waste">Read More</a></p>
<h4><a href="guide-helps-businesses-become-more-resource-efficient">Guide Helps Businesses Become More Resource Efficient</a></h4>
<p>LRS Consultancy and UK law firm Burges Salmon have published a guide to give businesses practical guidance on how to become more resource efficient. <a href="guide-helps-businesses-become-more-resource-efficient">Read More</a></p>
<h4><a href="food-waste-cost-uk-hospitality-food-service-sector-4-1-billion">Food Waste Cost UK Hospitality, Food Service Sector $4.1 Billion</a></h4>
<p>Food waste cost the UK hospitality and food service sector &pound;2.5 billion ($4.1 billion) in 2011, according to a report by the Waste and Resources Action Programme (WRAP). <a href="food-waste-cost-uk-hospitality-food-service-sector-4-1-billion">Read More</a></p>
<h4><a href="extreme-weather-is-proving-costly-for-china">Extreme Weather is Proving Costly for China</a></h4>
<p class="clearfix"><img class="pull-left mr15 mb15" src="http://cdn2.hubspot.net/hub/147290/file-446101007-jpg/extreme-weather-is-proving-costly-for-china.jpg" alt="" />China&rsquo;s extreme weather conditions has caused an average of more than 2,000 deaths and up to CNY200 billion (USD32.8 billion) of direct economic loss every year since the 1990s, according to Beijing's latest report on the nation's climate change strategies. <a href="extreme-weather-is-proving-costly-for-china">Read More</a></p>
<h4><a href="philippine-doj-backs-adoption-of-green-building-code">Philippine DOJ Backs Adoption of Green Building Code</a></h4>
<p>The Philippines Department of Justice (DOJ) has approved the Department of Public Works and Highways (DPWH) addition of green-building regulations in the National Building Code of the Philippines (NBCP). <a href="philippine-doj-backs-adoption-of-green-building-code">Read More</a></p></div></div>
</div>
