...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CPCECB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CPCECB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CPCECB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CPCECB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CPCECB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CPCECB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CPCECB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span> Cities Pledge Carbon Emissions Cuts from Buildings</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Cities Pledge Carbon Emissions Cuts from Buildings</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/30/10-cities-pledge-carbon-emissions-cuts/" target="_blank">Environmental Leader</a>, Published 30 January 2014</em></p>
<p>Mayors from 10 major US cities pledged to boost the&nbsp;<a href="http://www.environmentalleader.com/category/energy-efficiency/" target="_blank">energy efficiency</a>&nbsp;in their buildings as part of an initiative to cut a combined 5 to 7 million tons of&nbsp;<a href="http://www.environmentalleader.com/category/carbon-footprint/" target="_blank">carbon emissions</a>&nbsp;annually.</p>
<p>The total annual emissions reduction goal is equivalent to the amount of electricity used by 700,000 to nearly 1 million American homes each year, according to the&nbsp;Natural Resources Defense Council. If successful, the 10 participating cities will lower energy bills by nearly $1 billion annually.</p>
<p>The cities are Atlanta,&nbsp;<a href="http://www.environmentalleader.com/tag/boston/" target="_blank">Boston</a>,&nbsp;<a href="http://www.environmentalleader.com/tag/chicago/" target="_blank">Chicago</a>,&nbsp;<a href="http://www.environmentalleader.com/tag/denver/" target="_blank">Denver</a>, Houston, Kansas City,&nbsp;<a href="http://www.environmentalleader.com/tag/los-angeles/" target="_blank">Los Angeles,</a> Orlando, <a href="http://www.environmentalleader.com/tag/Philadelphia/" target="_blank">Philadelphia&nbsp;</a> and Salt Lake City.</p>
<p>The cities will pursue the goal under the City Energy Project, an initiative from the&nbsp;<a href="http://www.environmentalleader.com/tag/nrdc/" target="_blank">NRDC</a>&nbsp;and the Institute for Market Transformation designed to create healthier, more prosperous cities by targeting buildings, their largest source of energy use and&nbsp;<a href="http://www.environmentalleader.com/category/climate/" target="_blank">climate</a>&nbsp;pollution.</p>
<p>Each city will develop its own locally tailored plan to advance energy efficiency and reduce waste in large buildings. CEP will offer its energy expertise to guide cities through the plan, design and implementation phases of the initiative.</p>
<p>CEP says the energy efficiency solutions will promote efficient building operations, encourage private investment, promote transparency and push cities to focus on municipal buildings.</p>
<p>Buildings are the largest single source of US carbon emissions, representing 40 percent nationwide, largely due to their electricity consumption, NRDC says. At the city level, more than half of carbon emissions from buildings. In some cities, as much as 75 percent come from buildings.</p>
<p>New York has reduced its greenhouse gas&nbsp;<a href="http://www.environmentalleader.com/category/emissions/" target="_blank">emissions</a>&nbsp;19 percent since 2005 as part of former Mayor&nbsp;<a href="http://www.environmentalleader.com/tag/bloomberg/" target="_blank">Michael Bloomberg"s</a> <a href="http://www.environmentalleader.com/2011/04/26/nyc-seeks-30-ghg-reduction-in-updated-plan/" target="_blank">PlaNYC strategy</a>, which called on the city to reduce emissions 30 percent by 2030 through 132 initiatives including making municipal buildings more energy efficient.</p>
<p>The CEP initiative will be funded by a partnership with Bloomberg Philanthropies, the Doris Duke Charitable Foundation and the Kresge Foundation.</p></div></div>
</div>
