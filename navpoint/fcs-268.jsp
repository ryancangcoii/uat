...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_EMP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_EMP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_EMP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_EMP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_EMP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_EMP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_EMP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Energy Management Predictions</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Management Predictions</h1>
<p><em>From <a href="http://www.energymanagertoday.com/energy-management-predictions-for-2014-098412/" target="_blank">Energy Manager Today</a>, Published 31 January 2014</em></p>
<p>​In its new report &ldquo;<a href="http://www.verdantix.com/index.cfm/papers/Products.Details/product_uuid/DCE7A8AF-97E2-F4FA-731D0A00EE74D73C" target="_blank">Ten Predictions For Energy Management in 2014</a>,&rdquo; Verdantix says building energy management will explode in Japan. With all 54 of Japan&rsquo;s nuclear power stations still offline in December 2013, the Japanese government is promoting energy efficiency and utility demand response programs to temper increased fossil fuel imports.</p>
<p>Other key energy management trends that will impact commercial, industrial and utility sectors in 2014 and beyond, according to Verdantix, include:</p>
<ul>
<li class="first">Firms will power ahead with on-site solar electricity generation. In 2014 long-term financial savings, power reliability and reputational benefits will drive commercial and industrial firms to increase their proportion of renewable energy generated on site.</li>
<li>Building control systems will integrate with lighting control systems. Historically, building control applications have been HVAC-centric, since heating and cooling were the elements of the building where controls could provide the most value. In 2014 building management systems will integrate with more types of control systems &ndash; particularly lighting control systems &ndash; due to advances in open and wireless communication protocols and the growing installation of&nbsp;<a href="http://www.energymanagertoday.com/tag/led/" target="_blank">LED lighting</a>.</li>
<li class="last">Large-scale battery energy storage will gain access to broader energy markets. Large-scale energy storage has been under development for several decades, but apart from pumped hydroelectric storage it has largely been a market defined by government-funded pilots. Verdantix predicts increased use of energy storage for frequency regulation, particularly in the US, where more Independent System Operators (ISOs) and Regional Transmission Organizations (RTOs), such as those in Texas, are joining PJM to implement the 2011 FERC Order 755. This order rewards resources, including batteries and flywheels, which can react to grid signals at short notice.</li>
</ul></div></div>
</div>
