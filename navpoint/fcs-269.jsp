...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_PGEXNCLI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_PGEXNCLI10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_PGEXNCLI@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_PGEXNCLI10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_PGEXNCLI10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_PGEXNCLI10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_PGEXNCLI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>PG&E, Xerox on Natural Capital Leaders Index</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>PG&amp;E, Xerox on Natural Capital Leaders Index</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/03/pge-xerox-on-natural-capital-leaders-index/" target="_blank">Environmental Leader</a>, Published 03 February 2014</em></p>
<p>​Carnival, &nbsp;Kimberly-Clark, Intel, PG&amp;E and Xerox are among 34 companies named to the Natural Capital Leaders Index, which recognizes companies that have grown their revenue between 2008 and 2012 while reducing their environmental impacts during that same period.</p>
<p>The index also includes a separate list of efficiency leaders &mdash; companies that use the least&nbsp;<a href="http://www.environmentalleader.com/tag/natural-capital/" target="_blank">natural capital</a>&nbsp;to generate revenue compared to their sector peers. The efficiency leaders include <a href="http://www.environmentalleader.com/tag/bmw/" target="_blank">BMW</a>,&nbsp;<a href="http://www.environmentalleader.com/tag/ford/" target="_blank">Ford</a>, Manpower, Sprint,&nbsp;<a href="http://www.environmentalleader.com/tag/ebay/" target="_blank">eBay</a>, Fluor and&nbsp;<a href="http://www.environmentalleader.com/tag/adobe/" target="_blank">Adobe Systems</a>.</p>
<p>The&nbsp;<a href="http://www.trucost.com/naturalcapitalleadersindex" target="_blank">Natural Capital Leaders Index</a>, launched this year, was released along with the 2014 State of Green Business report. The seventh annual report found that although more companies are undertaking initiatives to reduce their environmental impacts, there is little progress to show for it.</p>
<p>A&nbsp;<a href="http://www.trucost.com/_uploads/downloads/TheMaterialityReport.pdf" target="_blank">Materiality Report</a>, designed to help companies learn how to use data to find actionable business insights, and a&nbsp;<a href="http://www.trucost.com/natural-capital-benchmarking-report" target="_blank">Natural Capital Benchmark report</a>, which provides&nbsp;<a href="http://www.environmentalleader.com/category/sustainability/" target="_blank">sustainability</a> metrics and environmental performance insights for companies and sectors, was released alongside the index and state of green report.</p>
<p>The report also names 10 sustainable business trends for 2014, including an increase in collaboration among big corporations to solve sustainability challenges, the growth of chemical transparency for consumer products and net positive buildings.</p>
<p>Last month,&nbsp;<a href="http://www.environmentalleader.com/tag/microsoft/" target="_blank">Microsoft&rsquo;s</a>&nbsp;chief environmental strategist Robert Bernard forecast that 2014 will see&nbsp;a transformation in the&nbsp;<a href="http://www.environmentalleader.com/2014/01/09/microsoft-predicts-ict-as-sustainability-strategy-in-2014/" target="_blank">role of information and communications technologies</a>&nbsp;in sustainability, including improved modeling and new ways to measure natural capital.</p>
<p>Valuing natural capital can be difficult to measure and price accurately. In 2014, there will be a shift in the approach of enterprises, governments and NGOs to find more sophisticated ways to leverage data and better understand the real value of their&nbsp;natural capital, Bernard said.</p></div></div>
</div>
