...
<section  ><%-- Widget fcs.pages.solutions_service@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_reprographics.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <span>By Service</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Ensure the success of your sustainability, management efforts</h3>
<p>If sustainability is one of your organization&rsquo;s initiatives or you are looking to ensure environmental compliance as you grow your operations, you deserve the best support and advice to make sure you succeed in these efforts. FirstCarbon Solutions has developed a broad menu of services to address your sustainability and energy and environmental management issues:</p>
<ul>
<li><a href="/ttsvr/solutions/by-service/consulting">Consulting</a></li>
<li><a href="/ttsvr/solutions/by-service/software">Software</a></li>
<li><a href="/ttsvr/solutions/by-service/reprographics">Reprographics</a></li>
<li><a href="/ttsvr/solutions/by-service/data-processing">Data Processing</a></li>
</ul>
<p>As industries adopt more sustainable practices &amp; technologies while adjusting to new standards and regulations, FirstCarbon Solutions understands the enormous challenges you face. Our solutions are customized to fully meet your requirements, accomplish the tasks cost-effectively and produce the results you need to meet your goals. These solutions also are integrated and delivered by some of the best energy management consultants, technical experts and environmental specialists in your industry, so you have confidence that your programs and projects will be completed with excellence.</p>
<h3>All the right tools and services under one roof</h3>
<p>FirstCarbon Solutions is a one-stop provider of comprehensive and cost-effective services to put all your worries to rest. Whatever you need --be it a professional guidance, software tools or support services-- FirstCarbon Solutions has what you need to put you on the path to sustainable profitability and operational efficiency.</p>
<p>The next time you&rsquo;re in need of services to handle either a minor project or a very important business initiative, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
