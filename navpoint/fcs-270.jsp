...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FCCGHGEPACP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Firms Cut Costs, GHGs with EPA Climate Programs</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Firms Cut Costs, GHGs with EPA Climate Programs</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/03/firms-cut-costs-ghgs-with-epa-climate-programs/" target="_blank">Environmental Leader</a>, Published 03 February 2014</em></p>
<p>​<img class="img-responsive" src="http://cdn2.hubspot.net/hub/147290/file-571561045-jpg/images/summary-of-OAP-Climate-Production-2.jpg" alt="" /></p>
<p>US businesses prevented 365 million metric tons of greenhouse gas&nbsp;<a href="http://www.environmentalleader.com/category/emissions/" target="_blank">emissions</a>&nbsp;in 2012 by partnering with the EPA on&nbsp;<a href="http://www.environmentalleader.com/category/climate/" target="_blank">climate</a> protection programs, the agency says.</p>
<p>According to the&nbsp;<a href="http://www.energystar.gov/about/sites/default/uploads/files/2012_AnnualReport_Final.pdf?3cd5-e266" target="_blank">EPA&rsquo;s annual Climate Protection Partnerships report</a>, some 21,000 organizations across the US have cut their greenhouse gas emissions and saved money by participating in the agency&rsquo;s programs.</p>
<p>The EPA&rsquo;s Energy Star program, for example, resulted in $7.5 billion in economic benefits for buildings in 2012, while the agency&rsquo;s methane programs provided $4.6 billion in annual economic benefits (<em>see chart</em>).</p>
<p>Earlier this week,&nbsp;<a href="http://www.environmentalleader.com/2014/01/28/google-ranks-sixth-for-green-power-purchases/" target="_blank">Google</a>&nbsp;debuted at no. 6 in the&nbsp;<a href="http://www.epa.gov/greenpower/toplists/top100.htm" target="_blank">EPA&rsquo;s Green Power Partner</a>&nbsp;rankings of the top clean electricity purchasers in the nation. The tech company uses more than&nbsp;737 million kilowatt-hours of green power a year, or 32 percent of its total electricity use, most supplied by two 20-year bundled power purchase agreements.</p></div></div>
</div>
