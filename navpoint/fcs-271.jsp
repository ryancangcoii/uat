...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CCWC2435Market@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CCWC2435Market10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CCWC2435Market@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CCWC2435Market10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CCWC2435Market10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CCWC2435Market10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CCWC2435Market@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <span>Newsletters</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Capture &lsquo;Would Create a $24.5bn to $35bn Market&rsquo;</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/04/carbon-capture-would-create-a-24-5bn-to-35bn-market/" target="_blank">Environmental Leader</a>, Published 04 February 2014</em></p>
<p>Carbon capture and storage (CCS) technology in the UK would generate jobs and create a market worth &pound;15 billion ($24.5 billion) to &pound;35 billion ($57 billion) by 2030, according to a joint report by the Trades Union Congress (TUC) and the Carbon Capture and Storage Association (CCSA).</p>
<p>The report, <a href="http://www.ccsassociation.org/index.php/download_file/view/748/76/" target="_blank">The Economic Benefits of CCS in the UK</a>, says the government should take action to boost CCS &mdash; and the economy.</p>
<p>Key findings include:</p>
<ul>
<li><a href="http://www.environmentalleader.com/category/carbon-capture/" target="_blank">Carbon capture</a> and storage can play a vital role in helping the UK meet its statutory target to reduce greenhouse gas <a href="http://www.environmentalleader.com/category/emissions/" target="_blank">emissions</a> by 80 percent by 2050. It estimates that without CCS, the cost of meeting this target will rise by &pound;30 billion ($49 billion to &pound;40 billion ($65 billion) per year.</li>
<li>Inclusion of CCS in the mix of low-carbon technologies would result in a 15 percent reduction in wholesale electricity prices.</li>
<li>Each new-build CCS power plant would generate between 1,000 and 2,500 jobs in construction, with a further 200 to 300 jobs in operation, maintenance and the associated supply chain.</li>
<li>CCS could help the UK to retain existing industries, such as <a href="http://www.environmentalleader.com/category/coal/" target="_blank">coal</a> and gas power generation, and support energy-intensive industries (such as <a href="http://www.environmentalleader.com/category/chemicals/" target="_blank">chemicals</a>, steel and cement manufacture) which employ 800,000 people directly and in supply chains.</li>
<li>The total economic benefits of CCS could reach &pound;2 billion ($3 billion) to &pound;4 billion ($6.5 billion) per year by 2030.</li>
</ul>
<p>In the US, the Department of Energy has made available <a href="http://www.environmentalleader.com/2013/12/13/8b-available-for-carbon-capture-other-advanced-fossil-energy-projects/" target="_blank">$8 billion in loan guarantee authority</a> to support advanced fossil energy projects including carbon capture and storage that avoid, reduce or sequester greenhouse gases. The first deadline for applications is Feb. 28.</p></div></div>
</div>
