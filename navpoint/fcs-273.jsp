...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FSMPSSNR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_FSMPSSNR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_FSMPSSNR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FSMPSSNR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_FSMPSSNR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FSMPSSNR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FSMPSSNR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Firms are Struggling to Make Progress on Sustainability, Says New Report</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Firms are Struggling to Make Progress on Sustainability, Says New Report</h1>
<p><em>From <a href="http://www.edie.net/news/5/Firms-are-struggling-to-make-progress-on-sustainability--says-new-report/" target="_blank">Edie Energy</a>, Published 07 February 2014</em></p>
<p>​Companies across the globe are struggling to make progress on climate change, resource efficiency and natural capital dependency, according to new research. </p>
<p>The '2014 State of Green Business' report has been published by sustainability specialist Trucost and its media partner.&nbsp;</p>
<p>The seventh annual edition of the report, which measures the global progress of large, publicly traded companies in addressing a myriad of environmental challenges, reveals little meaningful progress across most metrics, including greenhouse gas emissions, water use, waste disposal and other pollutant impacts.</p>
<p>Trucost chief executive Richard Mattison added: &ldquo;According to the World Bank, we expect global economic growth of 3.3% to 2015, 3% from the US and 7.9% from China, a region that uses three times more natural resources than the rest of the world to create each unit of GDP. The environmental impacts of business &ndash; air pollution, biodiversity loss, ecosystem degradation and water scarcity &ndash; are threatening the ability of our finite stock of natural capital to deliver sustainable growth.&nbsp;</p>
<p>&ldquo;The challenge for sustainable business is to identify growth models that result in reduced environmental impact.&rdquo;</p>
<p>The 2014 report includes the launch of the Natural Capital Leaders Index, a new methodology for identifying companies that are growing their revenue while reducing their environmental impacts. The 2014 Index found 34 companies from 10 countries that met Trucost&rsquo;s criteria, which include increasing revenue between 2008 and 2012, disclosure of greenhouse gas emissions and a decrease in environmental impacts during that same period.</p>
<p>Among the 34 &ldquo;decoupling leaders&rdquo; [increasing revenue while decreasing natural capital impacts] over the most recent five year period are Carnival Corp., CSX, Intel, Kimberly-Clark, National Australia Bank, Pearson, Tata Power and Verizon.</p>
<p>The Index further identifies US and global &ldquo;efficiency leaders&rdquo; that use the least natural capital to generate revenue compared to sector peers &ndash; the more traditional sustainability leaders &ndash; which include Adobe Systems, AMEC, BMW, Ford, Manpower, McGraw Hill Financial, Pepco Holdings and Sprint Corp.</p>
<p>The report also names the ten sustainable business trends for 2014. Among them are the growth of collaboration among big corporations to solve mutual sustainability challenges, the growth of chemical transparency for consumer products, the emergence of &ldquo;shadow pricing&rdquo; as a means for companies to assess their environmental risks and net-positive buildings.</p>
<p>The metrics from the report were drawn from Trucost's assessment of 4,600 of the world&rsquo;s largest companies representing 93% of global markets by market capitalisation.</p></div></div>
</div>
