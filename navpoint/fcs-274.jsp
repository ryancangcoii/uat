...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CEFTSY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CEFTSY10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CEFTSY@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CEFTSY10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CEFTSY10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CEFTSY10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CEFTSY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Carbon Emissions Fall for Third Straight Year</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Emissions Fall for Third Straight Year</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/07/carbon-emissions-fall-for-third-straight-year/" target="_blank">Environmental Leader</a>, Published 07 February 2014</em></p>
<p>​Greenhouse gas <a href="http://www.environmentalleader.com/category/emissions/" target="_blank">emissions</a> fell in the nine states that participate in a northeast carbon trading market by 6 percent in 2013. The states in the Regional Greenhouse Gas Initiative (<a href="http://www.environmentalleader.com/tag/rggi/" target="_blank">RGGI</a>) were helped by mild temperatures and the greater use of natural gas for power generation.</p>
<p>Carbon emissions in the region were down for a third straight year, to 86 million short tons from 92 million tons. Electricity use declined in four of the nine member states, according to the program&rsquo;s emission allowances tracking system.</p>
<p>The nine states &mdash; Connecticut, Delaware, Maine, Maryland, Massachusetts, New Hampshire, New York, Rhode Island and Vermont &mdash; last month approved a change to the program from 2014 that would cap emissions at 91 million tons, <a href="http://www.environmentalleader.com/2014/01/14/rggi-states-drop-carbon-emissions-cap-45/" target="_blank">a 45 percent reduction</a> from the original cap, to encourage more trading.</p>
<p>The five-year-old cap-and-trade market has been plagued by excess carbon permits due to abundant supplies of natural gas, improved energy efficiency and lower demand caused by the economic slump.</p></div></div>
</div>
