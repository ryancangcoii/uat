...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_UKECSGSCY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_UKECSGSCY10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_UKECSGSCY@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_UKECSGSCY10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_UKECSGSCY10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_UKECSGSCY10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_UKECSGSCY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>UK's Environmental Consultancy Sector Grows for Second Consecutive Year</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>UK's Environmental Consultancy Sector Grows for Second Consecutive Year</h1>
<p><em>From <a href="http://www.edie.net/news/6/UK-s-environmental-consultancy-sector-grows-for-second-consecutive-year-/" target="_blank">Edie Energy</a>, Published 10 February 2014</em></p>
<p>​The UK environmental consultancy (EC) sector continues to expand, increasing by 6.1% in 2012 to &pound;1.3bn, according to a new report.&nbsp;</p>
<p>Environment Analyst (EA), a business intelligence and market research firm, said the performance was "impressive" given that the UK economy recovered only slightly with real GDP growing by 0.2% in 2012.</p>
<p>According to the EA's report, growth across the sector is far from uniform with the impact of government spending cuts continuing to be felt.</p>
<p>In 2012, there was a 1.7% reduction in EC revenues from public sector commissioning bodies to stand at &pound;335.5m, equivalent to 25.1% of the total market.</p>
<p>Overall, the government sector is 19% down on what it was worth to environmental consultancies in 2009.</p>
<p>Author of the report Liz Trew said: "Consultancies that are strongly reliant on public sector sourced work continue to come under significant pressure and will need to diversify in order to survive."</p>
<p>However, the public sector decline was more than offset by increased spend from within the private sector and regulated industries, which together saw a solid growth rate of 9.0% in 2012 to reach &pound;998.6m, equivalent to 75% of the total UK EC market.</p>
<p>Total growth in the sector for 2012 follows a rise of 4.5% in 2011, after two consecutive years of significant declines at the height of recession.</p>
<p>In terms of specific service lines, the report finds that three core EC practice areas in particular stand out for their strong growth in 2012: contaminated land/remediation with a year-on-year increase of 7.4%; ecological/landscape services up 8.0% and environmental impact assessment (EIA) / sustainable development up 23.1%.</p>
<p>There are currently more than 646 such projects in the pipeline worth more than &pound;375bn, according to the latest government figures.</p>
<p>According to the EA's projections, overall growth is expected to continue into 2013 but at a slightly lower rate of 3.4%.</p>
<p>Trew adds: "Although there are still significant uncertainties - whether economic growth will be sustained and issues relating to the government's wavering support for green regulation and renewables - the fact that there have been two years of stable growth with specific areas forging ahead with some impressive growth rates against the climate of austerity, bodes well for the UKEC sector's performance over the next few years."</p>
<p>The report also highlights new market opportunities, and points to the UK's shale gas industry in particular, which it says "comes with a whole host of as yet poorly understood environmental risks that need to be assessed, monitored and mitigated - offering potentially rich pickings for environmental consultants".</p></div></div>
</div>
