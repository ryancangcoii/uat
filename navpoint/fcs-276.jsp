...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_GRIAG4R@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_GRIAG4R10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_GRIAG4R@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_GRIAG4R10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_GRIAG4R10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_GRIAG4R10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_GRIAG4R@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span> GRI Adds to G4 Resources</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>GRI Adds to G4 Resources</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/10/gri-adds-to-g4-resources/" target="_blank">Environmental Leader</a>, Published 10 February 2014</em></p>
<p>​The Global Reporting Initiative has launched a G4 Content Index Tool and a G4 Brochure for New Reporters. The two latest resources are intended to help companies prepare sustainability reports using the&nbsp;<a href="http://www.environmentalleader.com/2013/05/22/gri-releases-latest-guidelines/" target="_blank">latest generation of GRI&rsquo;s sustainability reporting guidelines, G4</a>.</p>
<p>The inclusion of a Content Index in a GRI-based report is a key requirement for both Core and Comprehensive &lsquo;in accordance&rsquo; options of the G4 Guidelines. GRI has created a new Content Index Tool that can be used in conjunction with the G4 Guidelines. The guidelines enable&nbsp;stakeholders and report readers to get a quick overview of the report.</p>
<p>A new G4&nbsp;<a href="https://www.globalreporting.org/resourcelibrary/GRI-An-introduction-to-G4.pdf" target="_blank">brochure</a>&nbsp;for use by those new to sustainability reporting and/or GRI, is now available. The brochure provides a brief introductory overview of G4 and the GRI Framework in general, and guides new reporters on how to get started on their sustainability reporting.</p></div></div>
</div>
