...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_GBWS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_GBWS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_GBWS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_GBWS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_GBWS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_GBWS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_GBWS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Green Builders Weather Storms</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Green Builders Weather Storms</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/11/green-builders-weather-storms/" target="_blank">Environmental Leader</a>, Published 11 February 2014</em></p>
<p>​<a href="http://www.environmentalleader.com/?s=green+building" target="_blank">Green homes</a>&nbsp;comprised 23 percent of the overall residential construction market in 2013 and are expected to grow to between 26 percent and 33 percent of the market by 2016.</p>
<p>The housing slump in recent years didn&rsquo;t stop the green building movement, in fact, indications are that segment accelerated. According to McGraw Hill Construction research dating back to 2006, builders experienced in green remained in business at higher proportions than those not knowledgeable about energy-efficient and green home building.</p>
<p>The trend will continue, as<a href="http://www.environmentalleader.com/2014/02/03/help-for-multifamily-building-owners-to-cut-carbon-pollution/" target="_blank">&nbsp;green home construction</a>&nbsp;over three years is expected to grow from $36 billion in 2013 to $83-$105 billion in 2016, based on the current McGraw Hill Construction forecast for total residential construction.</p>
<p>McGraw Hill Construction released findings from a new Green Home Builders and Remodelers Study at the recent&nbsp;<a href="http://www.nahb.org/news_details.aspx?sectionID=148&amp;newsID=16636&amp;print=true" target="_blank">National Association of Home Builders&nbsp;</a>(NAHB) International Builders&rsquo; Show.</p>
<p>The study shows that the top drivers to increased green home building activity include changes in codes and regulations, better quality, wider availability and affordability of green products, energy costs, and competitive advantage.</p></div></div>
</div>
