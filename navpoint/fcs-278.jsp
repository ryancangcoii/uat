...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CRRFL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CRRFL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CRRFL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CRRFL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CRRFL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CRRFL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CRRFL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-263">March 2014 - How Leading Financial Firms Make It Into the World's 100 Most Sustainable Companies</a> &raquo; <span>Climate Risk Reporting Found Lacking</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Climate Risk Reporting Found Lacking</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/02/11/climate-risk-reporting-found-lacking/" target="_blank">Environmental Leader</a>, Published 11 February 2014</em></p>
<p>The majority of financial reporting on&nbsp;<a href="http://www.environmentalleader.com/category/climate/" target="_blank">climate</a>&nbsp;change is too brief and largely superficial, and most companies are failing to meet federal requirements,&nbsp;<a href="http://www.environmentalleader.com/tag/ceres/" target="_blank">Ceres</a>&nbsp;says.</p>
<p>The US Securities and Exchange Commission (SEC) has not adequately addressed the&nbsp;<a href="http://www.environmentalleader.com/2014/01/16/climate-change-major-investment-risk-figueres-says/" target="_blank">climate disclosure deficiencies</a>&nbsp;of publicly traded corporations, according to a report,&nbsp;<a href="https://www.ceres.org/press/press-releases/inadequate-action-by-securities-exchange-commission-on-climate-change-report-says" target="_blank"><em>Cool Response: The SEC and Climate Change Reporting.</em></a></p>
<p>The report is based on a survey of more than 40,000 SEC comment letters sent to companies in the last four years and an analysis of the state of S&amp;P 500 company reporting on climate disclosure through the end of 2013.</p>
<p>Over 100 institutional investors around the world representing $7.6 trillion in assets formally supported the guidance on climate risk in 2010.</p>
<p>The report suggests the SEC:</p>
<ul>
<li>Issue more comment letters to companies with inadequate disclosure of material climate risks.</li>
<li>Focus on the adequacy of disclosures concerning recent, major regulatory developments.</li>
<li>Create a federal interagency task force focused on the business risks of climate change, and an SEC task force to focus on reviewing climate change disclosures.</li>
</ul></div></div>
</div>
