...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_HCSMEMSCPGCA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</h1>
<p>Supply chain has become a crucial and important part of large corporations&rsquo; wider sustainability strategies when it comes to addressing a number of concerns that threaten business operations. As big businesses now thrive and reap the fruits of sustainability efforts, similar expectations have funnelled down to small and medium sized enterprises (SMEs). This is turn, has increased supply chain pressures that include resource depletion and their stakeholders&rsquo; growing concern over corporate ethics and policies. In addition, these companies are receiving external pressures from customers who now &ldquo;demand&rdquo; to know more about their business, products, services and even corporate social responsibility initiatives.</p>
<p>In 2013, according to <a href="http://www.edie.net/news/5/Supply-chain-resource-risks-could-sound-death-knell-for-SMEs-/" target="_blank">Edie Energy</a>, small firms need to implement resource risk strategies or be at the mercy of supply chain pressures that could ultimately put them out of business. This year, a quarter of SMEs said that sustainability will be one of their top three priorities. This may be attributed to how SMEs see sustainability strategies (including those in the supply chain) really work for multinationals and big firms. To note, Zhihong Wang and Joseph Sarkis&rsquo; <a href="http://www.emeraldinsight.com/journals.htm?articleid=17098270&amp;show=abstract" target="_blank">Investigating the Relationship of Sustainable Supply Chain Management with Corporate Financial Performance</a>&nbsp;tracked&nbsp;411 companies from Newsweek&rsquo;s green ranking of the top 500 companies. They reported that firms with&nbsp;integrated sustainable&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-supply-chain" target="_blank">supply chain</a>&nbsp;management saw&nbsp;<a href="http://www.strategy-business.com/blog/For-Companies-Its-Not-Easy-Being-Green" target="_blank">&ldquo;marked upgrades&rdquo; in their fiscal returns</a>. However, to see the improvements, companies must patiently wait as the&nbsp;positive effects may take at least two years to take full effect.</p>
<p>Another survey focusing on SMEs - <a href="http://www.environmentalleader.com/2014/01/06/sustainability-helps-smes-cut-costs-increase-profitability/" target="_blank">the Maidenhead Advertiser</a>, reports on a survey conducted among SMEs about their sustainability practices. It highlighted that businesses have affirmed the overwhelming benefits of being sustainable. Accordingly, 87% of organizations that have implemented sustainable business practices say there are benefits such as reduced costs, increased profitability or positively affecting the environment.</p>
<p><strong>Sustainable Supply Chain and Sourcing: Sustainability Practices That Go Beyond Traditional &ldquo;Greening&rdquo; </strong></p>
<p>However, most businesses prefer to undertake &ldquo;traditional green activities&rdquo; that include <a href="http://www.environmentalleader.com/category/recycling/" target="_blank">recycling</a>&nbsp;and&nbsp;<a href="http://www.environmentalleader.com/category/energy-efficiency/" target="_blank">energy efficiency</a>. But these initiatives are undoubtedly immediate and short term efforts that yield far less impact when compared to broader sustainability practices.</p>
<p>The recent <a href="http://www.lloydsbankinggroup.com/media/pdfs/LTSB/2013/2712_SME_priority.pdf" target="_blank">Lloyds Bank Commercial Banking research</a> has found that SMEs are less likely to &ldquo;offer a clear business code of conduct (46%), work responsibly within a supply chain (42%) or operate an ethical sourcing policy (25%).&rdquo; The same report also mentioned that &ldquo;there are still businesses who do not believe there are any benefits to be gained from implementing such practices.&nbsp;&ldquo; <br /> <br /> According to<a href="http://www.lloydsbankinggroup.com/media/pdfs/LTSB/2013/2712_SME_priority.pdf" target="_blank"> Lloyds Banking Group's</a> external relations director, Stephen Pegge, sustainability for SMEs also means &ldquo;interacting with charities, social enterprises and the community in which they operate; working responsibly within their supply chain and engaging with the next generation through for example, apprenticeship schemes.&rdquo;</p>
<p>To create a sustainable supply chain management, experts within the company, with the help of external consultants, should analyze the supply chain process as a whole - breaking down each step, sub-process within a step process and raw materials needed to create the end product. It also means creating partnerships with suppliers. An analysis of the entire supply chain gamut will open opportunities to improve and impact both the company&rsquo;s economic and environmental goals.</p>
<p>What characterizes a sustainable supply chain and sourcing process? It starts with a clear business code of conduct. It also means the business has to work responsibly within a supply chain and to operate an ethical sourcing policy.&nbsp; When all these actions are in place, a company&rsquo;s sustainable supply chain will not only help reduce costs and optimize operations, it will also analyze the environmental impacts of production, procurement and delivery of a product or even a service.</p>
<p><strong>What are the Emerging Trends </strong><strong>that will Incorporate Sustainability in Supply Chain Management in 2014?</strong></p>
<p>According to environmental experts Liz Gorman and Lesley Lammers, 2014 promises new trends. These <a href="http://www.csrwire.com/blog/posts/1152-looking-ahead-5-csr-trends-on-the-radar-for-2014" target="_blank">emerging trends on how to incorporate sustainability in supply chain management</a> can be considered and possibly implemented by SMEs.</p>
<p><strong>1. Search for Alternative Materials</strong></p>
<p>As natural resource depletion has become a major concern among businesses, the search for alternative materials has become a major priority as well. Companies must rely more heavily in Research and Development (R&amp;D) and product development to safeguard against the risk of natural resource depletion. This would mean challenging materials science and major thinking out of the box for product developers and sustainability professionals.</p>
<p>This issue has already started some breakthroughs in several organizations, including Nike which collaborated recently with NASA to locate the most innovative textile fabricators it could find. Telecommunications giant Sprint, on the other hand, has turned to biomimicry to rethink its packaging design&mdash;it has partnered with the San Diego Zoo's centre for bio-inspiration for this pioneering project.</p>
<p><strong>2. Supply Chain Transparency</strong></p>
<p>Public trust has become a concern as well and gave rise to product transparency most especially in the food sector. More progressive food companies have decided to share more factual information about what's in their product and this is expected to echo widely in the coming months, thus placing greater pressure on conventional food firms to follow suit.</p>
<p><strong>3. Employee Engagement</strong></p>
<p>To strengthen a CSR initiative, it is highly recommended to start with the employee &ndash; your employees. Companies admit that to reduce their environmental impacts and retain healthy profit margins, it has to get the nod of its own people who will bring the CSR and their product or service right into their homes and communities.</p>
<p>To creatively engage their employees, some companies have turned to easy, fun and personalized activities such as the use of gamification and micro-volunteerism.</p>
<p>Micro-volunteerism has been popularly used by companies for years but gamification has emerged fairly recently as it engages staff through the use of game design - now a popular human resource tool due to its ability to change employee behaviour in a meaningful way.</p>
<p>For example, SMEs with products containing organic ingredients may run a &ldquo;create your own recipe promo&rdquo; among its employees to help promote their featured products. Winning entries can be part of the product&rsquo;s packaging and shared with customers&mdash;thereby encouraging more product usage within the company&rsquo;s employees and their families and friends.</p>
<p><strong>Let Customers Know Your Supply Chain Sustainability Initiative as a CSR and Make it Work!</strong></p>
<p>As more and more consumers worldwide are likely to switch to brands that are associated with a good or worthy cause, given the same price range and quality, CSR is a powerful differentiator that changes the mindset and behavior of consumers and in total, their perception towards the company or the brand itself. Hence, a company&rsquo;s supply chain sustainability initiative can be used to increase brand value that will in turn, generate more demand for the product, reduce corporate risks and increase business earnings. &nbsp;How then can companies take advantage of this?</p>
<p>Content is king. So, companies, including SMEs, should make sure their CSR is:</p>
<ul>
<li><strong>Seen and Heard &ndash;</strong> Define your CSR and say how it impacts the company, its own people, its customers and even the community. All these should be communicated to the target audience (the customers) to begin with.</li>
<li><strong>Made Personal &ndash; </strong>Make your Corporate Social Responsibility your Customer&rsquo;s Social Responsibility. Your customer&rsquo;s affinity to your cause generates trust and adds credibility to your brand.</li>
<li><strong>Monitored and Shared &ndash; </strong>Organizations should assess how well a company is doing on its sustainability efforts and report progress and returns back to its customers. The company should be consistent and transparent with results and their next steps. This transparency would show customers of the business organization&rsquo;s continuous commitment to its cause.</li>
</ul>
<p>Your media is just as important as your content, so businesses may opt to use any or all of the following communication channels:</p>
<ul>
<li><strong>Use Tri-Media - </strong>Traditional channels have remained the most effective means of communicating CSRs to consumers. These include messages in product packaging; releasing interviews and stories in local papers; and advertising on TV, radio and print media.</li>
<li><strong>Go Online! - </strong>The fourth media channel is the online channel which has given rise to new forms of media, such as corporate websites and social networking sites (SNS). Through these media (most especially the SNS), response to call-to-actions (CTAs) has become both instant and spontaneous. Positive feedbacks can range from generating a following for the company and/or the program by signing up; contributing directly to the projects through pledges, donations and the like; or sharing to friends who can join the &ldquo;cause&rdquo; with you.</li>
<li><strong>Are you Mobile? - </strong>Mobile communications is a fast-emerging way of reaching more and more consumers. With today&rsquo;s smartphones, your websites and blogs can be readily accessed by people on the move.</li>
<li><strong>Go-To-Market Promotions - </strong>Let customers know more about the company&rsquo;s sustainability initiatives through the company&rsquo;s own offices and/or stores. Tying up with relevant community projects can also help bring the message out to the market.</li>
</ul>
<p><strong>FCS can Help Improve your Supply Chain Management</strong></p>
<p><a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services" target="_blank">FirstCarbon Solutions</a> (FCS) can help organizations maximize their sustainability initiatives throughout the supply chain.</p>
<p>FCS offers lifecycle assessments, supplier scorecards, and carbon accounting to trace emission levels and inefficiencies across supply chains. Aside from cutting costs with FCS supply chain services, companies can also help expand profit margins along with inspiring product and supply chain redesign.</p>
<p>FCS also offers Sustainability Solutions to help companies effectively manage climate performance, carbon emissions, and corporate social responsibility (CSR) reporting through its strong partnership with CDP.</p>
<p>Through these services, FCS will provide SMEs with innovative solutions to track and measure their business inputs and outputs, in addition to the waste that they produce &ndash; allowing them to gain a <a href="http://www.theguardian.com/sustainable-business/sustainable-supply-chain-competitive-advantage" target="_blank">competitive advantage</a>.&nbsp;&nbsp;</p></div></div>
</div>
