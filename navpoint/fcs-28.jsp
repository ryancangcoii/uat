...
<section  ><%-- Widget fcs.pages.solutions_industry_associations@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_associations10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_associations.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_associations@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_associations10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_associations10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_associations.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_associations10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_associations@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Associations</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Management Program for Association Members</h1>
<h5>Offer your members valuable sustainability solutions that only larger companies have access to</h5>
<p>Members join associations for a variety of reasons, whether it&rsquo;s to keep up with the latest trends and ever-changing industry issues, networking with peers, or taking advantage of your organization&rsquo;s buying power with association-specific offers. By offering a wide range of events, programs, products and services, you ensure that you are providing diverse value and benefits across your membership.</p>
<p>Bringing best practices and sustainability leadership principles to organizations around the world is what FirstCarbon Solutions (FCS) is known for. We understand that sustainability goes beyond temporary gains in achievement scores to create lasting, meaningful improvements. Only FCS fully integrates consulting, software and data processing to provide your membership with elite comprehensive sustainability solutions that are only accessible to some of the largest companies in the world.</p>
<p><strong>Supporting your goals with exclusive association services</strong></p>
<p><em>New Sustainability Leaders</em> is a program we customize to the goals of your organization to ensure you are providing value and immediate benefit to your membership. Our worldwide experience with companies that have reported their sustainability and climate change performance, has armed FCS the skills, knowledge and experience needed to provide guidance and insights to your membership.</p>
<p>And, with our <em>New Sustainability Leaders</em> program, we work with you to tailor a sustainability program you can offer to your members across a number of services that matter most to your organization&rsquo;s membership, including:</p>
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/energy/energy-management"><em>ENERGY MANAGEMENT</em></a></p>
<ul>
<li>Energy and Utility Expense Management</li>
<li>Energy Efficiency Audits</li>
<li><a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">Utility Rebate and Incentive Processing</a></li>
<li>Energy Data Gathering and Standardization</li>
<li>Lighting Retrofits (LEDs)</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/supply-chain"><em>SUPPLY CHAIN MANAGEMENT</em></a></p>
<ul>
<li>Supply Chain / Scope 3 Inventory and Management</li>
<li>Supplier Scorecards</li>
<li>Supplier / Factory Audit Process Management</li>
<li>Supplier / Factory Remote Monitoring</li>
<li>Supplier CSR Engagement, Outreach &amp; Education Programs</li>
<li>Supply Chain Worker whistle-blower helplines</li>
<li>Supply Chain Networks Software</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/sustainability/carbon-management"><em>CARBON MANAGEMENT</em></a></p>
<ul>
<li>Carbon Inventory and Reporting</li>
<li>Carbon Reduction Projects</li>
<li>Carbon Tracking Software</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/environmental/water-management"><em>WATER AND WASTE MANAGEMENT</em></a></p>
<ul>
<li>Inventory</li>
<li>Minimization Projects</li>
<li>Tracking Software</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/sustainability"><em>SUSTAINABILITY/CSR MANAGEMENT</em></a></p>
<ul>
<li>Corporate Social Responsibility (CSR) Metrics Management, Reporting</li>
<li>Sustainability Management Systems</li>
<li>Life Cycle Assessments</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-service/data-processing"><em>DATA MANAGEMENT</em></a></p>
<ul>
<li>Data Collection</li>
<li>Data Management</li>
<li>Data Translation</li>
<li>Data Processing</li>
<li>Data Storage, Digitization &amp; Collection</li>
<li>Sustainability Workbench Software</li>
</ul>
</div>
<div class="col-lg-6 col-md-6 col-sm-6">
<p><a href="/ttsvr/solutions/by-focus/supply-chain"><em>SUPPLY CHAIN MANAGEMENT</em></a></p>
