...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SLSTRT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_SLSTRT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_SLSTRT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SLSTRT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_SLSTRT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SLSTRT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SLSTRT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Sustainability, Local Sourcing Top Restaurant Trends</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability, Local Sourcing Top Restaurant Trends</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/02/sustainability-local-sourcing-top-restaurant-trends/?graph=full&amp;id=1" target="_blank">Environmental Leader</a>, Published 02 January 2014</em></p>
<p>Locally sourced food, sustainability and waste reduction will be among the top <a href="http://www.environmentalleader.com/category/retail-restaurants/" target="_blank">restaurant</a>&nbsp;trends this year, according to a survey of about 1,300 US chefs.</p>
<p>The <a href="http://www.restaurant.org/Downloads/PDFs/News-Research/WhatsHot/What-s-Hot-2014.pdf" target="_blank">National Restaurant Association&rsquo;s What&rsquo;s Hot in 2014</a> survey ranks <a href="http://www.environmentalleader.com/category/sustainable-supply-chain/" target="_blank">locally sourced</a> meats and seafood, locally grown produce and environmental <a href="http://www.environmentalleader.com/category/sustainability/" target="_blank">sustainability</a> as the no. 1, no. 2 and no. 3 trends, respectively, that will be on restaurant menus in 2014.</p>
<p>Hyper-local sourcing, such as restaurant gardens, comes in at no. 6, while <a href="http://www.environmentalleader.com/tag/sustainable-seafood/" target="_blank">sustainable seafood</a> (no. 9) and nose-to-tail/root-to-stalk cooking (no. 11) &mdash; reducing food waste by using the entire animal or plant &mdash; also made the top 20 list.</p>
<p>The National Restaurant Association says local sourcing and environmental sustainability have been gaining momentum for several years, indicating that these wider themes influence the national culinary scene. Today&rsquo;s consumers want to know where their food comes from, says Hudson Riehle, senior vice president of the National Restaurant Association&rsquo;s research and knowledge group.</p>
<p>When asked which current food trend will be the hottest menu trends 10 years from now, environmental sustainability topped the list, followed by local sourcing, health-nutrition, children&rsquo;s nutrition and gluten-free cuisine.</p>
<p>Almost half (43 percent) of diners say they would <a href="http://www.environmentalleader.com/2013/08/20/diners-say-theyll-pay-more-for-sustainable-restaurant-meals/" target="_blank">pay up to 10 percent more for a meal in a sustainable restaurant</a>, according to a survey conducted in 2013 for the Sustainable Restaurant Association (SRA). The survey also found more than half of diners would pay a premium for their meal if they knew the restaurant was investing in reducing its environmental impact and taking its social responsibility seriously.</p>
<p>Manufacturers, wholesalers and retailers <a href="http://www.environmentalleader.com/2013/08/01/food-industry-sent-4-1b-pounds-of-waste-to-landfills-study-says/" target="_blank">threw away 4.1 billion pounds of food waste in 2011</a>, according to an assessment of data collected from the industry. The Food Waste Reduction Alliance, Grocery Manufacturers Association, the Food Marketing Institute and the National Restaurant Association conducted the study to provide a comprehensive assessment of the industry and to identify barriers to recycling food waste.</p></div></div>
</div>
