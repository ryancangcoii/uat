...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_NYCCGHGE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA_NYCCGHGE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA_NYCCGHGE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA_NYCCGHGE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA_NYCCGHGE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA_NYCCGHGE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_NYCCGHGE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>NYC Cuts GHG Emissions 19%</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>NYC Cuts GHG Emissions 19%</h1>
...
<p>The <a href="http://www.environmentalleader.com/category/emissions/" target="_blank">emissions</a> cuts put the city about two-thirds of the way to meeting the goal former mayor <a href="http://www.environmentalleader.com/tag/Michael-Bloomberg/" target="_blank">Michael Bloomberg</a> set five years ago. Bloomberg left the mayor&rsquo;s post yesterday after 12 years in office.</p>
<p>In 2007, <a href="http://www.environmentalleader.com/2011/04/26/nyc-seeks-30-ghg-reduction-in-updated-plan/" target="_blank">Bloomberg launched Plan NYC</a>, which called on the city to reduce emissions 30 percent by 2030 through a number of initiatives, such as requiring hybrid taxis and <a href="http://www.environmentalleader.com/2010/04/19/nyc-deploys-software-to-reduce-energy-use-carbon-emissions-in-govt-buildings/" target="_blank">making municipal buildings more energy efficient</a>, Reuters says.</p></div></div>
</div>
