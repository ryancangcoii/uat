...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FMCCSRGGB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_FMCCSRGGB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_FMCCSRGGB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FMCCSRGGB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_FMCCSRGGB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_FMCCSRGGB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_FMCCSRGGB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Firms Must Close CSR Gap to Grow Business</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Firms Must Close CSR Gap to Grow Business</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/03/how-to-close-the-csr-gap-grow-business/" target="_blank">Environmental Leader</a>, Published 03 January 2014</em></p>
<p>​Companies that close the gap between consumer expectations and perceptions of their corporate social responsibility work can positively transform their brand, according to Craig Bida, executive vice president of cause branding and nonprofit marketing for Cone Communications.</p>
<p>The public relations and marketing executive says&nbsp;<a href="http://www.mediapost.com/publications/article/216366/one-thing-that-really-matters-for-2014-closing-th.html" target="_blank">closing the CSR gap&nbsp;</a>&mdash; that gulf between what consumers think companies should do and what they think they actually do &mdash; is a valuable&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-strategy-leadership/" target="_blank">sustainable strategy</a>&nbsp;worth pursuing.</p>
<p>Cone Communications research found 93 percent of&nbsp;<a href="http://www.environmentalleader.com/category/us/" target="_blank">US</a> consumers expect companies to do more than just make money, but only 16 percent believe these companies have actually made a positive impact. Bida recommends to that to effectively close the CSR gap, management must first embrace consumer skepticism.</p>
<p>He suggests beginning by identifying key stakeholders, researching their needs, attitudes and barriers to belief. This step will allow companies to measure the extent of the CSR gap that exists for the brand or business. Once the gap has been assessed, companies should focus on a single issue that is relevant to their target audience and business to deliver the most meaningful impact.</p>
<p>Bida also recommends companies partner with leading nonprofits that will push for real outcomes and measure and report the results. For example,&nbsp;<a href="http://www.environmentalleader.com/tag/p&amp;g/" target="_blank">P&amp;G&rsquo;s</a>&nbsp;Pampers brand had focused on maternal/newborn tetanus for decades, but it wasn&rsquo;t until it partnered with UNICEF that the efforts began paying off, Bida says. Since 2006, Pampers brand has grown while funding more than 300 million vaccines and helping to eliminate maternal/newborn tetanus in eight countries.</p>
<p>Finally, Bida recommends companies improve how they share their CSR efforts with the public and emphasizes that transparency and authenticity is the best approach. Some 85 percent of consumers surveyed by Cone Communications say it&rsquo;s OK if companies aren&rsquo;t perfect as long as they&rsquo;re honest.</p>
<p>The 2013 Global CSR RepTrack 100 report, released in October, found 73 percent of global consumers are willing to recommend companies that are perceived to be <a href="http://www.environmentalleader.com/2013/10/17/which-companies-have-the-best-csr-reputation/" target="_blank">delivering on their CSR programs</a>. While consumer support for companies perceived to be socially responsible is strong, however, the number of companies believed to be actually delivering on their CSR programs dropped from 12 in 2012 to only five in the 2013 study.</p></div></div>
</div>
