...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_EEMFFBDC2014@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA_EEMFFBDC201410BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA_EEMFFBDC2014@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA_EEMFFBDC201410BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA_EEMFFBDC201410BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA_EEMFFBDC201410BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_EEMFFBDC2014@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Energy Efficiency Market Face Financing, Big Data Challenges in 2014</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Efficiency Market Face Financing, Big Data Challenges in 2014</h1>
<p><em>From <a href="http://www.energymanagertoday.com/energy-efficiency-market-has-promise-faces-hurdles-in-2014-097825/" target="_blank">Energy Manager Today</a>, Published 03 January 2014</em></p>
<p>​The efficiency industry, driven largely in 2013 by intelligent innovations such as energy management software and virtual audits, will face financing, big data, education and accountability hurdles this year, according to a survey of executives by GTM Research.</p>
<p>A range of efficiency executives speaking to GTM Research said better IT deployment, educating customers, creating better financing options and adjusting utility incentives will be critical to<a href="http://www.greentechmedia.com/articles/read/what-will-2014-bring-for-energy-efficiency" target="_blank">&nbsp;properly scale the efficiency market in 2014</a>.</p>
<p>Executives, including those from Johnson Controls, Vigilent and Retroficiency, pinpointed a number of trends to watch for in 2014 including continued momentum for PACE financing, better use of data, new approaches to equipment integration and operational savings versus equipment retrofits.</p>
<p>For example, Chuck McKinney of Aircuity told GTM Research that he sees airside energy efficiency, which will involve several strategies including natural ventilation and demand control ventilation, as the next big trend. Groom Energy&rsquo;s Paul Baier noted lighting controls and increased adoption of enterprise energy management software were examples of new approaches to equipment integration to watch for in 2014.</p>
<p>In 2013, the&nbsp;<a href="http://www.energymanagertoday.com/topic/conservation/energy-efficiency/" target="_blank">energy efficiency</a>&nbsp;market was buoyed by greater acceptance by large commercial customers, according to executives at Johnson Controls and Groom Energy. Executives from Aircuity and FirstFuel noted that better data and reporting helped the market, while Conservation Service Group CEO Stephen Cowell said technology and market convergence were responsible for growth.</p>
<p>The&nbsp;<a href="http://www.energymanagertoday.com/energy-efficiency-facilities-management-jobs-growing-097647/" target="_blank">sustainable energy sector is forecast to expand</a>&nbsp;in 2014 with job growth in the energy efficiency industry as well as the broader renewable energy umbrella, according to a report released in December by Ecotech Institute.</p>
<p>The&nbsp;Ecotech Institute&nbsp;<a href="http://www.ecotechinstitute.com/cleanjobsindex/" target="_blank">Clean Jobs Index&rsquo;s&nbsp;</a>&nbsp;data reveals a bright outlook in 2014 for cleantech leaders, educators, political leaders, students and job seekers.&nbsp;Energy efficiency jobs numbered about 6,600 posted on the index, and facility management had 6,470.</p></div></div>
</div>
