...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SHSMECCIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_SHSMECCIP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_SHSMECCIP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SHSMECCIP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_SHSMECCIP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SHSMECCIP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SHSMECCIP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Sustainability Helps SMEs Cut Costs, Increase Profitability</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Helps SMEs Cut Costs, Increase Profitability</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/06/sustainability-helps-smes-cut-costs-increase-profitability/" target="_blank">Environmental Leader</a>, Published 06 January 2014</em></p>
<p>​A quarter of small businesses say&nbsp;<a href="http://www.maidenhead-advertiser.co.uk/News/Business/Business-News/Small-and-medium-businesses-place-high-priority-on-sustainability-02012014.htm" target="_blank">sustainability ranks high on their priority list for 2014</a>&nbsp;and a third expect to increase their investment in sustainable business practices over the next five years, according to research by Lloyds Bank Commercial Banking.</p>
<p>The Maidenhead Advertiser reports that the UK bank surveyed small- and medium-sized enterprises (SME) about their&nbsp;<a href="http://www.environmentalleader.com/category/sustainability/" target="_blank">sustainability</a>&nbsp;practices and found more than half of those surveyed saw cost benefits of implementing such practices.</p>
<p>It also found 87 percent of businesses that have implemented sustainable business practices say there are benefits to this such as reduced costs, increased profitability or positively affecting the environment.</p>
<p>Most business, however, say they focus on &ldquo;traditional green activities&rdquo; such as&nbsp;<a href="http://www.environmentalleader.com/category/recycling/" target="_blank">recycling</a>&nbsp;and&nbsp;<a href="http://www.environmentalleader.com/category/energy-efficiency/" target="_blank">energy efficiency</a> as opposed to broader areas such as&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-supply-chain/" target="_blank">sustainable supply chains</a>&nbsp;and sourcing, according to the report.</p>
<p><a href="http://www.environmentalleader.com/2013/07/29/small-businesses-face-major-extreme-weather-challenges/" target="_blank">US small businesses</a>&nbsp;&mdash; which employ 60 million Americans, or about half of the workforce &mdash; are particularly at risk from extreme weather and climate change and must take steps to adapt, according to a July report from Small Business Majority (SBM) and the American Sustainable Business Council (ASBC).</p></div></div>
</div>
