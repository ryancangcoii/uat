...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_DCBME@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_DCBME10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_DCBME@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_DCBME10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_DCBME10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_DCBME10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_DCBME@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Data Centers Becoming More Efficient</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Data Centers Becoming More Efficient</h1>
<p><em>By William Opalka, <a href="http://www.energymanagertoday.com/data-centers-becoming-more-efficient-097843/" target="_blank">Energy Manager Today</a>, Published 06 January 2014</em></p>
<p>​Energy-efficient data centers will continue to demand attention in 2014, with high energy costs and government regulations and directives on measuring data center energy efficiency continuing to be prominent.</p>
<p>That&rsquo;s the view of Herman Chan, senior vice president of marketing &amp; general manager of DCIM (data center infrastructure management) at Raritan Inc., who discussed 2014 trends in <a href="http://www.ciol.com/ciol/features/205393/tech-treds-center-infrastructure-management" target="_blank">CIOL</a>.</p>
<p>DCIM provides valuable information on how to optimize data center power, cooling and physical space. Companies are embracing DCIM because information is readily available to help with capacity planning and troubleshooting, and to make informed decisions about equipment additions and changes.</p>
<p>Continued growth is expected in the nascent DCIM market, which may reach about $1 billion in 2016. Like most emerging markets, there have been many entrants, varied approaches and many views on market definition over the past several years.</p>
<p>Other trends observed are:</p>
<ul>
<li>Big data and cloud computing will continue to be the two transformational influences on data centers.</li>
<li>Cloud spending will surge by 25 percent in 2014, reaching over $100B, says research firm IDC. As a result, there will be a dramatic increase in the number of data centers to support growing cloud players.</li>
<li>The rising costs of energy, floor space, and operations and the increasing business demands on data centers will continue to drive the adoption of DCIM solutions that provide real-time visuals on what if going on in a data center &mdash; including views of all the equipment supporting a service application.</li>
<li>Running multi-million dollar data centers on spreadsheets and Visio have become impractical and ineffective as sites get larger and work processes get more complex. These tools can only take you so far in managing assets, capacity and change.</li>
</ul></div></div>
</div>
