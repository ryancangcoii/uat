...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_EEDI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_EEDI10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_EEDI@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_EEDI10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_EEDI10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_EEDI10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_EEDI@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Energy Efficiency Driving Innovation</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Efficiency Driving Innovation</h1>
<p><em>By William Opalka, <a href="http://www.energymanagertoday.com/energy-efficiency-driving-innovation-097839/" target="_blank">Energy Manager Today</a>, Published 06 January 2014</em></p>
<p>​Emphasis on energy efficient products over the next decade is expected to drive an expanding use of digital power management in applications such as DC-DC converters, says&nbsp;Reinhold Theurer, vice president EMEA in <a href="http://www.electronicsweekly.com/news/business/viewpoints/industry-rises-to-challenge-of-energy-efficiency-2013-12/" target="_blank">Electronics Weekly</a>.</p>
<p>Power electronic devices in controlling electrical systems is increasing as governments introduce new standards and consumers demand lower power consumption and greater energy efficiency with ever rising energy costs. Manufacturers are replacing electro-mechanically actuated systems using</p>
<p>AC-induction or brushed-DC motors with permanent magnet variable-speed drives.</p>
<p>Electric motor drives account for around 45 percent of global electricity consumption, encouraging new efficiency-focused legislation driving the adoption of variable-speed electronic control. Legislation on low-power lighting is expected to save millions of tons of CO2 emissions through using power-electronics ballasts or drivers. Another area of interest is digital power management as it enters a rapid adoption phase after being a niche technology for several years.</p></div></div>
</div>
