...
<section  ><%-- Widget fcs.pages.solutions_industry_commercialRealEstate@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_commercialRealEstate10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_commercial_real_estate.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_commercialRealEstate@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_commercialRealEstate10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_commercialRealEstate10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_commercial_real_estate.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_commercialRealEstate10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_commercialRealEstate@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Commercial real estate</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1 style="letter-spacing: -1px; word-spacing: -1px;">Sustainability Consulting for Commercial Real Estate</h1>
<h3>Finding ways to achieve maximum ROI across your real estate portfolio</h3>
<p>Are you a commercial property owner or management firm looking for ways to reduce your risk exposure and increase your organization's efficiency? Are you in need of solutions to upgrade your operational practices and processes for maximum ROI and improved bottom line? Then look to FirstCarbon Solutions for the <a href="/ttsvr/solutions/by-service/data-processing"><strong> software tools, consulting expertise and data management services</strong></a> that you need to succeed.</p>
<p>FirstCarbon Solutions will help you develop an <strong>integrated and comprehensive strategy</strong> to reduce your energy usage and carbon emissions. We integrate our consulting services with our Sustainability Workbench software platform to help you lower your overall energy costs and carbon footprint.</p>
<p>In addition, FirstCarbon Solutions provides <a href="/ttsvr/solutions/by-service/data-processing/utility-bill-processing"><strong>utility bill processing services</strong></a> that ensure you pay your bills accurately, promptly and without duplication. Our energy experts also provide professional advice on how you can take advantage of applicable rebates and incentives for increased savings and improved efficiency.</p>
<p>With our unparalleled expertise in data management, we have the technical capabilities to develop <a href="/ttsvr/solutions/by-service/software"><strong>software</strong></a> and <strong><a href="/ttsvr/solutions/by-service/data-processing">data processing</a></strong> services, such as transaction data administration, document management and data system conversion, so you can handle Big Data more efficiently and cost-effectively.</p>
<h3>Excellent support services to propel your expansion goals</h3>
<p>If you're planning to build or upgrade a retail or commercial complex, FirstCarbon Solutions supports your plans from day 1. If you're considering multiple locations for your project, our <strong>engineers, environmental specialists and regulatory experts</strong> help you make an intelligent site selection. We also ensure you leave no stone unturned in preparing your project blueprint by performing various environmental assessments, such as those for Air, Traffic &amp; Noise, Cultural Resources Management, Environmental Assessments, Environmental Compliance, Natural Resources Management and Water Management. And, we will even manage your entitlements and permitting processes so you don't have to wade through the myriad of paperwork and filing procedures.</p>
<p>FirstCarbon Solutions <a href="/ttsvr/solutions/by-service/software">integrating software solutions</a>, <a href="/ttsvr/solutions/by-service/consulting">top-notch consulting services</a> and <a href="/ttsvr/solutions/by-service/data-processing">expertise in back office data processing</a> to help you strategize for a successful venture. So expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p></div></div>
</div>
