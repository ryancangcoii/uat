...
<section  ><%-- Widget fcs.pages.resources_newsletters_VSSCUCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_VSSCUCT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_VSSCUCT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_VSSCUCT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_VSSCUCT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_VSSCUCT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_VSSCUCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Vietnam to Steer Support to Cities Under Climate Threat</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Vietnam to Steer Support to Cities Under Climate Threat</h1>
<p><em>From <a href="http://www.cleanbiz.asia/news/vietnam-steer-support-cities-under-climate-threat#.UtTXatKSyuk" target="_blank">Clean Biz Asia</a>, Published 08 January 2014</em></p>
<p>​A survey of the harshest effects of climate change on Vietnam&rsquo;s urban areas is scheduled to be completed by 2020 under a project recently approved by the country&rsquo;s Deputy Prime Minister, Hoang Trung Hai.</p>
<p>The initiative, which includes 41 cities, aims to encourage urban planning changes in these areas so they can cope with natural disasters and other effects of climate change. It will focus on coastal cities vulnerable to floods, rising sea levels and salinity intrusion as well as inland cities that will likely see flash floods, landslides and underground water reduction.</p>
<p>Under the first phase, from now to 2015, the Ministry of Construction will co-operate with relevant agencies to assess the potential impact of climate change on Ca Mau, Can Tho, Da Nang, Hanoi, Hai Phong and Ho Chi Minh City. The Ministry of Natural Resources and Environment will ensure that construction planning in these cities meets the requirement of coping with this situation, according to the&nbsp;<em>Vietnam News Service</em>.</p>
<p>The second phase of the project, between 2016 and 2020, will focus on 35 provincial-level cities in northern mountainous localities as well as in the northern and central coastal region, Mekong Delta and Central Highlands.</p>
<p>Funding will come from the State budget, although Hai also encouraged the ministries to seek out official development assistance and international co-operation.</p>
