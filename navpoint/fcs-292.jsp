...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CMVC152014@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CMVC15201410BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CMVC152014@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CMVC15201410BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CMVC15201410BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CMVC15201410BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CMVC152014@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Carbon Market Value to Climb 15% in 2014</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Market Value to Climb 15% in 2014</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/09/carbon-market-value-to-climb-15-in-2014/" target="_blank">Environmental Leader</a>, Published 09 January 2014</em></p>
<p>​<a href="http://www.bloomberg.com/news/2014-01-08/global-carbon-market-value-to-gain-15-in-2014-on-eu-surplus-fix.html" target="_blank">Global carbon markets&rsquo; value will rise 15 percent</a>&nbsp;this year to 46 billion euros ($63 billion), Bloomberg New Energy Finance forecasts.</p>
<p>The analysts attribute the increase to the European Union&rsquo;s plan to postpone sales of emissions permits. This may boost European&nbsp;<a href="http://www.environmentalleader.com/category/carbon-finance/" target="_blank">carbon prices</a>&nbsp;to 7.5 euros ($10) a metric ton &mdash;&nbsp;a more than 50 percent rise from today&rsquo;s price of less than 5 euros ($7).</p>
<p>The value of North American&nbsp;<a href="http://www.environmentalleader.com/tag/carbon-market/" target="_blank">carbon markets</a>&nbsp;is also expected to increase in 2014, New Energy says.<br /> The&nbsp;<a href="http://www.environmentalleader.com/2014/01/06/global-carbon-market-prices-drops-38-in-2013/" target="_blank">only carbon markets to grow in volume and price over 2013</a>&nbsp;were those in North America, according to analysts at Thomson Reuters Point Carbon.</p>
<p>While global carbon markets&rsquo; value dropped 38 percent to 38.4 billion euros ($52.9 billion) last year, the market spanning California and Quebec now has the highest permit prices in the world, at $10.71 per metric ton.</p></div></div>
</div>
