...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_CACMWCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA_CACMWCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA_CACMWCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA_CACMWCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA_CACMWCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA_CACMWCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_CACMWCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>CA Carbon Market ‘Well-Constructed, Strong’</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CA Carbon Market &lsquo;Well-Constructed, Strong&rsquo;</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/10/ca-carbon-market-well-constructed-strong/" target="_blank">Environmental Leader</a>, Published 10 January 2014</em></p>
<p>​The first year of California&rsquo;s cap-and-trade program for greenhouse gas&nbsp;<a href="http://www.environmentalleader.com/category/pollution/" target="_blank">pollution</a>&nbsp;shows the&nbsp;<a href="http://www.environmentalleader.com/tag/carbon-market/" target="_blank">carbon market</a>&nbsp;is well-constructed and strong while the state&rsquo;s economy continues to improve, according to analysis by Environmental Defense Fund.</p>
<p><a href="http://www.edf.org/california-cap-and-trade-updates" target="_blank">California Carbon Market Watch: A Comprehensive Analysis of the Golden State&rsquo;s Cap-and-Trade Program, Year One</a>, analyzes data and key metrics of the program, including a focus on the development of the secondary carbon market. It also examines the impact of notable partnerships, including&nbsp;<a href="http://www.environmentalleader.com/2013/12/09/low-demand-at-quebec-carbon-auction/" target="_blank">recent linkage with Quebec</a>&nbsp;and agreements signed with China, Australia and other regions.</p>
<p>Since California&rsquo;s program started on Jan. 1, 2013, the state has transitioned smoothly to a capped economy, <a href="http://www.environmentalleader.com/2013/11/15/court-upholds-california-carbon-auctions/" target="_blank">weathered legal challenges</a>, and expanded its clean energy sector, the report says. Most notably, under cap and trade, California has continued its economic recovery, balancing its budget for the first time in more than a decade.</p>
<p>First-year conclusions from the report include:</p>
<ul>
<li><a href="http://www.environmentalleader.com/2013/11/25/california-carbon-auction-raises-297-million/" target="_blank">Five successful cap-and-trade auctions</a>&nbsp;are evidence of a well-constructed, strong, and adaptive policy.</li>
<li>The average price for allowances suggests that reducing emissions under the cap may be less costly than some expected.</li>
<li>The secondary market for California carbon allowances is robust and healthy.</li>
<li>Wise investment of auction proceeds will be an integral part of achieving California Global Warming Solutions Act&rsquo;s (<a href="http://www.arb.ca.gov/cc/ab32/ab32.htm" target="_blank">AB 32</a>) carbon pollution reduction goals.</li>
<li>Market experts have given overwhelmingly positive views of the first-year performance of California&rsquo;s&nbsp;<a href="http://www.environmentalleader.com/tag/cap-and-trade/" target="_blank">cap-and-trade</a>&nbsp;program.</li>
</ul>
<p>According to&nbsp;Thomson Reuters Point Carbon analyst Olga Chistyakova, the market spanning California and Quebec now has the&nbsp;<a href="http://www.environmentalleader.com/2014/01/06/global-carbon-market-prices-drops-38-in-2013/" target="_blank">highest carbon permit prices in the world</a>, at $10.71 per metric ton.</p></div></div>
</div>
