...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_MOOEA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_MOOEA10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_MOOEA@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_MOOEA10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_MOOEA10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_MOOEA10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_MOOEA@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Michigan Office Offering Energy Audits</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Michigan Office Offering Energy Audits</h1>
<p><em>From <a href="http://www.energymanagertoday.com/michigan-office-offering-energy-audits-097957/" target="_blank">Energy Manager Today</a>, Published 10 January 2014</em></p>
<p>The Michigan Energy Office <a href="http://www.michigan.gov/mdcd/0,1607,7-122-25676---,00.html" target="_blank">(MEO)</a>&nbsp;has partnered with private-sector technical energy-saving experts throughout the state provide energy audits for qualified recipients. MEO pays for half of the audit cost.</p>
<p>The goal is improving energy efficiency for the commercial, industrial and nonprofit sectors. The MEO is making audits available through a network of qualified technicians. The initiative offers incentives for technicians to provide energy audits and support services.</p>
<p>MEO offers rebates to building operators who successfully complete training. The course prepares building operators with knowledge and skills to find ways to save energy, reduce operating costs, and improve overall efficiency and comfort at their facilities. In conjunction with sponsors of the building operator program, MEO offers tuition rebates to building operators who become certified through the course.</p></div></div>
</div>
