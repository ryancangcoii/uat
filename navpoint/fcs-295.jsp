...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_PMHPB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA_PMHPB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA_PMHPB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA_PMHPB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA_PMHPB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA_PMHPB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_PMHPB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Predictions Made for High Performance Building</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Predictions Made for High Performance Building</h1>
<p><em>From <a href="http://www.energymanagertoday.com/predictions-made-for-high-performance-building-097964/" target="_blank">Energy Manager Today</a>, Published 10 January 2014</em></p>
<p>Net-zero energy buildings are so 2013. Net-positive energy buildings are the future. That was among the predictions for 2014 made by green&nbsp;builder&nbsp;<a href="http://www.prweb.com/releases/2014/01/prweb11470367.htm" target="_blank">Hammer &amp; Hand</a> for the US high performance building industry.</p>
<p>The Portland/Seattle builder believes cheap solar panels, more electric vehicles and market mechanisms that reward onsite energy production will emerge.</p>
<p>Building energy codes will move toward performance-based measures, as the limitations of prescriptive codes become more obvious to policy makers.</p>
<p>Other predictions include:</p>
<ul>
<li class="first">CO2 heat pumps will help transform heating and cooling performance.</li>
<li>US-made high performance windows will continue to make high performance building easier here.</li>
<li>Builders and designers of high performance homes will design ventilation systems with a focus on quality of ventilation rather than just quantity.</li>
<li>The US-led move to make Passive House more climate-specific will improve performance at both micro and macro levels.</li>
</ul></div></div>
</div>
