...
<section  ><%-- Widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_CSRSRFR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HCSMEMSCPGCA_CSRSRFR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HCSMEMSCPGCA_CSRSRFR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HCSMEMSCPGCA_CSRSRFR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HCSMEMSCPGCA_CSRSRFR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HCSMEMSCPGCA_CSRSRFR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HCSMEMSCPGCA_CSRSRFR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>CSR Strategies Reap Financial Rewards</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CSR Strategies Reap Financial Rewards</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/14/csr-strategies-reap-financial-rewards/" target="_blank">Environmental Leader</a>, Published 14 January 2014</em></p>
<p>Companies that introduce a sustainability strategy throughout their supply chain generally see a boost in their financial performance &mdash; but those that don&rsquo;t fully commit to the strategy generally see a decline in revenue, according to a study by Clark University researchers.</p>
<p><a href="http://www.emeraldinsight.com/journals.htm?articleid=17098270&amp;show=abstract" target="_blank">Investigating the Relationship of Sustainable Supply Chain Management with Corporate Financial Performance</a>, by&nbsp;Zhihong Wang and Joseph Sarkis,&nbsp;tracked&nbsp;411 companies from Newsweek&rsquo;s green ranking of the top 500 companies.</p>
<p>The study found that those firms that&nbsp;integrated sustainable&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-supply-chain" target="_blank">supply chain</a>&nbsp;management, jointly including social and environmental supply chain management, generally saw&nbsp;<a href="http://www.strategy-business.com/blog/For-Companies-Its-Not-Easy-Being-Green" target="_blank">&ldquo;marked upgrades&rdquo; in their fiscal returns</a>, particularly through 2011, reports Strategy and Business. However, to see the improvements companies must be patient as the&nbsp;positive effects can have a time lag of at least two years, the study said.</p>
<p>The study also found that companies that only implemented half of a strategy did not reap financial rewards. In particular, those that implemented just an environmental strategy and no social responsibility strategy found that any installation costs outweighed <a href="http://www.environmentalleader.com/category/financial" target="_blank">financial</a>&nbsp;gains.</p>
<p>The authors theorize that the reason for this finding could be that the incremental cost of implementing these two programs may be less, on average, than an individual program, while accruing the full benefits of both programs.</p>
<p>Companies that&nbsp;<a href="http://www.environmentalleader.com/2014/01/03/how-to-close-the-csr-gap-grow-business/" target="_blank">close the gap between consumer expectations and perceptions</a>&nbsp;of their corporate social responsibility work can positively transform their brand,Craig Bida, executive vice president of cause branding and nonprofit marketing for Cone Communications, said earlier this month.</p>
<p>Cone Communications research found 93 percent of&nbsp;<a href="http://www.environmentalleader.com/category/us/" target="_blank">US</a>&nbsp;consumers expect companies to do more than just make money, but only 16 percent believe these companies have actually made a positive impact. Bida recommends to that to effectively close the CSR gap, management must first embrace consumer skepticism.</p></div></div>
</div>
