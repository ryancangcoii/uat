...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SRCTEY2014TL@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Sustainability Reporting Changes Top EY's 2014 Trends List</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Reporting Changes Top EY&rsquo;s 2014 Trends List</h1>
<p><em>From <a href="http://www.environmentalleader.com/2014/01/14/sustainability-reporting-changes-top-eys-2014-trends-list/" target="_blank">Environmental Leader</a>, Published 14 January 2014</em></p>
<p>The forthcoming conflict minerals reporting deadlines and transition to the Global Reporting Initiative (GRI) G4 reporting are among the&nbsp;<a href="http://www.ey.com/US/en/Services/Specialty-Services/Climate-Change-and-Sustainability-Services" target="_blank">2014 sustainability trends</a>&nbsp;that Ernst &amp; Young&rsquo;s Climate Change and Sustainability Services group have identified for companies.</p>
<p>The top trends, according to EY, are:</p>
<ul>
<li><strong>Meeting Dodd-Frank Act Section 1502&rsquo;s approaching deadline.</strong>&nbsp;The first filing deadline to comply with the US Securities Exchange Commission&rsquo;s (SEC) conflict minerals disclosure requirements covering calendar year 2013 is June 2. Per the legislation, companies must&nbsp;<a href="http://www.environmentalleader.com/2013/04/01/15-tips-for-complying-with-the-conflict-minerals-provision-of-the-dodd-frank-act/" target="_blank">investigate their supply chains for conflict minerals</a>&nbsp;and report on their source of origin.</li>
<li><strong>Managing the transition to G4 reporting.</strong>&nbsp;Leading sustainability reporting organizations are seeking to provide clarity and guidance on what&rsquo;s material in non-financial reporting. Conducting a non-financial materiality assessment this year can provide a company and its stakeholders with valuable intelligence to better measure, manage and assess the business in the short- and long-term. Additionally, this exercise is critical to laying a proper foundation for future reporting, particularly in light of the&nbsp;<a href="http://www.environmentalleader.com/2013/05/22/gri-releases-latest-guidelines/" target="_blank">GRI G4 sustainability reporting guidelines</a>.</li>
<li><strong>Reducing supply chain risk by driving social compliance into the business.</strong>&nbsp;Supply chain management is complex and in the spotlight after recent tragedies like those in Bangladesh. To avoid such catastrophes, companies should take steps in 2014 to drive social compliance into their business, such as mapping the&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-supply-chain/" target="_blank">supply chain</a>, integrating social compliance into the procurement process and systemizing collaboration between social compliance and internal audit.</li>
<li><strong>Understanding how environmental, social and governance disclosures impact companies listed on various stock exchanges.</strong>&nbsp;Stock exchanges around the world are beginning to recommend their listed companies report on select environmental and social indicators, or explain why they do not. This trend is likely to spread since the NASDAQ OMX and New York Stock Exchange are participating in the Investor Network on Climate Risk Sustainable Stock Exchanges Working Group, which is currently collaborating on a standards proposal. Now is the time for companies to establish systems for capturing key&nbsp;<a href="http://www.environmentalleader.com/tag/ESG/" target="_blank">ESG</a>&nbsp;metrics and develop a process for measuring non-financial data before such guidance becomes mandatory for listed companies on main US exchanges.</li>
</ul></div></div>
</div>
