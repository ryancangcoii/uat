...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CO2EEI2013@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_CO2EEI201310BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_CO2EEI2013@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CO2EEI201310BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_CO2EEI201310BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_CO2EEI201310BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_CO2EEI2013@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>CO2 Emissions Expected to Increase in 2013</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CO2 Emissions Expected to Increase in 2013</h1>
<p><em>By William Opalka, <a href="http://www.energymanagertoday.com/co2-emissions-expected-to-increase-in-2013-098048/" target="_blank">Energy Manager Today</a>, Published 14 January 2014</em></p>
<p>The&nbsp;<a href="http://www.eia.gov/todayinenergy/detail.cfm?id=14571&amp;src=email" target="_blank">Energy Information Administration&nbsp;</a>reports that once all data are in, energy-related carbon dioxide (CO2) emissions in 2013 are expected to be roughly 2 percent above the 2012 level. A small increase in coal consumption in the electric power sector is responsible.</p>
<p>Coal has regained market&nbsp;from natural gas since a&nbsp;<a href="http://www.energymanagertoday.com/electricity-from-natural-gas-16-down-090923/" target="_blank">low in April 2012</a>; however the&nbsp;<a href="http://www.energymanagertoday.com/aeo-2014-gas-to-overtake-coal-097676/" target="_blank">impact on overall emissions trends remains fairly small</a>.</p>
<p>Emissions in 2013 are slightly more than 10 percent below 2005 levels, a significant contribution towards the goal of a 17 percent reduction in emissions from the 2005 level by 2020 that was adopted by the current Administration. This level of reduction is expected to continue through 2015.</p>
<p>CO2&nbsp;emissions from energy activities declined four out of six years since their 2007 peak, and were historically low (12 percent below the 2005 level) in 2012. From 2005 to 2013, the key energy-economic drivers of a changing U.S. energy landscape included:</p>
<ul>
<li>Weak economic growth in recent years, dampening growth in energy demand compared to pre-recession expectations</li>
<li>Continuously improving energy efficiency across the economy, including buildings and transportation</li>
<li>High energy prices over the past four years, with the exception of natural gas, since about 2010</li>
<li>An abundant and inexpensive supply of natural gas, resulting from the widespread use of new production technologies for shale gas</li>
<li>Power sector decarbonization since 2010, as natural gas and renewables displaced coal</li>
</ul></div></div>
</div>
