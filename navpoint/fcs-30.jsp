...
<section  ><%-- Widget fcs.pages.solutions_industry_consumer@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_consumer10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_main.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_consumer@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_consumer10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_consumer10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_consumer10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_consumer@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Consumer Products</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Business Consumer Products</h1>
<h3>Leaner processes. Accessible data. Higher profits.</h3>
<p>FirstCarbon Solutions helps manufacturers of consumer goods bolster profitability and ROI in a number of ways. From how efficiently you operate to how competitive you are in a sustainability-conscious market, we offer consumer products-focused consulting expertise, tools, and data management services to make a bottom line difference <em>now.</em></p>
<h3>Measure your footprint</h3>
<p>Whether you&rsquo;re in apparel or electronics, our <a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">Life Cycle Assessment</a> and <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprinting</a> solutions will help you slash waste from your processes, <a href="/ttsvr/solutions/by-focus/energy">reduce energy consumption</a>, and put the data you need to respond to retailer requests at your fingertips. We&rsquo;ll help you become both leaner in how you operate and more competitive in your market.</p>
<h3>Trace your supply chain</h3>
<p>FirstCarbon Solutions will help you establish and validate your own <a href="/ttsvr/solutions/by-focus/sustainability">sustainability footprint</a> and that of <em>your</em> supply chain, because whether your raw materials include cotton or chemicals, it&rsquo;s your inputs and supply chain that factor most into the size of your environmental footprint.</p>
<h3>Leverage your labeling</h3>
<p>What product labeling is available in your market and what&rsquo;s the value of pursuing a sustainability-focused label? What labels will actually improve your bottom line? We&rsquo;ll work with you to develop or meet product declaration rules to create a labeling advantage for your business.</p>
<p>Only FirstCarbon Solutions fully integrates<a href="/ttsvr/solutions/by-service/consulting"> sustainability consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable, compliant profitability. The result is more cost-effective operations, improved process efficiency, and more secure customer contracts.</p>
<h3>FirstCarbon Solutions in action for consumer products</h3>
<p>For M.E. Heuck Co , FirstCarbon Solutions helped them successfully achieve their goals in manufacturing their first <a href="/ttsvr/fcs/pdf/meheuck.pdf">CarbonNeutral line of cookware</a> and kitchen gadgets in the market, while satisfying their certification requirements in a cost-effective manner.</p></div></div>
</div>
