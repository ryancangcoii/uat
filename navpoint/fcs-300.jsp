...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_HSBC2014MSNEFC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>HSBC: 2014 Marks Start of New Economic Focus on Climate</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>HSBC: 2014 Marks Start of New Economic Focus on Climate</h1>
<p><em>From <a href="http://www.edie.net/news/5/HSBC--2014-marks-start-of-new-economic-focus-on-climate-/" target="_blank">Edie Energy</a>, Published 15 January 2014</em></p>
<p>HSBC has said climate change will rise up the corporate finance agenda this year, highlighting three issues - impacts, carbon risk and green bonds - that will lend impetus to this.&nbsp;</p>
<p>The bank has issued a statement in which it states that the next 12 months will mark "the beginning of a new climate agenda" adding that "we should expect much more focus in 2014 on the present danger of climate vulnerability, impacts, loss and damage".&nbsp;<br /> <br /> New detail on observed climate impacts, plus guidance on the severity of climate risks to humans, will be revealed in forthcoming report from the Intergovernmental Panel on Climate Change (IPCC) in March.&nbsp;<br /> <br /> HSBC points to the fact that the study will also assess regional vulnerability to climate impacts, such as heatwaves, droughts, floods and wildfires.&nbsp;<br /> <br /> "It will likely emphasise that although developing countries are worst hit, many have not yet embedded adaptation and resilience into their economic strategies. Within the G20, we believe India, China, Indonesia, South Africa and Brazil are most vulnerable," the statement said.&nbsp;<br /> <br /> Turning to carbon risk, the bank says that in order to meet global climate goals, inefficient sub-critical coal-fired generation must be replaced with low-carbon alternatives.&nbsp;<br /> <br /> It called China and the US the two "carbon elephants" as they collectively account for more than 40% of global carbon pollution, but added that the recent establishment of a US-China Climate Change Working Group should pave the way for a bilateral agreement on phasing out fossil fuel subsidies.&nbsp;<br /> <br /> "[This] would be hugely positive and a China-US pact could have a transformative impact on realising a global deal at international talks in 2015," HSBC stated.&nbsp;<br /> <br /> The financial institution also predicted that this year would bring an intensification of interest in green bonds - these are increasingly being used to raise capital for the low-carbon transition.&nbsp;<br /> <br /> Within this, there is a fast-growing segment of badged 'green bonds' with funds ringfenced for renewable energy, environmental clean-up and energy efficiency and HSBC expects issuance of them to strengthen over the coming months.&nbsp;</p></div></div>
</div>
