...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SESMEG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_SESMEG10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_SESMEG@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SESMEG10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_SESMEG10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_SESMEG10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_SESMEG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Shanghai Environmental Spending not Matching Economic Growth</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Shanghai Environmental Spending not Matching Economic Growth</h1>
<p><em>From <a href="http://www.cleanbiz.asia/news/shanghai-environmental-spending-not-matching-economic-growth#.UtjsWtKSyuk" target="_blank">Clean Biz Asia</a>, Published 15 January 2014</em></p>
<p>Shanghai devoted a smaller share of its resources and has met a smaller proportion of its goals for environmental protection in the five years from 2008 to 2012, despite growing public dissatisfaction with the city's environment in recent years, the local statistics bureau said yesterday.</p>
<p>Although the city increased nominal spending on environmental protection by eight percent annually during the period, environmental protection spending as a percentage of local GDP actually fell, according to a press release from the Shanghai Municipal Statistics Bureau. It said spending equaled about 2.84 percent of the city's GDP in 2012, down from 3 percent in 2008.</p>
<p>At the same time, the city government reckons it achieved 88.5 percent of its environmental protection objectives in 2012, down from 93.2 percent in 2008. The bureau pointed out that the figure fell for three straight years from 2010 to 2012, though it didn't disclose the number of objectives for each year, or other year-by-year data.</p>
<p>The bureau also released survey results that found that public satisfaction with urban environmental protection has fallen since the World Expo 2010 in Shanghai.</p></div></div>
</div>
