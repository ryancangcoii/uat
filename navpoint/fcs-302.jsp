...
<section  ><%-- Widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_WSNROGRC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_HLFFMIIW100MSC_WSNROGRC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_HLFFMIIW100MSC_WSNROGRC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_HLFFMIIW100MSC_WSNROGRC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_HLFFMIIW100MSC_WSNROGRC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_HLFFMIIW100MSC_WSNROGRC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_HLFFMIIW100MSC_WSNROGRC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-264"> February 2014 - How Can SMEs Manage Supply Chain Pressures to Gain Competitive Advantage?</a> &raquo; <span>Water Security Now Ranks as One of Greatest Risks to Civilisation</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Water Security Now Ranks as One of Greatest Risks to Civilisation</h1>
<p><em>From <a href="http://www.edie.net/news/5/Water-security-now-ranks-as-one-of-greatest-risks-to-civilisation-/" target="_blank">Edie Energy</a>, Published 16 January 2014</em></p>
<p>Water is now one of the highest global risks, alongside the economy, unemployment, food shortages and extreme weather patterns, new research has found.</p>
<p>The ninth edition of the&nbsp;<em>Global Risk Report</em>, released today by the World Economic Forum (WEF), identified water security as a top priority for the planet - while also finding that women and younger people are most likely to recognise this.&nbsp;<br /> <br /> The study pointed to what it called "a significant decline in the quality and quantity of fresh water, combined with increased competition among resource-intensive systems, such as food and energy production" as a key resource risk facing both business and wider society.&nbsp;<br /> <br /> It said that increasing water risks were a result of "mismanagement and increased competition" for already scarce water resources from economic activity and population growth.&nbsp;<br /> <br /> The findings have already been picked up by Nestl&eacute; Group chairman Peter Brabeck-Letmathe who is an outspoken advocate of business addressing water security issues.&nbsp;<br /> <br /> Writing in his latest blog, he said that report showed how the most important risks are interconnected.&nbsp;<br /> <br /> "Food is one the dimensions here, and in earlier posts I have expressed my concern about the possible impact of water shortage on food production in the coming years, i.e., the risk of up to 30% shortfalls in global cereal production due to shortage in freshwater by 2030," he pointed out.&nbsp;<br /> <br /> "Not surprisingly, and with other factors involved (climate policies subsidising the use of food for fuel, slowdown in the growth of per-hectare productivity, etc.), the risk of a food crisis is also ranked very highly among the threats to our future."&nbsp;<br /> <br /> Brabeck-Letmathe has previously warned that water shortages could spark global food crisis by 2030 and <a href="http://www.edie.net/news/4/Water-will-run-out-before-oil-warns-Nestle-chairman/23540/" target="_blank"><strong>famously said back in 2012 that the world's resource base will run out of water before oil</strong></a></p></div></div>
</div>
