...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_FSWHEM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_FSWHEM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_FSWHEM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_FSWHEM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_FSWHEM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_FSWHEM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_FSWHEM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Frost & Sullivan: What's Hot in Environmental Markets?</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Frost &amp; Sullivan: What&rsquo;s Hot in Environmental Markets?</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/12/02/frost-sullivan-whats-hot-in-environmental-markets/" target="_blank">Environmental Leader, Published 02 December 2013</a></em></p>
<p><span style="line-height: 1.3em;">Urbanization and smart cities, the changing dynamics of unconventional gas, and opportunities generated from increased environmental awareness and legislation will be the key topics in 2014 and beyond, according to Frost &amp; Sullivan&rsquo;s&nbsp;<a href="http://www.environmentalleader.com/category/predictions/" target="_blank">predictions</a>&nbsp;for the global energy and environment market.</span></p>
<p><span style="line-height: 1.3em;">The predictions are based on F&amp;S&rsquo; 2013 Search for Growth survey, which involved 1835 executives in more than 40 countries globally.</span></p>
<p><span style="line-height: 1.3em;">According to the findings, urbanization and smart cities will drive changing market dynamics for energy and environment market participants. A growing percentage of the global population will be living in cities and urban areas in the coming decades. Higher concentrations of larger populations bring challenges including:</span></p>
<ul>
<li class="first">Urban populations will be higher income, and the growing middle class will consume more goods, resources, energy and water, and create more waste and pollution.</li>
<li>Increasing waste and&nbsp;<a href="http://www.environmentalleader.com/category/pollution/" target="_blank">pollution</a>&nbsp;will drive awareness and the need for cleaner, more efficient energy and transportation.</li>
<li class="last"><span style="line-height: 1.3em;">Smart cities that can better use existing resources through improved monitoring, controls and coordination of services and infrastructure can improve quality of life for residents and attract more businesses.</span></li>
</ul>
<p><span style="line-height: 1.3em;">&nbsp;</span></p>
<p><span style="line-height: 1.3em;">Smart systems have been in place across the transmission and distribution space and are now also moving into commercial and residential buildings.</span></p>
<p><span style="line-height: 1.3em;">The emergence of shale gas and shale oil in the&nbsp;<a href="http://www.environmentalleader.com/category/oil-gas/" target="_blank">oil and gas</a> space is also increasingly impacting the energy and environment sector. Natural gas has replaced&nbsp;<a href="http://www.environmentalleader.com/category/coal/" target="_blank">coal</a>&nbsp;as the <a href="http://www.energymanagertoday.com/fossil-fuels-dominate-global-energy-consumption-096446/" target="_blank">main fuel source for electricity in the US</a>. China has abundant, though technically difficult to access, shale beds that, if tapped, could further increase the country&rsquo;s economic clout on the global stage. Europe is looking at shale gas to increase domestic energy sources but also balancing that with environmental concerns.</span></p>
<p><span style="line-height: 1.3em;">Environmental concerns, highlighted by industry participants as a key area of interest, are an issue with shale extraction because they drive the potential for smart cities, Frost &amp; Sullivan says.</span></p></div></div>
</div>
