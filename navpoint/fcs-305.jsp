...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_FDMNCIMR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_FDMNCIMR10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_FDMNCIMR@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_FDMNCIMR10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_FDMNCIMR10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_FDMNCIMR10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_FDMNCIMR@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Financial Decision Makers Need Climate Information to Manage Risks</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Financial Decision Makers Need Climate Information to Manage Risks</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/25/financial-decision-makers-need-climate-information-to-manage-risks/" target="_blank">Environmental Leader, Published 25 November 2013</a></em></p>
<p>Maximizing returns on&nbsp;<a href="http://www.environmentalleader.com/category/financial/" target="_blank">financial&nbsp;</a>investments depends on understanding and accounting for weather and&nbsp;<a href="http://www.environmentalleader.com/category/climate/" target="_blank">climate</a> risks, according to a&nbsp;<a href="http://www.ametsoc.org/atmospolicy/cin/CIN_Report.pdf" target="_blank">study by the American Meteorological Society (AMS) Policy Program</a>.</p>
<p>The study also found that&nbsp;<a href="http://www.environmentalleader.com/tag/extreme-weather/" target="_blank">weather events</a>&nbsp;create and exacerbate risks to financial investments by causing:</p>
<ul>
<li class="first">Direct physical impacts on the investments themselves</li>
<li>Degradation of critical supporting infrastructure</li>
<li>Changes in the availability of key resources</li>
<li>Changes to workforce availability or capacity</li>
<li>Changes in the customer base</li>
<li>Supply chain disruptions</li>
<li>Legal liability</li>
<li>Shifts in the regulatory environment</li>
<li>Reductions in credit ratings</li>
<li>Additional impacts that alter competitiveness (e.g., shifts in consumer preferences).</li>
</ul>
<p>To overcome communication barriers that stem from technical terms often used in scientific assessments, the AMS report proposes three pre-defined levels of certainty for communicating with user communities about future climate impacts: possible, probable and effectively certain.</p>
...
<p>The report concludes that financial investments face a range of risks due to existing weather patterns, climate variability and climate change. Even small changes in weather can impact operations in critical economic sectors. At the same time, climate variability and change can either exacerbate existing risks or cause new sources of risk to emerge.</p>
<p><a href="http://www.environmentalleader.com/2013/11/18/climate-change-losses-cost-200-billion-over-last-decade/" target="_blank">Economic losses from extreme weather</a>&nbsp;events have risen from an annual global average of about $50 billion in the 1980s to close to $200 billion over the last decade, according to the report released by the World Bank.</p></div></div>
</div>
