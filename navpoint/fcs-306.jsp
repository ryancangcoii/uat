...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_CCLC200BLD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_CCLC200BLD10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_CCLC200BLD@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_CCLC200BLD10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_CCLC200BLD10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_CCLC200BLD10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_CCLC200BLD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Climate Change Losses Cost $200 Billion over Last Decade</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Climate Change Losses Cost $200 Billion over Last Decade</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/18/climate-change-losses-cost-200-billion-over-last-decade/" target="_blank">Environmental Leader, Published 18 November 2013</a></em></p>
<p>Economic losses from&nbsp;<a href="http://www.environmentalleader.com/tag/extreme-weather/" target="_blank">extreme weather</a>&nbsp;events have risen from an annual global average of about $50 billion in the 1980s to close to $200 billion over the last decade, according to the report released by the World Bank.</p>
<p><a href="http://www.worldbank.org/content/dam/Worldbank/document/SDN/Full_Report_Building_Resilience_Integrating_Climate_Disaster_Risk_Development.pdf" target="_blank">Building Resilience: Integrating Climate and Disaster Risk into Development</a>, cites the weather-related damage figure from Munich Re insurance group and warns that the poorest nations in Africa and Asia are among the most vulnerable to&nbsp;<a href="http://www.environmentalleader.com/category/climate/">climate</a>-related losses. It also says these financial losses are concentrated in fast-growing, middle-income countries because such countries&rsquo; high-value assets are becoming more exposed. The average impact of disasters in such nations equaled 1 percent of gross domestic product between 2001 and 2006 &mdash; 20 times higher than the average for high-income countries.</p>
<p>The World Bank says climate-resilient development is the answer &mdash; but warns it isn&rsquo;t cheap, with upfront costs running as much as 50 percent higher than traditional development. These investments will pay off in the long-run, the report says.</p>
<p>A study to calculate the&nbsp;<a href="http://www.environmentalleader.com/2013/10/02/how-much-does-climate-change-cost-companies/" target="_blank">economic risk US industries face from climate change</a>&nbsp;is being funded by New York City mayor Michael Bloomberg, billionaire Tom Steyer and George W. Bush-era Treasury secretary Henry Paulson.</p>
<p>If US businesses act now to&nbsp;<a href="http://www.environmentalleader.com/2013/06/20/3-ghg-reduction-could-save-firms-780-billion/" target="_blank">reduce GHG emissions by an average of 3 percent</a>&nbsp;annually, they can save up to $190 billion in 2020 alone, or $780 billion over 10 years, according to a report published in June by World Wildlife Fund&nbsp;and CDP.</p></div></div>
</div>
