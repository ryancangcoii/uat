...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_90FRTTE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_90FRTTE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_90FRTTE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_90FRTTE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_90FRTTE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_90FRTTE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_90FRTTE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>90 Firms Responsible for Two-Thirds of Emissions</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>90 Firms Responsible for Two-Thirds of Emissions</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/22/90-firms-responsible-for-two-thirds-of-emissions/?graph=full&amp;id=1" target="_blank">Environmental Leader, Published 22 November 2013</a></em></p>
<p>Just 90 companies, including ChevronTexaco, ExxonMobil and&nbsp;<a href="http://www.environmentalleader.com/tag/bp/" target="_blank">BP</a>,&nbsp;are responsible for causing almost two-thirds of all man-made global emissions during the industrial era, according to research by the&nbsp;Climate Accountability Institute.</p>
<p>These &ldquo;carbon majors&rdquo; include 50 investor-owned companies, 31 state-owned companies, and nine government-run industries in the former Soviet Union, <a href="http://www.environmentalleader.com/tag/china/" target="_blank">China</a>&nbsp;and other countries, according to&nbsp;<a href="http://link.springer.com/article/10.1007/s10584-013-0986-y" target="_blank">Tracing anthropogenic carbon dioxide and methane emissions to fossil fuel and cement producers, 1854-2010.</a></p>
<p>The 10 companies responsible for&nbsp;extracting the most fossil fuels that have been burned over the past 150 years are: ChevronTexaco, ExxonMobil,&nbsp;Saudi Aramco, BP, GazProm, Shell,&nbsp;National Iranian Oil Company, Pemex, <a href="http://www.environmentalleader.com/tag/conocophillips/" target="_blank">ConocoPhillips</a>&nbsp;and Petroleos de Venezuela.</p>
<p>In many cases, multinational companies have extracted more than most countries, according to the study.&nbsp;Investor-owned entities comprised 315 gigatons of carbon dioxide equivalent, while government-run industries, contributed 312 gigatons. State-owned companies produced 288 gigatons, the study shows.</p>
<p>The largest investor-owned producers weigh heavily in the analysis. The top 20 produced fuels that comprised 29.5 percent of emissions, while the top 10 account for 15.8 percent. Five &ldquo;oil majors,&rdquo; ChevronTexaco, ExxonMobil, BP, Shell, and ConocoPhillips account for a total of 181 gigatons of CO<sub>2</sub> over the past 130 years, amounting to 12.5 percent of total carbon emitted to the atmosphere, according to the study.</p>
<p>Most of the top producers primarily extract&nbsp;<a href="http://www.environmentalleader.com/category/oil-gas/" target="_blank">oil</a>. Coal producers Coal India and Peabody Energy rank 11th and 12th, respectively. The list also includes a handful of cement producers.</p>
<p>According to research released in September 2013 and commissioned by the American Petroleum Institute, oil and natural gas companies are America&rsquo;s&nbsp;<a href="http://www.environmentalleader.com/2013/09/11/oil-and-gas-firms-lead-carbon-reduction-efforts/" target="_blank">top investors in zero- and low-greenhouse gas emissions technologies</a>.</p>
<p>The study by T2 and Associates examined investments in greenhouse gas mitigation technologies from 2000 through 2012. During that period, the US&nbsp;<a href="http://www.environmentalleader.com/category/oil-gas/" target="_blank">oil and natural gas</a>&nbsp;industry directly invested about $81 billion in greenhouse gas&nbsp;mitigation technologies, it says.</p>
<p>Other US industries invested an estimated $91.2 billion, and the federal government invested an estimated $79.7 billion, the study said.<em><br /></em></p></div></div>
</div>
