...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_THMSAUNCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_THMSAUNCT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_THMSAUNCT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_THMSAUNCT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_THMSAUNCT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_THMSAUNCT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_THMSAUNCT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Typhoon Haiyan Must Spur Action at UN Climate Talks</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Typhoon Haiyan Must Spur Action at UN Climate Talks</h1>
<p><em>From <a href="http://www.edie.net/news/6/Typhoon-Haiyan-must-spur-action-at-UN-climate-talks/" target="_blank">Edie Energy, Published 18 November 2013</a></em></p>
<p>Governments across the world were told that Typhoon Haiyan, which hit the Philippines in November 2013, must act as a "wake-up call" on the dangers of climate change.&nbsp;</p>
<p>Members of the Disaster Emergencies Committee (DEC) called for governments meeting at the UN climate talks in Warsaw this week to increase their climate change policies as the typhoon was a "glimpse into the future".</p>
<p>Aid agencies Christian Aid, CAFOD, CARE International, Oxfam and Tearfund say governments must deliver more climate finance, drastically cut global emissions and establish a Loss and Damage mechanism which would obligate developed countries to help those that are "increasingly losing lives and livelihoods to the effects of climate change".</p>
<p>The agencies said this would avoid the unnecessary cost of lives and money in the future, adding that the losses from Typhoon Haiyan were expected to amount to several billion dollars.</p>
<p>Oxfam's head of advocacy Max Lawson said: "This should be a wake-up call for negotiators who have been sleepwalking through a process fraught with delay and indecision. The images we have seen from the Philippines are a reminder that climate change is not about numbers and process, but a growing reality for poor people who desperately need support to protect themselves and build safer futures."</p>
<p>Christian Aid senior climate adviser Mohamed Adow said: "The people of the Philippines, like millions of others around the world, will remain at the mercy of a changing climate unless we act on the findings of overwhelming scientific evidence and get a global deal on cutting carbon emissions. We must free these climate captives by choosing clean energy over dirty energy. Let this be the wake-up call for politicians to act."</p>
<p>Delegates from 195 countries were in Warsaw for the annual UN climate talks, which took place from November 11-22, 2013.</p></div></div>
</div>
