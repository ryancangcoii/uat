...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_SLCSRG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_SLCSRG10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_SLCSRG@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_SLCSRG10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_SLCSRG10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_SLCSRG10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_SLCSRG@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Sustainability Leads to Cost Savings, Revenue Growth</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Leads to Cost Savings, Revenue Growth</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/27/sustainability-leads-to-cost-savings-revenue-growth/" target="_blank">Environmental Leader, Published 27 November 2013</a></em></p>
<p>Sustainability programs are&nbsp;<a href="http://www.businessweek.com/articles/2013-11-26/a-sustainable-business-model-pays-off" target="_blank">producing cost savings, revenue growth</a>, competitive advantage and environmental benefits across corporate America, writes Harold L. Sirkin, a senior partner of the Boston Consulting Group (BCG).</p>
<p>Sirkin cites a survey BCG conducted in cooperation with the MIT Sloan Management Review in which 37 percent of the 2,600 managers and executives identified <a href="http://www.environmentalleader.com/2013/02/06/more-companies-profit-from-sustainability-survey-finds/" target="_blank">sustainability efforts as a source of profit</a>&nbsp;&mdash; a 23 percent rise over 2012. About half of the responding companies (48 percent) said they changed their business models as a result.</p>
<p>The blog quotes David Brodwin, co-founder of the <a href="http://asbcouncil.org/" target="_blank">American Sustainable Business Council</a>, who&nbsp;<a href="http://www.usnews.com/opinion/blogs/economic-intelligence/2013/02/28/sustainability-can-boost-profits" target="_blank">earlier in 2013</a>&nbsp;said&nbsp;sustainability&nbsp;efforts take many forms: &ldquo;Some companies succeed by targeting sophisticated consumers who prefer to pay more for a product that is organic, healthier, produced in [a] cleaner or safer way, or produced in a way that provides more benefit to the workers involved&hellip;Other companies succeed by driving their costs down as a result of rethinking their product&nbsp; and process design&hellip;Still other companies succeed because the pursuit of sustainability leads to a higher quality product, with fewer defects and rejects.&rdquo;</p>
<p>Firms that set tangible, public sustainability goals <a href="http://www.environmentalleader.com/2013/07/31/setting-sustainability-goals-improves-bottom-line/" target="_blank">improve their financial and environmental performance</a>, according to a white paper released in July 2013 by CH2M Hill.</p></div></div>
</div>
