...
<section  ><%-- Widget fcs.pages.solutions_industry_developers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_developers10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_commercial_developers.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_developers@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_developers10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_developers10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_commercial_developers.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_developers10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_developers@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Developers</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Consulting for Property Developers</h1>
<h3>Building a sustainable foundation for your properties</h3>
<p>In this sustainability-driven world you have to navigate an increasingly complicated regulatory landscape and meet rigorous standards when implementing a real estate project, whether it be a commercial complex or an industrial facility.</p>
<p>FirstCarbon Solutions&rsquo; environmental consulting experience spans a wide array of real estate development types, from mixed-use retail, industrial, commercial, residential subdivisions and planned communities to transportation, schools, medical facilities, landfills, reservoirs and recycling facilities. With our extensive background and <strong><a href="/ttsvr/solutions/by-service/data-processing">world-class expertise in back-office data processing</a></strong>, we provide professional advice, software solutions and legally defensible products to ensure full regulatory compliance, reduced development costs and project sustainability.</p>
<h3>Well-guided strategies are key to compliance &amp; sustainability success</h3>
<p>FirstCarbon Solutions guides you in every phase of property development, from pre-development planning to construction and turn-over. Our consulting team scouts potential locations and helps you select the best site for your needs.</p>
<p>As you roll-out your project, our team of professionals provides all forms of <strong><a href="/ttsvr/solutions/by-focus/entitlements-permitting/entitlement-processing-services">entitlement processing assistance</a></strong> to help you through design &amp; site plan review processes and succeed in securing conditional-use permits.</p>
<p>The best development plan is one that fully complies with regulatory and environmental requirements in the most cost-effective manner. With our environmental consultants and compliance experts on your development team, rest assured that environmental services will be the least of your concerns as <span style="text-decoration: underline;">we</span> take charge of <strong><a href="/ttsvr/solutions/by-focus/environmental/air-traffic-and-noise-assessments">air quality, traffic &amp; noise</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/cultural-resources-management">cultural resources management</a></strong>,<strong> <a href="/ttsvr/solutions/by-focus/environmental/natural-resources-management">natural resources management</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/environmental-assessments">environmental assessments</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">environmental compliance</a></strong>, and <strong><a href="/ttsvr/solutions/by-focus/environmental/water-management">water management</a></strong>.</p>
<p>As you build a foundation for sustainable development, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p></div></div>
</div>
