...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_WRUSCBAD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_WRUSCBAD10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_WRUSCBAD@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_WRUSCBAD10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_WRUSCBAD10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_WRUSCBAD10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_WRUSCBAD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Water Risks to US Companies are Becoming more Acute: Deloitte</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Water Risks to US Companies are Becoming more Acute: Deloitte</h1>
<p><em>From <a href="https://www.cdp.net/en-US/News/CDP%20News%20Article%20Pages/Water-risks-to-US-companies-are-becoming-more-acute-deloitte.aspx" target="_blank">Carbon Disclosure Project, Published 19 November 2013</a></em></p>
<p>Water security risks are increasing and will significantly impact business continuity if left unaddressed, according to the CDP U.S. Water Report 2013, prepared by Deloitte. Even as water risks become more acute, the majority of Standard &amp; Poor&rsquo;s 500 index (S&amp;P 500) companies facing water risks lack strategic plans to adequately address these risks.</p>
<p>The CDP US Water Report 2013 is based on information provided by 145 companies listed on the S&amp;P 500 at the request of 530 institutional investors representing $57 trillion in assets to disclose through CDP, formerly known as the Carbon Disclosure Project, providers of the only global environmental disclosure system.</p>
<p><strong>More water-related risks are identified, impacting business continuity</strong></p>
<p>While the number of U.S. companies participating in CDP&rsquo;s water program this year increased 4% to 145 from 2012, risks reported increased 16%. The majority (58%) of the 523 risks reported are expected to be felt now or within the next five years. Furthermore, nearly half (46%) of the companies analyzed have already experienced detrimental impacts related to water, with costs as high as $400 million and projected impacts as great as $1 billion.</p>
<p><strong>Most businesses appear to lack strategic responses to water-related risks</strong></p>
<p>Board-level oversight of water-related issues has increased 13% from 2012, but is still relatively low at 32%. This compares unfavorably to findings of the recently released <a href="https://www.cdp.net/CDPResults/CDP-Global-Water-Report-2013.pdf" target="_blank">CDP Global Water Report 2013</a>, which analyzed 180 of the largest global companies listed on the FTSE Global 500 Equity Index and found that 58% have board-level oversight of water-related issues.</p>
<p>While 94% of the S&amp;P 500 respondents can identify which, if any, of their operations are located in water-stressed regions, 43% do not know if key inputs or raw materials come from regions subject to water-related risk &ndash; potentially leading to business interruption.</p>
<p><strong>Companies are overlooking risks within their value chain</strong></p>
<p>There was a significant increase (23%) in the proportion of companies setting concrete, quantifiable water-related targets or goals, but unfortunately the majority of these companies focus solely on water management within direct operations such as usage reduction, efficiency or compliance. Companies that continue to focus on direct water risks only could be missing business opportunities and overlooking substantive risks within their value chain that could be mitigated.</p>
<p>Companies with robust water stewardship strategies typically have comprehensive knowledge of water use across their value chain and are aware of the current and projected impact that water-related issues have on their business. Most importantly, they have appropriate plans and processes in place that give adequate consideration to priorities of the local watershed in which they operate.</p>
<p>Cate Lamb, head of CDP&rsquo;s water program, says: &ldquo;U.S. companies are improving their ability to identify the wide variety of risks that water presents them. However, their response to these risks lacks strategic direction and clearly demands some catch up on the part of the corporation.</p>
<p>&ldquo;If businesses are to become truly resilient to the growing threat that water poses, they must develop a comprehensive understanding of their relationship with water and strive for stewardship. Those that fail to develop a holistic water stewardship strategy may struggle to maintain the strong financial returns expected by their investors.&rdquo;</p>
<p><strong>Water Stewardship helps businesses develop water resilience</strong></p>
<p>Will Sarni, leader of Deloitte&rsquo;s enterprise water strategy practice, says: &ldquo;The shift from awareness of water risks to quantifying the &lsquo;business value at risk&rsquo; from water scarcity and quality is gaining traction. Companies now need to quantify potential business value at risk from water and integrate water availability into business growth strategies &ndash; a focus on &lsquo;water as a license to grow&rsquo; mindset.</p>
<p>&ldquo;Effective water stewardship strategies should also include identification of opportunities to create strategic advantage. Companies cannot address water-related risks alone, and must therefore develop a proactive approach to water stewardship with a focus on external engagement to mitigate water-related risks, increase resiliency and identify business opportunities.&rdquo;</p>
<p>Cate Lamb added, &ldquo;In 2014, CDP will trial the world&rsquo;s first public water scoring methodology on a confidential basis with Global 500 companies, as listed on the FTSE Global 500 Equity Index. A wide range of stakeholders will be consulted throughout 2014 to test and refine the methodology, which will be fully implemented across all respondents in 2015. The resultant water scores will be a key component in driving improved disclosure and corporate water stewardship. For investors and other stakeholders, scores will highlight how prepared a company is in the face of rising water challenges. The markets will favor companies that lead a collaborative approach to safeguard water as a vital shared resource and contribute to sustainable revenue generation.&rdquo;</p>
<p>The <a href="https://www.cdp.net/CDPResults/CDP-US-Water-Report-2013.pdf" target="_blank">CDP U.S. Water Report 2013</a> was launched at the CDP U.S. Water Forum on November 18. The report and public company disclosures on water are available for download on the <a href="https://www.cdp.net/" target="_blank">CDP website</a>.</p></div></div>
</div>
