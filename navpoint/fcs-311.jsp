...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_NYCRD2500TFW@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_NYCRD2500TFW10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_NYCRD2500TFW@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_NYCRD2500TFW10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_NYCRD2500TFW10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_NYCRD2500TFW10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_NYCRD2500TFW@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>NYC Restaurants Divert 2,500 Tons of Food Waste</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>NYC Restaurants Divert 2,500 Tons of Food Waste</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/26/nyc-restaurants-divert-2500-tons-of-food-waste/" target="_blank">Environmental Leader, Published 26 November 2013</a></em></p>
<p>New York City restaurants have diverted more than 2,500 tons of food waste from landfills in the past six months, the Associated Press reports.</p>
<p>The food from 100 restaurants participating in the city&rsquo;s voluntary Food Waste Challenge has been used as compost or donated to food banks.</p>
<p>Mayor Michael Bloomberg plans to expand the program to hotels, stadiums and other large producers of food waste, the news agency reports. New York officials are working to launch a cloud-based software platform that will track waste and evaluate it for more efficient pickup or delivery.</p>
<p>Food waste currently comprises one-third of the city&rsquo;s more than 20,000 tons of daily refuse.</p>
<p><span style="line-height: 1.3em;">New York is not alone in its efforts to reduce food waste. Starting in July 2014, large swathes of commercial food waste in Massachusetts will be converted into energy via anaerobic digesters, according to plans proposed by Gov. Deval Patrick&rsquo;s administration. In August, Boston began piloting its first public composting program, inviting residents to drop off compostable food scraps for free at three city farmers&rsquo; markets.<br /></span></p></div></div>
</div>
