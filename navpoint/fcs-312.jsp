...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_GHBBMRE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_GHBBMRE10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_GHBBMRE@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_GHBBMRE10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_GHBBMRE10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_GHBBMRE10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_GHBBMRE@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Guide Helps Businesses Become More Resource Efficient</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Guide Helps Businesses Become More Resource Efficient</h1>
<p><em>From <a href="http://www.environmentalleader.com/2013/11/26/guide-helps-businesses-become-more-resource-efficient/" target="_blank">Environmental Leader, Published 26 November 2013</a></em></p>
<p>LRS Consultancy and UK law firm Burges Salmon have published a guide to give businesses practical guidance on how to become more resource efficient.</p>
<p><a href="http://www.lrsconsultancy.com/news-events/publications.aspx" target="_blank">A Practical Path to Resource Efficiency</a>&nbsp;is aimed at <a href="http://www.environmentalleader.com/category/sustainable-manufacturing/" target="_blank">manufacturers</a>, retailers and brand managers, as well as their supply chain partners, to give them a better understanding of how resource&nbsp;<a href="http://www.environmentalleader.com/category/efficiency/" target="_blank">efficiency</a>&nbsp;can benefit them. It provides ideas about how to make better use of materials and energy, the firms say.</p>
<p>The guide provides case studies showing how other companies have looked at their supply chains and their own businesses and implemented resource efficiencies. It also helps companies to understand what they should consider in terms of materials and energy security to make their&nbsp;<a href="http://www.environmentalleader.com/category/sustainable-supply-chain/" target="_blank">supply chains more sustainable</a>.</p></div></div>
</div>
