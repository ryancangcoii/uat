...
<section  ><%-- Widget fcs.pages.resources_newsletters_CSBM_PDOJBAGBC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesresources_newsletters_CSBM_PDOJBAGBC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.resources_newsletters_CSBM_PDOJBAGBC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesresources_newsletters_CSBM_PDOJBAGBC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesresources_newsletters_CSBM_PDOJBAGBC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/resource_newsletter.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesresources_newsletters_CSBM_PDOJBAGBC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.resources_newsletters_CSBM_PDOJBAGBC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-108">Resources</a> &raquo; <a href="/ttsvr/n/fcs-110">Newsletters</a> &raquo; <a href="/ttsvr/n/fcs-265">January 2014 - Constructing Sustainable Business Models</a> &raquo; <span>Philippine DOJ Backs Adoption of Green Building Code</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Philippine DOJ Backs Adoption of Green Building Code</h1>
<p>From <a href="http://www.cleanbiz.asia/news/philippine-doj-backs-adoption-green-building-code#.Up7ox9IW13s" target="_blank">CleanBiz.Asia, Published 02 December 2013</a></p>
<p>The Philippines Department of Justice (DOJ) has approved the Department of Public Works and Highways (DPWH) addition of green-building regulations in the National Building Code of the Philippines (NBCP).</p>
<p>In a nine-page legal opinion, Justice Secretary Leila de Lima said the power of the DPWH to issue implementing rules and regulations (IRR) for the effective implementation of the provisions of the NBCP under Presidential Decree 1096 includes the power to amend or revise the same under the doctrine of necessary implications, according to a report in the&nbsp;<em>Business Monitor</em>.</p>
<p>However, de Lima reminded the DPWH that any amendment or revision of the IRR of the NBCP, including the green-building regulations, must not go beyond and contradict the purposes and standards prescribed by the law.</p>
<p>Besides amending the NBCP&rsquo;s IRR and existing referral codes, the DOJ said the DPWH may also craft a separate referral code, to be known as Green Building Code, in order to expedite the adoption of the green-building regulation.</p>
<p>On the issue of whether compliance to the green-building regulation should be made mandatory or directory, the DOJ noted that Section 102 of the NBCP mandates the government to &ldquo;safeguard life, health, property, and public welfare, consistent with the principle of sound environmental management and controls.&rdquo;</p>
<p>The county&rsquo;s Green Building Code follows the <a href="http://www.usgbc.org/leed" target="_blank">LEED</a> (Leadership in Energy and Environmental Design) certification standard.</p></div></div>
</div>
