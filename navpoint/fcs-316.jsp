...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_COMPANYDONTCOLLECT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_COMPANYDONTCOLLECT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_COMPANYDONTCOLLECT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_COMPANYDONTCOLLECT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Companies Don’t Collect Potential Savings from Cutting Carbon in Supply Chains";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sustainable-planet.gif\"";
	String snippetVar_date = "Tuesday, January 31, 2012";
	String snippetVar_excerpt = "Despite improving their own carbon performance, multinational companies are not yet demonstrating significant emissions reductions in their supply chains, according to research published today by theCarbon Disclosure Project (CDP) and Accenture. The...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/sustainable-planet.gif\">Despite improving their own carbon performance, multinational companies are not yet demonstrating significant emissions reductions in their supply chains, according to research published today by theCarbon Disclosure Project (CDP) and Accenture. The survey of 50 CDP member companies, including L’Oréal, Philips and Walmart, and more than 1,800 of their suppliers revealed that while 43 percent of companies have achieved year-on-year emissions reductions, only 28 percent of suppliers have done so.<br /><br /><i>To read the full article from Sustainable Planet, please<a href=http://www.sustainableplant.com/2012/01/companies-don-t-collect-potential-savings-from-cutting-carbon-in-supply-chains/ target=“_blank”>  click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_COMPANYDONTCOLLECT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
