...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_HARNESSINGSUSTAIN10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_HARNESSINGSUSTAIN10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_HARNESSINGSUSTAIN10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_HARNESSINGSUSTAIN10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Harnessing Sustainability Data to Gain Competitive Advantage";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/medical-construction-and-design.gif\"";
	String snippetVar_date = "Saturday, November 12, 2011";
	String snippetVar_excerpt = "To read the full article from Medical Construction and Design, please click here.    ";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/medical-construction-and-design.gif\"><i>To read the full article from Medical Construction and Design, please<a href=http://www.sustainableplant.com/2012/01/companies-don-t-collect-potential-savings-from-cutting-carbon-in-supply-chains/ target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_HARNESSINGSUSTAIN@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
