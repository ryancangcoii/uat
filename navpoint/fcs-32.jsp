...
<section  ><%-- Widget fcs.pages.solutions_industry_education@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_education10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_education.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_education@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_education10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_education10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_education.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_education10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_education@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Education</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Management &amp; Sustainability Consulting for Educational Institutions</h1>
<h3>Achieve efficiency and leadership</h3>
<p>Schools and universities are often leaders in <a href="/ttsvr/solutions/by-focus/sustainability">sustainability practices</a> &ndash; in part because they are not only under constant pressure to reduce costs and resource consumption, but also because they have a unique role in our society as environmental stewards and innovators. FirstCarbon Solutions works with institutions large and small to manage their <a href="/ttsvr/solutions/by-focus/energy">energy</a>, <a href="/ttsvr/solutions/by-focus/environmental/water-management">water</a> and resource costs and support their environmental leadership.</p>
<p>Heating, cooling, and lighting &ndash; especially in your data centers and other technology-intensive facilities &ndash; are major operating cost drivers for academic campuses. FirstCarbon Solutions will help you audit and reduce those costs, find opportunities for conservation and waste reduction, and implement <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> plans that will significantly improve your financial health.</p>
<p>Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable efficiency.</p>
<h3>Supporting your goals with special institutional promotions</h3>
<p>FirstCarbon Solutions' University Licensing Program enables accredited universities to purchase FirstCarbon Solutions <a href="/ttsvr/solutions/by-service/software/ghgtrack"><em>ghgTrack</em></a> and <a href="/ttsvr/solutions/by-service/consulting">consulting</a> services at a 20% discount. This program is a cost-effective offering that enables universities of any size to generate even higher ROI from their sustainability efforts.</p>
<p><a href="/ttsvr/about-us/contact-us">Contact</a> us for more details about this university-specific offer.</p></div></div>
</div>
