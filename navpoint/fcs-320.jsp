...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_SMIF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_SMIF10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SMIF@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_SMIF10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_SMIF10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_SMIF10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SMIF@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_SMIF@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Sustainability: Market Increases Focus on Good Corporate Citizenship";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/financial-times.gif\"";
	String snippetVar_date = "Tuesday, November 08, 2011";
	String snippetVar_excerpt = "To read the full article from Financial Times, please click here.   ";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/financial-times.gif\"><i>To read the full article from Financial Times, please<a href=http://www.ft.com/intl/cms/s/a43ddae8-00b3-11e1-8590-00144feabdc0,Authorised=false.html?_i_location=http%3A%2F%2Fwww.ft.com%2Fcms%2Fs%2F0%2Fa43ddae8-00b3-11e1-8590-00144feabdc0.html&_i_referer=http%3A%2F%2Fwww.firstcarbonsolutions.com%2Fnews-news-market-increases-focus-on-good-corporate-citizenship.php#axzz1kM0eOjVp target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SMIF@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SMIF@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
