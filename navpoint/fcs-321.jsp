...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_DEMANDFORCARBON@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_DEMANDFORCARBON10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_DEMANDFORCARBON@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_DEMANDFORCARBON10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_DEMANDFORCARBON10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_DEMANDFORCARBON10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_DEMANDFORCARBON@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_DEMANDFORCARBON@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Demand for Carbon Transparency Increases in the Global Supply Chain ";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/edie-water.gif\"";
	String snippetVar_date = "Monday, November 07, 2011";
	String snippetVar_excerpt = "FirstCarbon Solutions director business development (Europe), Charles Hansard,writes for edie energy on the growth in carbon transparency in the global supply chain To read the full article from Edie Water, please...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/edie-water.gif\">FirstCarbon Solutions director business development (Europe), Charles Hansard,writes for edie energy on the growth in carbon transparency in the global supply chain<br /><br /><i>To read the full article from Edie Water, please<a href=http://www.edie.net/library/view_article.asp?id=6038&title=Demand+for+carbon+transparency+increases+in+the+global+supply+chain%20%20 target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_DEMANDFORCARBON@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_DEMANDFORCARBON@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
