...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_SCORINGSYSTEM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_SCORINGSYSTEM10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SCORINGSYSTEM@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_SCORINGSYSTEM10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_SCORINGSYSTEM10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_SCORINGSYSTEM10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SCORINGSYSTEM@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_SCORINGSYSTEM@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Scoring System Devised to Calculate Carbon";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/blue-and-green.gif\"";
	String snippetVar_date = "Thursday, November 03, 2011";
	String snippetVar_excerpt = "Scoring System Devised to Calculate CarbonThe Carbon Disclosure Project and FirstCarbon Solutions have joined forces to put together a carbon emissions scoring system. Alex Blackburne finds out about it. To read...";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/blue-and-green.gif\">The Carbon Disclosure Project and FirstCarbon Solutions have joined forces to put together a carbon emissions scoring system. Alex Blackburne finds out about it.<br /><br /><i>To read the full article from Blue and Green, please<a href=http://blueandgreentomorrow.com/2011/11/3/scoring-system-devised-to-calculate-carbon-emissions/ target=“_blank”> click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_SCORINGSYSTEM@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_SCORINGSYSTEM@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
