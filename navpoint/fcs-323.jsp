...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_REDUCEEMISSION@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_REDUCEEMISSION10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_REDUCEEMISSION@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_REDUCEEMISSION10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_REDUCEEMISSION10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_REDUCEEMISSION10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_REDUCEEMISSION@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_REDUCEEMISSION@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Reduce Emissions Save Money";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/electricity-today.gif\"";
	String snippetVar_date = "Sunday, October 30, 2011";
	String snippetVar_excerpt = "To read the full article from Electricity Today, please click here.    ";
	String snippetVar_content = "<p><img src=\"/ttsvr/fcs/images/news/electricity-today.gif\"><i>To read the full article from Electricity Today, please <a href=\"http://online.electricity-today.com/doc/electricity-today/et_oct2011_digital/2011102401/#20\" target=\"“_blank”\">click here.</a></i> </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_REDUCEEMISSION@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_REDUCEEMISSION@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
