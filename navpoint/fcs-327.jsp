...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCCDPROJECT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCCDPROJECT10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCCDPROJECT@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCCDPROJECT10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCCDPROJECT10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCCDPROJECT10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCCDPROJECT@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCCDPROJECT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon, Carbon Disclosure Project Collaborate on CO2 Reporting";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/world-fuels.com.gif\"";
	String snippetVar_date = "Thursday, October 20, 2011";
	String snippetVar_excerpt = "To read the full article from WorldFuels.com, please click here.";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/world-fuels.com.gif\">  <i>    To read the full article from WorldFuels.com, please     <a href=\"http://www.worldfuels.com/archives/Global-Refining-Fuels-Today/3/202/FirstCarbon-Carbon-Disclosure-Project-Collaborate-COspan-stylevertical-align-sub-font-size70-2span-Reporting_49361\" target=\"_blank\">      click here.    </a>  </i>  </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCCDPROJECT@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCCDPROJECT@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
