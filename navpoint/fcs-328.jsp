...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPLAUNCHESSES10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPLAUNCHESSES10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPLAUNCHESSES10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPLAUNCHESSES10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "CDP Launches Supplier Emissions Scoring";
	...
	String snippetVar_excerpt = "The Carbon Disclosure Project and FirstCarbon Solutions have launched an initiative to score the CDP Supply Chain program, with performance scores introduced for the first time. To read the full article...";
	String snippetVar_content = "<p>    <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">  The Carbon Disclosure Project and FirstCarbon Solutions have launched an initiative to score the CDP Supply Chain program, with performance scores introduced for the first time.<br /><br />  <i>To read the full article from Environmental and Energy Management News, please<a href=http://www.environmentalleader.com/2011/10/20/cdp-launches-supplier-emissions-scoring/ target=\"_blank\">  click here.</a>      </i></p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPLAUNCHESSES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
