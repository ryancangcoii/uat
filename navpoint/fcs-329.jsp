...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSPCARBOND@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSPCARBOND10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSPCARBOND@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSPCARBOND10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSPCARBOND10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSPCARBOND10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSPCARBOND@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSPCARBOND@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions Partners with Carbon Disclosure";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/logistics-week.gif\"";
	String snippetVar_date = "Thursday, October 20, 2011";
	String snippetVar_excerpt = " FirstCarbon Solutions Partners with Carbon Disclosure  FirstCarbon Solutions, a pioneer and industry leader in environmental business intelligence announced on October 18, 2011, a partnership with the Carbon Disclosure Project (CDP) in which FirstCarbon Solutions will score...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/logistics-week.gif\">FirstCarbon Solutions, a pioneer and industry leader in environmental business intelligence announced on October 18, 2011, a partnership with the Carbon Disclosure Project (CDP) in which FirstCarbon Solutions will score all company submissions to CDP Supply Chain, a programme which works with global corporations to understand the impacts of climate change across the supply chain.          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSPCARBOND@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSPCARBOND@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
