...
<section  ><%-- Widget fcs.pages.solutions_industry_finance@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_finance10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_environmental_finance.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_finance@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_finance10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_finance10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental_finance.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_finance10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_finance@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Finance</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Finance</h1>
<h3>Improving your operations and your investments</h3>
<p>Whether you&rsquo;re a bank or a hedge fund, FirstCarbon Solutions will help you achieve sustainable profitability both in your internal operations and the investments you make.</p>
<p>Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting </a>and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable profitability in finance.</p>
<h3>Due diligence services</h3>
<p>We offer <a href="/ttsvr/solutions/by-service/consulting">expert services</a> for conducting Phase I and Phase II site assessments to establish your financial risk from an energy, water, and resource cost perspective. And we will quantify and validate the CO<sub>2</sub>e savings used to finance projects.</p>
<h3>Inside your walls</h3>
<p>Heating, cooling, and lighting &ndash; especially in your data centers and other technology-intensive facilities &ndash; are often a primary cost driver for your operations. FirstCarbon Solutions will help you audit and reduce those costs, find opportunities for conservation and waste reduction, and implement <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> plans that will significantly improve your financial health.</p></div></div>
</div>
