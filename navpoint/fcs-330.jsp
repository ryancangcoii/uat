...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_CDPISSUESCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_CDPISSUESCS10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPISSUESCS@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_CDPISSUESCS10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_CDPISSUESCS10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_CDPISSUESCS10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPISSUESCS@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_CDPISSUESCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Carbon Disclosure Project to Issue Supply Chain Scores";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sustainable-brands.gif\"";
	String snippetVar_date = "Wednesday, October 19, 2011";
	String snippetVar_excerpt = "The Carbon Disclosure Project (CDP) will for the first time add a scoring system to its supply chain program through a new partnership with FirstCarbon Solutions. To read the full article from...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/sustainable-brands.gif\">The Carbon Disclosure Project (CDP) will for the first time add a scoring system to its supply chain program through a new partnership with&nbsp;FirstCarbon Solutions.<br><br> <i>To read the full article from Sustainable Brands, please<a href=\"http://www.sustainablebrands.com/news_and_views/articles/carbon-disclosure-project-issue-supply-chain-scores\" target=\"“_blank”\"> click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_CDPISSUESCS@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_CDPISSUESCS@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
