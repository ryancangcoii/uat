...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCFPARTNERCDP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCFPARTNERCDP10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCFPARTNERCDP@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCFPARTNERCDP10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCFPARTNERCDP10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCFPARTNERCDP10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCFPARTNERCDP@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCFPARTNERCDP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Forms Partnership with CDP";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/ebr.gif\"";
	String snippetVar_date = "Wednesday, October 19, 2011";
	String snippetVar_excerpt = "FirstCarbon Solutions will form partnership with the Carbon Disclosure Project (CDP), in which FirstCarbon will score all company submissions to CDP supply chain. To read the full article from Sustainable Brands,...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/ebr.gif\">FirstCarbon Solutions will form partnership with the Carbon Disclosure Project (CDP), in which FirstCarbon will score all company submissions to CDP supply chain.<br /><br />  <i>To read the full article from Sustainable Brands, please <a href=http://carbon.energy-business-review.com/news/firstcarbon-forms-partnership-with-cdp-191011 target=“_blank”>click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCFPARTNERCDP@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCFPARTNERCDP@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
