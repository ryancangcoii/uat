...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_NEWSCORECARD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_NEWSCORECARD10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NEWSCORECARD@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_NEWSCORECARD10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_NEWSCORECARD10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_NEWSCORECARD10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NEWSCORECARD@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_NEWSCORECARD@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "New Scorecard Developed to Track Green Supply Chains";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/mh-l.giff\"";
	String snippetVar_date = "Tuesday, October 18, 2011";
	String snippetVar_excerpt = "FirstCarbon Solutions, a provider of sustainability solutions, has formed a partnership with the Carbon Disclosure Project (CDP) in which FirstCarbon Solutions will score all company submissions to CDP Supply Chain, a program...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/mh-l.gif\">FirstCarbon Solutions, a provider of sustainability solutions, has formed a partnership with the Carbon Disclosure Project (CDP) in which FirstCarbon Solutions will score all company submissions to CDP Supply Chain, a program which works with global corporations to understand the impacts of climate change across the supply chain. CDP, an independent not-for-profit organization, provides a global system for organizations to measure, disclose, manage and share climate change information.<br /><br />  <i>This article was published on MH&L.</i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_NEWSCORECARD@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_NEWSCORECARD@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
