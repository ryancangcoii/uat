...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_MANYCOMPANIESSTRUGGLES10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_MANYCOMPANIESSTRUGGLES10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_MANYCOMPANIESSTRUGGLES10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_MANYCOMPANIESSTRUGGLES10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Many Companies Struggle to Get Environmental Data from Systems";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/environmental-leader.gif\"";
	String snippetVar_date = "Monday, October 17, 2011";
	String snippetVar_excerpt = "Major companies are generally satisfied with the accuracy and completeness of data in their sustainability performance management systems, but 39 percent say the systems are poorly integrated and 38 percent...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/environmental-leader.gif\">Major companies are generally satisfied with the accuracy and completeness of data in their sustainability performance management systems, but 39 percent say the systems are poorly integrated and 38 percent say it’s too hard to get the data they need, according to a report by Green Research.<br /><br />  <i>To read the full article from Environmental and Energy Management News, please <a href=http://www.environmentalleader.com/2011/10/17/many-companies-struggle-to-get-environmental-data-from-systems/ target=“_blank”>click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_MANYCOMPANIESSTRUGGLES@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
