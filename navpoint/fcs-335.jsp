...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_FCSENVERITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_FCSENVERITY10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSENVERITY@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_FCSENVERITY10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_FCSENVERITY10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_FCSENVERITY10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSENVERITY@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_FCSENVERITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "FirstCarbon Solutions acquires Enverity";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/mobility-techzone.gif\"";
	String snippetVar_date = "Thursday, February 03, 2011";
	String snippetVar_excerpt = "FirstCarbon Solutions acquires Enverity  Feb 03, 2010 (Datamonitor Financial Deals Tracker via COMTEX) -- FirstCarbon Solutions, Inc., an environmental management outsourcing company, has acquired Enverity Corporation, an environmental software provider. Both the companies are...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/mobility-techzone.gif\">Feb 03, 2010 (Datamonitor Financial Deals Tracker via COMTEX) -- FirstCarbon Solutions, Inc., an environmental management outsourcing company, has acquired Enverity Corporation, an environmental software provider. Both the companies are based in the US.<br><br>  <i>To read the full article from Mobility Techzone, please <a href=\"http://www.mobilitytechzone.com/news/2010/02/03/4603366.htm\" target=\"“_blank”\">click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_FCSENVERITY@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_FCSENVERITY@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
