...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_performanceReview@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_performanceReview10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_performanceReview@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_performanceReview10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_performanceReview10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_performanceReview10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_performanceReview@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Performance Review</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Performance Review</h3>
<p>If you're looking to improve your score, but aren't quite sure where to begin, let FCS give you a Performance Review for this year's disclosure.&nbsp;</p>
<p>After three years of scoring thousands of CDP questionnaires, FCS recognizes that <strong>participating companies are losing a significant number of points for two reasons</strong>:</p>
<ul>
<li>A company doesn't have all the necessary processes and practices in place for a full-fledged climate change management system</li>
<li>The answers are not properly structured to achieve the maximum points based upon the CDP scoring methodology.</li>
</ul>
<p>According to CDP, "<strong>FCS' services will be more in depth, insightful, and aimed at helping suppliers improve</strong>, rather than a simple admin check of responses." In fact, 100% of our CDP clients improved their score year-over-year from 2012-2013.</p>
<p>This <strong>free, 30-minute consultation</strong> will help you interpret this year's scores, so that you can formulate a plan for improving your organization's CDP score and environmental performance.</p>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p>
<p><strong>Find out about our other services. <br /> </strong> <a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a>&nbsp; | &nbsp;<a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>PERFORMACE REVIEW</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/4d9b9111-42d4-4382-bd1d-d677f9b2a2da" method="POST" role="form" novalidate>
