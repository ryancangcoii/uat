...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_responseCheck@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_responseCheck10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_responseCheck@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_responseCheck10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_responseCheck10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_responseCheck10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_responseCheck@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Response Check</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Response Check</h3>
<p>As a Gold Consultancy Partner of CDP, FCS will review your CDP Response to make sure it's complete and accurate <strong>BEFORE</strong> you submit it, potentially increasing your chances of receiving a higher score. From 2012-2013, 100% of our CDP clients improved their score year-over-year.</p>
<p>Our team of CDP-trained experts will review your response, provide written feedback for you to incorporate into your response, and follow up with a phone call to review the information. FCS provides a review of your CDP Response, <strong>saves you time</strong>, helps you <strong>avoid detrimental mistakes</strong> and <strong>relieves the pressure from your internal resources</strong>.</p>
<p>With our typical Response Check turnaround time of 5 business days, we'll keep you ahead of the response due date. For a nominal fee, you'll get feedback on:</p>
<ul>
<li>Incomplete or <strong>missing information</strong></li>
<li>Any answers provided in an <strong>inappropriate place or format</strong></li>
<li><strong>Data points</strong> that you should address in your qualitative response</li>
<li>Misdirected or <strong>misunderstood responses</strong></li>
<li><strong>Priority areas</strong> that are weighted more heavily in the scoring.</li>
</ul>
<p>Fill out the form on this page to speak with one of our CDP Experts about your individual situation.</p>
...
<p><strong>Find out about our other services. <br /> </strong><a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a>&nbsp; | &nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>RESPONSE CHECK</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/4d3acceb-c2d3-42ab-8b9c-6a9456be4a07" method="POST" role="form" novalidate>
