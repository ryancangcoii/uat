...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_scoringAssessment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_scoringAssessment10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_scoringAssessment@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_scoringAssessment10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_scoringAssessment10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_scoringAssessment10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_scoringAssessment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Scoring Assessment</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Scoring Assessment</h3>
<p>When you choose FCS's Scoring Assessment, you gain access to our unique experience with CDP's scoring methodology and unmatched resource of thousands of CDP responses.&nbsp;</p>
<p>FCS's Scoring Assessment takes Response Check a step further.&nbsp; It's more than a cursory, question-by-question check that ensures you've provided an answer to each question.&nbsp; Further, we review the substance of every response you provide in your CDP questionnaire, and recommend how to <strong>better answer and structure each question to receive the maximum number of points</strong> for each question.</p>
<p>FCS runs your organization's completed questionnaire through the CDP scoring process <strong>BEFORE your formal submission</strong>.&nbsp; This process identifies the points that would be assigned, as well as the points that would be lost, for each question.&nbsp; Armed with that information, FCS prepares a report that provides:</p>
<ul>
<li><strong>Details</strong> on the points lost</li>
<li>An <strong>explanation</strong> of why points were lost</li>
<li><strong>Suggestions</strong> for improvement.</li>
</ul>
<p>Our cost-effective solution arms you with detailed information to help revise and restructure your answers to the CDP questionnaire to improve your company's CDP Disclosure and Performance scores. In 2013, our clients improved their disclosure scores 30% overall vs. the prior year, with one client receiving CPLI status for the first time. Fill out the form on this page to speak with one of our CDP Experts about your individual situation.</p>
<table class="table table-striped table-bordered">
<thead>
<tr>
<td class="text-center">&nbsp;</td>
<td class="text-center">FCS Response Check</td>
<td class="text-center">FCS Scoring Assessment</td>
</tr>
</thead>
<tbody>
<tr>
<td>Reviews <strong>completion</strong> of responses</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Highlights missing and misunderstood responses</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Showcases priority areas weighted more heavily</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Reviews <strong>substance</strong> of every response</td>
<td>&nbsp;</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Provides recommendations to better structure answers</td>
<td>&nbsp;</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Identifies points awarded for each answer</td>
<td>&nbsp;</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
<td>Explains why points are lost</td>
<td>&nbsp;</td>
<td class="text-center"><img src="/ttsvr/fcs/images/checkmark.png" alt="" /></td>
</tr>
<tr>
...
<p><strong>Find out about our other services. <br /> </strong><a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a> &nbsp;|&nbsp; </strong> <a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a>&nbsp; | &nbsp;<a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>SCORING ASSESSMENT</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/078d9a61-0a34-4019-bfb9-e06c741ce2bc" method="POST" role="form" novalidate>
