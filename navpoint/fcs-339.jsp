...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_gapAnalysis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_gapAnalysis10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_gapAnalysis@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_gapAnalysis10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_gapAnalysis10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_gapAnalysis10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_gapAnalysis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Gap Analysis</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Gap Analysis</h3>
<p>If you've received your CDP score, and are ready to take action, look to FCS for a Gap Analysis to put the wheels in motion.&nbsp;</p>
<p>FCS's Gap Analysis specifically determines, question by question, what points were not achieved in your current submission by reviewing your questionnaire, comparing your answers to the scoring requirements, and, when necessary, interviewing your staff to get more information on company practices and processes as they relate to CDP requirements.&nbsp; Using this baseline research, FCS identifies:</p>
<ul>
<li>Points not achieved</li>
<li>Estimated reasons for the loss of points</li>
<li>Action items necessary to achieve lost points,</li>
</ul>
<p>and provides you with <strong>a matrix of required activities to improve your score</strong>. In fact, 100% of our CDP clients improved their score year-over-year from 2012-2013.</p>
<p>This report gives you a <strong>solid foundation to plan your efforts</strong> in better aligning your activities and answers with the CDP scoring methodology for an affordable price.</p>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p>
<p><strong>Find out about our other services. <br /> </strong><a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a> &nbsp;|&nbsp; </strong> <a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a>&nbsp; | &nbsp;<a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>GAP ANALYSIS</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/ab8c4876-b5b5-4682-afe1-ffb21fc7d9e6" method="POST" role="form" novalidate>
