...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_dataCollection@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_dataCollection10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_dataCollection@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_dataCollection10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_dataCollection10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_dataCollection10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_dataCollection@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Data Collection</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Data Collection</h3>
<p>If carbon accounting and reporting is a priority for you, but seems like a lot to take on, FCS can help you capture, manage and upload your carbon inventory, as part of a fully managed carbon data collection and reporting solution.&nbsp; FCS specializes in translating disparate and diverse data sources into usable, clean information for your carbon reporting framework.&nbsp; Using our <em><a href="/ttsvr/solutions/by-service/software/ghgtrack" target="_blank"><strong>ghgTrack</strong></a></em>&nbsp;solution or working alongside your existing reporting software, FCS can manage it all with minimal intervention from your team.&nbsp; Our unmatched quality of service gets you a better end result, with <strong>increased scores</strong>, <strong>improved operational efficiencies</strong> and <strong>optimized resource use</strong>. In fact, our clients improved their 2013 disclosure scores 30% overall vs. the prior year, with one client receiving CPLI status for the first time.</p>
<p>With our CDP data collection service, you'll get:</p>
<ul>
<li><strong>Expertise.</strong>&nbsp; With FCS' trained professionals, you'll get a complete picture:&nbsp; inventory, gap analysis and recommendations for improvement.</li>
<li><strong>Quality.</strong>&nbsp; FCS' carbon management experts utilize thorough quality assurance processes with a 100% QC policy and double-key accuracy.</li>
<li><strong>Security.</strong>&nbsp; FCS' systems are in-line with the most stringent ISO and PCI-certified Data Security standards.</li>
<li><strong>Transparency.</strong>&nbsp; You can monitor our workflow any time with FCS' real-time process overview and client portal.</li>
<li><strong>Confidence.</strong>&nbsp; Your inventory will stand up to third-party verification and maximize your reporting scores, since the data we collect is in-line with the latest reporting requirements.</li>
<li><strong>Freedom.</strong>&nbsp; You and your team can refocus on more strategic activities by outsourcing the burdensome "data chase" to our team of experts.</li>
<li><strong>Flexibility.</strong>&nbsp; Instantly scale up and down to manage the seasonal demands of your reporting program.</li>
</ul>
<p>We customize and deliver tailor-made onshore and offshore solutions, providing cost-effective services for your CDP data collection, including:</p>
<ul>
<li>email and telephone notices and reminders</li>
<li>mailroom services</li>
<li>scanning and imaging</li>
<li>data capture and conversion</li>
<li>quality assurance and exception management</li>
<li>data and document storage</li>
<li>supply chain and research services.</li>
</ul>
<p>Our long-standing relationships with global organizations give FCS a wide breadth of experience managing the administration of compliance and sustainability processes, ensuring that your CDP data collection is processed effectively, efficiently and with the utmost integrity.</p>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p>
<p><strong>Find out about our other services. <br /> </strong> <a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>DATA COLLECTION</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/618eb55d-8eb2-4c1a-8cf0-e756ce82ea24" method="POST" role="form" novalidate>
