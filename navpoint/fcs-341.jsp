...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_CDPDisclosureCompletion@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_CDPDisclosureCompletion10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_CDPDisclosureCompletion@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_CDPDisclosureCompletion10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_CDPDisclosureCompletion10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_CDPDisclosureCompletion10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_CDPDisclosureCompletion@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <a href="/ttsvr/n/fcs-73">CDP Services</a> &raquo; <span>Disclosure Completion</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>CDP Disclosure Completion</h3>
<p>As the recognized global system for companies and cities to measure, disclose and share vital environmental information, CDP&rsquo;s questionnaire is extremely detailed and lengthy.&nbsp; And, with three years&rsquo; experience scoring the majority of CDP disclosures globally, FCS has extensive experience with this questionnaire.&nbsp;</p>
<p>Our unique, unmatched insight into CDP&rsquo;s scoring methodology allows FCS to help our Clients <strong>submit thorough, accurate and complete questionnaires,</strong> with the potential for the <strong>highest scores</strong>.&nbsp; In fact, from 2012-2013, 100% of our CDP clients improved their scores year-over-year.&nbsp; Maximize your potential and <strong>save your internal resources&rsquo; time and energy</strong> by consulting with FCS to complete your disclosure for you.</p>
...
<p><strong>Find out about our other services. <br /> </strong> <a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a> &nbsp;|&nbsp; <a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a></p></div></div>
</div>
...
<div  class="formsHub"><h3>DISCLOSURE COMPLETION</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/c2cc39c5-9fe5-47c3-80fe-54f54a9ba025" method="POST" role="form" novalidate>
