...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_CDPCaseStudies@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_CDPCaseStudies10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_CDPCaseStudies@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_CDPCaseStudies10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_CDPCaseStudies10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_CDPCaseStudies10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_CDPCaseStudies@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <span>CDP Case Studies</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>CDP Case Studies</h3>
<p>As the exclusive Scoring Partner for CDP's supply chain program in 2011 and 2012, as well as a Scoring Partner for CDP's Climate Change Program, FCS offers a unique experience to organizations disclosing to CDP. In fact, 100% of our CDP clients improved their score year-over-year from 2012-2013. Learn first-hand how FCS has collaborated with clients to better formulate their responses and develop a plan for long-term sustainability initiatives.</p>
<div class="cdp-cs cdp-cs-green">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-green.png" alt="" /></div>
<div class="cdp-cs-text">
<p>"FCS provided a quick and efficient service. The Scoring Assessment feedback was provided in a really clear format and so it was easy to see where we could make improvements. As FCS is an accredited partner of CDP, <strong>we feel confident with their advice and experience</strong>." -Madeleine Cobb, Sustainability Executive, <strong>Virgin Atlantic</strong><br /><a href="/ttsvr/fcs/pdf/casestudies/Virgin_Atlantic_casestudy_101813.pdf" target="_blank">Download the full Virgin Atlantic case study here.</a></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/virgin-atlantic-logo.png" alt="" /></div>
</div>
<div class="cdp-cs cdp-cs-blue">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-blue.png" alt="" /></div>
<div class="cdp-cs-text">
<p>&ldquo;<strong>Working with FCS has exceeded every expectation we had</strong>. While we expected them to help us establish our initial environmental sustainability program, we did not anticipate how quickly FCS would <strong>achieve incremental, measurable results</strong>.&rdquo; -Theresa Mathews, <strong>Cavium, Inc.</strong><br /><a href="/ttsvr/fcs/pdf/casestudies/sustainability-case-study-110613.pdf" target="_blank">Download the full Cavium, Inc. case study here.</a></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/cavium-logo.png" alt="" /></div>
</div>
<div class="cdp-cs cdp-cs-green">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-green.png" alt="" /></div>
<div class="cdp-cs-text">
<p>"Concerned by our CDP score, <strong>we turned to FCS to help us identify areas of improvement</strong>. Based on this consultation with FCS, we now have a much better idea of what activities and disclosures are required to improve Pochet's CDP score next year &ndash; and in the many years to follow." -Marianne Smati, <strong>Pochet du Courval</strong></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/pochet-du-courv-al-logo.jpg" alt="" /></div>
</div>
<div class="cdp-cs cdp-cs-blue">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-blue.png" alt="" /></div>
<div class="cdp-cs-text">
<p>"We realize that to progress, we need to measure. Our consultation with FCS reinforced our need to better communicate the risks and opportunities facing SWM International. In addition, <strong>FCS provided unique insight into how SWM International compared to other suppliers</strong>." -Juliette Audren, Sustainability Program Manager, <strong>SWM International</strong></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/swm-international.png" alt="" /></div>
</div>
<div class="cdp-cs cdp-cs-green">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-green.png" alt="" /></div>
<div class="cdp-cs-text">
<p>"Taking advantage of the consulting services provided by <strong>FCS was very useful and will absolutely help Vision-Ease improve</strong> how we approach some of our sustainability practices." -George Anderson, Environmental Health and Safety Engineer, <strong>Vision-Ease Lens</strong></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/vision-ease-lens.png" alt="" /></div>
</div>
<div class="cdp-cs cdp-cs-blue">
<div class="cdp-cs-quote"><img src="/ttsvr/fcs/images/cdpquote-blue.png" alt="" /></div>
<div class="cdp-cs-text">
<p>"After trying to analyze our CDP feedback on our own, we decided to talk to FCS for additional insights. <strong>The information FCS provided in this consultation was invaluable</strong> and gave me good direction and ideas on what American Licorice needs to work on this year." -Laurel Haas, Corporate Social Responsibility Manager, <strong>American Licorice Company</strong></p>
</div>
<div class="cdp-cs-logo"><img src="/ttsvr/fcs/images/casestudies/american-licorice-logo.png" alt="" /></div>
</div>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p></div></div>
</div>
<div  class="sec2RightCont col-sh  col-lg-3 col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><!-- Split button -->
<div class="btn-group btn-dropdown-block">
  <a href="/ttsvr/n/fcs-73" type="button" class="btn btn-info">CDP SERVICES</a>
  <a type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
    <span class="caret"></span>
    <span class="sr-only">Toggle Dropdown</span>
  </a>
  <ul class="dropdown-menu" role="menu">
    <li><a href="/ttsvr/n/fcs-336">Performance Review</a></li>
    <li><a href="/ttsvr/n/fcs-337">Response Check</a></li>
    <li><a href="/ttsvr/n/fcs-338">Scoring Assessment</a></li>
    <li><a href="/ttsvr/n/fcs-339">Gap Analysis</a></li>
      <li><a href="/ttsvr/n/fcs-340">Data Collection</a></li>
      <li><a href="/ttsvr/n/fcs-341">Disclosure Completion</a></li>
  </ul>
</div>

<a href="/ttsvr/n/fcs-74" class="btn btn-danger btn-block">Climate Change Program</a>
<a href="/ttsvr/n/fcs-75" class="btn btn-danger  btn-block">Supply Chain Program</a>
<a href="/ttsvr/n/fcs-342" class="btn btn-danger btn-block">Case Studies</a>
<a href="#" class="btn btn-danger btn-block" data-toggle="modal" data-target="#cdp-services-video" >Watch the CDP Video</a>
<a href="/ttsvr/n/fcs-343" class="btn btn-danger  btn-block">Ask the CDP Experts</a>

<div id="cdp-services-video" class="modal fade" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button class="close" type="button" data-dismiss="modal">&times;</button>
        <h4 id="myModalLabel" class="modal-title">Transform Your Business with FCS' CDP Services</h4>
      </div>
      <div class="modal-body">
        <iframe src="//www.youtube.com/embed/YdCLRvXP2Rc" width="100%" height="400" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
      </div>
    </div>
  </div>
</div>
</div>
<div  class="formsHub"><h3>CDP CASE STUDIES</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/b044793a-8f23-4da6-9244-d633f3a34d08" method="POST" role="form" novalidate>
