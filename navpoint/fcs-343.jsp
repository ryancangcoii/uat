...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_AskCDPExperts@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_AskCDPExperts10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_AskCDPExperts@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_AskCDPExperts10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_AskCDPExperts10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_AskCDPExperts10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_AskCDPExperts@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <span>Ask the CDP Experts</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Ask the CDP Experts</h3>
<p>Not sure which of our services is right for you?&nbsp;FCS can lead you through the entire process, to choose the best solution.</p>
<p><strong><a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review</a>:</strong>&nbsp; Our free, 30-minute consultation will help you interpret your scores.</p>
<p><strong><a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check</a>:</strong>&nbsp; With a multi-step process, FCS ensures your response is as complete as possible, saves you time and relieves pressure from your internal resources.</p>
<p><strong><a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment</a>:</strong>&nbsp; FCS runs your completed questionnaire through the CDP scoring process ahead of your formal submission, providing you with question level scores and suggestions for improvement.</p>
<p><strong><a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis</a>:</strong>&nbsp; Our in-depth analysis identifies areas and activities that correspond with lost points, and recommends activities to increase your score.</p>
<p><strong><a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection</a>:</strong>&nbsp; Outsource the tedious tasks of data gathering, collection, standardization, compiling and reporting of your carbon and energy information.</p>
<p><a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion"><strong>Disclosure Completion </strong></a>:&nbsp; FCS takes on the responsibility of completing your lengthy CDP questionnaire, freeing up your internal resources.</p>
<p>Contact our experts so they can evaluate your unique situation to better formulate your response and design a plan for long-term sustainability initiatives and reporting.</p>
<div class="space">&nbsp;</div>
