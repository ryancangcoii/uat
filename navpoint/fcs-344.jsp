...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_TSCRYSTALB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_TSCRYSTALB10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TSCRYSTALB@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_TSCRYSTALB10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_TSCRYSTALB10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_TSCRYSTALB10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TSCRYSTALB@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_TSCRYSTALB@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "The Sourcing Crystal Ball";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/sourcing-focus.gif\"";
	String snippetVar_date = "Monday, January 18, 2010";
	String snippetVar_excerpt = "As the business community settles into its post-festive comedown, it is customary to look to the future and guess at the brighter things to come. Visions of 2010 have been...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/sourcing-focus.gif\">As the business community settles into its post-festive comedown, it is customary to look to the future and guess at the brighter things to come. Visions of 2010 have been hitting the sourcingfocus.com newsdesk thick and fast and we have picked out the best of them including the much anticipated views of the National Outsourcing Association (NOA) board and membership.<br /><br />  <i>To read the full article from sourcingfocus.com, please <a href=http://www.sourcingfocus.com/site/featurescomments/2048 target=“_blank”>click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_TSCRYSTALB@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_TSCRYSTALB@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
