...
<section  ><%-- Widget fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_news_OUTSOURCINGCAC10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_news_OUTSOURCINGCAC10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_news_OUTSOURCINGCAC10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_news_OUTSOURCINGCAC10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><%-- Widget fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@12 (type=tooltwist.fcs.widgets.NewsArticleWidget) --%>
<%
try {
	String snippetVar_title = "Outsourcing the Carbon Accounting Chore";
	String snippetVar_imageThumb = "/ttsvr/fcs/images/news/e-commerce-times.gif\"";
	String snippetVar_date = "Monday, January 04, 2010";
	String snippetVar_excerpt = "Accounting for the amount of carbon a business emits is already a fact of life for some firms, and it could soon become business as usual for many more. Doing...";
	String snippetVar_content = "        <p>     <img src=\"/ttsvr/fcs/images/news/e-commerce-times.gif\">Accounting for the amount of carbon a business emits is already a fact of life for some firms, and it could soon become business as usual for many more. Doing the carbon accounting work in-house could be a major obstacle for companies worldwide as they scramble to deal with rising regulatory and market forces. Solutions for outsourcing the work are emerging.<br /><br />  <i>To read the full article from E-Business Means Business, please <a href=http://www.ecommercetimes.com/story/Outsourcing-the-Carbon-Accounting-Chore-69012.html target=“_blank”>click here.</a>      </i>          </p>";
	String snippetVar_widgetName = "@12";
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@12";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_news_OUTSOURCINGCAC@12 (type=tooltwist.fcs.widgets.NewsArticleWidget)", e);
}
%>
</div>
</div>
