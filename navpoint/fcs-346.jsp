...
<section  ><%-- Widget fcs.pages.requestaConsultation@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesrequestaConsultation10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.requestaConsultation@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesrequestaConsultation10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesrequestaConsultation10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesrequestaConsultation10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.requestaConsultation@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Request a Consultation</h1>
<p>Whether your strategy is calculating your carbon footprint, reducing your energy use or improving your supply chain's environmental performance, our consulting services combined with our sustainability management software and data processing solutions will ensure you achieve your ROI goals.</p>
<p>With some of the world's most experienced environmental and energy consultants on staff, FCS collaborates with you to help steer your business toward sustainable profitability.</p>
<p>Request a high level consultation with one of our sustainability and energy experts so you can rapidly identify and optimize resource use throughout your organization and supply chain, uncover and quantify hidden costs and inefficiencies, and discover new revenue opportunities.</p>
<p>FCS also provides <a href="/solutions/by-focus/cdp" target="_blank">CDP-specific consultations</a> for the <a href="/solutions/by-focus/cdp/supply-chain-program" target="_blank">Supply Chain program</a>and for the <a href="/solutions/by-focus/cdp/climate-change-program" target="_blank">Climate Change Program</a>.</p>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="http://cdn.firstcarbonsolutions.com/images/cdp-microsite/cdp-bottom-logo.png" alt="" width="130" border="0" /></a></p></div></div>
</div>
<div  class="sec2RightCont col-lg-3 col-sh col-md-3 col-sm-5 col-xs-12 noPad"><div  class="formsHub"><h3>REQUEST A CONSULTATION</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/93895060-d756-4174-8537-35eb25561813" method="POST" role="form" novalidate>
