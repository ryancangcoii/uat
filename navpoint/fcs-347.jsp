...
<section  ><%-- Widget fcs.pages.newsAndEvents_pressReleases_FTSE350@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesnewsAndEvents_pressReleases_FTSE35010BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.newsAndEvents_pressReleases_FTSE350@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesnewsAndEvents_pressReleases_FTSE35010BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesnewsAndEvents_pressReleases_FTSE35010BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/news_events_.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesnewsAndEvents_pressReleases_FTSE35010BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.newsAndEvents_pressReleases_FTSE350@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>FirstCarbon Solutions and CDP Announce Expanded Global Partnership to Include S&amp;P 500 and FTSE 350</h1>
<p><em>Three-year agreement designates FCS as CDP&rsquo;s global sustainability business process outsourcing partner and scoring provider across a greater global footprint</em></p>
<p>IRVINE, CA and LONDON, UK (March 12, 2014) &ndash; FirstCarbon Solutions (FCS), a pioneer in environmental and sustainability business solutions, and CDP today announced an expanded global scoring partnership, designating FCS as CDP&rsquo;s global sustainability business process outsourcing (BPO) partner under a three-year agreement.</p>
<p>FCS has been a CDP scoring partner since 2011, scoring over 6,400 company disclosures and providing guidance to help organizations track and improve environmental performance. FCS&rsquo; participation in CDP scoring activities has grown consistently over the course of the partnership, as they have added the Nordic, Benelux, India, and Australia/New Zealand regions to their role as CDP&rsquo;s exclusive supply chain program scoring partner.</p>
<p>Climate change, water scarcity, flooding, pollution and deforestation present material risks and opportunities for change. Not only does CDP provide an information platform for investors to protect their long term investments and reduce the risks arising from environmental externalities, it also helps organizations implement successful supplier engagement strategies, reduce supply chain emissions, control water impact and manage risk in a changing climate.</p>
<p>As CDP&rsquo;s global sustainability BPO partner, FCS will take on an expanded role in CDP&rsquo;s scoring programs and initiatives and manage a greater scope of work under CDP investor-led programs. In addition to continuing to provide scoring services for the CDP supply chain program and regional investor programs, FCS will now become the scoring partner for the S&amp;P 500 and FTSE 350 climate change disclosures &ndash; analyzing how market-leading companies are accelerating progress toward a lower-carbon future. FCS will also take on scoring disclosures for the CDP Southeast Asia region. As a result of its expanded role, FCS expects to score a total of 3,500 disclosures in 2014 alone.</p>
<p>CDP investor initiatives &ndash; backed in 2014 by more than 767 institutional investors representing an excess of US$92 trillion in assets &ndash; give investors access to a global source of year-on-year information that supports long-term objective analysis. This includes evidence and insight into companies&rsquo; greenhouse gas emissions, water usage and strategies for managing climate change, water and deforestation risks.</p>
<p>&ldquo;As one of our key partners,FCS has been a valuable asset to our investor and supply chain members and to CDP,&rdquo; says Nigel Topping, executive director at CDP. &ldquo;Now, this enhanced partnership positions them as our go-to solutions provider for any company looking to outsource environmental data collection from complex worldwide operations, and enhance the efficiency of this process. This will enable companies to spend more time on taking action to reduce emissions.&rdquo;</p>
<p>&ldquo;With a growing number of investment groups and customers requiring transparency in environmental, social and corporate governance (ESG), it becomes even more critical for organizations to participate in standards such as CDP to document their commitment to climate resiliency,&rdquo; says Robert Francisco, President at FCS. &ldquo;Our sustainability expertise along with our analytical capabilities aligns very well with CDP&rsquo;s mission to help organizations measure, disclose and improve their climate change strategies, and we&rsquo;re pleased to take a greater role as part of this mission and provide even more innovative services to suppliers, investors and member organizations.&rdquo;</p>
<p>In conjunction with the new partnership, FCS will retain its status as CDP gold consultancy partner and silver software partner. FCS will also provide consultation on the development of CDP&rsquo;s scoring processes and IT capabilities, and will again serve as lead scorer for CDP&rsquo;s on-demand scoring services.</p>
<p><strong>About CDP</strong><br /> CDP is an international, not-for-profit organization providing the only global system for companies and cities to measure, disclose, manage and share vital environmental information. CDP works with market forces, including 767 institutional investors with assets of US$92 trillion, to motivate companies to disclose their impacts on the environment and natural resources and take action to reduce them. CDP now holds the largest collection globally of primary climate change, water and forest risk commodities information and puts these insights at the heart of strategic business, investment and policy decisions. Please visit <a href="http://www.cdp.net" target="_blank">www.cdp.net</a> or follow us <a href="https://twitter.com/CDP" target="_blank">@CDP</a> to find out more.</p>
<p><strong>About FCS</strong><br /> FirstCarbon Solutions (FCS) advances sustainable practices around the world and helps organizations responsibly grow and operate. As a CDP partner scoring more than 6,400 CDP disclosures globally, FCS has unique experience managing climate change, water and resource efficiency risks and opportunities. With 30+ years of environmental, sustainability and energy consulting experience, and offices around the world, FCS helps clients save time, reduce costs, optimize resource use, and drive operational efficiencies. Please visit <a href="/ttsvr/solutions/by-focus/cdp">/ttsvr/solutions/by-focus/cdp</a> to find out more.</p>
<div class="row"><br />
