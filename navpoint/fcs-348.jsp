...
<section  ><%-- Widget fcs.pages.aboutus_careers_BiologistBotanist@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_BiologistBotanist10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_BiologistBotanist@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_BiologistBotanist10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_BiologistBotanist10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_BiologistBotanist10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_BiologistBotanist@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Biologist/Botanist</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Biologist/Botanist</h1>
<p>FCS is seeking a terrestrial Biologist/Botanist with strong wetland delineation skills to work in one of our Northern California offices of either Sacramento or Walnut Creek. The candidate should have between 4 and 7 years of experience and be familiar with standard procedures for conducting wetland delineations. Individuals with take permits for state and federally listed species preferred.</p>
<ul>
<li>Strong familiarity with terrestrial and aquatic ecology of Northern California.</li>
<li>Strong botanical skills including proficiency at conducting wetland delineations.</li>
<li>Familiarity with state and federal Clean Water Acts and Endangered Species Acts.</li>
<li>Take permits for listed species in Northern California preferred (VPFS, CTS, CRLF, GGS).</li>
</ul>
<p>Compensation will be commensurate with experience.</p>
<p>How to apply:</p>
<p>FirstCarbon Solutions is an equal opportunity employer. Please email your resume with cover letter and salary expectations to<a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with "Biologist/Botanist" in the subject heading.</p></div></div>
</div>
