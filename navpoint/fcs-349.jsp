...
<section  ><%-- Widget fcs.pages.aboutus_careers_Archaeologist@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_Archaeologist10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_Archaeologist@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_Archaeologist10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_Archaeologist10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_Archaeologist10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_Archaeologist@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Archaeologist</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Archaeologist</h1>
<div><ol><ol>
<li><strong>GENERAL DESCRIPTION</strong></li>
</ol></ol><br />
<p>Responsible for performing field surveys, field monitoring, managing field data, curating collections, and preparing written documentation of cultural resources studies and impact assessments.</p>
<ol><ol>
...
<ol><ol>
<ul>
<li>Reviews literature and maps, performs field surveys, collects and analyses data, and curates collections.</li>
<li>Schedules and supervises cultural resources field activities, including surveys, monitoring, and salvages.</li>
<li>Attends pre-construction meetings with contractor and client.</li>
<li>Maintains client contact, and serves as liaison between client, public agencies, and subconsultants.</li>
<li>Educates clients about compliance with cultural resource regulations; advises clients on options to minimize impacts on known cultural resources, and recommends courses of action.</li>
<li>Visits job sites on a regular basis in accordance with budget stipulations.</li>
<li>Monitors sites when necessary.</li>
<li>Reviews, tabulates, and plots field data.</li>
<li>Curates collections and arranges their transfers to client-designated repositories.</li>
<li>Prepares written documents based upon data interpretation for cultural resources impact assessments and mitigation.</li>
<li>Reviews and edits certain MBA cultural resources documents for format, style, accuracy, and completeness, and for compliance with local, state, and federal regulations governing the protection and management of cultural resources.</li>
</ul>
</ol></ol><br />
<p><strong>Business Development</strong></p>
<ol><ol>
<ul>
<li>Reviews (and generates) proposals, scopes of work, fee estimates, and contracts prior to submittal.</li>
<li>Assists in marketing MBA's cultural resources services through interaction with potential clients, active participation in appropriate organizations, preparation or review of news releases and articles, presentations at professional meetings, and other promotional activities.</li>
<li>Participates in marketing and business development activities by generating business leads, creating opportunities, preparing proposals, participating in interviews, and obtaining contracts.</li>
</ul>
</ol></ol><br />
<p><strong>Administrative/Financial</strong></p>
<ol><ol>
<ul>
<li>Keeps Senior Archaeologist and Section Manager informed of all project and business development matters.</li>
<li>Maintains assigned level of personal chargeability.</li>
<li>Monitors conformance with assigned project budgets and schedules.</li>
<li>Assists in monitoring staff's workload, coordinates schedules, and makes appropriate job assignments.</li>
<li>Procures, inventories, maintains, and distributes field and lab equipment and supplies.</li>
<li>Participates in screening and interviewing prospective candidates for technical staff positions in the Cultural Resources Management Division.</li>
</ul>
...
<ol><ol>
<ul>
<li>M.S./M.A. in anthropology, archaeology, geology, or paleontology.</li>
<li>Minimum of 6 years experience as a professional archaeologist (SOPA or ROPA) or paleontologist.</li>
<li>Minimum of 3 years supervising laboratory or field crews.</li>
<li>Expertise in southern California archaeology or paleontology with recognition among the regional scientific community, and general knowledge of the other Cultural Resources discipline.</li>
<li>Familiarity with information resources in the scientific community, including other archaeologists and paleontologists, college and university programs, research centers and libraries, and data depositories.</li>
<li>Familiarity with sections relating to cultural resources in the California Environmental Quality Act (CEQA), the National Environmental Policy Act (NEPA), the National Historic Preservation Act as Amended, Executive Order 11593, and the Mitigation Guidelines of the Society of Vertebrate Paleontologists.</li>
</ul>
</ol></ol><br />
<p><strong>Professional Abilities and Personal Character</strong></p>
<ol><ol>
<ul>
<li>Has highly efficient and productive working habits and can handle multiple assignments simultaneously.</li>
<li>Demonstrates excellent analytical and verbal communication skills.</li>
<li>Has superior skills in preparing written documents.</li>
<li>Effectively negotiates sufficient fees and determines contract terms.</li>
<li>Prepares clear and appropriate scopes of work.</li>
<li>Executes contracts and secure amendments in a timely manner.</li>
<li>Supervises establishment of subcontracts and ensures timely and successful subcontractor performance.</li>
<li>Utilizes strong interpersonal skills to inspire cooperation and motivation among staff and clients.</li>
<li>Effectively supervises, trains, and enhances the capabilities of peers and subordinates.</li>
<li>Employs management skills that ensure efficient and successful completion of projects.</li>
<li>Demonstrates leadership skills by taking initiative, motivating and helping others, sharing pertinent knowledge, emphasizing teamwork, and providing feedback.</li>
<li>Proactively and creatively adapts to new work-related challenges.</li>
<li>Maintains a highly professional image in all work-related activities.</li>
<li>Supports company goals as evidenced by attitude, effort, and loyalty.</li>
</ul>
</ol></ol><br />
<p><strong>CAREER PATH</strong></p>
<ol><ol>
<ul>
<li class="first last">Senior Archaeologist</li>
</ul>
<li>How to apply:</li>
</ol></ol>
<p>FirstCarbon Solutions is an equal opportunity employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with "Archaeologist" in the subject heading. The successful candidate will hold office in Irvine, California, USA.</p>
</div></div></div>
</div>
