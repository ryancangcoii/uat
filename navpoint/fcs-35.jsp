...
<section  ><%-- Widget fcs.pages.solutions_industry_government@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_government10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_government.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_government@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_government10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_government10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_government.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_government10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_government@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Government</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Government Agencies</h1>
<h3>Leadership in efficiency</h3>
<p>Our government clients have unique needs. They must manage their own operations and facilities with extreme efficiency and shrinking budgets; they must serve as role models for sustainability; and they are tasked with managing large and complex programs to foster environmental sustainability in their constituencies.</p>
<p>At every step, FirstCarbon Solutions has the <a href="/ttsvr/solutions/by-service/consulting">consulting</a> expertise, <a href="/ttsvr/solutions/by-service/software">software</a>, and <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> services governments need to keep costs low and effectiveness high.</p>
<p>As a <a href="/ttsvr/n/fcs-227?">GSA Multiple Award Schedules contract-holder</a>, FirstCarbon Solution provides licenses and software implementation of <em>ghgTrack&trade; </em>and energy consulting services - both at a pre-negotiated prices.</p>
<h3>Do more with less</h3>
<p>Federal, state, and local governments can significantly reduce their operational costs in the face of shrinking budgets by outsourcing sustainability-related programs to the experts at FirstCarbon Solutions. We have the systems, people, and processes in place to take on a variety of government functions with proven quality customer service and dramatic cost benefits.</p>
<ul>
<li class="first">Energy Action Plans for <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> at distributed facilities, from parks and recreation to administrative installations</li>
<li>Managing <a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">rebate and incentive programs</a> for your constituency from program design to data management to claims processing</li>
<li><a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">Carbon footprinting</a> and <a href="/ttsvr/solutions/by-focus/environmental/water-management">water management consulting</a></li>
<li>Developing, benchmarking, and managing climate action plans and other <a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">regulatory requirements</a> in your jurisdiction such as California AB 32</li>
<li>Transportation planning and GHG assessment services for transport corridors, ports, and airport authorities, including GIS mapping</li>
<li>Designing and managing green purchasing programs and <a href="/ttsvr/solutions/by-focus/supply-chain/supplier-scorecards">supplier scorecards</a> for government agencies and procurement bodies</li>
<li class="last">Support for policy planning &ndash; designing what-if scenarios for water, energy, development and transportation policy</li>
</ul>
<h3>FirstCarbon Solutions in action for governments</h3>
<ul>
<li class="first">For the <a href="/ttsvr/clients/case-studies">Southern California Association of Governments</a>, FirstCarbon Solutions conducted energy, water, and GHG inventories for six counties and 191 cities.</li>
<li>In the United Kingdom, the Boiler Scrappage Scheme was designed to provide a rebate to homeowners for installing newer, more fuel-efficient boilers. FirstCarbon Solutions converted nearly 200,000 program documents into digital format, deployed a web app to streamline data retrieval times by 90%, enhanced customer service, and improved data security and audit trails for processed applications.</li>
<li class="last">For the <a href="/ttsvr/clients/case-studies">California Energy Commission's</a> Cash for Appliances rebate program, FirstCarbon Solutions oversees customer call center support, evaluation of rebate applications, and the process and approval of applications in a timely and cost-effective manner.</li>
</ul>
<p>Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a>, <a href="/ttsvr/solutions/by-service/software">software</a>, and <a href="/ttsvr/solutions/by-service/consulting/program-design-management">program management</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to ensure government organizations optimize their budgets and resources for the public good.</p></div></div>
</div>
