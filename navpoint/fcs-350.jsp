...
<section  ><%-- Widget fcs.pages.aboutus_careers_sustainabilityBusinessLeader@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_sustainabilityBusinessLeader10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_sustainabilityBusinessLeader@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_sustainabilityBusinessLeader10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_sustainabilityBusinessLeader10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_sustainabilityBusinessLeader10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_sustainabilityBusinessLeader@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Sustainability Business Leader</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h2>Sustainability Business Leader</h2>
<p>As a key member of the senior leadership team, this individual will leverage their broad experience, and work across teams &ndash; within the U.S. and across the FirstCarbon Solutions global leadership team to promote significant business growth and ensure profitability of this high growth potential business line.&nbsp; In this position, the incumbent will advance the company to the next level by leading the strategic vision, overseeing staffing and resource allocation, and anticipating and responding to the evolving market and customer needs. Managing the overall P&amp;L for this business line, the Sustainability Business Leader is responsible for managing solutions across: energy management, carbon management, supply chain sustainability, life cycle assessments, corporate social responsibility, data processing and management, and software solutions.</p>
<p><strong>Key Responsibilities</strong></p>
<p>Planning</p>
<ul>
<li class="first">Collaborates with the leadership team members around the world to define and articulate the organization&rsquo;s vision and to develop strategies for achieving that vision.</li>
<li>Creates and manages annual business plans and budgets that support company&rsquo;s overall strategic direction.</li>
<li>Evaluates and advises on the impact of short- and long-range planning; introduces new programs and strategies in anticipation of or response to evolving market and customer needs.</li>
<li>Prudently manages the team&rsquo;s resources while also continually looking for areas of growth and expansion necessary to meet the overall vision of the company.</li>
<li>Effectively develop solutions to meet client business challenges.</li>
<li class="last">Identify and provide strategic input and leadership on potential alliances or acquisitions.</li>
</ul>
<p>Management</p>
<ul>
<li class="first">Manages the P&amp;L for the business line and provides regular reports and updates to President and CEO on the health of the business.</li>
<li>Identifies and develops future leadership within the organization.</li>
<li>Promotes a culture that reflects the company&rsquo;s values, encourages good performance, and rewards high performers.</li>
<li>Keeps team up to date on company and business line activities and progress.</li>
<li class="last">Evaluates the organization&rsquo;s and the staff&rsquo;s performance on a regular basis.</li>
</ul>
<p>Sales and Marketing</p>
<ul>
<li class="first">Nurtures client relationships and helps close deals.</li>
<li>Provides strategic direction to the sales and marketing teams in order to hit sales goals and revenue targets.</li>
<li class="last">Supports development of content, production and distribution of all marketing and materials.</li>
</ul>
<p><strong>Skills and Experience</strong></p>
<ul>
<li class="first">B.A., B.S. degree; master&rsquo;s degree a plus.</li>
<li>Executive with 10+ years of progressive experience in sustainability consulting and/or software.&nbsp;</li>
<li>Proven track record of strategic leadership and in growing revenues rapidly.</li>
<li>Experience leading projects that are on time, on scope and on budget</li>
<li>Proven management expertise, with ability to lead diverse teams and mentor professional staff.</li>
<li>Demonstrated technical expertise within sustainability and/or energy discipline.</li>
<li>Strong oral and written communications skills, along with proven ability to effectively manage client relationships and support closing new business.</li>
<li>Able to work with diverse, global clients in both management and technical capabilities</li>
<li>Well-organized individual who is "politically savvy" and can play the role of team leader or player.</li>
<li class="last">Highly self-motivated, forward-thinking and dynamic.</li>
</ul>
<p>FirstCarbon Solutions is an equal opportunity employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with "Sustainability Business Leader" in the subject heading.</p></div></div>
</div>
