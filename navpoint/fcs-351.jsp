...
<section  ><%-- Widget fcs.pages.aboutus_careers_environmentalAnalyst@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_environmentalAnalyst10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_environmentalAnalyst@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_environmentalAnalyst10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_environmentalAnalyst10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_environmentalAnalyst10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_environmentalAnalyst@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Environmental Analyst</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Analyst</h1>
<ol><ol>
<li><strong>GENERAL DESCRIPTION</strong></li>
</ol></ol>
<p>Performs environmental analysis and provides documentation support for environmental impact reports (EIRs) on a variety of subject areas, including land use, socio-economics, earth resources, hydrology, air quality, noise, cultural resources, etc. Provides general support for environmental document preparation.</p>
<ol><ol>
<li><strong>POSITION OBJECTIVES</strong></li>
<ul>
<li>Support project managers with appropriate research information in order to respond to project documentation requirements.</li>
<li>Ensure that the requirements of CEQA and NEPA are met by completing analysis and documentation within specific guidelines.</li>
<li class="last">Gain practical knowledge of the environmental consulting industry.</li>
</ul>
...
<ol><ol>
<ul>
<li class="first last">Support senior staff, as needed, in administrative functions.</li>
</ul>
</ol></ol>
<p><strong>Financial</strong></p>
<ol><ol>
<ul>
<li>Perform project assignments within established budgets.</li>
<li class="last">Assist senior staff in a timely and efficient manner.</li>
</ul>
</ol></ol>
<p><strong>Technical/Quality Assurance</strong></p>
<ol><ol>
<ul>
<li>Provide assistance to project managers in the preparation, organization, and production of EIRs.</li>
<li>Incorporate subconsultant reports and personal research and knowledge into appropriate sections of environmental documents.</li>
<li>Communicate with various jurisdictions, agencies, and subconsultants to collect and verify information.</li>
<li class="last">Conduct field studies and land use surveys.</li>
</ul>
</ol></ol>
<p><strong>Marketing</strong></p>
<ol><ol>
<ul>
<li class="first last">Assist in preparation of marketing materials, including proposals, resumes, and other items as directed.</li>
</ul>
<li><strong>EDUCATION, KNOWLEDGE, AND SKILLS REQUIRED</strong></li>
</ol></ol>
<p><strong>Education</strong></p>
<p>A combination of education and experience which provides the required knowledge and skills to effectively fill this position. Typical qualifications include, or are equivalent to:</p>
<ol><ol>
<ul>
<li class="first last">A bachelor&rsquo;s degree in environmental sciences, planning, geography or a related field.</li>
</ul>
</ol></ol>
<p><strong>Knowledge</strong></p>
<p>General understanding of the principles and practices of the environmental consulting industry, including:</p>
<ol><ol>
<ul>
<li>CEQA and/or NEPA and their processing requirements.</li>
<li>Technical competence and understanding of one or more environmental specialties, such as land use, socio-economics, earth resources, hydrology, air, noise, sustainability, etc.</li>
<li class="last">Thorough knowledge of and demonstrated facility with written and verbal business English, spelling, grammar, and vocabulary.</li>
</ul>
</ol></ol>
<p><strong>Skills &amp; Abilities:</strong></p>
<ol><ol>
<ul>
<li>Proven ability to create results and complete assignments in a timely fashion, many times under strict deadlines, while maintaining a positive attitude and professionalism.</li>
<li>Keen attention to detail.</li>
<li>Demonstrate professional appearance and demeanor and an ability to handle assignments, as well as confidential information with professionalism, tact and discretion.</li>
<li>Strong organizational talents.</li>
<li>Strong self-motivation and ability to work independently with minimum guidance.</li>
<li>Follow instructions and ask informed questions.</li>
<li>Maintain positive interaction with others to accomplish tasks.</li>
<li>Communicate efficiently through written and oral methods.</li>
<li>Research and write reports in a timely manner.</li>
<li class="last">Demonstrated proficiency in MS Office software applications, especially Word and Excel as well as Internet usage.</li>
</ul>
<li>How to apply:</li>
</ol></ol>
<p>FirstCarbon Solutions is an equal opportunity employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a>&lt; with "Environmental Analyst" in the subject heading. The successful candidate will hold office in Irvine, California, USA.</p></div></div>
</div>
