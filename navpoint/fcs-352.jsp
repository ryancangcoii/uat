...
<section  ><%-- Widget fcs.pages.aboutus_careers_projectManager@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_projectManager10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_projectManager@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_projectManager10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_projectManager10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_projectManager10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_projectManager@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Project Manager</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Project Manager</h1>
<ol><ol>
<li><strong>GENERAL DESCRIPTION</strong></li>
</ol></ol>
<p>The Project Manager mainly manages the preparation and administration of technically and legally defensible environmental studies&mdash;primarily EIRs or EISs. He or she is also responsible for establishing proactive business development and marketing activitiesand providing training to technical staff for professional growth.</p>
<ol><ol>
<li><strong>POSITION OBJECTIVES</strong></li>
<ul>
...
<li>Develop and maintain mutually beneficial relationships with clients, sub-consultants and colleagues.</li>
...
<ol><ol>
<ul>
<li>Manage client and sub-consultant contracts, project budgets and billings.</li>
...
<ol><ol>
<ul>
<li>Manage medium to large, complicated or controversial projects through completion of contract with minimal guidance. Dollar value of projects typically in the range of $25,000 to $250,000.00.</li>
<li>Review contractual terms and inform Project Director of potential conflicts with firm's policies.</li>
<li>Prepare project invoices and monitor accounts receivable in a timely and effective manner.</li>
<li>Seek out opportunities to maximize profitability of projects.</li>
<li>Review and approve project sub-consultant invoices.</li>
</ul>
</ol></ol>
...
<ol><ol>
<ul>
<li>Conduct project initiation meetings for team members to be able toexplain proposed projects, project issues, and sensitive concerns, and to establish formats for environmental documents.</li>
...
<li>Establish and maintain a high level of communication directly with the clients and sub-consultants.</li>
<li>Establish task budgets and time schedules and coordinate the overall project.</li>
<li>Compile and review project-related written material. Review staff research and written material for content, conciseness and completeness.</li>
<li>Conduct and oversee research as well as the preparation of technical sections for environmental documents.</li>
</ul>
</ol></ol>
...
<li>Prepareproject fee, schedule and scope of work for proposals. Provide opportunities to maximize profitability.</li>
<li>Obtain project sub-consultants and compile their input for proposals and qualifications.</li>
...
<li><strong>EDUCATION, KNOWLEDGE, AND SKILLS REQUIRED</strong></li>
</ol></ol>
...
<li>At least 3 years of professional experience in preparing and managing preparation of CEQA and/or NEPA environmental documents.</li>
<li>Completion of FCS speaker's workshop or its equivalent, as determined by FCS management.<strong><br clear="all" /> </strong></li>
</ul>
</ol></ol>
...
<p>Must possess the ability to:</p>
<ol><ol>
<ul>
<li>Productively and efficiently manage multiple and multidisciplinary projects.</li>
<li>Plan, organize, assign and coordinate the activities of technical and support staff and those of the sub-consultant.</li>
...
<p>FirstCarbon Solutions is an equal opportunity employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with "Project Manager" in the subject heading.</p></div></div>
</div>
