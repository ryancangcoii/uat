...
<section  ><%-- Widget fcs.pages.aboutus_careers_noiseAnalyst@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_noiseAnalyst10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_noiseAnalyst@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_noiseAnalyst10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_noiseAnalyst10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_noiseAnalyst10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_noiseAnalyst@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Noise Analyst</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Noise Analyst</h1>
<p><strong>Primary Responsibilities</strong> The Noise Analyst would prepare technically sound and legally defensible analyses for California Environmental Quality Act (CEQA) documents.</p>
<p><strong>Specific Responsibilities</strong></p>
<ul>
<li>Provide support and assistance to Section and Project Managers, as requested, in administration functions, and provide suggestions to improve efficiency and effectiveness.</li>
<li>Develop technically and legally defensible noise analyses and technical appendices to be included in CEQA-related environmental and standalone analysis documents.</li>
<li>Develop scientific noise impact assessments for assessing compliance with environmental noise standards and significance thresholds.</li>
<li>Develop environmental noise impact policy documents such as noise elements to General Plans.</li>
<li>Develop mitigation monitoring plans and programs to insure compliance with stated and agreed-to mitigation requirements.</li>
<li>Meet firm&rsquo;s and client&rsquo;s goals within the agreed-upon scope of work and budget.</li>
<li>Develop and maintain mutually beneficial relationships with clients and colleagues.</li>
<li>Promote firm&rsquo;s strengths and good reputation in the environmental noise impact analysis field.</li>
<li>Develop new areas of interest and market areas.</li>
</ul>
<p><strong>Skills</strong></p>
<ul>
<li>Providing effective and quality communication through written and oral methods</li>
<li>Familiarity or experience with using noise analysis software such as FHWA Traffic Noise Prediction Model (FHWA-RD-77-108), Sound Plan, Sound Plan Essential, or similar software</li>
<li>Familiarity or experience with obtaining ambient noise readings and using noise meters is a plus.</li>
<li>Working creatively as a member of an environmental assessment team</li>
<li>Promoting teamwork through interpersonal skills</li>
<li>Demonstrating proficiency in MS Office software applications, especially Word and Excel</li>
</ul>
<p><br /> <strong>Additional Information</strong></p>
<ul>
<li>The position requires a Bachelor&rsquo;s degree in Physics, Engineering, Environmental Sciences or a related field.</li>
<li>A writing sample (such as a report prepared in college) will be requested.</li>
<li>This position will be filled through the San Bernardino office.</li>
<li>Additional training can be provided.</li>
</ul>
<p><br /> <strong>How to apply:</strong> FirstCarbon Solutions is an Equal Opportunity Employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with<span style="text-decoration: underline;">&ldquo;Noise Analyst&rdquo;</span>in the subject heading.</p></div></div>
</div>
