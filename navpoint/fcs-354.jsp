...
<section  ><%-- Widget fcs.pages.aboutus_careers_seniorProjectManager@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_seniorProjectManager10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_seniorProjectManager@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_seniorProjectManager10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_seniorProjectManager10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_seniorProjectManager10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_seniorProjectManager@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Senior Project Manager</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Senior Project Manager</h1>
<ol>
<li><strong>GENERAL DESCRIPTION</strong>
<p>The Senior Project Manager mainly manages the preparation and administration of technically and legally defensible environmental studies&mdash;primarily EIRs or EISs. S/He is also responsible for establishing proactive business development and marketing activities and providing training to technical staff for professional growth.</p>
</li>
<li><strong>POSITION OBJECTIVES</strong>
<ul>
<li>Develop technically and legally defensible environmental documents, including EIRs and EISs.</li>
<li>Ensure strong financial management and profitability of projects.</li>
<li>Meet firm's and client's goals within the agreed-upon scope of work and budget.</li>
<li>Develop and maintain mutually beneficial relationships with clients, subconsultants, and colleagues.</li>
<li>Promote firm's strengths and good reputation in the environmental planning industry.</li>
<li>Develop new areas of interest and market areas.</li>
</ul>
</li>
<li><strong>DUTIES AND RESPONSIBILITIES</strong>
<p><strong>Administrative</strong></p>
<ul>
<li>Manage client and subconsultant contracts, project budgets, and billings.</li>
<li>Support the Section Managers, as requested, in administrative functions, and provide suggestions to improve efficiency and effectiveness.</li>
<li>Represent the firm in all communications with the client from initial contact through project completion.</li>
</ul>
<p><strong>Financial</strong></p>
<ul>
<li>Manage medium to large, complicated, or controversial projects through completion of contract with minimal guidance. Dollar value of projects typically in the range of $100,000.00 to $500,000.00.</li>
<li>Review contractual terms and inform Section Managers of potential conflicts with firm's policies.</li>
<li>Prepare project invoices and monitor accounts receivable in a timely and effective manner.</li>
<li>Seek out opportunities to maximize profitability on projects.</li>
<li>Provide input for long-range financial planning (i.e., 3- to 6-month workload projections).</li>
<li>Review and approve project subconsultant invoices.</li>
</ul>
<p><strong>Personnel Supervision/Development/Training</strong></p>
<ul>
<li>Plan, organize, schedule, assign, coordinate, and direct the activities of project staff.</li>
<li>Enhance staff members' capabilities through training. Review research and written materials submitted by staff and suggest improvements.</li>
<li>Keep abreast of recent legislative, administrative, and judicial interpretations of related environmental statutes, and ensure that staff members are well informed of changes.</li>
<li>Identify the need for technical and production staff assistance for projects and assign staff members accordingly through workload projections while recognizing the need to maximize division use.</li>
</ul>
<p><strong>Technical/Quality Assurance</strong></p>
<ul>
<li>Conduct project initiation meetings for team members to be able to explain proposed projects, project issues, and sensitive concerns, and to establish formats for environmental documents.</li>
<li>Conduct and participate in public and private sector project meetings. This includes making presentations to the public during scoping, community meetings, and public hearings.</li>
<li>Establish and maintain a high level of communication directly with the clients and subconsultants.</li>
<li>Establish task budgets and time schedules and coordinate the overall project.</li>
<li>Compile and review project written material. Review staff research and written material for content, conciseness, and completeness.</li>
<li>Conduct and oversee research as well as preparation of technical sections for environmental documents.</li>
</ul>
<p><strong>Marketing</strong></p>
<ul>
<li>Organize and prepare proposal and qualification packages with the Marketing Department.</li>
<li>Develop project opportunities through proactive marketing.</li>
<li>Prepare project fee, schedule, and scope of work for proposals. Provide opportunities to maximize profitability.</li>
<li>Obtain project subconsultants and compile their input for proposals and qualifications.</li>
<li>Assist with marketing efforts by providing complete descriptions of current projects and updates on resume as required.</li>
</ul>
</li>
<li><strong>EDUCATION, KNOWLEDGE, AND SKILLS REQUIRED</strong>
<p>A combination of education and experience which provides the required knowledge and skills is needed to effectively fill this position. Typical qualifications include, or are equivalent to:</p>
<ul>
<li>A bachelor's degree in environmental sciences, planning, geography, or any related field.</li>
<li>Approximately 6 years of professional experience in preparing and managing preparation of CEQA and/or NEPA environmental documents.</li>
<li>Completion of FCS' speaker's workshop or equivalent, as determined by FCS management.</li>
</ul>
<p><strong>Knowledge</strong></p>
<p>Thorough understanding of the principles and practices of the environmental consulting industry, including:</p>
<ul>
<li>CEQA and/or NEPA and their processing requirements</li>
<li>Project management techniques</li>
<li>Marketing and proposal preparation</li>
<li>Financial management principles and practices</li>
</ul>
<p><strong>Skills</strong></p>
<p>Ability to:</p>
<ul>
<li>Productively and efficiently manage multiple and multidisciplinary projects.</li>
<li>Plan, organize, assign, and coordinate the activities of technical and support staff, and those of the subconsultants.</li>
<li>Provide effective and quality communication through written and oral methods.</li>
<li>Supervise technical staff on a project-by-project basis.</li>
<li>Promote teamwork through interpersonal skills.</li>
<li>Demonstrate proficiency with MS Office software applications, especially Word and Excel, as well as Internet usage</li>
</ul>
</li>
</ol>
<p class="Bulletindent">&nbsp;</p>
<p class="Bulletindent">How to apply:</p>
<p>FCS is an Equal Opportunity Employer. Please email your resume with cover letter and salary expectations to <a href="mailto:Careers@brandman.com">Careers@brandman.com</a> with <span style="text-decoration: underline;">"Senior Project Manager"</span> in the subject heading.</p></div></div>
</div>
