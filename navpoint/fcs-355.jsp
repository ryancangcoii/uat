...
<section  ><%-- Widget fcs.pages.aboutus_careers_interns@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagesaboutus_careers_interns10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.aboutus_careers_interns@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagesaboutus_careers_interns10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagesaboutus_careers_interns10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/about_us.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagesaboutus_careers_interns10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.aboutus_careers_interns@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-15">About Us</a> &raquo; <a href="/ttsvr/n/fcs-21">Careers</a> &raquo; <span>Intern Program</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Intern Program</h1>
<p>FirstCarbon Solutions takes great pride in our Internship program and offer internships in all of our <a href="/about-us/contact-us">United States offices</a> across all areas of the business.</p>
<ul>
<li>Sustainability, Energy, Carbon Management and Air Quality</li>
<li>Environmental Services</li>
<li>Natural Resources</li>
<li>Supply Chain and Life Cycle Assessments</li>
<li>Technology and Software</li>
<li>Telecommunications</li>
<li>Entitlements and Licensing</li>
<li>Rebates and Incentives</li>
</ul>
<p>Interns are paid a competitive wage and given the opportunity to explore the day-to-day workings of a global sustainability, environmental and data management solutions company. We offer a flexible schedule and will work around your academic courses, as necessary.</p>
<p>Our goal is to provide you with the hands-on experience that will enrich your knowledge of the industry and let you share your fresh perspective with our staff who are eager to work with professionals new to our business. To apply for an Internship with FirstCarbon Solutions, please forward your resume to <a href="mailto:Careers@Brandman.com">Careers@Brandman.com</a>. Please indicate in the subject line that you are seeking to join our Intern Program.</p></div></div>
</div>
