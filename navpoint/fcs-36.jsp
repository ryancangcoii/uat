...
<section  ><%-- Widget fcs.pages.solutions_industry_healthcare@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_healthcare10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_health_care.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_healthcare@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_healthcare10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_healthcare10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_health_care.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_healthcare10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_healthcare@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Healthcare</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1 style="letter-spacing: -1px; word-spacing: -1px;">Environmental Consulting for Healthcare</h1>
<h3>Supporting efficiency and quality</h3>
<p>From drug manufacturers to hospital facilities, every sector of the healthcare industry is under pressure to reduce costs and waste. Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a>&nbsp;with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable profitability.&nbsp;</p>
<h3>Reduce operational costs</h3>
<p>For manufacturers of healthcare-related products and pharmaceutical supplies, we offer <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon management</a>, <a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA (life cycle assessment)</a>,&nbsp;and <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> services to help you identify waste, reduce energy and resource consumption, and operate more profitably. And we understand the constraints FDA-regulated manufacturing sites are under in making processes more sustainable, and we&rsquo;re the partner you need to become more efficient while maintaining required protocols.&nbsp;</p>
<h3>Supporting suppliers of choice</h3>
<p>If you are a supplier of pharmaceutical products, we help you cost-effectively <a href="/ttsvr/solutions/by-focus/supply-chain">collect and report on your sustainability status</a>&nbsp;to make responding to customer requests for data simpler and faster. Our data processing capabilities are cost-effective, scalable, and proven, because having granular data on your performance readily available to your customers at a moment&rsquo;s notice can make you a supplier of choice and more competitive in the marketplace.<strong>&nbsp;</strong></p>
<h3>Efficiency partners for hospitals</h3>
<p>Because of a hospital's required "on-demand" flow of energy, from lighting and heating 24 hours a day to medical analysis equipment and even laundry and food preparation, managing energy usage is a unique challenge. FirstCarbon Solutions helps healthcare organizations balance the goals of improving operating costs while upholding your core mission to deliver high quality patient care. We help our hospital clients <a href="/ttsvr/solutions/by-focus/energy">manage&nbsp; energy</a>&nbsp;usage and <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon emissions</a>&nbsp;as well as assess their broader footprint, encompassing mobile sources such as travel of personnel; shipping of goods, equipment and materials; and production of non-GHG emissions, such as air toxic emissions, sterilization, pathological waste and water usage.</p>
<p>Across the healthcare spectrum, FirstCarbon Solutions provides the expert consulting services you need to plan for profitability, the software systems required for tracking data across facilities and various energy efficient devices in real time, and the data processing expertise to make it all happen seamlessly and cost-effectively.</p>
<h3>FirstCarbon Solutions in action for healthcare</h3>
<p>For <a href="/ttsvr/clients/case-studies">Baystate Health</a>, FirstCarbon Solutions prepared a comprehensive baseline GHG inventory, encompassing all of Baystate Health&rsquo;s locations based on sound principles and leading protocols.</p></div></div>
</div>
