...
<section  ><%-- Widget fcs.pages.solutions_industry_hospitality@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_hospitality10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_hospitality.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_hospitality@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_hospitality10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_hospitality10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_hospitality.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_hospitality10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_hospitality@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Hospitality</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Consultants for Hospitality</h1>
<h3>Focus on your guests and leave sustainability management to us</h3>
<p>Whether you run a hotel or an amusement park, managing your operations is both challenging and rewarding. You must cope with myriad challenges such as safety and profitability on a daily basis, while exceeding your guests' expectations and needs. FirstCarbon Solutions has the team who can steer your business to<strong> <a href="/ttsvr/solutions/by-focus/sustainability">profitable sustainability</a></strong> by performing services proven to address your challenges and concerns &ndash; so you can focus on your brand and guest experience.</p>
<p>As your company embarks on new development projects, our business consultants support you by providing services to earn the necessary rights and approvals. With proven experience and technical expertise, our team of development managers works with you to develop and implement an effective strategy to obtain site development approvals for your projects. In addition, FirstCarbon Solutions takes care of the legwork in filing your applications. Working with us, you are assured of submitting correct documents and other prerequisites to avoid unnecessary delays.</p>
...
<p>Our <strong><a href="/ttsvr/solutions/by-focus/energy">energy management and technical experts</a></strong> provide solutions to enable your organization to adopt new practices and equipment to achieve your energy and carbon reduction goals. And, with our Sustainability Workbench software platform, monitor the progress you make in improving your energy and carbon footprint.</p>
<p>If processing and paying your utility bills has become a growing concern for your business, our data management team provides cost-effective services to improve your utility bill processing, making sure you settle your bills on time, pay the correct amount and avoid duplicate payments. With our expertise in back-office data processing, we provide <strong><a href="/ttsvr/solutions/by-service/data-processing">data management and reporting support</a></strong> for your efforts to take advantage of available rebates and incentives.</p>
<h3>Brand-building in a sustainability-focused world</h3>
<p>No organization understands business sustainability better than FirstCarbon Solutions. That's why our sustainability solutions are designed to balance your operational efficiency and environmental performance for an improved focus on guest experience and greater profitability. We also help track your sustainability efforts and address your environmental impact across your portfolio through supply chain services that include <strong><a href="/ttsvr/solutions/by-focus/supply-chain">supplier scorecards, carbon accounting and life cycle assessment.</a></strong></p>
<p>What's more, with our user-friendly software and outcome-focused data processing services, your initiatives for profitable sustainability and efficiency are sealed with success.</p>
<p>Continue giving safe, enjoyable and modern hospitality services to the public and expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p></div></div>
</div>
