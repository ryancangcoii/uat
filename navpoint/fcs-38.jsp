...
<section  ><%-- Widget fcs.pages.solutions_industry_industrial@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_industrial10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_industrial.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_industrial@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_industrial10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_industrial10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_industrial.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_industrial10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_industrial@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Industrial</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Industrial</h1>
<h3>Uncover hidden costs. Discover untapped opportunities.</h3>
<p>Accounting for a significant proportion of total greenhouse gas emissions, heavy industry faces high energy and resource costs, pervasive regulation, and a critical public eye. That&rsquo;s why industrial clients have the most to gain from smart <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> and <a href="/ttsvr/solutions/by-focus/sustainability">sustainability programs</a> &ndash; in terms of profitability and in meeting <a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">Corporate Social Responsibility (CSR)</a> and <a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">compliance obligations</a>.</p>
<p>FirstCarbon Solutions makes achieving those goals efficient and cost-effective. Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable, compliant profitability.</p>
<p>We&rsquo;ll help you track and measure the sustainability of all your business inputs and outputs &ndash; how much waste you produce, how much water you consume and from where, and in what condition you return it to the environment. And of course, we&rsquo;ll help you evaluate where you can conserve resources to reduce costs and risks throughout your <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> &ndash; improving both your environmental performance and your profitability.</p>
<h3>LCA or Carbon Footprint?</h3>
<p>To optimize economies of scale and minimize costs, many industrial clients elect to conduct a full <a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessment (LCA)</a> at the time they conduct a <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprint</a>. FirstCarbon Solutions encourages this practice for several reasons:</p>
<ul>
...
<li>Performing a life cycle assessment of your entire process lets you simultaneously evaluate multiple products, product lines, and processes.</li>
...
<p><br /> <a href="/ttsvr/solutions/by-service/data-processing">Outsource the administrative tasks and data entry components</a> of your LCA to FirstCarbon Solutions, and you&rsquo;ll dramatically reduce your overall program costs as well./p&gt;</p>
<h3>LCA can make you a more competitive supplier</h3>
<p>From retail giants to government procurement agencies, your customers increasingly require transparent and comprehensive sustainability data from suppliers.</p>
<p>Our LCA services provide you with ready access to data on your processes, your systems, and sustainability on a product-by-product level. With that data at your fingertips, you&rsquo;ll improve your status as a supplier of choice in a sustainability-driven marketplace.</p>
<p>Underpinning our solutions for industry are robust tools and data processing services that allow easy and accurate tracking of your sustainability indicators, going beyond assessing <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon footprint</a> and GHG emissions to encompass <a href="/ttsvr/solutions/by-focus/environmental/water-management">water</a>, waste, and a full spectrum of natural resources throughout your supply chain.</p></div></div>
</div>
