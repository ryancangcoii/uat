...
<section  ><%-- Widget fcs.pages.solutions_industry_insurance@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_insurance10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_insurance.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_insurance@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_insurance10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_insurance10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_insurance.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_insurance10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_insurance@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Insurance</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Insurance</h1>
<h3>Manage operating costs across your organization</h3>
<p>While claims costs aren&rsquo;t always under your control, the costs of operating your facilities and data centers are. And only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable profitability.</p>
<p>Heating, cooling, and lighting &ndash; especially in your data centers and other technology-intensive facilities &ndash; are often primary operating cost drivers for insurance organization facilities.</p>
<p>FirstCarbon Solutions will help you audit, reduce, and manage those costs on an ongoing basis, finding opportunities for conservation and waste reduction and implementing <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> plans that will significantly improve your financial health.</p></div></div>
</div>
