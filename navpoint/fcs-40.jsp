...
<section  ><%-- Widget fcs.pages.solutions_industry_manufacturing@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_manufacturing10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_manufacturing.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_manufacturing@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_manufacturing10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_manufacturing10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_manufacturing.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_manufacturing10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_manufacturing@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Manufacturing</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Manufacturing</h1>
<h3>Uncover hidden costs. Discover untapped opportunities.</h3>
<p>Opportunities for reducing resource costs can be found throughout your manufacturing processes, facilities, and supply chain. FirstCarbon Solutions will help you not only uncover them &ndash; but also prioritize what changes will deliver the best ROI <em>now</em>. Even better, we make achieving those goals simple and cost-effective.</p>
<p>From raw materials to fleet fuel consumption to electricity use, we&rsquo;ll help you track and measure the sustainability of all your business inputs and outputs &ndash; how much waste you produce, how much water you consume and from where, and in what condition you return it to the environment. And of course, we&rsquo;ll help you evaluate where you can conserve resources to reduce costs and risks throughout your <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> &ndash; improving both your <a href="/ttsvr/solutions/by-focus/sustainability">environmental performance</a> and your profitability.</p>
<h3>LCA or Carbon Footprint?</h3>
<p>To optimize economies of scale and minimize costs, many manufacturing clients elect to conduct a full life cycle assessment (<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>) at the time they conduct a <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon footprint</a>. FirstCarbon Solutions encourages this practice for several reasons:</p>
<ul>
<li class="first">Implementing carbon footprint, energy efficiency<a href="#">,</a> and LCA measures concurrently is more cost-effective, as they share much of the same data.</li>
<li>Performing a life cycle assessment of your entire manufacturing process lets you simultaneously evaluate multiple products, product lines and processes.</li>
<li class="last">LCA data can be used to drive a wider range of business decisions to improve supply chain and product line sustainability and profitability.</li>
</ul>
<p><br /> <a href="/ttsvr/solutions/by-service/data-processing">Outsource the administrative tasks and data entry</a> components of your LCA to FirstCarbon Solutions, and you&rsquo;ll dramatically reduce your overall program costs even further.</p>
<h3>LCA can make you a more competitive supplier</h3>
<p>From retail giants to healthcare organizations to government procurement agencies, your customers increasingly require transparent and comprehensive sustainability data from suppliers.</p>
<p>Our services provide you with <a href="/ttsvr/solutions/by-service/software">ready access to data</a> on your processes, your systems, and sustainability on a product-by-product level. With that data at your fingertips, you&rsquo;ll improve your status as a supplier of choice in a sustainability-driven marketplace.</p>
<p>Underpinning our solutions for manufacturers are robust <a href="/ttsvr/solutions/by-service/software">software</a> tools and <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> services that allow easy and accurate tracking of your sustainability indicators, going beyond assessing <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprint</a> and GHG emissions to encompass <a href="/ttsvr/solutions/by-focus/environmental/water-management">water</a>, waste and a full spectrum of natural resources throughout your manufacturing processes and your <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>.</p>
<h3>FirstCarbon Solutions in action for manufacturing</h3>
<p>For M.E. Heuck Co, FirstCarbon Solutions helped them successfully achieve their goals in manufacturing the first CarbonNeutral line of cookware and kitchen gadgets in the market, while satisfying the certification requirements in a cost-effective manner.</p></div></div>
</div>
