...
<section  ><%-- Widget fcs.pages.solutions_industry_municipalities@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_municipalities10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_municipalities.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_municipalities@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_municipalities10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_municipalities10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_municipalities.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_municipalities10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_municipalities@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Municipalities</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainable Municipalities</h1>
<h3>Lead your community to sustainable development</h3>
<p>Whether you're a large city or a smaller town, you are concerned about balancing economic growth with sustainable development. Take advantage of FirstCarbon Solutions' knowledge of, and technical expertise in <strong><a href="/ttsvr/solutions/by-focus/environmental">environmental planning</a></strong> &amp; <strong><a href="/ttsvr/solutions/by-focus/environmental">compliance</a></strong>, and <strong><a href="/ttsvr/solutions/by-focus/energy">energy</a></strong> &amp; <strong><a href="/ttsvr/solutions/by-service/data-processing">data management</a></strong> to help put your community on an accelerated path towards sustainability and energy efficiency.</p>
<p>FirstCarbon Solutions brings together some of the best environmental and sustainability consultants to conduct comprehensive assessments and investigations so you can make the most <strong><a href="/ttsvr/solutions/by-industry/developers">intelligent site selection</a></strong> for crucial development projects such as parks, airports and municipal buildings - without losing sight of your sustainability targets.</p>
<p>If you're looking to find ways to drive down expenses in securing all the necessary permits and licenses for your project, we provide cost-effective services to take care of all aspects of <strong><a href="/ttsvr/solutions/by-focus/entitlements-permitting/entitlement-processing-services">entitlement processing</a></strong> - from conditional use permits, regulatory reviews and scrutiny to environmental impact assessments if required. Our environmental sustainability solutions are designed to support on schedule project implementation and ensure you are able to reduce costs while carrying out all these tasks with ease and confidence.</p>
<h3>Pursue sustainability through eco-friendly projects and practices</h3>
<p>As you are aware, you have to meet a cadre of state and federal regulations before you finalize the blueprint for a new infrastructure or development project. FirstCarbon Solutions fully understands the importance of complying with government standards and regulatory requirements and of reaching a final project design that addresses environmental concerns.</p>
<p>With our environmental experts and sustainability consultants on board, we leave no stone unturned in performing various <strong><a href="/ttsvr/solutions/by-focus/environmental">environmental services</a>,</strong> such as <strong><a href="/ttsvr/solutions/by-focus/environmental/air-traffic-and-noise-assessments">air, traffic &amp; noise</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/water-management">water management</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/cultural-resources-management">cultural resources management</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/environmental-assessments">environmental assessments</a></strong>, <strong><a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">environmental compliance</a></strong>, and <strong><a href="/ttsvr/solutions/by-focus/environmental/natural-resources-management">natural resources management</a>.</strong></p>
<p>For existing properties and facilities, we have developed comprehensive sustainability solutions that will step-up your efforts towards <a href="/ttsvr/solutions/by-focus/energy"><strong>energy and carbon reduction.</strong></a> Our Sustainability Workbench platform is an invaluable tool that allows you to easily and accurately monitor the progress you make in improving your carbon &amp; energy footprint and your sustainability program as a whole.</p>
<p>Our energy management consultants will also help you develop initiatives such as retrofitting existing buildings and structures in order to reduce energy consumption, improve your carbon footprint and secure rebates and incentives. With our<strong> <a href="/ttsvr/solutions/by-focus/energy">energy data processing expertise,</a></strong> roll out the best program aimed at improving your energy bottom line and streamlining your data management systems.</p>
<p>As you build sustainable communities amid mounting economic and environmental challenges, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need in a sustainability-focused world.</p></div></div>
</div>
