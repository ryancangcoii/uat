...
<section  ><%-- Widget fcs.pages.solutions_industry_packaging@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_packaging10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_packaging.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_packaging@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_packaging10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_packaging10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_packaging.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_packaging10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_packaging@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Packaging</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Packaging</h1>
<h3>For sustainable profitability</h3>
<p>Opportunities for reducing resource costs can be found throughout your packaging facilities and <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>. FirstCarbon Solutions will help you not only uncover them &ndash; but also prioritize what changes will deliver the most ROI <em>now</em>. Even better, we make achieving those goals simple and cost-effective.</p>
<p>To reduce your operating costs and resource usage and meet the <a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">requirements of regulators</a> and customers, FirstCarbon Solutions will help you implement sustainable measures throughout your production process. You&rsquo;ll not only reduce costs and waste, but you&rsquo;ll also meet the environmental standards of a variety of oversight agencies, including GRI and <a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">CSR initiatives</a> and voluntary reporting projects.</p>
<p>From high <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy costs</a> to emissions regulation to the proliferation of <a href="/ttsvr/solutions/by-focus/supply-chain/supplier-scorecards">supplier scorecard initiatives</a>, FirstCarbon Solutions understands the demands of your market and the need for proactive solutions for packaging operators. FirstCarbon Solutions will help you design and implement a comprehensive <a href="/ttsvr/solutions/by-focus/sustainability">sustainability program</a> to boost your profitability, environmental performance, and competitiveness in your market.</p>
