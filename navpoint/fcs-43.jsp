...
<section  ><%-- Widget fcs.pages.solutions_industry_restaurants@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_restaurants10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_restaurants.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_restaurants@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_restaurants10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_restaurants10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_restaurants.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_restaurants10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_restaurants@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Restaurants</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Consulting for Restaurants</h1>
<h3>Profitable sustainability for the foodservice business</h3>
<p>From fast-food and fast-casual restaurants to coffeehouse chains, being ahead of the competition means doing business that drives sustainable profitability. Working with FirstCarbon Solutions, you will develop strategies and programs to <strong><a href="/ttsvr/solutions/by-focus/supply-chain">optimize your resource use, eliminate waste and streamline your systems across your supply chain</a></strong> for improved food service, increased customer satisfaction and optimum ROI.</p>
<p>If you are looking to open a new location, our team of consultants provides a complete package of services so that securing the necessary <strong><a href="/ttsvr/solutions/by-focus/entitlements-permitting">entitlements</a></strong> is the least of your concerns. With proven experience and technical expertise, our team of development managers works with you to develop and implement an effective strategy to obtain site development approvals for your projects. We also facilitate the process of obtaining necessary licenses and permits by helping you prepare the application papers, complying with all applicable standards &amp; regulations and undergoing all review processes.</p>
<p>In addition, FirstCarbon Solutions takes care of the legwork in filing your applications. Working with us, you are assured of submitting correct documents and other prerequisites to avoid unnecessary delays.</p>
<p>And, for ongoing operations, with FirstCarbon Solutions, you will be able to keep track of all your permits, across all your locations, so you never miss a renewal deadline.</p>
<h3>Energy solutions to support your bottom line</h3>
<p>As more restaurants adopt policies to increase energy efficiency, you can rely on our environmental and energy experts to establish a workable, integrated program to reduce your energy costs. Our software solutions such as <strong><a href="/ttsvr/solutions/by-focus/sustainability">Sustainability Workbench and <em>ghgTrack</em></a></strong> are tools that monitor your energy performance and provide support to enable you improve your carbon footprint.</p>
<p>We also have more than 5,000 data management professionals around the world who have the expertise to fully manage your <strong><a href="/ttsvr/solutions/by-service/data-processing/utility-bill-processing">utility bill processing</a></strong> so that you pay your bills promptly and accurately, protecting your bottom line by making you avoid any duplication and unnecessary penalties for late payments.</p>
<p>Increasing your revenues is a significant focus, especially amid a slow-moving economy. Our technical experts and industry consultants study front and back of the house operations and recommend new initiatives, such as retrofitting and using new, energy-efficient equipment to reduce energy consumption, improve your environmental performance and subsequently receive <strong><a href="/ttsvr/solutions/by-service/data-processing/rebate-processing">rebates and incentives</a></strong> from utilities and government agencies - increasing your profitability and sustainability at the same time.</p>
<p>We provide your organization with <strong><a href="/ttsvr/solutions/by-focus/sustainability">sustainability solutions</a></strong> on climate change, carbon and energy management and corporate social responsibility reporting. Our vast experience ensures you get the right sustainability strategies and programs.</p>
<p>Also, our professional team performs <strong><a href="/ttsvr/solutions/by-focus/supply-chain">supply chain services</a></strong>, including supplier scorecards, carbon accounting and life cycle assessment to help track your sustainability efforts and address your environmental impact across your portfolio. FirstCarbon Solutions is a pioneer in fully integrating consulting and <strong><a href="/ttsvr/solutions/by-service/software">software</a></strong> with <strong><a href="/ttsvr/solutions/by-service/data-processing">data processing</a></strong> services to support your efforts to make your company more sustainable.</p>
<p>Expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p></div></div>
</div>
