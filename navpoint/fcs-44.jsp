...
<section  ><%-- Widget fcs.pages.solutions_industry_retail@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_retail10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_retail.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_retail@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_retail10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_retail10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_retail.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_retail10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_retail@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Retail</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Consulting for Retail Businesses</h1>
<h3>Optimize your operations and your supply chain</h3>
<p>Retail businesses today are some of the most progressive when it comes to leveraging <a href="/ttsvr/solutions/by-focus/sustainability"><span style="text-decoration: none;">sustainability</span></a> to improve profits. Retailers around the world are actively setting targets and making performance improvements to reduce their carbon footprints inside store walls and throughout the supply chain.</p>
<p>FirstCarbon Solutions works with retailers both to reduce the resource and consumption costs of their operations and fleets and to establish effective <a href="/ttsvr/solutions/by-focus/supply-chain/supplier-scorecards">scorecard programs</a> for their supply chains.</p>
<h3>Developing meaningful rating systems</h3>
<p>As more importance is placed on mandatory and consistent reporting of <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon emissions</a>, a standard scoring system is one way to provide the transparency required for effective <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon managemen</a>t along the entire <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>. With our deep experience in sustainability analysis and reporting, FirstCarbon Solutions helps you develop a rating system for your retail supply chain that is both rational and scientific.</p>
<p>From <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy</a> to waste to <a href="/ttsvr/solutions/by-focus/environmental/water-management">water</a>, we&rsquo;ll help you establish standards that work for your business, help you influence and control costs in your <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>, and are compelling to your customers.</p>
<h3>Operate more efficiently</h3>
<p>From fleet and transportation costs to heating, cooling, and lighting at your warehouses and retail storefronts, FirstCarbon Solutions will help you audit and reduce resource costs throughout your operations. Whether it&rsquo;s via <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon footprinting</a> or a full-scale life cycle assessment (LCA), our retail consulting services, software, and data management services will help you find opportunities for conservation and implement <a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management</a> plans that will significantly improve your bottom line.</p>
<p>Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable profitability.</p></div></div>
</div>
