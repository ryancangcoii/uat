...
<section  ><%-- Widget fcs.pages.solutions_industry_telecommunications@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_industry_telecommunications10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_telecommunications.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_industry_telecommunications@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_industry_telecommunications10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_industry_telecommunications10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_telecommunications.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_industry_telecommunications10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_industry_telecommunications@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-25">By Industry</a> &raquo; <span>Telecommunications</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Comprehensive Consulting Services for Telecommunications</h1>
<p>The telecommunications industry plays an important role in the world economy, revolutionizing social relationships and cultural exchanges. Wireless service providers are aggressively expanding and upgrading facilities to advance or maintain your competitive edge. In order to gain approval for your rapid growth, like other telecommunications companies, you need effective solutions.</p>
<p>FirstCarbon Solutions (FCS)&rsquo; <a href="/ttsvr/solutions/by-service/consulting">consulting</a> team provides technical advice and solutions tailored to help you <a href="/ttsvr/solutions/by-focus/environmental">comply with regulations</a>, secure approvals and meet certification requirements from regulatory agencies such as the Federal Communication Commission (FCC), National Environmental Policy Act (NEPA), Migratory Bird Protection Act, State Historical Preservation Offices (SHPO), and the Nationwide Programmatic Agreement (NPA).</p>
<p>To minimize environmental risks and reduce future costs, FCS completes Phase I Environmental Site Assessments (ESA) and Limited Phase II Site Assessments to identify potential or existing environmental liabilities through analyses that typically address both the underlying land, as well as physical improvements to your property.</p>
<p>Additional FCS Services:</p>
<ul>
<li class="first"><a href="/ttsvr/solutions/by-focus/environmental/cultural-resources-management">Archaeological</a> Surveys, Testing and Monitoring</li>
<li><a href="/ttsvr/solutions/by-focus/environmental/cultural-resources-management">Architectural</a> Historical Assessments</li>
<li><a href="/ttsvr/solutions/by-focus/environmental/natural-resources-management">Biological</a> Resources Impact Analysis</li>
<li>Focused <a href="/ttsvr/solutions/by-focus/environmental/natural-resources-management">Biological</a> Surveys and Monitoring</li>
...
<li><a href="/ttsvr/solutions/by-focus/environmental/air-traffic-and-noise-assessments">Noise Studies</a></li>
<li>Arborist Studies</li>
<li>Wetland Delineation/Assessment</li>
<li><a href="/ttsvr/solutions/by-service/data-processing">Software</a> Tracking and Reporting</li>
<li class="last">Business Process Outsourcing Support</li>
</ul>
<p>With experience in <a href="/ttsvr/solutions/by-focus/environmental">planning</a>, permitting, and management in the telecommunications sector, the FCS team has a diverse professional background to meet your unique needs and objectives.</p>
<p>Whether you are looking to obtain compliance, streamline processes or require assistance reviewing environmental and sustainability programs, look to FCS' team of experts to provide the guidance and execution to improve your bottom line.</p></div></div>
</div>
