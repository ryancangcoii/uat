...
<section  ><%-- Widget fcs.pages.solutions_focus_sustainability@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_sustainability10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_sustainability@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_sustainability10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_sustainability10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_sustainability.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_sustainability10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_sustainability@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/">Home</a> &raquo; <a href="/ttsvr/solutions">Solutions</a> &raquo; <a href="/ttsvr/solutions/by-focus">By Focus</a> &raquo; <span>Sustainability</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Solutions</h1>
<h3>Improve your profitability with sustainability solutions</h3>
<p>If you&rsquo;re looking to reduce operational costs, eliminate waste or improve your sustainability performance, let FirstCarbon Solutions show you the way. With expertise in energy and environmental management, we help you optimize your resources, programs and operations for maximum return on investment (ROI) and increased profitability by providing sustainability solutions for:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/sustainability/climate-change">Climate Change</a></li>
<li><a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">Carbon Management</a></li>
<li><a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">Corporate Social Responsibility Reporting</a></li>
</ul>
<p>Our sustainability solutions enable you to monitor, manage, and report pertinent data quickly and cost-effectively, so you can enhance your operational efficiency. Our vast experience in working with various companies, organizations and government institutions ensures you have the right strategies and practices in place. We fully integrate consulting and software with superior capability in back-office data processing to give you well-rounded and the most effective solutions for sustainable profitability.</p>
<h3>Sustainability Software that makes the difference</h3>
<p>With FirstCarbon Solutions, you not only receive the best consulting and data processing services but our Sustainability Workbench software features advanced tools to measure, monitor, manage, and report your sustainability progress. For the best sustainability solutions that will balance environmental performance and profitability, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a world increasingly focused on sustainability.</p>
<div class="space">&nbsp;</div>
