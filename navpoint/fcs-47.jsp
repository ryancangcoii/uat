...
<section  ><%-- Widget fcs.pages.solutions_focus_sustainability_climatechange@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_sustainability_climatechange10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_sustainability_climatechange@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_sustainability_climatechange10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_sustainability_climatechange10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_sustainability.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_sustainability_climatechange10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_sustainability_climatechange@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/">Home</a> &raquo; <a href="/ttsvr/solutions">Solutions</a> &raquo; <a href="/ttsvr/solutions/by-focus">By Focus</a> &raquo; <a href="/ttsvr/solutions/by-focus/sustainability">Sustainability</a> &raquo; <span>Climate Change</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Climate Change Solutions</h1>
<h3>Business solutions to adapt to climate change</h3>
<p>As industries and governments deal with the challenges posed by climate change, FirstCarbon Solutions environmental specialists have developed solutions that support your regulatory compliance efforts, environmental impact assessments and mitigation programs for sustainability across your entire organization. Our extensive consulting background and expertise in greenhouse gas management and carbon trends and regulations ensure you will get professional advice on policies, standards and the best methodologies to address the potential impact of climate change on your organization, and your supply chain.</p>
<p>Our climate change solutions cover technical services ranging from air quality and climate change analysis to emission inventories. In addition, our specialists develop climate action plans &amp; air quality mitigation strategies and conduct emission quantification &amp; conformity analyses for federally funded and tribal projects.</p>
<p>And, as the exclusive scoring partner for the <a href="/ttsvr/solutions/by-focus/cdp">Carbon Disclosure Project&rsquo;s (CDP) Supply Chain program</a> since 2011, FirstCarbon Solutions has gained a unique perspective that we offer companies looking to improve their CDP score or their overall organization&rsquo;s performance.</p>
<h3>Improve your carbon footprint</h3>
<p>Whether you are a public utility, a real estate contractor, a retailer or a CDP Supply Chain member looking for ways to reduce your carbon footprint, you need expert guidance and technologies that cost-effectively support your sustainability initiatives. Aside from our climate change solutions, our ghgTrack software enables you to measure, record and monitor your carbon emissions and improve your greenhouse gas management as part of your sustainability strategy.</p>
<p>As you work to address the challenges from climate change, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a sustainability-focused world.</p>
<div class="space">&nbsp;</div>
<p><a href="/ttsvr/solutions/by-focus/cdp"><img src="/ttsvr/fcs/images/cdp_logo2.png" alt="" /></a></p></div></div>
</div>
