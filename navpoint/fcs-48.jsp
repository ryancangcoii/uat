...
try {
	...
	String snippetVar_caseStudiesLink = "/ttsvr/clients/case-studies";
	String snippetVar_cdpLink = "/ttsvr/solutions/by-focus/cdp";
	String snippetVar_brochureLink = "/ttsvr/resources/brochures";
	String snippetVar_newsletterLink = "/ttsvr/resources/newsletters";
...
<section  ><%-- Widget fcs.pages.solutions_focus_sustainability_carbonmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_sustainability_carbonmanagement10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_sustainability.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_sustainability_carbonmanagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_sustainability_carbonmanagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_sustainability_carbonmanagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_sustainability.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_sustainability_carbonmanagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_sustainability_carbonmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/">Home</a> &raquo; <a href="/ttsvr/solutions">Solutions</a> &raquo; <a href="/ttsvr/solutions/by-focus">By Focus</a> &raquo; <a href="/ttsvr/solutions/by-focus/sustainability">Sustainability</a> &raquo; <span>Carbon Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Management Solutions &amp; Consulting Services</h1>
<h3>How carbon-efficient is your business?</h3>
<p>Understanding and accurately calculating the carbon-intensity of your business is a complex process. Your true carbon footprint isn&rsquo;t just a matter of inventory, it&rsquo;s a matter of efficiency, - i.e., how much carbon are you generating per unit sold or moved? Both your productivity per unit of carbon as well as your total carbon footprint factor into your sustainability status.</p>
<p>In addition to providing carbon&nbsp;<a href="/ttsvr/solutions/by-service/consulting">consulting&nbsp;</a>services, FirstCarbon Solutions helps you get beyond simple spreadsheet-based totals to help you accurately inventory and manage your carbon intensity for greater profitability and sustainability. Our expertise and tools help EHS and sustainability professionals manage operations more efficiently and strategically while more easily meeting requests for data.</p>
<h3>The path to carbon management and greater profitability</h3>
<p>First, we&rsquo;ll help you understand the drivers and business case for carbon management. What are other businesses in your industry doing? What are your reporting requirements? Where are your control points? Is third-party verification required?</p>
<p>Next, we&rsquo;ll provide a detailed accounting of how much CO<sub>2</sub>e each of your emission sources generate per unit of production. If you need help gathering and standardizing your carbon data, FirstCarbon Solutions offers&nbsp;<a href="/ttsvr/solutions/by-service/data-processing">data processing</a> services&nbsp;to make the process painless.</p>
<p>Using FirstCarbon Solutions&nbsp;<a href="/ttsvr/solutions/by-service/software/ghgtrack"><em>ghgTrack</em></a>&nbsp;application, you&rsquo;ll manage your carbon footprint in real-time, with reports that detail GHG emissions companywide, by business unit and by facility. Our inventories have built-in quality assurance and quality control and provide seamless auditing and verification, because you can store your third-party documentation within&nbsp;<em>ghgTrack</em>. Our carbon footprint software lets you append images, PDF files, and other documents, so your data and the supporting documentation reside in the same location.</p>
<p>Finally, we&rsquo;ll help you identify and implement efficiency improvement measures that will produce immediate cost savings by reducing your electricity, heating, and air conditioning bills.</p>
<h3>Carbon Footprint or LCA?</h3>
<p>They&rsquo;re not the same. But a carbon footprint is a key component of a <a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessment (LCA)</a>. To optimize economies of scale and minimize costs, many organizations elect to conduct a full&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA&nbsp;</a>&ndash; encompassing water, waste, and other natural resources and impacts &ndash; at the time they establish their carbon footprint. FirstCarbon Solutions encourages this practice for several reasons:</p>
<ul>
<li class="first">Implementing carbon footprint,&nbsp;<a href="/ttsvr/solutions/by-focus/energy/energy-management">energy efficiency</a>,&nbsp;and&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA&nbsp;</a>measures concurrently is more cost-effective, as they share much of the same data.</li>
<li>Performing an&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>&nbsp;of your entire manufacturing process lets you simultaneously evaluate multiple products, product lines, and processes.</li>
<li class="last"><a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>&nbsp;data can be used to drive a wider range of business decisions to improve&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>&nbsp;and product line sustainability and profitability.</li>
</ul>
<div><a href="/ttsvr/solutions/by-focus/cdp" target="_blank"><img src="/ttsvr/fcs/images/cdp_logo2.png" alt="" /></a></div></div></div>
</div>
