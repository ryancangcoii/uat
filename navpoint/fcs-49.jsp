...
<section  ><%-- Widget fcs.pages.solutions_focus_sustainability_csrreporting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_sustainability_csrreporting10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_sustainability_csrreporting@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_sustainability_csrreporting10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_sustainability_csrreporting10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_sustainability.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_sustainability_csrreporting10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_sustainability_csrreporting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-46">Sustainability</a> &raquo; <span>CSR Reporting</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>CSR Reporting</h1>
<h3>Strengthen the environmental pillars of your CSR programs &amp; policy with sustainability metrics</h3>
<p>With drivers ranging from reducing stakeholder risk to strengthening brand value to increasing access to funding, most Corporate Social Responsibility (CSR) programs now comprise environmental components such as cost-effective energy consumption and reduced environmental impact.</p>
<p>In fact, with the new GHG Protocol implemented by the World Resources Institute (WRI) and the World Business Council for Sustainable Development (WBCSD), the implementation of CSR programs with strong environmental components has become a must for companies seeking to promote sustainable and credible operations. And, in fact, more sustainable operations mean more for your bottom line.</p>
<p>The CSR reporting framework (WRI CSR Protocol) used most by companies and organizations today has been updated to emphasize stricter product accounting and accurate, verifiable reports containing true accounts of environmental compliance.</p>
<h3>We&rsquo;ll bring environmental transparency to your CSR program</h3>
<p>FirstCarbon Solutions helps you maintain immediate, transparent access to the data elements these recognized methodologies require for CSR data capture and reporting. FirstCarbon Solutions <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> services help gather and standardize all your relevant CSR documents and data. Our <a href="/ttsvr/solutions/by-service/software">software</a> and expert <a href="/ttsvr/solutions/by-service/consulting">consulting</a> services address your company's need for reliable, verifiable and accurate CSR carbon management, sustainability and greenhouse gas metrics, and more. FirstCarbon Solutions <a href="/ttsvr/solutions/by-service/software/ghgtrack">ghgTrack</a> provides a comprehensive CSR carbon management and reporting tool for regulators, employees, and the other stakeholders of your company.</p>
<p>FirstCarbon Solutions sustainability services provide the right solutions to establish environmental best practices within your CSR program.</p>
<div class="space">&nbsp;</div>
