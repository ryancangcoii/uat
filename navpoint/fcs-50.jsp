...
<section  ><%-- Widget fcs.pages.solutions_focus_energy@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <span>Energy</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Management Services</h1>
<h3>Management is key to improving your energy bottom line</h3>
<p>Are you looking to reduce power consumption and improve your energy footprint? Does your organization need to save on power costs and boost energy efficiency? FirstCarbon Solutions brings you a complete array of energy management services that suit your needs. Our energy specialists and management consultants are ready to share their expertise in:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/energy/energy-leadership">Energy Leadership</a></li>
<li><a href="/ttsvr/solutions/by-focus/energy/energy-management">Energy Management</a></li>
<li><a href="/ttsvr/solutions/by-focus/energy/energy-reporting">Energy Reporting</a></li>
<li><a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">Rebate &amp; Incentive Programs</a></li>
<li><a href="/ttsvr/solutions/by-focus/energy/utility-bill-management">Utility Bill Management</a></li>
</ul>
<p>FirstCarbon Solutions creates programs that allow you to save on energy costs and consumption and improves your organization&rsquo;s bottom line. We record, monitor &amp; manage your company's energy information and help you obtain government rebates &amp; incentives for improving your energy footprint.</p>
<p>When it comes to cost-effective and comprehensive energy management services, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in an energy-conscious world.</p>
<div class="space">&nbsp;</div>
