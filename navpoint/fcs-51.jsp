...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_leadership@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_leadership10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_leadership@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_leadership10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_leadership10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_leadership10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_leadership@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-50">Energy</a> &raquo; <span>Energy Leadership</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><p>h1&gt;Energy Leadership</p>
<h3>As energy sustainability consultants, we look ahead so you can lead</h3>
<p>Where should your energy programs be headed? What lies down the road in energy policy? What investments make the most sense now? And what are the best technologies to support your energy initiatives?</p>
<p>As a company at the forefront of energy management and <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a>, FirstCarbon Solutions helps you navigate the energy landscape now and prepare for what&rsquo;s ahead; so you have greater knowledge on where to invest your limited capital resources. Whether you are a public or private organization, count on us to be your eyes and ears &ndash; ensuring you understand the current energy environment and where trends may take you.</p>
<p>Our solutions are also at the leading edge, offering you unique capabilities, robust and flexible energy efficiency solutions, and next-generation technologies.</p>
<p>And while regulatory uncertainty is inevitable in the form of reporting <a href="/ttsvr/solutions/by-focus/sustainability/environmental-compliance">compliance</a>, cap and trade, and taxation, FirstCarbon Solutions helps your organization create business value by initiating proactive sustainability programs and environmental leadership.</p>
<div class="space">&nbsp;</div>
