...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_managementservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_managementservices10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_energy.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_managementservices@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_managementservices10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_managementservices10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_managementservices10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_managementservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-50">Energy</a> &raquo; <span>Energy Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Management Services</h1>
<h3>Smart energy management for energy data, strategies and programs</h3>
<p>Whether it&rsquo;s managing energy programs for your internal operations, customers or constituents, only FirstCarbon Solutions has the <a href="/ttsvr/solutions/by-service/software">expertise-software</a> and <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> capabilities to manage your energy programs in a way that optimizes both costs and results.</p>
<h3>For your operations</h3>
<p>FirstCarbon Solutions helps companies in a range of industries design strategic energy plans to reduce both costs and consumption. Whether it's recommending replacement lighting, implementing new space heating or cooling systems, or operating existing products more effectively, we&rsquo;ll help you dramatically reduce your energy costs and intensity &ndash; and help drive those changes throughout your organization.</p>
<p>An energy assessment or audit is the starting point. We'll take you through a step-by-step process designed to pinpoint weak links in your energy infrastructure and recommend ways to optimize your overall energy use. We&rsquo;ll design a complete energy efficiency program for your building(s) and operations and recommend solutions that will save you time and money, not only in terms of consumption but also in the handling of bills, audits, verifications, and payments.</p>
<p>FirstCarbon Solutions eases the burden of energy management with solutions that include:</p>
<ul>
<li>Energy bill consolidation and management</li>
<li>Validation and verification of energy usage</li>
<li>Energy efficiency programs</li>
<li>Secure data management transfers within <a href="/ttsvr/about-us/certifications">PCI-DSS guidelines</a></li>
<li>Account payment programs</li>
<li>Increased purchasing power and rate negotiation</li>
<li>Energy conservation programs</li>
</ul>
<h3>Program design for the public sector</h3>
<p>For government organizations, utilities, and municipalities managing <a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">incentive/rebate</a> programs for customers and constituents, FirstCarbon Solutions offers seamless energy program management capabilities that dramatically reduce costs, complexity, and headaches. Managing the program, processing all transactions, and tracking results &ndash; the <a href="/ttsvr/solutions/by-service/consulting">consultants</a> at FirstCarbon Solutions have the program expertise, technology and resources to oversee your programs for maximum effectiveness and efficiency.</p>
<h3>Tools for your success</h3>
<p>In addition to <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and data management services, FirstCarbon Solutions provides industry-specific, comprehensive, <a href="/ttsvr/solutions/by-service/software">software solutions</a> for the collection, management, reporting, and analysis of sustainability data &ndash; giving you a complete picture of your energy performance.</p>
<p>Accessible via the Internet, our <a href="/ttsvr/solutions/by-service/software/sustainability-workbench">Sustainability Workbench tool</a> offers a secure, robust data and document management platform to automate your energy data recording, monitor any metric you need, and establish energy consumption baselines for you to set improvement goals. For systematic, measurable energy program management aimed at dramatic improvements to your energy efficiency, look first to FirstCarbon Solutions.</p>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdp.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp_logo2.png" alt="" /></a></p></div></div>
</div>
