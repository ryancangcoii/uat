...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_reportingtrakingsoftware@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_reportingtrakingsoftware10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_reportingtrakingsoftware@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_reportingtrakingsoftware10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_reportingtrakingsoftware10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_reportingtrakingsoftware10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_reportingtrakingsoftware@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-50">Energy</a> &raquo; <span>Energy Reporting</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Reporting &amp; Tracking Software</h1>
<h3>Energy management solutions - energy answers at your fingertips</h3>
<p>Improving your energy footprint and reducing costs start with understanding where your energy dollars are going today. FirstCarbon Solutions offers unique ability to track, monitor, and report on energy usage on a day-to-day, nearly real-time basis.</p>
<p>Our monitor-based commissioning solutions, for example, combine the ability to track and report on energy efficiency minute-by-minute with continual commissioning for optimal performance.</p>
<p>And our <a href="/ttsvr/solutions/by-service/software/sustainability-workbench">Sustainability Workbench</a> tool provides a robust data management platform to automate your energy data recording, monitor any metric that you need, and establish energy consumption baselines for you to set improvement goals.</p>
<p>You can create your own ad hoc reports or generate editable CSR reports in Microsoft&reg;Word, which are pre-populated with the charts and graphs that you specify. And you can access your sustainability data anytime, anywhere, and rest assured that it&rsquo;s safe, because FirstCarbon Solutions develops and tests on a secure infrastructure.</p>
<div class="space">&nbsp;</div>
