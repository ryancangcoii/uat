...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_rebateincentiveadministrator@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_rebateincentiveadministrator10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_rebateincentiveadministrator@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_rebateincentiveadministrator10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_rebateincentiveadministrator10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_rebateincentiveadministrator10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_rebateincentiveadministrator@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-50">Energy</a> &raquo; <span>Rebate Incentive programs</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Rebate and Incentive Administration</h1>
<h3>Reach your energy management program goals at half the cost</h3>
<p>No company is better equipped than FirstCarbon Solutions to help private companies, utilities, and municipalities plan, launch, and implement energy rebate and incentive programs.</p>
<p>Our rebate and incentive administration and call center services support programs from a few hundred claims to hundreds of thousands; thanks to our team of <a href="http://www.adec-group.com/" target="_blank">5000 sourcing professionals across five continents</a>. We&rsquo;ll provide you with expert data management and reporting that is critical to a successful rebate program. Best of all, we find we can do it at up to half the cost of managing it yourself.</p>
<p>Highly <a href="/ttsvr/solutions/by-service/consulting/program-design-management">experienced program management</a>, outstanding customer service from call center operations, <a href="/ttsvr/solutions/by-service/data-processing">paper processing, document management, reporting, and payment processing</a> &ndash; we manage your entire rebate program more efficiently and cost-effectively than you could in-house &ndash; which means you get more for your investment.</p>
<h3>Take your program dollars further</h3>
<p>Whether you are a <a href="/ttsvr/solutions/by-industry/government">government</a> agency launching PACE funded improvement programs or a private company offering an appliance trade-in program, FirstCarbon Solutions is the partner you need.</p>
<p>These programs are complex and create unpredictable workloads. Peaks and troughs in volume driven by consumer demand mean that many utilities and municipalities are not staffed or equipped to handle time consuming rebate claims from customers in an efficient and cost-effective manner.</p>
<p>FirstCarbon Solutions offers a proven, outcome-focused solution including a robust audit path for your treasury or auditors. Using established, <a href="/ttsvr/about-us/certifications">certified processes</a>, we&rsquo;ll manage your call center operations, evaluation and processing of applications and approvals, document processing and management, reporting, and payment processing in a secure, accurate, and timely manner.</p>
<p>Our service allows you to quickly identify and collect the necessary data, review and verify it, and calculate the amount your individual customers should receive. It's just this kind of streamlined support that turns a burdensome, onerous rebate task into a simple, reliable operation that will provide positive experience for your customers &ndash; and meet your program <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> goals.</p>
<div class="space">&nbsp;</div>
