...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_utilitybillmanagementtoolsplatforms@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_utilitybillmanagementtoolsplatforms10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_utilitybillmanagementtoolsplatforms@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_utilitybillmanagementtoolsplatforms10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_utilitybillmanagementtoolsplatforms10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_energy.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_utilitybillmanagementtoolsplatforms10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_utilitybillmanagementtoolsplatforms@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-50">Energy</a> &raquo; <span>Utility Bill Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Utility Bill Management Tools &amp; Platforms</h1>
<h3>Find the right solutions to streamline your utility bill management</h3>
<p>If your goal is to create a better system for managing your utility bills, avoiding delays in bill payments or making your utility data more organized and accessible, you can count on FirstCarbon Solutions&rsquo; expertise in back-office data processing to create customized solutions to better handle and reduce your utility expenses.</p>
<p>We create centralized and computer-assisted tools and platforms that streamline the processes involved in managing your utility bills and procurement documents, including data-capturing and bill-tracking with the utmost accuracy and completeness. Our consultants and data experts also provide in-depth data analyses of utility fees and other charges to help your organization determine cost-saving opportunities, improve your energy footprint, and identify billing errors across the supply chain.</p>
<h3>Good record keeping for reduced costs and sustainability</h3>
<p>With FirstCarbon Solutions, your organization will manage utility bills more efficiently and cost-effectively. Whether you are a major retailer, a restaurant chain, a manufacturing firm or a government agency, we help you maintain good record&ndash;keeping practices, which are essential to your cost-saving and sustainability efforts.</p>
<p>As you seek to improve your utility bill management system, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p>
<div class="space">&nbsp;</div>
