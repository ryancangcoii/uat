...
<section  ><%-- Widget fcs.pages.solutions_focus_enviromental@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_enviromental10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_enviromental@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_enviromental10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_enviromental10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_enviromental10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_enviromental@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <span>Environmental</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Planning &amp; Compliance</h1>
<h3>Make more of your environmental compliance and performance</h3>
<p>If you face increased environmental regulations or are looking to improve operational efficiency, FirstCarbon Solutions knows what compliance</p>
<p>and performance really mean to your business. We transform these initiatives into opportunities for growth and sustainability for your company. With 30 years of experience in environmental planning and services, FirstCarbon Solutions brings comprehensive and cost-effective solutions to:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/environmental/air-traffic-and-noise-assessments">Air, Traffic &amp; Noise</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental/cultural-resources-management">Cultural Resources Management</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental/environmental-assessments">Environmental Assessments</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental/environmental-compliance">Environmental Compliance</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental/natural-resources-management">Natural Resources Management</a></li>
<li><a href="/ttsvr/solutions/by-focus/environmental/water-management">Water Management</a></li>
</ul>
<p>These solutions combined with our expertise in back-office data management allow you to address your environmental requirements in ways that will save you precious time and considerable resources.</p>
<h3>Count on the experts to help meet your environmental requirements.</h3>
<p>Our environmental specialists have worked on over 6,000 projects for various companies, governments, institutions and non-profit organizations. Our technical capabilities and understanding of environmental regulations and industry trends ensure the success of your compliance and management efforts. With FirstCarbon Solutions, you get to see how your environmental performance improves while you achieve profitable sustainability.</p>
<p>Whether you comply with a simple environmental requirement or address a complex regulatory issue, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
