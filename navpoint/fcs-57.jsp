...
<section  ><%-- Widget fcs.pages.solutions_focus_enviromental_airtrafficnoiseassessments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_enviromental_airtrafficnoiseassessments10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_environmental.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_enviromental_airtrafficnoiseassessments@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_enviromental_airtrafficnoiseassessments10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_enviromental_airtrafficnoiseassessments10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_enviromental_airtrafficnoiseassessments10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_enviromental_airtrafficnoiseassessments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-56">Environmental</a> &raquo; <span>Air, Traffic & Noise Assessments</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Air, Traffic &amp; Noise Assessments</h1>
<h3>Minimizing the impact: Air quality, traffic and noise management</h3>
<p>As part of your everyday business, and if you embark on new development projects, you need to manage your air emissions and minimize traffic &amp; noise impacts. You also are required to comply with all applicable regulations &ndash; especially if you are looking to receive the necessary permits and approvals for a new project.</p>
<p>With 30 years of experience, FirstCarbon Solutions provides standard analyses &amp; assessments, research &amp; peer reviews, mitigation strategies and legal &amp; regulatory advice for managing your environmental outputs.</p>
<h3>Promoting air quality for public health, sustainability and regulatory compliance</h3>
<p>In addition to assessing the air quality impact of your operations and development activities, you may want to promote air quality as part of your long-term sustainability goals. FirstCarbon Solutions applies our extensive knowledge about greenhouse gas emissions, air pollution, health risks and other issues and proactively helps you through:</p>
<ul>
<li>Air Quality Assessments</li>
<li>Health Risk Assessments</li>
<li>Indirect Source Review</li>
<li>Greenhouse gas emissions management</li>
<li>Air Quality Education &amp; Training</li>
</ul>
<p>With FirstCarbon Solutions, you get support from a team of experts and professionals who are knowledgeable about the California Environmental Quality Act (CEQA) and National Environmental Policy Act (NEPA) and other regulations. Many of our specialists have served local districts involved in air quality control &amp; regulations and are able to give you appropriate guidance on regulatory review.</p>
<h3>Stamp out traffic from your worry list</h3>
<p>If your organization is involved in property development or urban planning, FirstCarbon Solutions helps you assess the traffic impact of your project on the community. We also review existing road conditions, predict traffic impacts of your development project, as well as give you design recommendations and advice on the inter-modal aspects of transportation.</p>
<p>Our team of traffic experts performs a variety of services, such as traffic impact studies that include simulation &amp; analysis, calming solutions and mitigation reviews. We develop traffic solutions that account for commuter behavior &amp; travel patterns, parking &amp; alternative modes, and effective signal designs based on the latest theories and traffic forecasting models.</p>
<h3>A quieter environment to boost business prospects</h3>
<p>Noise is another concern you need to address when working on a development project. Whether it is a commercial complex or an industrial facility, FirstCarbon Solutions provides environmental noise impact assessments that include noise analyses &amp; monitoring, general plan noise elements and noise control compliance.</p>
<p>Our specialists offer their expertise in utilizing traffic noise prediction models and noise modeling tools for various types of projects, including recycling plants, parks and railroads. We also give expert testimony, legislative support and peer review to back your project.</p>
<p>Air quality, traffic and noise are business considerations that demand the attention and solutions only the experts can give, so expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
