...
<section  ><%-- Widget fcs.pages.solutions_focus_enviromental_culturalresourcesmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_enviromental_culturalresourcesmanagement10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_enviromental_culturalresourcesmanagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_enviromental_culturalresourcesmanagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_enviromental_culturalresourcesmanagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_enviromental_culturalresourcesmanagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_enviromental_culturalresourcesmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-56">Environmental</a> &raquo; <span>Cultural Resources Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Cultural Resources Management</h1>
<h3>Managing cultural resources the right way</h3>
<p>Whether you are a real estate firm developing on a potential historical site, a retailer expanding to an area that may contain unearthed fossils and artifacts, or an organization that recently acquired a property of cultural value, FirstCarbon Solutions helps you preserve the prehistoric and cultural heritages of regions undergoing development.</p>
<p>From preconstruction site assessments and fossil salvage plans to construction monitoring, you are assured of receiving professional services and technical assistance from our team of archeologists and paleontologists to ensure these resources are properly managed.</p>
<p>Archival research, archaeological surveys, laboratory testing and documentation are conducted to produce complete and accurate information about your cultural resources. Our recovery programs are designed in accordance with federal and state regulations, professional guidelines and local requirements to protect the integrity of cultural and archaeological finds.</p>
<h3>Take responsibility in preserving your cultural wealth</h3>
<p>For inclusion in local and national registers, FirstCarbon Solutions conducts evaluations through literature and archival record searches, in-field assessments and comprehensive recording of findings. We may also provide recommendations for site mitigation when necessary.</p>
<p>We consult with the Native American Heritage Commission and concerned tribal representatives in evaluating your prehistoric resources. After our field surveys and thorough study of these resources, you will receive professional advice on what course of action to take in preserving burial grounds, religious sites, artifacts and traditionally valued plants and animals that may be found on your properties.</p>
<p>As you manage your properties of great cultural and historical significance, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
