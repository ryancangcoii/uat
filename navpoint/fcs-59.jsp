...
<section  ><%-- Widget fcs.pages.solutions_focus_enviromental_assessments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_enviromental_assessments10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_enviromental_assessments@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_enviromental_assessments10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_enviromental_assessments10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_enviromental_assessments10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_enviromental_assessments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
...
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Assessments</h1>
<h3>Know the impacts to your environment</h3>
<p>Addressing issues such as sensitive habitats, historic or archaeological resources, and hazardous materials can drive up your development costs. Whether your goal is to conduct business or harness the potential of a specific location, accurate environmental assessments are a must to create a development plan with the least delays and most minimal environmental impacts.</p>
<p>FirstCarbon Solutions helps organizations efficiently and responsibly assess and manage these issues so you understand the true costs of development, choose the right site, and optimize costs. FirstCarbon Solutions combines technical expertise in, and knowledge of, air quality, biological and cultural resources, land use and urban planning to perform these assessments with focus on permitting and entitlements.</p>
<p>For years, our environmental specialists have dealt with various challenges that include scheduling and logistics, long-term field efforts and complicated compliance issues. These collective experiences ensure you get cost-effective, technically sound, and legally defensible solutions.</p>
<h3>Navigate the regulatory process swiftly and cost-effectively</h3>
<p>Our background in environmental compliance covers more than 6,000 projects that are subject to the California Environmental Quality Act (CEQA) and the National Environmental Policy Act (NEPA). These projects range from industrial, commercial &amp; residential properties to dams &amp; reservoirs, schools, golf courses, hospitals, and transportation &amp; recycling facilities. Because of this enormous experience in the regulatory landscape, we easily identify the requirements and mandated procedures for your projects, helping you navigate the review process swiftly and cost-effectively.</p>
<p>More than ever, organizations are looking for efficient, practical and cost-effective ways to assess and manage the environmental impacts of new or modified projects. We assist both owners and developers with cost-effective evaluations, compliance and continuing sustainability programs.</p>
<p>Our professional team of wetland delineators, permitting specialists, endangered species biologists and restoration ecologists takes you through the entire regulatory process as quickly and as efficiently as possible.</p>
<p>In addition, our archaeologists and cultural historians ensure that nonrenewable resources are saved for future scientific study and public education. We conduct preconstruction site assessments, literature and archival record searches, field surveys, and, if necessary, subsequent testing and recovery programs.</p>
<p>As you rely on our expertise in environmental assessments, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
