...
<section  ><%-- Widget fcs.pages.solutions_focus_enviromental_naturalresourcesmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_enviromental_naturalresourcesmanagement10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_enviromental_naturalresourcesmanagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_enviromental_naturalresourcesmanagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_enviromental_naturalresourcesmanagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_enviromental_naturalresourcesmanagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_enviromental_naturalresourcesmanagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-56">Environmental</a> &raquo; <span>Natural Resources Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Natural Resources Management</h1>
<h3>Caring for protected species and their habitats</h3>
<p>Do you need to conduct a survey of protected species? Monitor the construction of a project in an area abundant in flora and fauna? Is your organization required to restore habitats as part of your development plan? Then let FirstCarbon Solutions to give you the professional support you need to accomplish these tasks. We develop and implement an effective program to manage your natural resources and enhance your company&rsquo;s reputation in preserving biodiversity.</p>
<p>FirstCarbon Solutions helps you with advance planning and to develop innovative solutions and practices to address issues concerning natural resources. You receive the necessary technical and management assistance from biologists, ecologists and environmental specialists to ensure that your projects are implemented without harming nearby ecosystems and your long-term development goals.</p>
<h3>Seek expert guidance in managing critical habitat areas</h3>
<p>With our extensive knowledge of land development, the natural environment and regulatory processes, you get the needed evaluations, advice and mediations to meet even the most complicated requirements in managing your natural resources, especially those in critical habitat-designated areas.</p>
<p>While development is not prohibited in these areas, there are additional government consultations required under the Endangered Species Act and only the experts can provide you with adequate and proper guidance. Our involvement in major management projects in some of the most critical habitat areas gives you the assurance that your natural resources management program supports business sustainability while protecting endangered species.</p>
<p>When handling natural resources in pursuit of your development projects and goals, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
