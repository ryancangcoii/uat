...
<section  ><%-- Widget fcs.pages.solutions_focus_energy_watermanagementforindustrybusiness@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_energy_watermanagementforindustrybusiness10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_energy_watermanagementforindustrybusiness@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_energy_watermanagementforindustrybusiness10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_energy_watermanagementforindustrybusiness10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_environmental.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_energy_watermanagementforindustrybusiness10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_energy_watermanagementforindustrybusiness@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-56">Environmental</a> &raquo; <span>Water Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Water Management for Industry &amp; Business</h1>
<h3>The next wave</h3>
<p>Around the globe, water issues are putting greater pressure on organizations large and small. A crucial and increasingly scarce resource in many parts of the world, water and its management must be on every organizational radar, including yours. In industries from electronics to food products to manufacturing, water is a lynchpin resource. Without clean water in and sustainable water out, your business is at risk. But FirstCarbon Solutions helps you bring it under control.</p>
<p>As we do with <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon</a> and other <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> components, FirstCarbon Solutions helps you evaluate and mitigate the water intensity of your operations to reduce costs and improve the sustainability of your business.</p>
<h3>Water in</h3>
<p>Are you harming your water resources and putting your business future at risk? What are your water dependencies, and how fast are your resources depleting and by whom? Are aquifers being recharged or polluted? Do you have the water rights or contracts you&rsquo;ll need down the road? Are there ways you can become more water efficient today to reduce costs and risks?</p>
<p>We&rsquo;ll help you assess your water status today and establish smart water strategies for tomorrow &ndash; from sewer management to water treatment and water budget planning.</p>
<h3>Water out</h3>
<p>How can your business ensure you return water to the environment in a usable form? What is the water footprint of your business, and how are you contributing to the sustainability of water resources you depend on?</p>
<p>FirstCarbon Solutions water management <a href="/ttsvr/solutions/by-service/consulting">experts</a> help businesses in a wide variety of industries understand, inventory, and improve the role water conservation plays in the success of their businesses.</p></div></div>
</div>
