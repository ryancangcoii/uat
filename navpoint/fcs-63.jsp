...
<section  ><%-- Widget fcs.pages.solutions_focus_duediligenceentitlementservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_duediligenceentitlementservices10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_due_diligence.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_duediligenceentitlementservices@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_duediligenceentitlementservices10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_duediligenceentitlementservices10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_due_diligence.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_duediligenceentitlementservices10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_duediligenceentitlementservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <span>Due Diligence and Entitlement Services</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Due Diligence and Entitlement Services</h1>
<h3>Designing and implementing effective strategies for your site development</h3>
<p>Developing a new site can be a complicated and painstaking venture.&nbsp; FCS understands the process, as well as the issues involved, and takes a strategic approach to obtain approvals.&nbsp; Our dedicated, <a href="/ttsvr/about-us/management-team">responsive team</a> guides you through the process, keeping you on-target and on-time.&nbsp; Your dedicated project manager lets you know exactly where your project is, and facilitates and streamlines the entire process so that you&rsquo;re up and running faster:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/due-diligence-and-entitlement-services/due-diligence">Due Diligence</a></li>
<li><a href="/ttsvr/solutions/by-focus/due-diligence-and-entitlement-services/entitlements">Entitlements</a></li>
<li><a href="/ttsvr/solutions/by-focus/due-diligence-and-entitlement-services/environmental-reporting">Environmental Reporting</a></li>
<li><a href="/ttsvr/solutions/by-focus/due-diligence-and-entitlement-services/licensing-permitting">Licensing/Permitting</a></li>
</ul>
<p>With FCS, you&rsquo;ll:</p>
<ul>
<li>Open for business faster, employing a dedicated Team that understands and effectively manages the development process</li>
<li>Achieve greater accuracy in forecasting your development schedule</li>
<li>Rest assured that FCS is advocating your business</li>
<li>Stay updated on exactly where everything is in the approval process</li>
</ul>
<p>FCS&rsquo; expertise includes Site Investigation Reports/Due Diligence, Land Use and Planning application processing, as well as associated environmental study or report preparation. Our dedicated Team of professionals works with regulatory agencies to develop and implement an effective strategy to obtain development approvals for your projects. FCS will oversee the consultant/design team to address issues and support you through reasonable and cost-effective solutions.&nbsp; We offer uniquely superior customer service.</p></div></div>
</div>
