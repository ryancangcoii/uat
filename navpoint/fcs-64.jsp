...
<section  ><%-- Widget fcs.pages.solutions_focus_duediligenceentitlementservices_duediligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_duediligenceentitlementservices_duediligence10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_duediligenceentitlementservices_duediligence@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_duediligenceentitlementservices_duediligence10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_duediligenceentitlementservices_duediligence10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_due_diligence.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_duediligenceentitlementservices_duediligence10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_duediligenceentitlementservices_duediligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-63">Due Diligence and Entitlement Services</a> &raquo; <span>Due Diligence</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Due Diligence</h1>
<ul>
<li>What is the property Zoning?</li>
<li>What is the process for approvals?</li>
<li>How long will it take?</li>
<li>How much will the fees be?</li>
<li>What other design/construction issues will impact my timing and budget?</li>
</ul>
<p>Whether your project is ground-up or inline, it can be overwhelming to figure out where to start. Evaluating the process and issues early &ndash; before the Lease/Purchase Agreement is signed &ndash; helps you manage your expectations, save time, and avoid unnecessary expenses. FCS can help.</p></div></div>
</div>
