...
<section  ><%-- Widget fcs.pages.solutions_focus_duediligenceentitlementservices_entitlements@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_duediligenceentitlementservices_entitlements10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_duediligenceentitlementservices_entitlements@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_duediligenceentitlementservices_entitlements10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_duediligenceentitlementservices_entitlements10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_due_diligence.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_duediligenceentitlementservices_entitlements10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_duediligenceentitlementservices_entitlements@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-63">Due Diligence and Entitlement Services</a> &raquo; <span>Entitlements</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Entitlements</h1>
<p>No matter your business, you can count on FCS to act as your representative in seeking Planning and Zoning clearances and approvals.</p>
<p>Our focused effort keeps the development process on-task and on-time. Your dedicated Project Manager will lead the preparation of all of the applications and submittals discovered during the Due Diligence. The Project Manager will also coordinate the preparation and processing of the entitlement applications, and directs the design team to complete plans and specifications with clear messaging. Our effective team leadership, combined with accurate and thorough document preparation, results in quicker agency reviews and approvals.</p></div></div>
</div>
