...
<section  ><%-- Widget fcs.pages.solutions_focus_duediligenceentitlementservices_licensingpermitting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_duediligenceentitlementservices_licensingpermitting10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_duediligenceentitlementservices_licensingpermitting@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_duediligenceentitlementservices_licensingpermitting10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_duediligenceentitlementservices_licensingpermitting10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_due_diligence.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_duediligenceentitlementservices_licensingpermitting10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_duediligenceentitlementservices_licensingpermitting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-63">Due Diligence and Entitlement Services</a> &raquo; <span>Licensing Permitting</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Licensing/Permitting</h1>
<p>Now, fast-forward to getting your business open and operating. Having a comprehensive knowledge of the licensing and operational permitting process is invaluable. You not only need to know each and every permit, but also which government offices issue each permit, what information is necessary, and how often and under what circumstances the permit must be renewed. Sounds like a lot to manage when you&rsquo;ve got a business to run? It is. FCS can help.</p></div></div>
</div>
