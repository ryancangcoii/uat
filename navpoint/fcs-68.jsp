...
<section  ><%-- Widget fcs.pages.solutions_focus_supplychain@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_supplychain10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_supplychain@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_supplychain10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_supplychain10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_supply_chain.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_supplychain10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_supplychain@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <span>Supply Chain</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Achieve sustainability by improving your supply chain</h1>
<p>If improving your organization&rsquo;s sustainability and environmental reputation is part of your business plan, FirstCarbon Solutions knows how and where to start working to help you achieve your goals. With some of the best consultants and environmental experts, FirstCarbon Solutions will comprehensively review your supply chain, including power &amp; water consumption, greenhouse gas and waste. We also provide support to enable you meet all reporting requirements promptly and correctly, determine areas for improvement and recommend a program of work to reduce costs.</p>
<p>Specifically, we assist your initiatives in improving the environmental impacts and sustainability of your supply chain through the following:</p>
<ul>
<li><a href="/ttsvr/solutions/by-focus/supply-chain/supplier-scorecards">Supplier Scorecards</a></li>
<li><a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">Carbon Accounting</a></li>
<li><a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">Life Cycle Assessment</a></li>
</ul>
<div class="space">&nbsp;</div>
<h3>Gain a competitive edge in a carbon-conscious market</h3>
<p>With more and more organizations implementing initiatives to improve their carbon and energy footprint, FirstCarbon Solutions integrates its energy management services, environmental assessment capabilities and data processing expertise to help you stay ahead of the race. With our experts on your team, you will have a sustainability index in place to monitor your progress, the ability to account for the environmental impact of your products &amp; services and a mechanism to give your clients ready access to this information.</p>
<p>If you&rsquo;re looking to give your organization an improved and more sustainable supply chain, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value in a carbon-conscious world.</p>
<div class="space">&nbsp;</div>
