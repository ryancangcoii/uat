...
<section  ><%-- Widget fcs.pages.solutions_focus_supplychain_scoreacards@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_supplychain_scoreacards10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_supplychain_scoreacards@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_supplychain_scoreacards10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_supplychain_scoreacards10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_supply_chain.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_supplychain_scoreacards10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_supplychain_scoreacards@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-68">Supply Chain</a> &raquo; <span>Supplier Scorecards</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Supplier Sustainability Scorecards</h1>
<h3>Supporting both sides of the equation through sustainability analysis</h3>
<p>From apparel manufacturers to global retailers to healthcare facilities, organizations around the world are actively setting targets and making performance improvements to reduce their <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprints</a>. As more importance is placed on mandatory and consistent reporting of carbon emissions, a standard scoring system is one way to provide the transparency required for effective carbon management along the entire supply chain. LEED certifications and the rigorous indexing programs put in place by the Walmart consortium are just two examples.</p>
<p>FirstCarbon Solutions works with companies to establish effective scorecards for their supply chains, and we help suppliers readily and successfully respond to requests for <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> data by their customers.</p>
<h3>Developing meaningful rating systems</h3>
<p>With our deep experience in sustainability analysis and reporting, FirstCarbon Solutions helps you develop a rating system for your supply chain that is both rational and scientific.</p>
<p>From <a href="/ttsvr/solutions/by-focus/energy">energy</a> to waste to <a href="/ttsvr/solutions/by-focus/sustainability/water-management">water</a>, we&rsquo;ll help you establish standards that work for your business and are compelling to your stakeholders.</p>
<h3>Helping suppliers respond and compete</h3>
<p>On the supplier side, FirstCarbon Solutions helps suppliers cost-effectively collect and report on their sustainability status to make responding to customer requests for data simpler and faster. Having granular data on your performance readily available to a customer can make you a supplier of choice and more competitive in the marketplace.</p>
<h3>CDP looks to FirstCarbon Solutions</h3>
<p>CDP, an independent non-profit organization, provides a transformative global system for organizations to measure, disclose, manage, and share climate change information.</p>
<p>With consumers, shareholders, and other stakeholders demanding carbon reporting transparency, businesses are actively examining the green credentials of their existing and potential suppliers. More than 50 brands, including Vodafone, PepsiCo and Walmart, participate in the CDP Supply Chain Program. The program is designed to promote information sharing and innovation between CDP Supply Chain members and their suppliers of goods and services.</p>
<p>As CDP Supply Chain's scoring partner, FirstCarbon Solutions was tasked with taking information provided by participating suppliers, creating a disclosure score, and for the first time, assigning a CDP Supply Chain performance score. These scores help CDP Supply Chain members and their suppliers benchmark performance and seek year-on-year improvements.</p>
<p>FirstCarbon Solutions was selected as a scoring partner because of its leadership position in both <a href="/ttsvr/solutions/by-service/data-processing">data management</a> and sustainability. The scored data provides tangible insights for CDP members in assessing which suppliers are performing well on climate change and those that are lagging behind.</p>
<div class="space">&nbsp;</div>
