...
<section  ><%-- Widget fcs.pages.solutions_focus_supplychain_carbonaccountingbeyondinventory@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_supplychain_carbonaccountingbeyondinventory10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_supply_chain.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_supplychain_carbonaccountingbeyondinventory@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_supplychain_carbonaccountingbeyondinventory10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_supplychain_carbonaccountingbeyondinventory10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_supply_chain.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_supplychain_carbonaccountingbeyondinventory10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_supplychain_carbonaccountingbeyondinventory@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-68">Supply Chain</a> &raquo; <span>Carbon Accounting</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Carbon Accounting: Beyond Inventory</h1>
<p>The fuel in your forklifts, the refrigerant in your cooling systems &ndash; carbon footprinting services from FirstCarbon Solutions provide detailed, comprehensive, and accessible data about the carbon intensity of your business, processes, and products from cradle-to-grave. Our&nbsp;<a href="/ttsvr/solutions/by-service/data-processing">data processing</a>&nbsp;experience and&nbsp;<a href="/ttsvr/solutions/by-focus/energy/energy-management">energy management expertise</a>&nbsp;is unsurpassed, making us an efficient, cost-effective and trusted partner for your carbon footprint initiatives.&nbsp;</p>
<h3>Be a more competitive supplier</h3>
<p>How easily and completely you can respond to supply chain requests from your customers can determine how competitive you are as a supplier. We save you time and money by making up-to-the-minute carbon data available any time. Our carbon accounting solutions ensure you have precise and granular data at your fingertips &ndash; on a product-by-product, process-by-process basis and from raw materials to the loading dock to the retailers&rsquo; doors.&nbsp;</p>
<h3>Selected by the CDP</h3>
<p>Our experience with carbon accounting is unmatched. As CDP Supply Chain's scoring partner, FirstCarbon Solutions was tasked with taking information provided by participating suppliers and creating a disclosure score, and for the first time, assessing a CDP Supply Chain performance score. These scores help CDP Supply Chain members and their suppliers benchmark performance and seek year-on-year improvements.&nbsp;</p>
<p>FirstCarbon Solutions was selected as a scoring partner because of its leadership position in sustainability and data processing and management. The scored data provides tangible insights for CDP members in assessing which suppliers are performing well on climate change and those that are lagging behind.</p>
<h3>Carbon Footprint or LCA?</h3>
<p>They&rsquo;re not the same. But a carbon footprint is a key component of a&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">life cycle assessment (LCA)</a>. To optimize economies of scale and minimize costs, many organizations elect to conduct a full&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>&nbsp;&ndash; encompassing water, waste, and other natural resources and impacts - at the time they establish their carbon footprint. FirstCarbon Solutions encourages this practice for several reasons:</p>
<ul>
<li>Implementing carbon footprint,&nbsp;<a href="/ttsvr/solutions/by-focus/energy">energy efficiency</a>, and&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>&nbsp;measures concurrently is more cost-effective, as they share much of the same data.</li>
...
<li><a href="/ttsvr/solutions/by-focus/supply-chain/lca-and-supply-chain-services">LCA</a>&nbsp;data can be used to drive a wider range of businesses decisions to improve&nbsp;<a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a>&nbsp;and product line sustainability and profitability.</li>
</ul>
<div class="space">&nbsp;</div>
<p><a href="./../by-focus/cdp"><img src="/ttsvr/fcs/images/cdp_logo2.png" alt="" /></a></p></div></div>
</div>
