...
<section  ><%-- Widget fcs.pages.solutions_focus_supplychain_lcasupplychainservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_supplychain_lcasupplychainservices10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_supplychain_lcasupplychainservices@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_supplychain_lcasupplychainservices10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_supplychain_lcasupplychainservices10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_supply_chain.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_supplychain_lcasupplychainservices10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_supplychain_lcasupplychainservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-68">Supply Chain</a> &raquo; <span>LCA and Supply Chain Services</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>LCA and Supply Chain Services</h1>
<h3>Get the complete picture through production life cycle assessment</h3>
<p>FirstCarbon Solutions Life Cycle Assessment (LCA) services go beyond assessing carbon footprint and GHG emissions to encompass water, waste, and a full spectrum of natural resources throughout your supply chain.</p>
<p>We&rsquo;ll help you track and measure the sustainability of all your business inputs and outputs &ndash; how much waste you produce, how much water you consume and from where, and in what condition you return it to the environment. And of course, we&rsquo;ll help you evaluate where you can conserve resources to reduce costs and risks throughout your supply chain &ndash; improving both your environmental performance and your profitability.</p>
<p><a href="/ttsvr/solutions/by-service/data-processing">Outsource the administrative tasks</a>&nbsp;and data entry components of your LCA to FirstCarbon Solutions, and you&rsquo;ll dramatically reduce your overall program costs as well.</p>
<h3>LCA or Carbon Footprint?</h3>
<p>To optimize economies of scale and minimize costs, many organizations elect to conduct a full LCA at the time they conduct a <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprint</a>. FirstCarbon Solutions encourages this practice for several reasons:</p>
<ul>
<li>Implementing <a href="/ttsvr/solutions/by-focus/supply-chain/carbon-accounting">carbon footprint</a>, <a href="/ttsvr/solutions/by-focus/energy">energy efficiency</a>,&nbsp;and LCA measures concurrently is more cost-effective, as they share much of the same data.</li>
...
<li>LCA data can be used to drive a wider range of business decisions to improve supply-chain and product line sustainability and profitability.</li>
</ul>
<h3>LCA can make you a more competitive supplier</h3>
<p>Retail giants around the world increasingly require transparent and comprehensive sustainability data from suppliers of the products they carry, so consumers can make informed choices.</p>
