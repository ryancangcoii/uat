...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <span>CDP</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>CDP</h3>
<p>FCS provides services that help improve your performance and disclosures to CDP, the only global system for companies and cities to measure, disclose, manage and share vital environmental information.&nbsp;Like FCS, CDP works to <strong>transform the way the world does business</strong>, in an effort to <strong>curb the impacts of climate change</strong> and <strong>protect our natural resources</strong>.&nbsp; Over 3,000 organizations and cities across the world's largest economies measure and disclose their greenhouse gas emissions and climate change strategies through CDP, in order&nbsp;to set reduction goals and improve performance.</p>
<p>FCS is a CDP Gold Consultancy Partner and Silver Software Partner. With three years' experience scoring the majority of CDP disclosures globally, FCS has the unique, proven capabilities to help you develop and implement a carbon and climate change strategy that leads to:</p>
<ul>
<li>Unprecedented <strong>cost savings</strong></li>
<li>Business <strong>innovations</strong></li>
<li><strong>Reduced emissions</strong></li>
<li>Improved <strong>business efficiency</strong></li>
<li><strong>Stronger relationships</strong> with customers</li>
<li><strong>Improved collaboration</strong> with customers.</li>
</ul>
<h3>Transform Your Business with FCS' CDP Services</h3>
<p class="clearfix"><a href="#" data-toggle="modal" data-target="#cdp-services-video"><img class="pull-left mb15 mr15" src="/ttsvr/fcs/images/cdpvideo-thumb.jpg" alt="" /></a> FCS transforms businesses around the world using a unique approach in helping companies improve their CDP performance and disclosures.</p>
<div class="space">&nbsp;</div>
<p><a href="https://www.cdproject.net/en-US/Pages/HomePage.aspx" target="_blank"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p>
<div class="cdp-icon-links clearfix">
<div class="cdp-icon-link">
<h4>Find Out More</h4>
<a href="#" data-toggle="modal" data-target="#cdp-services-video"><img class="img-responsive" src="/ttsvr/fcs/images/find_out_more_icon.png" alt="" /> </a></div>
<div class="cdp-icon-link">
<h4>Our CDP Services</h4>
<a href="cdp/services"><img class="img-responsive" src="/ttsvr/fcs/images/cdp_services_icon.png" alt="" /> </a></div>
<div class="cdp-icon-link">
<h4>Climate Change Program</h4>
<a href="cdp/climate-change-program"><img class="img-responsive" src="/ttsvr/fcs/images/climate_change_program_icon.png" alt="" /> </a></div>
<div class="cdp-icon-link">
<h4>Supply Chain Program</h4>
<a href="cdp/supply-chain-program"><img class="img-responsive" src="/ttsvr/fcs/images/supply_chain_program_icon.png" alt="" /> </a></div>
<div class="cdp-icon-link">
<h4>CDP Case Studies</h4>
<a href="cdp/case-studies"><img class="img-responsive" src="/ttsvr/fcs/images/cdp_case_study_icon.png" alt="" /> </a></div>
<div class="cdp-icon-link">
<h4>Ask the CDP Experts</h4>
<a href="cdp/ask-the-cdp-experts"><img class="img-responsive" src="/ttsvr/fcs/images/ask_cdp_experts_icon.png" alt="" /> </a></div>
</div></div></div>
</div>
