...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_ourcdpservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_ourcdpservices10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solutionbyfocus.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_ourcdpservices@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_ourcdpservices10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_ourcdpservices10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solutionbyfocus.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_ourcdpservices10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_ourcdpservices@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <span>CDP Services</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Our CDP Services</h1>
<p>CDP holds the largest collection globally of primary climate change, water and forest-risk information. FCS scores more than 50% Supply Chain disclosers for CDP &mdash; one of the most credible sustainability rating/ranking indices in the world according to Globescan's 2012 Rate the Raters survey. This experience makes FCS unique in its capability and qualification for helping you maximize your score and develop a plan to put those insights into your organizational strategy.</p>
<p>As the exclusive Scoring Partner for the CDP Supply Chain Program in 2011 and 2012, as well as a Scoring Partner for the CDP Climate Change Program, FCS has developed significant expertise in the scoring and reporting methods of CDP. In fact, only FCS has question-by-question scoring information for participating companies that no other CDP partner has access to. Applying this unique experience, FCS is able to assist participants to better formulate their responses. In 2013, our clients improved their disclosure scores 30% overall vs. the prior year, with one client receiving CPLI status for the first time. Choose the solution that's right for you:</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/performance-review">Performance Review:</a></h3>
<p>Our free, 30-minute consultation will help you interpret your scores.</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/response-check">Response Check:</a></h3>
<p>With a multi-step process, FCS ensures your response is as complete as possible, saves you time and relieves pressure from your internal resources.</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/scoring-assessment">Scoring Assessment:</a></h3>
<p>FCS runs your completed questionnaire through the CDP scoring process ahead of your formal submission, providing you with question level scores and suggestions for improvement.</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/gap-analysis">Gap Analysis:</a></h3>
<p>Our in-depth analysis identifies areas and activities that correspond with lost points, and recommends activities to increase your score.</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/data-collection">Data Collection:</a></h3>
<p>Outsource the tedious tasks of data gathering, collection, standardization, compiling and reporting of your carbon and energy information.</p>
<h3 class="pull-left mr15 no-mb"><a href="/ttsvr/solutions/by-focus/cdp/services/disclosure-completion">Disclosure Completion:</a></h3>
<p>FCS takes on the responsibility of completing your lengthy CDP questionnaire, freeing up your internal resources.</p>
<div class="space">&nbsp;</div>
...
<div  class="formsHub"><h3>ASK CDP EXPERTS</h3>
<form id="contact-us" accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/e5951fb1-aed3-4a12-a2a0-ca5a619ebe6b" method="POST" role="form" novalidate>
