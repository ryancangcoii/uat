...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_climatechangeprogram@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_climatechangeprogram10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_climatechangeprogram@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_climatechangeprogram10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_climatechangeprogram10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_climatechangeprogram10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_climatechangeprogram@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <span>Climate Change Program</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Climate Change Program</h3>
<p>Providing a transformative global system for thousands of companies and cities to measure, disclose, manage and share environmental information, the CDP Climate Change Program supports the <strong>efficient collection, analysis and exchange of climate change data</strong> between stock market listed companies and their investors.</p>
<p>As the exclusive scoring partner for CDP&rsquo;s Nordic and DACH (Deutschland, Austria, and Switzerland) regions in 2012, and as the scoring partner for Australia, New Zealand, India, Nordic and Benelux (Belgium, Netherlands, Luxembourg) Regions, FCS offers a <strong>unique perspective</strong> to companies like yours.</p>
...
<div  class="formsHub"><h3>CLIMATE CHANGE PROGRAM</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/b9917ff1-6788-4ad2-93e7-b5f55d608502" method="POST" role="form" novalidate>
