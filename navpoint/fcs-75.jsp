...
<section  ><%-- Widget fcs.pages.solutions_focus_cdp_supplychainprogram@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_focus_cdp_supplychainprogram10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_focus_cdp_supplychainprogram@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_focus_cdp_supplychainprogram10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_focus_cdp_supplychainprogram10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_cdp_main.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_focus_cdp_supplychainprogram10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_focus_cdp_supplychainprogram@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-26">By Focus</a> &raquo; <a href="/ttsvr/n/fcs-72">CDP</a> &raquo; <span>Supply Chain Program</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h3>Supply Chain Program</h3>
<p>CDP's supply chain program gathers consistent information from suppliers on climate- and water-related strategy and action, as requested by the <a href="https://www.cdproject.net/en-US/Programmes/Pages/CDP-Supply-Chain.aspx#members">60+ CDP supply chain members</a> including companies like Walmart, Unilever, The Coca-Cola Company and Cisco Systems.</p>
<p>Scoring thousands of disclosures as the exclusive Scoring Partner for CDP's supply chain program in 2011 and 2012, FCS has developed significant <strong>expertise in the scoring and reporting methods of CDP</strong>. In fact, only FCS has question-by-question scoring information for participating companies that no other CDP partner has access to. Applying this unique experience, FCS is able to assist participants to better formulate their responses.</p>
<p>Fill out the form on this page to speak with one of our CDP Experts about your individual situation.</p>
<div class="space">&nbsp;</div>
<p><a href="#"><img src="/ttsvr/fcs/images/cdp.jpg" alt="" /></a></p></div></div>
</div>
...
<div  class="formsHub"><h3>SUPPLY CHAIN PROGRAM</h3>
<form accept-charset="UTF-8" enctype="multipart/form-data" action="https://forms.hubspot.com/uploads/form/v2/147290/881d987b-429b-43aa-866b-d57e5bcb2e7f" method="POST" role="form" novalidate>
