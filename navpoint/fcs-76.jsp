...
<section  ><%-- Widget fcs.pages.solutions_service_consulting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <span>Consulting</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability, Environmental &amp; Energy Consulting</h1>
<h3>Lead the pack. Let the experts show you the way.</h3>
<p>With some of the best sustainability, environmental and energy consultants in the industry, FirstCarbon Solutions empowers your business with the strategies and technologies that will help manage your environmental and sustainability initiatives profitably &ndash;&nbsp;so you can differentiate your business in a highly competitive marketplace.</p>
<p>We bring decades of experience and expertise to help you reduce your environmental costs and impacts, lower energy and resource use, ensure compliance, and operate more sustainably and efficiently.</p>
<p>Our consulting services include:</p>
<ul>
<li class="first"><a href="/ttsvr/solutions/by-service/consulting/business-case-development">Business Case Development</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/business-intelligence">Business Intelligence</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/environmental-due-diligence">Due Diligence</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/energy-management">Energy Management</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/environmental-impacts">Environmental Impacts</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/market-regulatory-guidance">Market &amp; Regulatory Guidance</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/performance-management">Performance Management</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/program-design-management">Program Design &amp; Management</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/resource-use-analysis">Resource Use Analysis</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/site-assessments">Site Assessments</a></li>
<li><a href="/ttsvr/solutions/by-service/consulting/strategy-deployment">Strategy Deployment</a></li>
<li class="last"><a href="/ttsvr/solutions/by-service/consulting/sustainability-environmental-management">Sustainability &amp; Environmental Management</a></li>
</ul>
<h3>Set industry standards in sustainable profitability</h3>
<p>FirstCarbon Solutions energy &amp; environmental consulting services, combined with our software solutions and back-office data processing expertise, will help you achieve sustainable profitability.</p>
<p>Whether your organization is reviewing environmental and sustainability practices throughout your operations or you are looking to ensure compliance with current regulations, FirstCarbon Solutions helps you expand and operate in a world that is increasingly demanding sustainable business practices for all participants.&nbsp;</p></div></div>
</div>
