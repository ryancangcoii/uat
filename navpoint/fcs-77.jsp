...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_businessCase@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_businessCase10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_businessCase@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_businessCase10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_businessCase10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_businessCase10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_businessCase@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Business Case Development</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting for Business - Business Case Development</h1>
<h3>Is it worth it?</h3>
<p>You can&rsquo;t do it all, so where do you put your dollars to get the fastest and highest ROI for your sustainability and energy initiatives?</p>
<p>FirstCarbon Solutions&rsquo; consultants will help you identify and quantify the actions that will bring the most value to your business &ndash; lower costs, increased profitability, and improved shareholder value, public perception, and market share. Our consultants are exceptionally well qualified to help you link your sustainability and energy efforts to bottom line results. They&rsquo;ll help you measure the potential ROI for the many options available to you, identifying the wisest and most lucrative opportunities.</p>
<p>Our business case development services can conduct complex modeling and what-if scenarios to compare alternative strategies. You&rsquo;ll enhance the accuracy of your business case with factors you might not otherwise consider, and you&rsquo;ll understand the energy and resource costs and savings that drive your decisions.</p>
<p>Understand your options, analyze the costs and benefits, and prioritize investments for sustainable profitability. That&rsquo;s the value you&rsquo;ll get from FirstCarbon Solutions business case development consulting services. And only FirstCarbon Solutions fully integrates that consulting expertise with <a href="/ttsvr/solutions/by-service/software">software</a>, program management, and unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to not only plan but also execute your strategy for success.</p></div></div>
</div>
