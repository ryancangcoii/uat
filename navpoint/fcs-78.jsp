...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_businessIntelligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_businessIntelligence10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_businessIntelligence@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_businessIntelligence10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_businessIntelligence10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_businessIntelligence10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_businessIntelligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Business Intelligence</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Business Intelligence</h1>
<h3>Valuable insight through sustainability consultants from FirstCarbon</h3>
<p>Profitability requires having the best possible business insights and data at your fingertips.</p>
<p>FirstCarbon Solutions&rsquo; consultants will provide the focused business intelligence you need to plan and operate for maximum business performance.</p>
<p>What-if scenarios. Benchmarking. Regulatory and market analysis and forecasting. Trends and insights mined from your own energy and consumption data. Our consultants give you the information and guidance you need to make informed decisions.</p>
<h3>Your competitive landscape</h3>
<p>What is your competition doing to harness sustainability for profitability? Our unique industry perspective and access to extensive data from the CDP and its membership empower you to understand your sustainability strengths, weaknesses, and opportunities in sustainability.</p>
<p>Only FirstCarbon Solutions fully integrates business intelligence consulting, <a href="/ttsvr/solutions/by-service/software">software</a>, and program management with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to put you on the path to sustainable efficiency.</p></div></div>
</div>
