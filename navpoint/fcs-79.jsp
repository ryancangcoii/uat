...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_environmentalDueDilligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_environmentalDueDilligence10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_environmentalDueDilligence@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_environmentalDueDilligence10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_environmentalDueDilligence10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_environmentalDueDilligence10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_environmentalDueDilligence@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Environmental Due Diligence</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Due Diligence</h1>
<p><strong>Protect your business interest no matter what the cost.</strong></p>
<p>Whether you buy a property or manage a commercial complex, it is important that you protect your business interests and secure your investments. FirstCarbon Solutions brings together assessors, legal experts and property consultants who are ready to share our proficiency in the due diligence process.</p>
<p>You get the best advice on, and assistance in, environmental site assessments, engineering or property condition assessments and other investigations needed to manage your risk, ensure you are making the most lucrative investments, and avoid liability. We help you through negotiations, evaluate the properties involved, and identify regulatory requirements as part of your mitigation plan.</p>
<p><strong>Be sharp. Work with a keen eye for detail. </strong></p>
<p>FirstCarbon Solutions leaves no stone unturned to support the integrity and completeness of your property transaction. That way you don&rsquo;t have to worry about issues that could arise later on, no matter what the future brings. We&rsquo;ve got it covered for you.</p>
<p>As you rely on our expertise in environmental due diligence, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
