...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_energyManagment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_energyManagment10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_energyManagment@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_energyManagment10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_energyManagment10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_energyManagment10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_energyManagment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Energy Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Management Consulting Services</h1>
<h3>Reduce your energy costs and exposure</h3>
<p>The right energy strategy can dramatically reduce your operating costs, risks and carbon footprint and help you meet your business goals. But finding the best approach in a world full of &lsquo;green&rsquo; possibilities isn&rsquo;t simple.</p>
<p>FirstCarbon Solutions energy management consulting services will put you on the best possible path toward cost reduction and greater profitability. We&rsquo;ll evaluate your current energy status and then identify the changes that will generate the greatest ROI now and down the road.</p>
<p>The FirstCarbon Solutions team includes some of the most experienced and knowledgeable energy consultants to help you make the most effective decisions about energy use in your business.</p>
<p>From monitor-based retrocommissioning to daylighting solutions to outsourcing your costly and cumbersome energy <a href="../../by-service/data-processing">data processing</a>, our consultants will help you sift through your energy saving opportunities to find the <a href="../../solutions">solutions</a> that make the most sense for your business.</p>
<p>Both our services and systems integrate with your existing <a href="../../by-focus/energy">energy</a> and <a href="../by-focus/sustainability">sustainability</a> solutions to enhance and streamline the energy and environmental management of your organization. And only FirstCarbon Solutions fully integrates our energy consulting services with <a href="../../by-service/software">software</a>, program management, and unmatched expertise in back office data processing to put you on the path to sustainable profitability.</p></div></div>
</div>
