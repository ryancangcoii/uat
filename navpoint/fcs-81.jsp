...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_environmentalImpacts@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_environmentalImpacts10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_environmentalImpacts@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_environmentalImpacts10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_environmentalImpacts10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_environmentalImpacts10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_environmentalImpacts@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Environmental Impacts</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Impacts</h1>
<h3>Mitigate environmental consequences early on</h3>
<p>Reducing your environmental costs and impacts, lowering energy and resource use, ensuring compliance, and operating more sustainably and efficiently provides a path to an improved bottom line. Whether your organization is reviewing environmental and sustainability practices throughout your operations or you are looking to ensure compliance with current regulations, FirstCarbon Solutions helps you expand and operate in a world that is increasingly demanding sustainable business practices.</p>
<p>FirstCarbon Solutions brings you the right mix of experts who can foresee the potential environmental impacts of your business plans. We&rsquo;ll help you understand how plans, programs and activities affect your sustainability and compliance efforts and work with you to improve your operations and environmental performance organization-wide.</p>
<p>By studying the location, project design, materials gathering and other activities involved before implementation, we determine how your development plan can affect your natural and cultural resources. FirstCarbon recommends solutions, alternatives and mitigation programs to help you avoid lost time and sizeable costs.</p>
<h3>Improving your carbon footprint. And your bottom line.</h3>
<p>And, if you&rsquo;re looking to improve your processes or inputs, our consultants are able to assess the impacts of your existing businesses on air quality, land use, water conservation, ecosystems and habitats. We introduce strategies and technologies to improve your carbon footprint, reduce emissions and increase your energy efficiency across the supply chain while meeting environmental regulations.</p>
<p>If you embark on a major project development, determine the environmental trade-offs when making changes to your business or supply chain, or want to enhance your environmental reputation, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
