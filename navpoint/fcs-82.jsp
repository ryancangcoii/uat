...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_marketAndRegulatory@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_marketAndRegulatory10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_marketAndRegulatory@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_marketAndRegulatory10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_marketAndRegulatory10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_marketAndRegulatory10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_marketAndRegulatory@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Market & Regulatory Guidance</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Market and Regulatory Guidance</h1>
<h3>Get the lay of the land through environmental consulting services</h3>
<p>Where should your <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> and <a href="/ttsvr/solutions/by-focus/energy">energy</a> programs be headed? What lies down the road in energy trends, policies, regulations, and initiatives such as cap and trade, offset programs, labeling and market trends? What investments make the most sense now? And what are the best technologies to support your environmental and energy objectives? Asking these questions is crucial to making good business decisions, yet they can be complex to answer.</p>
<p>The professional market and regulatory consultants at FirstCarbon Solutions will help you understand the latest trends impacting your industry, the unique parameters in which your business operates, what it means for your future, and what you can do today to position yourself for profitability and success in this constantly changing environment.</p>
<p>What&rsquo;s more, only FirstCarbon Solutions fully integrates market and regulatory consulting services with <a href="/ttsvr/solutions/by-service/software">software</a>, program management, and unmatched expertise in back office <a href="/ttsvr/solutions/by-focus/energy">data processing</a> to put you on the path to sustainable profitability.</p></div></div>
</div>
