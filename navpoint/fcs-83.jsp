...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_performanceManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_performanceManagement10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_performanceManagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_performanceManagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_performanceManagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_performanceManagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_performanceManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Performance Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Performance Management</h1>
<h3>Measure by measure</h3>
<p>Developing smart and cost-effective <a href="/ttsvr/solutions/by-focus/energy">energy</a>, <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a>, and <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> strategies is a critical part of the profitability picture.But capturing and managing performance metrics over time is crucial, too. Our performance management consultants will help you track and manage the performance of every component of your operations and processes for optimal resource use, cost savings, and <a href="/ttsvr/solutions/by-focus/sustainability/environmental-compliance">compliance</a>.</p>
<p>And, you can continually monitor your performance using FirstCarbon Solutions <a href="/ttsvr/solutions/by-service/software/sustainability-workbench">Sustainability Workbench</a> or <a href="/ttsvr/solutions/by-service/software/ghgtrack"><em>ghgTrack</em></a> software platforms &ndash; or we will work with your preferred technology solution and reporting layer to ensure that you stay on top of your energy and sustainability performance.</p>
<p>Set, monitor, and manage your targets with consulting guidance from FirstCarbon Solutions' performance management services. Only FirstCarbon Solutions gives you unrivaled consulting combined with the <a href="/ttsvr/solutions/by-service/software">software</a>, program management, and back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> services you need to achieve rapid, sustainable profitability.</p></div></div>
</div>
