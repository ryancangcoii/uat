...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_programDesign@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_programDesign10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_consulting.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_programDesign@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_programDesign10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_programDesign10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_programDesign10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_programDesign@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Program Design & Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Program Design and Management for Sustainability</h1>
<h3>Leave the complexity to us</h3>
<p>FirstCarbon Solutions&rsquo; program design and management consultants are among the best in the industry for developing and executing <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> and <a href="/ttsvr/solutions/by-focus/energy">energy</a> programs that deliver profitability advantages in both the short and long term.</p>
<p>Our consultants can help you steer your entire infrastructure towards utilization of low-energy technologies to reap substantial savings, design a <a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">rebate or incentive program</a> that&rsquo;s both effective and efficient, or help you plan for a future of sustainable <a href="/ttsvr/solutions/by-focus/sustainability/water-management">water management</a>.</p>
<h3>Energy programs made simple</h3>
<p>Whether it's recommending replacement lighting, installation of new heating or cooling systems, pace balancing, operating existing products more effectively or installing energy saving devices, FirstCarbon Solutions stands ready to help you save money by substantially reducing your current energy use and maximizing your ROI.</p>
<p>After assessing the energy consumption of your business through the first step of an energy audit, an energy efficiency program is designed. Through a step-by-step process, we evaluate the infrastructure, usage, and weak links in your system, followed by actionable recommendations.</p>
<p>FirstCarbon Solutions designs a complete energy efficiency program for your operations in multiple facilities and recommends energy efficiency solutions that will save you substantial time and money, removing the guesswork on what installations and corrective measures will realize our mutual objective of reducing your overall energy expense.</p>
<p>Only FirstCarbon Solutions fully integrates program design and management consulting expertise with <a href="/ttsvr/solutions/by-service/software">software</a> and unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a>. Our experts offer a robust, easy-to-use, and highly scalable software solution for customers to produce and track detailed, verifiable data about on-going energy consumption. You can even rely on us to gather and manage this data, saving you valuable internal resources.</p></div></div>
</div>
