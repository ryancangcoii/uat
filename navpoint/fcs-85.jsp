...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_resourceUseAnalysis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_resourceUseAnalysis10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_resourceUseAnalysis@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_resourceUseAnalysis10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_resourceUseAnalysis10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_resourceUseAnalysis10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_resourceUseAnalysis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Resource Use Analysis</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Resource Use Analysis</h1>
<h3>Understand your consumption</h3>
<p>From raw materials to fleet/equipment fuel consumption to <a href="/ttsvr/solutions/by-focus/energy">energy</a> use, the resource analysts at FirstCarbon Solutions will help you track and measure the <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a> of all your business inputs and outputs &ndash; how much waste you produce, how much water you consume and from where, and in what condition you return it to the environment. And of course, we&rsquo;ll help you evaluate where you can conserve resources to reduce costs and risks throughout your <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> &ndash; improving both your environmental performance and your profitability.</p>
<h3>Analyze, monitor, and improve</h3>
<p>Our <a href="/ttsvr/solutions/by-service/software/sustainability-workbench">Sustainability Workbench</a> tool, for example, offers a robust data management platform to automate your energy data recording, monitor any metric you need, and establish energy consumption baselines for you to set improvement goals.</p>
<p>Only FirstCarbon Solutions fully integrates resource analysis consulting expertise with <a href="/ttsvr/solutions/by-service/software">software</a>, program management, and unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a>.</p></div></div>
</div>
