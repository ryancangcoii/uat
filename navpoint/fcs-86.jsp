...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_siteAssestments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_siteAssestments10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_siteAssestments@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_siteAssestments10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_siteAssestments10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_siteAssestments10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_siteAssestments@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Site Assessments</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Site Assessments</h1>
<h3>Get all the data you need when appraising a site.</h3>
<p>Do you want to get the vital information you need about a certain location where you&rsquo;re planning to build or dig? What about how its physical features affect the overall design of your future project? Perhaps you want to ensure the success of the due diligence process you&rsquo;re about to undertake? Then let FirstCarbon Solutions to get you the data you need.</p>
<p>Our team of environmental assessment experts visits your site to accurately describe the locale&rsquo;s physical environment. We determine its project suitability and conduct research to give you a compliance checklist for doing business in that location. We also survey the property&rsquo;s natural and cultural resources and identify critical aspects that may have an impact on development design and future operations at that spot.</p>
<p>FirstCarbon Solutions also includes air, water and other assessments so you can meet all necessary environmental regulations as well as integrate appropriate mitigation programs into your project&rsquo;s overall blueprint.</p>
<h3>Complete package, only from FirstCarbon.</h3>
<p>With FirstCarbon Solutions, rest assured that your site assessments have all the data necessary to make the right decisions on whatever project you&rsquo;re into, be it a restaurant venture or an industrial park. You get a complete assessment package straight from the experts.</p>
<p>When it comes to giving you the most thorough &amp; practical site assessments, expect nothing less from FirstCarbon Solutions than providing you with the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
