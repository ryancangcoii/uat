...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_strategyDeployment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_strategyDeployment10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_strategyDeployment@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_strategyDeployment10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_strategyDeployment10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_strategyDeployment10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_strategyDeployment@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Strategy Deployment</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Consulting Strategy Deployment</h1>
<h3>Now what?</h3>
<p>Your goals are in place. Your strategies and program needs are set. Now where do you start? Our team of consultants will manage your strategy deployment to ensure you achieve each and every efficiency objective you&rsquo;ve set &ndash; measure by measure &ndash; across your <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a>, <a href="/ttsvr/solutions/by-focus/energy">energy</a>, and <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> programs.</p>
<p>Our planning guidance allows for easier integration into your overall business planning activities. We&rsquo;ll identify the projects that will deliver the highest ROI, manage execution, and guide you toward sustainable performance and profitability.</p>
<p>Only FirstCarbon Solutions fully integrates strategy deployment expertise with <a href="/ttsvr/solutions/by-service/software">software</a>, <a href="/ttsvr/solutions/by-service/consulting/program-design-management">program management</a>, and unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a>.</p></div></div>
</div>
