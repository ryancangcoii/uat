...
<section  ><%-- Widget fcs.pages.solutions_service_consulting_sustainabiltyEnvironmental@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_consulting_sustainabiltyEnvironmental10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_consulting_sustainabiltyEnvironmental@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_consulting_sustainabiltyEnvironmental10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_consulting_sustainabiltyEnvironmental10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_consulting.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_consulting_sustainabiltyEnvironmental10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_consulting_sustainabiltyEnvironmental@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-76">Consulting</a> &raquo; <span>Sustainability & Environmental Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability and Environmental Management</h1>
<h3>Unmatched sustainability consulting expertise for business &amp; industry</h3>
<p>No other service provider offers FirstCarbon Solutions&rsquo; depth of experience in multimedia sustainability and environmental management services, <a href="../../by-service/software">software</a>, and <a href="../../by-service/data-processing">data processing</a> and <a href="../../by-service/data-processing">management</a> solutions.</p>
<p>From <a href="../../by-focus/sustainability/carbon-management">carbon management</a> to air quality <a href="../by-focus/sustainability/environmental-compliance">compliance</a> and to <a href="../../by-focus/sustainability/water-management-for-industry-business">water management</a> and more, we bring to you a full portfolio of environmental services and expertise under one roof.</p>
<p>FirstCarbon Solutions delivers improved profitability with the versatility, simplicity, and confidence of one consulting organization &ndash; from conducting environmental impact assessments to addressing NEPA, CEQA, ISO 14001-environmental issues, regulatory analyses and developing compliance challenges. Our consulting offerings include:</p>
<ul>
<li class="first">Human health risk assessments</li>
<li>Ecological risk assessment</li>
<li>Wetlands mitigation</li>
<li class="last">Biological resource studies</li>
</ul>
<p><br /> Only FirstCarbon Solutions fully integrates sustainability consulting, software, and program management with unmatched expertise in back office data processing to put you on the path to sustainable profitability.</p></div></div>
</div>
