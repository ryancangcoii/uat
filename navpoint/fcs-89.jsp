...
<section  ><%-- Widget fcs.pages.solutions_service_software@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_software10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_software@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_software10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_software10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_software.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_software10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_software@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <span>Software</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Energy Monitoring &amp; Management Software</h1>
<h4>Environmental Software solutions for operational efficiency and profitability</h4>
<p>Our software solutions take you to a new level of cost-effective environmental management by automating your energy, sustainability and supply chain programs for optimal performance and profitability.</p>
<p>Only FirstCarbon Solutions fully integrates consulting expertise with software and extensive knowledge in back-office data processing.</p>
<p>FirstCarbon Solutions software services include:</p>
<p><a href="/ttsvr/solutions/by-service/software/sustainability-workbench">Sustainability Workbench</a><br /> <em><a href="/ttsvr/solutions/by-service/software/ghgtrack">ghgTrack</a></em><br /> <a href="/ttsvr/solutions/by-service/software/emis">Environmental Management Information System (EMIS)</a></p></div></div>
</div>
