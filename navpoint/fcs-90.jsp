...
<section  ><%-- Widget fcs.pages.solutions_service_software_susWorkbench@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_software_susWorkbench10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_software_susWorkbench@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_software_susWorkbench10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_software_susWorkbench10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_software.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_software_susWorkbench10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_software_susWorkbench@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-89">Software</a> &raquo; <span>Sustainability Workbench</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Workbench&trade; for Sustainability Reporting</h1>
<h3>Your sustainability metrics and energy portal</h3>
<p>FirstCarbon Solutions Sustainability Workbench enables you to monitor, manage, and report all your <a href="/ttsvr/solutions/by-focus/sustainability">sustainability</a>, <a href="/ttsvr/solutions/by-focus/energy">energy</a>, and <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> data easily and cost-effectively &ndash; so you can maximize ROI from all your efforts.</p>
<p>Regardless of the data source, this robust data management platform allows you to automate data recording, monitor virtually any metric, and establish use and consumption baselines in order to set improvement goals.</p>
<p>Sustainability Workbench empowers you to:</p>
<ul>
<li class="first">Report and graph the precise metrics you need</li>
<li>Collect data manually through web forms or through existing data sources. Or look to FirstCarbon Solutions expert, efficient <a href="/ttsvr/solutions/by-service/data-processing">data entry and processing services</a></li>
<li>Build repeatable and auditable procedures</li>
<li>Access your data securely, anytime via the Web</li>
<li class="last">Generate pre-populated editable <a href="/ttsvr/solutions/by-focus/sustainability/csr-reporting">CSR reports</a> in Microsoft<sup>&reg;</sup> Word</li>
</ul>
<p><br /> Only FirstCarbon Solutions fully integrates <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and software services like Sustainability Workbench with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to help you achieve sustainable profitability.</p></div></div>
</div>
