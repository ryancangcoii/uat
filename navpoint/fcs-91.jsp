...
<section  ><%-- Widget fcs.pages.solutions_service_software_ghgTrack@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_software_ghgTrack10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_software.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_software_ghgTrack@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_software_ghgTrack10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_software_ghgTrack10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_software.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_software_ghgTrack10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_software_ghgTrack@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-89">Software</a> &raquo; <span>ghgTrack</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1><em>ghgTrack <sup>&trade;</sup></em> for Sustainability Metrics</h1>
<h4>Go beyond carbon to reduce all your resource costs with our energy tracking software</h4>
<p>Effectively and precisely tracking your consumption can help you uncover hidden, wasted resources as well as opportunities for cost reduction. FirstCarbon Solutions <em>ghgTrack</em>&trade; brings you the tools you need to maximize those savings while reducing the costs and complexity of accounting for and reporting your greenhouse gas (GHG) emissions and resource consumption, especially across multiple facilities.</p>
<p>With <em style="border: 0px; margin: 0px; padding: 0px;">ghgTrack</em>, GHG is just the beginning. The <em>ghgTrack </em>tool lets you monitor all your environmental metrics, including water usage, waste, recycling, and more to reduce costs and report accurately for GRI, CDP, and consortium initiatives, like Walmart&rsquo;s.</p>
<h4>Why <em>ghgTrack</em>?</h4>
<p style="padding-left: 30px;"><strong>Simple.</strong> <em>ghgTrack</em> makes it easy to set up, use, and track your resource utilization. A hosted Internet-based solution, it eliminates the costs of maintaining a sustainability IT infrastructure.</p>
<p style="padding-left: 30px;"><strong>Accessible.</strong> <em>ghgTrack</em> provides a repository for utility bills and all documents related to the resources you&rsquo;re tracking for easy access and auditing.</p>
<p style="padding-left: 30px;"><strong>Expert.</strong> Only FirstCarbon Solutions offers integrated inventory <a href="/ttsvr/solutions/by-service/consulting">consulting services</a> and program management with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to help you make the most of your software investment.</p>
<p style="padding-left: 30px;"><strong>Customizable.</strong> We&rsquo;ll even customize <em>ghgTrack</em> to meet your specific needs with your own data entry pages, dashboards, and reports.</p>
<p>Our experts set up this robust, easy-to-use, highly scalable software solution for you to produce and track detailed, verifiable data about ongoing energy consumption. You can even <a href="/ttsvr/solutions/by-service/data-processing/data-system-conversion">rely on us to collect and manage your data</a>, saving you valuable internal resources.</p>
<p>And by combining our consulting with our industry leading software, we can provide an unparalleled comprehensive solution that collects, verifies, monitors, and manages all of your energy and sustainability data.</p></div></div>
</div>
