...
<section  ><%-- Widget fcs.pages.solutions_service_software_emis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_software_emis10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_software_emis@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_software_emis10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_software_emis10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_software.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_software_emis10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_software_emis@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-89">Software</a> &raquo; <span>EMIS</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Environmental Management Information Systems (EMIS)</h1>
<h3>Keep your compliance programs on track with EMIS</h3>
<p>FirstCarbon Solutions environmental management information systems provide you with powerful, hassle-free tools to simplify <a href="/ttsvr/solutions/by-focus/sustainability/environmental-compliance">compliance</a> workflows. With automated tracking of assignments and action items, you&rsquo;ll never miss a deadline and will always be ready for audits and inspections.</p>
<p>Simplicity is a key to compliance success. Our environmental information management systems are user-friendly, easy to manage, and role-based &ndash; so every participant can focus on owned tasks without distraction or confusion. Smart notifications keep your team updated when reports are due and what needs to be done to prepare, so nothing falls through the cracks.</p>
<p>For OSHA compliance, our OSHA-specific tools let you easily record incidents and illnesses; specify incident types, locations, dates, and other required information; automatically generate and store OSHA Form 300 and 300A reports and much more.</p>
<p>For wastewater compliance and DMR, you&rsquo;ll improve the accuracy of your reports to the National Pollutant Discharge Elimination System with FirstCarbon Solutions DMR software.</p>
<p>And for air emissions compliance, FirstCarbon Solutions&rsquo; Title V software streamlines the process of collecting air emissions data for your annual or semi-annual Title V report, whether you have a handful of emission units or hundreds.</p>
<p>Only FirstCarbon Solutions fully integrates EMIS software services and <a href="/ttsvr/solutions/by-service/consulting">consulting</a> with unmatched expertise in back office <a href="/ttsvr/solutions/by-service/data-processing">data processing</a> to help you achieve sustainable profitability.</p></div></div>
</div>
