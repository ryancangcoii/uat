...
<section  ><%-- Widget fcs.pages.solutions_service_reprographics@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_reprographics10BannerInnerPage";
	String snippetVar_banner = "/ttsvr/fcs/images/bannerInner/solution_reprographics.jpg";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_reprographics@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_reprographics10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_reprographics10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_reprographics.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_reprographics10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_reprographics@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <span>Reprographics</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Reprographics</h1>
<h3>Providing the reprographic support you need</h3>
<p>Do you want the some of the best technical people taking care of your reprographic needs? FirstCarbon Solutions has an in-house team with expertise in project information and version controlto give you well-integrated reprographic solutions that support your project&rsquo;s compliance goals. We utilize various techniques to secure quality control and a facility that reduces your project&rsquo;s reproduction costs.</p>
<p>FirstCarbon Solutions evaluates all materials for consistency and accuracy, and offers peer review of your technical products for better quality. We are also able to support immediate file exchange to perform version control as well as provide data output and geographic information services.</p>
<h3>Specialists and state-of-the-art technologies all in one place</h3>
<p>Our team of word processors, technical editors, graphic artists and reprographic specialists relies on powerful software that includes current Windows, GIS and CAD applications. We also use Ricoh systems, automated binding options and other advance technologies for professional report and CD productions to meet your expectations.</p>
<p>If you seek cost-effective and high-quality solutions to your reprographic needs, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
