...
<section  ><%-- Widget fcs.pages.solutions_service_dataProcessing_transactionData@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_dataProcessing_transactionData10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_dataProcessing_transactionData@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_dataProcessing_transactionData10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_dataProcessing_transactionData10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_data_processing.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_dataProcessing_transactionData10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_dataProcessing_transactionData@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-94">Data Processing</a> &raquo; <span>Transaction Data Administration</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Transaction Data Administration</h1>
<h3>Reduce your costs by as much as 50% with sustainability reporting solutions</h3>
<p>The process of collecting, inputting, and assuring all your energy and carbon data across your distributed enterprise and <a href="/ttsvr/solutions/by-focus/supply-chain">supply chain</a> is enormously costly and time-consuming. FirstCarbon Solutions offers a cost-effective and streamlined alternative, saving you money, conserving your professional resources for more strategic activities, and assuring you the most accurate and auditable results possible.</p>
<p>FirstCarbon Solutions&rsquo; sustainability professionals specialize in identifying <a href="/ttsvr/solutions/by-focus/energy">energy</a> and <a href="/ttsvr/solutions/by-focus/sustainability/carbon-management">carbon management</a> data including utility bills, fuel receipts, meter readings, HVAC maintenance reports, and travel logs. We put people, systems, and processes in place to find, collect, and organize all these different data types &ndash; transforming spreadsheet files, word processing documents, and boxes of paper records into standardized, easily accessible, and valuable electronic data.</p>
<p>We then key relevant information into the systems you specify, whether you&rsquo;re using a single, master spreadsheet, a software application or a custom application.</p>
<p>For quality control, we apply <a href="/ttsvr/about-us/certifications">certified</a>, multi-tiered processes to ensure the accuracy of your data.</p>
<p>Finally, we automatically extract and integrate data into the business application or database of your choice, whether you use <a href="/ttsvr/solutions/by-service/software">FirstCarbon Solutions software</a> or another tool.</p>
<p>Customers who source their data management tasks to FirstCarbon Solutions routinely realize 35-50 percent cost savings compared to in-house processing. And, only FirstCarbon Solutions combines this expertise in back office data processing with comprehensive <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> to help you achieve sustainable profitability.</p></div></div>
</div>
