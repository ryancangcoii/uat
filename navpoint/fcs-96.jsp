...
<section  ><%-- Widget fcs.pages.solutions_service_dataProcessing_documentManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_dataProcessing_documentManagement10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_dataProcessing_documentManagement@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_dataProcessing_documentManagement10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_dataProcessing_documentManagement10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_data_processing.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_dataProcessing_documentManagement10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_dataProcessing_documentManagement@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-94">Data Processing</a> &raquo; <span>Document Management</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Sustainability Document Management Services</h1>
<h3>Documents at your fingertips via sustainability reporting systems</h3>
<p>Let FirstCarbon Solutions digitize and centralize your <a href="/ttsvr/solutions/by-focus/energy">energy</a> and <a href="/ttsvr/solutions/by-focus/sustainability">environmental</a> data &ndash; for real cost savings at every step.</p>
<p>Many carbon reporting programs, both voluntary and mandatory, require that an independent third party verify the accuracy of your total greenhouse gas (GHG) emissions. These auditors can spend dozens of billable hours sifting through file cabinets looking for specific utility bills. If an auditor has to prove, for example, that you correctly reported the 623 kWH of electricity that a facility used in March, you don't want to pay for the time it takes to find the paper record.</p>
<p>Our sustainability document management services include:</p>
<ul>
<li class="first"><strong>Image scanning, data processing, and indexing:</strong> Turn paper records and key data into digital files for online file storage and fast access.</li>
<li><strong>Storage and archiving:</strong> We can box and store your paper records for you, give you access to your digitized, searchable documents in our document management system, upload your electronic documents on your document management system or provide you with a DVD of information.</li>
<li><strong>Security and permissions:</strong> Specify who can see and do what, if you are using our document management system.</li>
<li><strong>Software integration</strong>: Interface with your organization's existing systems to streamline data management.</li>
<li class="last"><strong>In the event of an audit:</strong> FirstCarbon Solutions document management services save you precious hours of verifying time by compressing and optimizing your data, time, and resource requirements.</li>
</ul>
<p>FirstCarbon Solutions combines this extensive expertise in back office document management and data processing with comprehensive <a href="/ttsvr/solutions/by-service/consulting">consulting</a> and <a href="/ttsvr/solutions/by-service/software">software</a> to help you achieve sustainable profitability across your organization.</p></div></div>
</div>
