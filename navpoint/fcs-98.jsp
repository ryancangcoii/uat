...
<section  ><%-- Widget fcs.pages.solutions_service_dataProcessing_rebateProcessing@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_dataProcessing_rebateProcessing10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_dataProcessing_rebateProcessing@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_dataProcessing_rebateProcessing10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_dataProcessing_rebateProcessing10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_data_processing.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_dataProcessing_rebateProcessing10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_dataProcessing_rebateProcessing@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-94">Data Processing</a> &raquo; <span>Rebate Processing</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Incentive and Rebate Processing</h1>
<h3>Get twice the ROI from your incentive programs with sustainability processing systems from FirstCarbon</h3>
<p>Utilities and <a href="/ttsvr/solutions/by-industry/government">municipalities</a> are increasingly utilizing rebate and other incentive programs to promote resource conservation and reduce costs. The rebate processing experts at FirstCarbon Solutions make these programs far more efficient and cost-effective to implement, ensuring the best possible results for every budget dollar spent.</p>
<p>Outsourcing rebate processing to FirstCarbon Solutions streamlines the entire process and ensures accountable customer service for every program participant. Our extensive rebate experience, specialized technologies, and ability to digitize paper documents for instant Internet-based access will slash the overhead costs of your <a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">rebate program</a>, allowing more dollars to be focused on program goals. We routinely save our clients <strong>60 to 70 percent or more per application </strong>on a variety of <a href="/ttsvr/solutions/by-focus/energy/rebate-incentive-programs">incentive programs</a> from water measures to electric appliances. With results like that, there&rsquo;s simply no reason to staff up in-house.</p>
<p>And only FirstCarbon Solutions combines this expertise in back office data and transaction processing with comprehensive <a href="/ttsvr/solutions/by-service/consulting">consulting</a>, <a href="/ttsvr/solutions/by-service/software">software</a>, and <a href="/ttsvr/solutions/by-service/consulting/program-design-management">program management</a> to help you achieve all your sustainability goals.</p></div></div>
</div>
