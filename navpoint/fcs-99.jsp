...
<section  ><%-- Widget fcs.pages.solutions_service_dataProcessing_utilityBill@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget) --%>
<%
try {
	String snippetVar_id = "fcspagessolutions_service_dataProcessing_utilityBill10BannerInnerPage";
	...
	String snippetVar_widgetPath = "fcs.pages.solutions_service_dataProcessing_utilityBill@10";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
		...
		<script id="scriptfcspagessolutions_service_dataProcessing_utilityBill10BannerInnerPage">/**
 * @author Dino Martin
 */
...
(function() {
	...
	ready(function () {
		try {
			var div = document.getElementById("fcspagessolutions_service_dataProcessing_utilityBill10BannerInnerPage");
			div.style.backgroundImage = "url(/ttsvr/fcs/images/bannerInner/solution_data_processing.jpg)";
			div.removeAttribute("id");

			var script = document.getElementById("scriptfcspagessolutions_service_dataProcessing_utilityBill10BannerInnerPage");
...
WbdSession.addError(jh.getCredentials(), "Rendering widget fcs.pages.solutions_service_dataProcessing_utilityBill@10 (type=tooltwist.fcs.widgets.BannerInnerPageWidget)", e);
}
%>
</section>
<div  class="row middlePage"><div  class=" col-lg-9 col-md-9 col-sm-7 col-xs-12 articleCont"><div  class="breadcrumbs"><a href="/ttsvr/n/fcs-home">Home</a> &raquo; <a href="/ttsvr/n/fcs-24">Solutions</a> &raquo; <a href="/ttsvr/n/fcs-27">By Service</a> &raquo; <a href="/ttsvr/n/fcs-94">Data Processing</a> &raquo; <span>Utility Bill Processing</span></div>
<div  class="advanceRichtext"><div class="wt12 wcGray3" ><h1>Utility Bill Processing Services</h1>
<h3>Ensuring prompt bill payments to help you avoid fines</h3>
<p>If you&rsquo;re a company operating in multiple locations or an organization whose operations are heavily dependent on electricity, water and other utilities, verifying and processing your monthly utility bills can be a big challenge.</p>
<p>FirstCarbon Solutions provides services and systems that ensure prompt and correct payment of your utility bills to avoid fines, surcharges and interruptions that arise from payment delays. With our technology-based solutions, you are able to access your utility bill data easily, avoid billing errors and duplications, and monitor energy rates &amp; consumption. Our integrated solutions record and organize pertinent data that you can use for your cost-saving programs and energy sustainability initiatives.</p>
<p>With our utility bill processing solution, you can perform overall management of your utility bill data &ndash; from capturing invoice information, organizing details, and interfacing with your service providers&rsquo; processing systems to making payments and queries about your consumption. Our staff readily provides support and guidance so that the processing runs smoothly and efficiently.</p>
<h3>Effective utility bill processing for reduced costs and increased savings</h3>
<p>Being in the business of back-office data processing for decades, FirstCarbon Solutions understands that an efficient, accurate and thorough processing of utility bills drives down operational costs and supports efforts to improve energy efficiency and sustainability. With FirstCarbon Solutions, not only can you eliminate unnecessary worries, you also allow your personnel to spend more time on crucial aspects of your everyday operations.</p>
<p>With our experts working to improve your utility bill processing chores, expect nothing less from FirstCarbon Solutions than providing the guidance and support you need to improve your bottom line value.</p></div></div>
</div>
