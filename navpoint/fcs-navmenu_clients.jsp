...
<%
	String jspName = "fcs-navmenu_clients";
...
<html lang="en">
  <head>
    <title>Clients</title>
	<meta name="description" content="Learn first-hand from FirstCarbon clients how our energy management and sustainability consulting services allow them to become more sustainable and profitable. Read our fascinating case studies today">
	<meta name="keywords" content="case studies, firstcarbon solutions, energy management, sustainability consulting, carbon management, sustainability consulting for businesses, environmental consulting solutions, energy management services, carbon trading credits, carbon management consulting, carbon asset management, baystate health, cec, heuck, southern California association of governments">
...
<div  class="d1n0m4rt1n"><a href="/ttsvr/n/fcs-100" class="dropdown-toggle">    <b>Clients</b></a><ul class="dropdown-menu">    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-101" >Case Studies</a>    </li>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-102" >Testimonials</a>    </li></ul></div>
