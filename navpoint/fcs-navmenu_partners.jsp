...
<%
	String jspName = "fcs-navmenu_partners";
...
<html lang="en">
  <head>
    <title>Carbon Management, Carbon Consulting</title>
	<meta name="description" content="FirstCarbon Solutions’ collaborative partnerships create revenue streams and new solutions for customers. Talk to us about carbon management, environmental sustainability & carbon consulting solutions & more today.">
	<meta name="keywords" content="firstcarbon solutions, carbon management, energy management consulting, carbon asset management, carbon emission trading, corporate energy management, energy sustainability for business, energy sustainability for industry, green energy management, first carbon solutions, our partners, carbon consulting">
...
<div  class="d1n0m4rt1n"><a href="/ttsvr/n/fcs-19" class="dropdown-toggle">    <b>Partners</b></a><ul class="dropdown-menu">    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-23" >Our Partners</a>    </li>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-22" >Become a Partner</a>    </li></ul></div>
