...
<%
	String jspName = "fcs-navmenu_solutions_industry_col2";
...
<div  class="d1n0m4rt1n"><ul>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-42" >Packaging</a>    </li>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-43" >Restaurants</a>    </li>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-44" >Retail</a>    </li>    <li>        <i class="glyphicon glyphicon-chevron-right"></i><a href="/ttsvr/n/fcs-45" >Telecommunications</a>    </li></ul></div>
