...
<%
	String jspName = "fcs-navmenu_solutions_tabs";
...
<div  class="d1n0m4rt1n"><ul class="dropdown-lg-tab clearfix">    <li class="active"><a href="/ttsvr/n/fcs-25" data-container="nav-industry-content">By Industry</a>    </li>    <li class=""><a href="/ttsvr/n/fcs-26" data-container="nav-focus-content">By Focus</a>    </li>    <li class=""><a href="/ttsvr/n/fcs-27" data-container="nav-service-content">By Service</a>    </li></ul></div>
