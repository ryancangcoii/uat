...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_54Params.setProperty("currentNavpoint", "skypepi-114");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_54Params.setProperty("currentNavpoint", "skypepi-114");
...
try {
	...
	String snippetVar_currentNavpoint = "skypepi-114";
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (status == 'FAILED') {
						...
						setTimeout(function() {
							window.location.href = "/ttsvr/n/skypepi-117?paymentDetailID=" + $("#paymentDetailID").val();
						}, 3000);
