...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_37Params.setProperty("navpointId", "/ttsvr/n/Payment-GOPI/skypepi-115");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_38Params.setProperty("navpointId", "/ttsvr/n/Payment-GOPI/skypepi-115");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_51Params.setProperty("navpointId", "/ttsvr/n/Payment-GOPI/skypepi-115");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_54Params.setProperty("currentNavpoint", "skypepi-115");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_54Params.setProperty("currentNavpoint", "skypepi-115");
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_btstrap_payment2_14 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_btstrap_payment2_14Params = new Properties();
	productionHelper_skypepi_pages_portal_p_btstrap_payment2_14 = new tooltwist.skypepi.productionHelpers.TransactPaymentProductionHelper(productionHelper_skypepi_pages_portal_p_btstrap_payment2_14Params);
	productionHelper_skypepi_pages_portal_p_btstrap_payment2_14.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_btstrap_payment2_14", e);
}
...
try {
	...
	String snippetVar_currentNavpoint = "skypepi-115";
...
<div class='DivWidget page-content' style=""><div class='DivWidget standard-width' style=""><%-- Widget skypepi.pages.portal_p_btstrap_payment2@14 (type=tooltwist.skypepi.widgets.TransactPaymentWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_portal_p_btstrap_payment2_14;
	...
	String snippetVar_widgetPath = "skypepi.pages.portal_p_btstrap_payment2@14";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<div class="ribbon-wrap left-edge fork lblue"><span><%=lang.getString("makePayment", null, "") %></span></div>
<br><br><br>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_btstrap_payment2@14 (type=tooltwist.skypepi.widgets.TransactPaymentWidget)", e);
}
%>
</div>
</div>
