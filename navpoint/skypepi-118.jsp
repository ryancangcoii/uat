...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_37Params.setProperty("navpointId", "/ttsvr/n/View-Receipt/skypepi-118");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_38Params.setProperty("navpointId", "/ttsvr/n/View-Receipt/skypepi-118");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_51Params.setProperty("navpointId", "/ttsvr/n/View-Receipt/skypepi-118");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_54Params.setProperty("currentNavpoint", "skypepi-118");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_54Params.setProperty("currentNavpoint", "skypepi-118");
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13Params = new Properties();
	productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13 = new tooltwist.skypepi.productionHelpers.ViewReceiptsProductionHelper(productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13Params);
	productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13", e);
}
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/View-Receipt/skypepi-118";
...
try {
	...
	String snippetVar_currentNavpoint = "skypepi-118";
...
<% if (h.isParentStudent()) { %> 
				...
				<li class="active"><a href="/ttsvr/n/myProgressions/skypepi-70"><%=h.getAltLang().getString("myProgressions",null,"") %></a><span></span></li>
...
<div class='DivWidget page-content' style=""><div class='DivWidget standard-width' style=""><%-- Widget skypepi.pages.portal_p_btstrap_myReceiptProgression@13 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_portal_p_btstrap_myReceiptProgression_13;
	String snippetVar_previewReceipts = "/ttsvr/n/Receipt-Preview/skypepi-119";
	String snippetVar_backNavpoint = "/ttsvr/n/myProgressions/skypepi-70";
	String snippetVar_widgetName = "@13";
	String snippetVar_widgetPath = "skypepi.pages.portal_p_btstrap_myReceiptProgression@13";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
					...
					<table cellspacing="0" class="table  bordered" id="tblReceipts">
						<tbody>
							<tr class="list-header">
								<th width="80px" class=""><%=lang.getString("Date", null, "") %></th>
							...
							%>
							<tr class="<%=clss %>">
								<td align="left" class=""><%=studentFinances.getPaymentDate() %></td>
								<td align="left" class=""><%=studentFinances.getPaymentDescription() %></td>
								<td align="right" class=""><%=StringUtil.formatCurrency(studentFinances.getPaymentGrossAmount()) %></td>
								<td align="left" class=""><%=studentFinances.getPaymentMethod() %></td>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_btstrap_myReceiptProgression@13 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget)", e);
}
%>
</div>
</div>
