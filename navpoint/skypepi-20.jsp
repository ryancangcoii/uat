...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/About-Us/skypepi-20");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-20");
...
<% } %>
<title>SkyPortal - About Us</title>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/About-Us/skypepi-20";
