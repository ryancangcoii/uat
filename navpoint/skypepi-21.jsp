...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/Contact-Us/skypepi-21");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-21");
...
<% } %>
<title>SkyPortal - Contact Us</title>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Contact-Us/skypepi-21";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-21";
...
%>
 ...
 <tr>
  <td  class='heading color-blue' align='left' valign='top'><span class="wbdRichText">Contact Us</span></td>
 </tr>
 <tr>
  <td  height='10'></td>
 </tr>
 <tr>
  <td  class='body-text'><span class="wbdRichText"><p>Our services and opening hours are displayed in the table below. </p><p>Our office will be closed on Sundays in July and August. &nbsp;We apologise for any inconvenience. </p><p>Please click here to check for dates in 2011 when our centres will be closed.  </p><p>Changes to Education UK information provision From September 2009, all Education UK enquiries will be handled by e-mail or by our online counselling services. We will no longer be able to answer enquiries made by telephone, or in person at our office.  </p><p>Thank you for your understanding and we would like to remind you that you can attend our monthly Postgraduate presentations which are delivered by British Council staff, as well as presentations and consultation sessions with visiting UK representatives. Details of these events can be found in our monthly events calendar. </p><p>  If you have any Education UK enquiries, please contact us at educationuk@britishcouncil.org.tw or via our online counselling service </p></span></td>
 </tr>
</table>
</td>
 </tr>
