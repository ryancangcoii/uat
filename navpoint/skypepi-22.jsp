...
try {
	...
	productionHelper_skypepi_pages_portal_p_btsrpForgotPasswordpage_14Params.setProperty("cancelNavpoint", "/ttsvr/n/Login/skypepi-75");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_notAuth_40Params.setProperty("currentNavpoint", "skypepi-22");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_73Params.setProperty("currentNavpoint", "skypepi-22");
...
<div class='DivWidget' style=" width:100%;"><table border='0' cellpadding='0' cellspacing='0'  width='100%' align='center' valign='top'>
 ...
 <tr>
  <td ><%-- Widget skypepi.zones.portal_z_header_notAuth@57 (type=tooltwist.skypepi.widgets.LibraryImporterWidget) --%>
<%
try {
...
%>
 ...
 <tr>
  <td  class='magic2 headerBG' height='75' align='center'><div class='DivWidget standard-width' style=""><table border='0' cellpadding='0' cellspacing='0'  width='100%' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><table border='0' cellpadding='0' cellspacing='0'  width='100%' align='center' valign='top'>
 <tr>
...
try {
	...
	String snippetVar_currentNavpoint = "skypepi-22";
