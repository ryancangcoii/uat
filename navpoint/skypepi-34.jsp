...
<%@page import="tooltwist.skypepi.productionHelpers.StudentFeesProductionHelper"%>
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/Fees/skypepi-34");
...
try {
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_studentFees_67 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_studentFees_67Params = new Properties();
	productionHelper_skypepi_pages_skypepi_studentFees_67Params.setProperty("navpointId", "/ttsvr/n/Fees/skypepi-34");
	productionHelper_skypepi_pages_skypepi_studentFees_67Params.setProperty("viewReceiptsLink", "/ttsvr/n/View-Receipts/skypepi-37");
	productionHelper_skypepi_pages_skypepi_studentFees_67Params.setProperty("recordsNoTransactions", "20");
	productionHelper_skypepi_pages_skypepi_studentFees_67Params.setProperty("payFeesOnlineLink", "/ttsvr/n/Online-Payment/skypepi-36");
	productionHelper_skypepi_pages_skypepi_studentFees_67 = new tooltwist.skypepi.productionHelpers.StudentFeesProductionHelper(productionHelper_skypepi_pages_skypepi_studentFees_67Params);
	productionHelper_skypepi_pages_skypepi_studentFees_67.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_studentFees_67", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-34");
...
try {
	...
	productionHelper_skypepi_zones_z_studentFunctionsMenu_61Params.setProperty("navpointId", "/ttsvr/n/Fees/skypepi-34");
...
<% } %>
<title>SkyPortal - Student Fees</title>
...
<script type="text/javascript">var host = window.location.protocol + "//" + window.location.hostname + ":" + window.location.port;

var pageNumber = 1;
var maxPage = 1;

function getTransactionsList() {
	var recordsNo = document.getElementById("recordsNoTransactions").value;
	var url = "";
	url = url
	+ "?"
	+ "&op=skypepi_widgets.studentFees.studentFeesRequestHandler"
	+ "&recordsNo=" + recordsNo
	+ "&pageNo=" + pageNumber;
	$.ajax({
		url: url,
		...
		success: function(data) {
			document.getElementById("transactionsListContainer").innerHTML = data;
			if(document.getElementById("transactionslist_max_page") != null) {
				maxPage = document.getElementById("transactionslist_max_page").value;
			}
			loadData(10);
			jQuery("#outstandingDue").val(jQuery("#studentDue").val());
		},
		error: function() {
...
function setTransactionsList(pageNo) {
...
function loadData(val) {
	pager = null;
	pager = new Pager('tblStudentFees', parseInt(val)); 
    pager.init(); 
    pager.naviType = 'TYPE3';
    pager.naviClass = 'navi';
    pager.showSelection = false;
    pager.showPageNav('pager', 'divFeesNavi', 9); 
    pager.showPage(1);
}</script>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Fees/skypepi-34";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-34";
...
<tr>
 <td class='skypepi_studentFees@63_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_studentFees@63_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_studentFees@63_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_studentFees@63_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_studentFees@63_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  height='550' width='730' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_studentFees@67 (type=tooltwist.skypepi.widgets.StudentFeesWidget) --%>
<%
try {
	...
	String snippetVar_widgetName = "@67";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_studentFees@67";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<%@page import="tooltwist.skypepi.util.DataBlockUtil"%>
<%@page import="tooltwist.skypepi.util.WebUtil"%>
<%@page import="tooltwist.skypepi.bean.FetchStudent"%>
<%@page import="com.dinaa.misc.AltLang"%>

<%
	StudentFeesProductionHelper h = (StudentFeesProductionHelper) helper;
	AltLang lang = h.getAltLang();

	FetchStudent fetchStudent = h.getFetchStudent();
	String fullName = fetchStudent.getFullName(lang.getCurrentLangCode());
	String studentID = fetchStudent.getId();
	String studentNumber = fetchStudent.getStudentNumber();

	String languageCode = WebUtil.getAttributes(request, DataBlockUtil.SESSION_VARIABLE.LANGUAGE, "");

	int recordsNoTransactions = h.getRecordsNoTransactions();
...
<!-- 					<img src="/ttsvr/skypepi/images/skypepi_brtl.png" alt="" width="8" height="8" class="corner" style="display: none" /> -->
				...
				<div class="studentFees-container" align="center">
					<form id="form-studentFees" name="form-studentFees" method="post" action="<%=snippetVar_navpointId%>">
						<input type="hidden" name="navpointId" value="<%=snippetVar_navpointId%>"/>
						<table>
							<tr>
								<td width="400px" align="left" class="heading color-blue"><%=lang.getString("Student Fees", null, "") %> <span class="color-regular">(<%=fullName %>)</span></td>
									...
									<table cellpadding="0" cellspacing="0">
										<tr>
											<td>
												<table width="149" border="0" cellspacing="0" cellpadding="0">
								                    <tr>
								                      ...
								                      <td width="126" class="button_m"><a href="javascript:payFeesOnline();"><%=lang.getString("Pay fees online", null, "") %></a></td>
											...
											<td>
							                    ...
							                    <tr>
							                      <td width="6" class="button_l">&nbsp;</td>
							                      <td width="126" class="button_m"><a href="javascript:viewReceipts();"><%=lang.getString("View Receipts", null, "") %></a></td>
							                      <td width="17" class="button_r">&nbsp;</td>
							                    </tr>
							                  </table>
											</td>
							...
							<%--<tr>
								<td align="left" class="body-text color-regular" colspan="2"><%=lang.getString("Student ID", null, "") %>:</td>
							</tr>
							<tr>
								<td align="left" class="label-text color-regular" colspan="2">
									<div class="form-input-medium-container">
										<input id="studentId" name="studentId" class="form-input-medium" type="text" autocomplete="off" value="<%=studentID %>" readonly="readonly"/>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="left" class="body-text color-regular" colspan="2"><%=lang.getString("Student Number", null, "") %>:</td>
							</tr>
							<tr>
								<td align="left" class="body-text color-regular" colspan="2">
									<div class="form-input-medium-container">
										<input id="student" name="student" class="form-input-medium" type="text" autocomplete="off" value="<%=studentNumber %>" readonly="readonly"/>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="left" class="body-text color-regular" colspan="2"><%=lang.getString("Student Name", null, "") %>:</td>
							</tr>
							<tr>
								<td align="left" class="label-text color-regular" colspan="2">
									<div class="form-input-large-container">
										<input id="studentName" name="studentName" class="form-input-large" type="text" autocomplete="off" value="<%=fullName %>" readonly="readonly"/>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="left" class="body-text color-regular" colspan="2"><%=lang.getString("Outstanding/Due", null, "") %>:</td>
							</tr>
							<tr>
								<td align="left" class="label-text color-regular" colspan="2">
									<div class="form-input-small-container">
										<input id="outstandingDue" name="outstandingDue" class="form-input-small" type="text" autocomplete="off" value="0.00" readonly="readonly"/>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="left" class="table-heading color-regular" colspan="2"><b><%=lang.getString("Transactions", null, "") %></b></td>
							</tr>
							<tr>
								<td align="left" colspan="2">
									<input type="hidden" id="recordsNoTransactions" value="<%=recordsNoTransactions %>"/>
									<div id="transactionsListContainer">
										<img alt="loading..." src="/ttsvr/skypepi/images/dialog/loadingAnimation.gif">
									</div>
								</td>
							</tr>
						</table>
...
function payFeesOnline() {
	var studentFeesForm = $("#form-studentFees");
	studentFeesForm.attr("action", "<%=snippetVar_payFeesOnlineLink%>");
	studentFeesForm.submit();
}

function viewReceipts() {
	var studentFeesForm = $("#form-studentFees");
	studentFeesForm.attr("action", "<%=snippetVar_viewReceiptsLink%>");
	studentFeesForm.submit();
}
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_studentFees@67 (type=tooltwist.skypepi.widgets.StudentFeesWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_studentFees@63_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_studentFees@63_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_studentFees@63_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_studentFees@63_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_studentFees_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
