...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/Select-Course-And-Confirm/skypepi-35");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-35");
...
try {
	...
	productionHelper_skypepi_zones_z_studentFunctionsMenu_61Params.setProperty("navpointId", "/ttsvr/n/Select-Course-And-Confirm/skypepi-35");
...
<% } %>
<title>SkyPortal - Conclude and Confirm</title>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Select-Course-And-Confirm/skypepi-35";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-35";
