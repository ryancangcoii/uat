...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/View-Receipts/skypepi-37");
...
try {
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_viewReceipt_60 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_viewReceipt_60Params = new Properties();
	...
	productionHelper_skypepi_pages_skypepi_viewReceipt_60Params.setProperty("timetagbleSessionNavPointLink", "/ttsvr/MISSING_LINK/skypepi-94");
	productionHelper_skypepi_pages_skypepi_viewReceipt_60Params.setProperty("alertNavPointLink", "/ttsvr/MISSING_LINK/skypepi-94");
	productionHelper_skypepi_pages_skypepi_viewReceipt_60Params.setProperty("bookingsNavPointLink", "/ttsvr/MISSING_LINK/skypepi-94");
	productionHelper_skypepi_pages_skypepi_viewReceipt_60Params.setProperty("forumCocNavPointLink", "/ttsvr/MISSING_LINK/skypepi-94");
	...
	productionHelper_skypepi_pages_skypepi_viewReceipt_60Params.setProperty("assessmentAttendanceNavPointLink", "/ttsvr/MISSING_LINK/skypepi-94");
	...
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_viewReceipt_60", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-37");
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_viewReceipt_64 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_viewReceipt_64Params = new Properties();
	productionHelper_skypepi_pages_skypepi_viewReceipt_64 = new tooltwist.skypepi.productionHelpers.ViewReceiptsProductionHelper(productionHelper_skypepi_pages_skypepi_viewReceipt_64Params);
	productionHelper_skypepi_pages_skypepi_viewReceipt_64.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_viewReceipt_64", e);
}
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/View-Receipts/skypepi-37";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-37";
...
%>
 ...
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_viewReceipt@60 (type=tooltwist.skypepi.widgets.StudentFunctionsMenuWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_viewReceipt_60;
	String snippetVar_navpointId = "/ttsvr/n/View-Receipts/skypepi-37";
	...
	String snippetVar_alertNavPointLink = "/ttsvr/MISSING_LINK/skypepi-94";
	String snippetVar_assessmentAttendanceNavPointLink = "/ttsvr/MISSING_LINK/skypepi-94";
	String snippetVar_timetagbleSessionNavPointLink = "/ttsvr/MISSING_LINK/skypepi-94";
	String snippetVar_bookingsNavPointLink = "/ttsvr/MISSING_LINK/skypepi-94";
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_viewReceipt@60 (type=tooltwist.skypepi.widgets.StudentFunctionsMenuWidget)", e);
}
%>
</td>
  <td  width='20'></td>
  <td  width='760' valign='top'><table border='0' cellpadding='0' cellspacing='0'>
<tr>
 <td class='skypepi_viewReceipt@62_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_viewReceipt@62_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_viewReceipt@62_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_viewReceipt@62_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_viewReceipt@62_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  height='550' width='730' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_viewReceipt@64 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_viewReceipt_64;
	String snippetVar_previewReceipts = "/ttsvr/n/Preview-Receipt/skypepi-38";
	String snippetVar_widgetName = "@64";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_viewReceipt@64";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_viewReceipt@64 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_viewReceipt@62_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_viewReceipt@62_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_viewReceipt@62_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_viewReceipt@62_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_viewReceipt_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
