...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/Preview-Receipt/skypepi-38");
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_previewReceipt_64 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_previewReceipt_64Params = new Properties();
	productionHelper_skypepi_pages_skypepi_previewReceipt_64Params.setProperty("viewReceipts", "/ttsvr/n/skyportal--my-course-history/skypepi-62");
	productionHelper_skypepi_pages_skypepi_previewReceipt_64 = new tooltwist.skypepi.productionHelpers.PaymentReceiptProductionHelper(productionHelper_skypepi_pages_skypepi_previewReceipt_64Params);
	productionHelper_skypepi_pages_skypepi_previewReceipt_64.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_previewReceipt_64", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-38");
...
<% } %>
<title>SkyPortal - Receipt Preview</title>
...
<tr>
 <td class='skypepi_previewReceipt@62_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_previewReceipt@62_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_previewReceipt@62_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_previewReceipt@62_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_previewReceipt@62_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  height='550' width='900' align='center' valign='top'>
 <tr>
  <td  align='center' valign='top'><%-- Widget skypepi.pages.skypepi_previewReceipt@64 (type=tooltwist.skypepi.widgets.PaymentReceiptWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_previewReceipt_64;
	String snippetVar_viewReceipts = "/ttsvr/n/skyportal--my-course-history/skypepi-62";
	String snippetVar_widgetName = "@64";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_previewReceipt@64";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_previewReceipt@64 (type=tooltwist.skypepi.widgets.PaymentReceiptWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_previewReceipt@62_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_previewReceipt@62_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_previewReceipt@62_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_previewReceipt@62_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_previewReceipt_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
