...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/English-Courses/skypepi-44");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-44");
...
<% } %>
<title>SkyPortal - English Courses</title>
