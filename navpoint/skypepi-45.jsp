...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/Exams/skypepi-45");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-45");
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Exams/skypepi-45";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-45";
...
%>
 ...
 <tr>
  <td  class='heading color-blue' align='left' valign='top'><span class="wbdRichText">Exams</span></td>
 </tr>
 <tr>
  <td  height='10'></td>
 </tr>
 <tr>
  <td  class='body-text'><span class="wbdRichText"><p><strong>Professional advice  </strong></p><p>The British Council has a long history of working closely with a wide range of international UK exams bodies and can offer you advice and guidance to make sure you choose the one most suited to your needs. Come and talk to us for free.</p></span></td>
 </tr>
 <tr>
  <td  height='20'></td>
 </tr>
 ...
 <tr>
  <td  class='sub-header color-blue' align='left' valign='top'><span class="wbdRichText">IELTS</span></td>
  <td ></td>
 </tr>
</table>
</td>
 ...
 <tr>
  ...
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">If you are planning to study, live or work abroad, you will need to take an IELTS (International English Language Testing System) exam. Find out more about testing your level of English with us. <a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Read More</a></span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  class='sub-header color-blue' align='left' valign='top'><span class="wbdRichText">ACADEMIC AND PROFESSIONAL EXAMS</span></td>
  <td ></td>
 </tr>
</table>
</td>
 ...
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_aca_prof_exams.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">The British Council Examinations Services organises examinations for a range of UK professional bodies, educational institutions and associations throughout the year. <a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Read More</a></span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  class='sub-header color-blue' align='left' valign='top'><span class="wbdRichText">CAMBRIDGE ESOL EXAMS</span></td>
  <td ></td>
 </tr>
</table>
</td>
 ...
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_cambridge_exams.jpg" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">Cambridge ESOL (English for Speakers of Other Languages) can develop your general, workplace and academic English. We can help you gain an internationally recognised Cambridge qualification. <a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Read More</a></span></td>
 </tr>
</table>
</td>
 </tr>
  ...
  <td  width='20'></td>
  <td  valign='top'><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  width='320' align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_exams.png" border="0"></td>
 </tr>
 <tr>
  <td  height='10'></td>
 </tr>
 <tr>
  <td  class='body-text'><span class="wbdRichText"><strong>Do you want to further your education? Do you need to improve your career prospects? We can help you gain a UK qualification that could lead to worldwide opportunities in business and education.</strong></span></td>
 </tr>
</table>
</td>
 </tr>
