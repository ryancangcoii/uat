...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/English-Courses/skypepi-46");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-46");
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/English-Courses/skypepi-46";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-46";
...
%>
 ...
 <tr>
  <td  class='heading color-blue' align='left' valign='top'><span class="wbdRichText">English Courses</span></td>
 </tr>
 <tr>
  <td  height='10'></td>
 </tr>
 <tr>
  <td  class='body-text'><span class="wbdRichText"><p>Success Tomorrow Starts Today      </p><ul><li>Do you want to develop your English skills?     </li><li>Do you want your child to be more confident in English? </li><li>    Do you want to improve your professional abilities and further your career?  </li></ul><p>Whatever your need we offer you a range of courses, training programmes and workshops to support your learning.</p></span></td>
 </tr>
 <tr>
  <td  height='15'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_arrow_small_green.png" border="0"></td>
  <td  width='5'></td>
  <td ><a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">English Course Bundling Discount</a></td>
 </tr>
 <tr>
  <td  height='10'></td>
  <td ></td>
 ...
 <tr>
  <td ><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_arrow_small_green.png" border="0"></td>
  <td ></td>
  <td ><a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Learn English online - World news English</a></td>
 </tr>
 <tr>
  <td  height='10'></td>
  <td ></td>
 ...
 <tr>
  <td ><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_arrow_small_green.png" border="0"></td>
  <td ></td>
  <td ><a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Learn English online - CNA NEWSWORLD</a></td>
 </tr>
 <tr>
  <td  height='10'></td>
  <td ></td>
 ...
 <tr>
  <td ><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_arrow_small_green.png" border="0"></td>
  <td ></td>
  <td ><a href="#" class="wt" style=" font-size:12px; color:#3c7fc5; font-weight:normal; text-decoration:none;"  onmouseover="this.style.color='#b14600';this.style.textDecoration='underline';"  onmouseout="this.style.color='#3c7fc5';this.style.textDecoration='none';">Mobile learning</a></td>
 </tr>
</table>
</td>
 </tr>
  ...
  <td  width='15'></td>
  <td  width='330'><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_english_courses.png" border="0"></td>
 </tr>
 <tr>
  <td ></td>
 </tr>
 ...
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  class='sub-header color-blue' align='left' valign='top'><span class="wbdRichText">EXAM PREPARATION</span></td>
 </tr>
 <tr>
  <td  height='5'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_ietls.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">For anyone who is interested in improving their English to take the <a href="http://www.britishcouncil.org/taiwan-exams-ielts.htm">IELTS test</a> we offer IELTS preparation courses , and Academic Writing courses </span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td  class='sub-header color-blue'><span class="wbdRichText">ENGLISH FOR YOUNG LEARNERS</span></td>
 </tr>
 <tr>
  <td  height='5'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_english_for_young_learners.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">For children aged 9 to 12 and young adults aged 13 &ndash; 16 these courses will build on the English your child already has and develop the confidence and ability to use English especially to speak and listen. </span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td  class='sub-header color-blue'><span class="wbdRichText">ENGLISH FOR ADULTS</span></td>
 </tr>
 <tr>
  <td  height='5'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_english_for_adults.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">Whatever your level, we offer a wide range of English language courses in our centre in Taiwan. </span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td  class='sub-header color-blue'><span class="wbdRichText">BUSINESS SKILLS DEVELOPMENT</span></td>
 </tr>
 <tr>
  <td  height='5'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_business_skills_development.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">Do you want to enhance your Business writing or become more confident when dealing with English speakers?  Look no further because we have just the right courses for you! </span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td  class='sub-header color-blue'><span class="wbdRichText">CORPORATE TRAINING</span></td>
 </tr>
 <tr>
  <td  height='5'></td>
 </tr>
 <tr>
  <td ><table border='0' cellpadding='0' cellspacing='0'  align='left' valign='top'>
 <tr>
  <td  align='left' valign='top'><img onerror="$(this).setStyle({ visibility:'hidden' });" src="/ttsvr/cropImage/skypepi.images.skypepi_corporate_training.png" border="0"></td>
  <td  width='15'></td>
  <td  class='body-text'><span class="wbdRichText">We can help you develop your management and communication skills, and improve your professional abilities with our range of <strong>Business Skills Development</strong> programmes and workshops. </span></td>
 </tr>
</table>
</td>
 </tr>
 ...
 <tr>
  <td  height='228' align='center' valign='top'><table border='0' cellpadding='0' cellspacing='0'  width='100%' align='center' valign='top'>
 <tr>
