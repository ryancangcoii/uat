...
<%@page import="tooltwist.skypepi.productionHelpers.CourseDetailsProductionHelper"%>
...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_courseDetails_58 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_courseDetails_58Params = new Properties();
	productionHelper_skypepi_pages_skypepi_courseDetails_58 = new tooltwist.skypepi.productionHelpers.CourseDetailsProductionHelper(productionHelper_skypepi_pages_skypepi_courseDetails_58Params);
	productionHelper_skypepi_pages_skypepi_courseDetails_58.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_courseDetails_58", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/Course-Details/skypepi-49");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-49");
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Course-Details/skypepi-49";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-49";
...
<tr>
 <td class='skypepi_courseDetails@56_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_courseDetails@56_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_courseDetails@56_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_courseDetails@56_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_courseDetails@56_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_courseDetails@58 (type=tooltwist.skypepi.widgets.CourseDetailsWidget) --%>
<%
try {
	...
	String snippetVar_widgetPath = "skypepi.pages.skypepi_courseDetails@58";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<%
	CourseDetailsProductionHelper h = (CourseDetailsProductionHelper) helper;
...
<!-- 					<img src="/ttsvr/skypepi/images/skypepi_brtl.png" alt="" width="8" height="8" class="corner" style="display: none" /> -->
				...
				<form id="form-courseDetails" name="form-courseDetails" method="post" action="<%=snippetVar_navpointId%>">
					<input type="hidden" name="navpointId" value="<%=snippetVar_navpointId%>"/>
					<input type="hidden" name="courseDetailId" id="courseDetailId" value="<%=h.getCourseDetailId() %>"/>
					<input type="hidden" name="courseCategory" id="courseCategory" value="<%=h.getCourseCategory() %>"/>
					<table>
						<tr>
							<td align="left" colspan="2"><span class="heading color-blue"><%=lang.getString("Course Details", null, "") %></span></td>
							<td align="right">
										...
										<td>
											<table width="" border="0" cellspacing="0" cellpadding="0">
				                               <tr>
				                                 ...
				                                 <td width="" class="button_m">
				                                 <a href="#" onclick="bookPlacement(<%=courseId %>)">
													&nbsp;<%=lang.getString("Book Placement Test", null, "") %>&nbsp;
												</a>
												</td>
										...
										<td>
											<table width="" border="0" cellspacing="0" cellpadding="0">
				                               <tr>
				                                 <td width="6px" class="button_l">&nbsp;</td>
				                                 <td width="" class="button_m">
				                                 <a href="<%=snippetVar_enquireNavpoint%>?courseId=<%=courseId %>&courseCategory=<%=h.getCourseCategory() %>">
													&nbsp;<%=lang.getString("Enquire About Course", null, "") %>&nbsp;
												</a>
												</td>
				                                 <td width="17px" class="button_r">&nbsp;</td>
				                               </tr>
										...
										<%-- <td>
											<table width="" border="0" cellspacing="0" cellpadding="0">
				                               <tr>
				                                 ...
				                                 <td width="" class="button_m">
				                                 <a href="<%=snippetVar_enquireNavpoint%>?courseId=<%=courseId %>&courseCategory=<%=h.getCourseCategory() %>">
													&nbsp;<%=lang.getString("Download PDF", null, "") %>&nbsp;
												</a>
												</td>
				                                 <td width="17px" class="button_r">&nbsp;</td>
				                               </tr>
						...
						<tr>
							<td align="left" colspan="3"><span class="sub-heading color-blue"><b><%=courseName %></b></span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular"><%=courseDescription %></span></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="regular-link-underline-blue"><a href="javascript:gotoCourseCategory();"><span class="body-text"><b><%=disciplineDescription %></b></span></a></span></td>
						</tr>
						<tr>
							<td height="30"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-blue"><b><%=lang.getString("FILTER YOUR SCHEDULE RESULTS", null, "") %></b></span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							...
							<td align="left" width="750px"><span class="body-text color-regular"><b><%=lang.getString("Select time of the day", null, "") %>:</b></span></td>
						</tr>
						<tr>
							<td align="left">
								<select id="locationDropdown" name="locationDropdown" class="medium-dropdown" onchange="getScheduleResult();">
									<option><%=lang.getString("Taiwan", null, "") %></option>
								</select>
							</td>
							<td class="separator">&nbsp;</td>
							<td align="left">
						...
						<tr>
							<td colspan="3" align="center">
								<div id="scheduleCourseDetailsContainer">
									<table>
												<tr>
													<td>
														<table class="table-list table-list-regular" cellspacing="0">
						...
						<!-- <tr>
							<td align="left" colspan="3"><span class="body-text color-regular"><b>Planning</b></span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">We base our Teens Courses on the Council of Europe Framework</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">We divide them into 5 main levels Pre-Intermediate (B1), Intermediate (B1+), Upper Intermediate (B2), Pre-Advanced (B2+) to Advanced (C1)</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">Our Teens courses aims to develop your ability to understand and use English effectively by developing your confidence and building on the English students have already learn.</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">These courses focus on getting students to actively use English for speaking and listening as well as improve writing and reading skills.</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">The language element of each level is based on a course book. Study of course book material will account for 50-60% of the syllabus.</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">Our lessons contain content from a wide range of curriculum subjects and help your children to improve their knowledge, not just of English, but also of the world through science, history, geography, and social studies.</span></td>
						</tr>
						<tr>
							<td height="10"></td>
						</tr>
						<tr>
							<td align="left" colspan="3"><span class="body-text color-regular">Students will also work on class projects throughout the year.</span></td>
						</tr> -->
						<tr>
							<td height="30"></td>
						</tr>
...
<!-- Hold temporary html for empty tables -->
<div id="divTempHtml" style="display: none;">
		<table>
			<tbody>
				<tr>
					<td>
						<table cellspacing="0" class="course-schedule-list-container">
							<tbody>
								<tr class="list-header">
									<td width="100px" class="table-header color-regular"><%=lang.getString("Location", null, "") %></td>
									<td width="100px" class="table-header color-regular"><%=lang.getString("Start Date", null, "") %></td>
...
function getScheduleResult() {
	var url = host + "/ttsvr/servlet/tooltwist.skypepi.servlet.CourseDetailsServlet";
	url = url
	+ "?"
	+ $("#form-courseDetails").serialize()
	+ "&op=getScheduleResult";
	$.ajax({
		url: url,
		dataType: "html",
		cache:false,
		...
		success: function(data) {
			$("#scheduleCourseDetailsContainer").html(data);
		}
	});
}
...
function getCourseIntake() {
	...
	$("#scheduleCourseDetailsContainer").html(jQuery("#divTempHtml").html());
	$("#scheduleCourseDetailsContainer").attr("disabled","disabled")
	
	
	var params = $("#form-courseDetails").serialize();
	
	var location = $('#locationDropdown').val();
	var url = window.location.pathname;
	url = url
	+ "?op=skypepi_widgets.courseDetails.courseDetails&subOp=getCourseDetails&" 
	+ params;
	...
	$.ajax({
		...
		success: function(data) {
			$("#scheduleCourseDetailsContainer").html(data);
			$("#scheduleCourseDetailsContainer").removeAttr("disabled")
		},
		error: function() {
...
function bookPlacement(courseId) {
	$("#form-courseDetails").attr("action","<%=snippetVar_bookingNavpoint%>");
	$("#courseDetailId").val(courseId);
	$("#form-courseDetails").submit();
}

jQuery(function() {
	
	for(var ctr = 1; ctr <= 7; ctr++) {
		$("#checkboxDay" + ctr).click(function() {getCourseIntake();});
	}
	
	jQuery("#selectTimeDropdown").change(function() {getCourseIntake()});
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_courseDetails@58 (type=tooltwist.skypepi.widgets.CourseDetailsWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_courseDetails@56_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_courseDetails@56_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_courseDetails@56_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_courseDetails@56_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_courseDetails_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
