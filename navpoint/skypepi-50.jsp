...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_59Params.setProperty("navpointId", "/ttsvr/n/Course-Enquiry/skypepi-50");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_57Params.setProperty("currentNavpointId", "skypepi-50");
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-50";
