...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_assessmentAttendance_70 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_assessmentAttendance_70Params = new Properties();
	productionHelper_skypepi_pages_skypepi_assessmentAttendance_70 = new tooltwist.skypepi.productionHelpers.AssessmentAttendanceProductionHelper(productionHelper_skypepi_pages_skypepi_assessmentAttendance_70Params);
	productionHelper_skypepi_pages_skypepi_assessmentAttendance_70.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_assessmentAttendance_70", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/Assessment-and-Attendance/skypepi-55");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-55");
...
try {
	...
	productionHelper_skypepi_zones_z_studentFunctionsMenu_61Params.setProperty("navpointId", "/ttsvr/n/Assessment-and-Attendance/skypepi-55");
...
<% } %>
<title>SkyPortal - Assessment and Attendance</title>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/Assessment-and-Attendance/skypepi-55";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-55";
...
<tr>
 <td class='skypepi_assessmentAttendance@68_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance@68_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance@68_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_assessmentAttendance@68_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance@68_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  width='730' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_assessmentAttendance@70 (type=tooltwist.skypepi.widgets.AssessmentAttendanceWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_assessmentAttendance_70;
	String snippetVar_targetPage = "/ttsvr/n/Timetable-of-Session-Details/skypepi-58";
	String snippetVar_titleHeader = "Assessment and Attendance";
	String snippetVar_widgetName = "@70";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_assessmentAttendance@70";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_assessmentAttendance@70 (type=tooltwist.skypepi.widgets.AssessmentAttendanceWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_assessmentAttendance@68_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_assessmentAttendance@68_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance@68_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance@68_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
