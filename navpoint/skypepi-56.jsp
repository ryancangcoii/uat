...
<%@page import="tooltwist.skypepi.productionHelpers.AssessmentAttendanceDetailsProductionHelper"%>
...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70Params = new Properties();
	productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70 = new tooltwist.skypepi.productionHelpers.AssessmentAttendanceDetailsProductionHelper(productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70Params);
	productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/Assessment-Details/skypepi-56");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-56");
...
try {
	...
	productionHelper_skypepi_zones_z_studentFunctionsMenu_61Params.setProperty("navpointId", "/ttsvr/n/Assessment-Details/skypepi-56");
...
<% } %>
<title>SkyPortal - Assessment Details</title>
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-56";
...
<tr>
 <td class='skypepi_assessmentAttendance_details@68_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance_details@68_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance_details@68_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_assessmentAttendance_details@68_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance_details@68_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  width='730' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_assessmentAttendance_details@70 (type=tooltwist.skypepi.widgets.AssessmentAttendanceDetailsWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_assessmentAttendance_details_70;
	String snippetVar_targetPage = "/ttsvr/MISSING_LINK/skypepi-67";
	String snippetVar_widgetName = "@70";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_assessmentAttendance_details@70";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<%
	...
	AssessmentAttendanceDetailsProductionHelper h = (AssessmentAttendanceDetailsProductionHelper) helper;
	XData data = h.getData(jh);
	AltLang lang = h.getAltLang();
%>

<!-- ********** INSERT HTML HERE ********** -->
<div <%=snippetVar_idDefinition%> class="AssessmentAttendanceDetails">
	
	<table width="100%">
	<tr>
		<td>
				<form id="form-reEnrolment" name="form-reEnrolment" method="post" action="<%=snippetVar_targetPage%>">
					<table width="100%">
						<tr>
							<td class="heading color-blue" align="left" colspan="2" style="padding-left:10px;"><%=lang.getString("Student Details", null, "") %></td>
						</tr>
						<tr><td height="30"></td></tr>
						<tr>
							<td align="left" class="body-text color-regular" width="150"><%=lang.getString("Student Number", null, "") %>:</td>
							<td align="left" class="body-text color-regular"><%=h.getStudentNumber() %></td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td align="left" class="body-text color-regular" width="150"><%=lang.getString("Qualification", null, "") %>:</td>
							<td align="left" class="body-text color-regular"><%=h.getQualification() %></td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td align="left" class="body-text color-regular" width="150"><%=lang.getString("Study Mode", null, "") %>:</td>
							<td align="left" class="body-text color-regular"><%=h.getStudyMode() %></td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td align="left" class="body-text color-regular" width="150"><%=lang.getString("Student Name", null, "") %>:</td>
							<td align="left" class="body-text color-regular"><%=h.getFullName() %></td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td align="left" class="body-text color-regular" width="150"><%=lang.getString("Enrolment Status", null, "") %>:</td>
							<td align="left" class="body-text color-regular"><%=h.getEnrolmentStatus() %></td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr class="line-separator"><td colspan="2" align="right">
						</td></tr>
						<tr ><td colspan="2" align="right">
							<table width="" border="0" cellspacing="0" cellpadding="0">
			                    <tr>
			                      <td width="6" class="button_l">&nbsp;</td>
			                      <td width="90" class="button_m"><a href="#" id="btnAssCancel" name="btnAssCancel"><%=lang.getString("Cancel", null, "") %></a></td>
						...
						<tr><td height="30"></td></tr>
						<tr>
							<td colspan="2" align="left"><span class="sub-heading color-blue"><%=lang.getString("Assessments Elements", null, "") %></span></td>
						</tr>
						<tr>
							<td colspan="2">
									    ...
									    <td colspan="3">
										    <table class="table-list table-list-content" cellspacing="0" width="100%"  id="table-enrolment">
											    <tr class="list-header">
													<td width="320px" class="table-header color-regular"><%=lang.getString("Name", null, "") %></td>
													<td width="150px" class="table-header color-regular"><%=lang.getString("Result", null, "") %></td>
													<td width="150px" class="table-header color-regular"><%=lang.getString("Grade", null, "") %></td>
												</tr>
												
												<%
												XData assData = h.getAssData();
												XNodes nodes = assData.getNodes("//Assessment");
												int ctr = 1;
												for(nodes.first(); nodes.next();) {
													Element e = (Element)nodes.getCurrentNode();
												...
												%>
												<tr class="<%=classTag %>">
													<td class="table-data color-regular"><%=name %></td>
													<td class="table-data color-regular"><%=result %></td>
													<td class="table-data color-regular"><%=grade %></td>
												</tr>
												<% } %>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_assessmentAttendance_details@70 (type=tooltwist.skypepi.widgets.AssessmentAttendanceDetailsWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_assessmentAttendance_details@68_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_assessmentAttendance_details@68_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance_details@68_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_assessmentAttendance_details@68_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_assessmentAttendance_details_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
...
<script type="text/javascript">
var AssessmentAttendanceDetails = function() {
	return {
		myVariable: null,

		init: function() {
			$("#form-reEnrolment #btnAssCancel").click(function() {
				$("#form-reEnrolment").submit();
			});
		}
	};
}();

jQuery(AssessmentAttendanceDetails.init()); // Run after page loads</script>
<script type="text/javascript">
