...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_skypepi_bookings_72 = null;
try {
	Properties productionHelper_skypepi_pages_skypepi_bookings_72Params = new Properties();
	productionHelper_skypepi_pages_skypepi_bookings_72 = new tooltwist.skypepi.productionHelpers.BookingsWidgetProductionHelper(productionHelper_skypepi_pages_skypepi_bookings_72Params);
	productionHelper_skypepi_pages_skypepi_bookings_72.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_skypepi_bookings_72", e);
}
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_59Params.setProperty("navpointId", "/ttsvr/n/skyportal--my-course-history/skypepi-62");
...
try {
	...
	productionHelper_skypepi_zones_skypepi_header_auth_57Params.setProperty("currentNavpointId", "skypepi-62");
...
try {
	...
	productionHelper_skypepi_zones_z_studentFunctionsMenu_61Params.setProperty("navpointId", "/ttsvr/n/skyportal--my-course-history/skypepi-62");
...
<% } %>
<title>SkyPortal - My Course History</title>
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/skyportal--my-course-history/skypepi-62";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-62";
...
<tr>
 <td class='skypepi_bookings@68_NW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_F.png);background-repeat:no-repeat;background-position:0 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_bookings@68_N' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_X.png);background-repeat:repeat-x;background-position:0 0;height:10;"  nowrap></td>
 <td class='skypepi_bookings@68_NE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_F.png);background-repeat:no-repeat;background-position:-10 0;width:10;height:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_bookings@68_W1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_Y.png);background-repeat:repeat-y;background-position:0 0;width:10;"  nowrap></td>
 <td class='skypepi_bookings@68_M1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_0.png);background-repeat:repeat;"  nowrap><table border='0' cellpadding='0' cellspacing='0'  height='550' width='730' align='center' valign='top'>
 <tr>
  <td  align='left' valign='top'><%-- Widget skypepi.pages.skypepi_bookings@72 (type=tooltwist.skypepi.widgets.BookingsWidgetWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_skypepi_bookings_72;
	String snippetVar_previewReceiptNavpoint = "/ttsvr/n/Preview-Receipt/skypepi-38";
	String snippetVar_previewMarksGradesNavpoint = "/ttsvr/n/View-Marks-and-Grades/skypepi-64";
	String snippetVar_widgetName = "@72";
	String snippetVar_widgetPath = "skypepi.pages.skypepi_bookings@72";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<%
	...
	BookingsWidgetProductionHelper h = (BookingsWidgetProductionHelper) helper;
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.skypepi_bookings@72 (type=tooltwist.skypepi.widgets.BookingsWidgetWidget)", e);
}
%>
</td>
 </tr>
 ...
 <td class='skypepi_bookings@68_E1' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_Y.png);background-repeat:repeat-y;background-position:-10 0;width:10;"  nowrap></td>
</tr>
<tr>
 <td class='skypepi_bookings@68_SW' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_F.png);background-repeat:no-repeat;background-position:-20 0;width:10;height:10;"  nowrap></td>
 <td class='skypepi_bookings@68_S' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_X.png);background-repeat:repeat-x;background-position:0 -10;height:10;"  nowrap></td>
 <td class='skypepi_bookings@68_SE' style="background-image:url(/ttsvr/sprite/skypepi.pages.skypepi_bookings_F.png);background-repeat:no-repeat;background-position:-30 0;width:10;height:10;"  nowrap></td>
</tr>
</table>
</td>
 </tr>
