						...
						<table width="100%">
							<tr>
								<td>
									...
									<div class="row" style="margin-top: 10px">
										<div class="col-md-2">
											<label class="control-label"><%=lang.getString("Nickname", null, "") %>:</label>
										</div>
										<div class="col-md-5">
											<input id="nickname" name="nickname" class="form-control" type="text" autocomplete="off" value="" readonly="readonly" />
										</div>
									</div>
								</td>
							</tr>
							...
							<div class="row">
								...
								<div class="col-md-8">
									<select id="addressTypeNew" style="width: 280px;" class="form-control">
										...
										<option value="Postal"><%=lang.getString("Postal", null, "") %></option>
										<option value="Others"><%=lang.getString("Others", null, "") %></option>
									</select>
								</div>
							</div>
										...
										<div class="row">
											...
											<div class="col-md-5">
												<select id="emailTypeNew" name="emailTypeNew" style="width: 280px;" class="form-control">
													<option value="Personal"><%=lang.getString("Personal", null, "") %></option>
													<option value="Office"><%=lang.getString("Office", null, "") %></option>
													<option value="Temporary"><%=lang.getString("Temporary", null, "") %></option>
													<option value="Other"><%=lang.getString("Other", null, "") %></option>
												</select>
											</div>
										</div>
