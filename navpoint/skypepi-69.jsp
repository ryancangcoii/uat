...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_37Params.setProperty("navpointId", "/ttsvr/n/myCurrentEnrolment/skypepi-69");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_38Params.setProperty("navpointId", "/ttsvr/n/myCurrentEnrolment/skypepi-69");
...
try {
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13Params = new Properties();
	productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13 = new tooltwist.skypepi.productionHelpers.MyCurrentEnrolmentProductionHelper(productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13Params);
	productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13", e);
}
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_73Params.setProperty("currentNavpoint", "skypepi-69");
...
<div class='DivWidget page-content' style=""><div class='DivWidget standard-width' style=""><%-- Widget skypepi.pages.portal_p_btstrap_myCurrentEnrollment@13 (type=tooltwist.skypepi.widgets.MyCurrentEnrolmentWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_portal_p_btstrap_myCurrentEnrollment_13;
	...
	String snippetVar_widgetPath = "skypepi.pages.portal_p_btstrap_myCurrentEnrollment@13";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<div class="ribbon-wrap left-edge fork lblue"><span><%=lang.getString("myCurrentEnrolment", null, "") %></span></div>
<br><br><br>
		<table width="100%">
		<tr>
			<td>
...
<br>
										<div class="table-responsive portalTable" id="enrolment-container">
											    <table class="table bordered" cellpadding="0" cellspacing="0" id="table-bookings" width="100%">
											    	<tr>
											    		<th colspan="6" style="text-align: left;"><%=lang.getString("Current Enrolment", null, "") %></th>
											    	</tr>
													<tr  class="grey">
													...
													%>
														...
														for(EnrolledStreamUnits enrolledStreamUnit: enrolledStreamUnits) {
															...
															//get list of attendance count
															List<Map<String, String>> attendance = AttendanceProductionHelper.getAttendanceData(enrolmentId, request);

															//get list of receipts count
															TransactionCollection studentTransaction = new TransactionCollection();
															ArrayList<StudentFinances> receipts = studentTransaction.getStudentPaymentDetailCollection(WebUtil.getAttributes(request, DataBlockUtil.SESSION_VARIABLE.SIGN_ON_ID, 0), "", request);
...
// 															if (teacher.equals("")) continue;
														...
														<tr class="<%=classTag %>">
															...
															<td class="table-data color-regular column-date" rowspan="3"><%=PublicUtil.formatDate(PublicUtil.convertStringFromDBToDate(start), h.getDateFormat())%></td>
															...
															<td class="table-data color-regular" rowspan="3">
																...
																<%if (dt.after(dtTo)) { %>
																	...
																	<img src="/ttsvr/skypepi/images/arrow-course-details.png" class="v-align-middle">
																	<span class="regular-link-underline-light-blue">
																		<a href="<%=snippetVar_viewMarksGradesNavpoint + "?enrolmentID=" + enrolmentId %>" >
													...
													%>
														...
														<tr class="list-even-item">
															<td colspan="6" class="table-header color-regular column-text"></td>
														</tr>
													<%
													}
													%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_btstrap_myCurrentEnrollment@13 (type=tooltwist.skypepi.widgets.MyCurrentEnrolmentWidget)", e);
}
%>
</div>
</div>
