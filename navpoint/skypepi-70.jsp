...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_54Params.setProperty("currentNavpoint", "skypepi-70");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_54Params.setProperty("currentNavpoint", "skypepi-70");
...
try {
	...
	String snippetVar_currentNavpoint = "skypepi-70";
...
try {
	...
	String snippetVar_previewMarksGradesNavpoint = "/ttsvr/n/View-Certificate/skypepi-121";
			...
			%>
				...
				<tr class="<%=classTag %>">
					...
					<td class="table-data color-regular">
						...
						<%if (dt.after(dtTo) && h.isViewableCertificate()) { %>
						<br />
						<img src="/ttsvr/skypepi/images/arrow-course-details.png" class="v-align-middle">
						<span class="regular-link-underline-light-blue">
