...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_myProgression_14 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_myProgression_14Params = new Properties();
	productionHelper_skypepi_pages_portal_p_myProgression_14 = new tooltwist.skypepi.productionHelpers.BookingsWidgetProductionHelper(productionHelper_skypepi_pages_portal_p_myProgression_14Params);
	productionHelper_skypepi_pages_portal_p_myProgression_14.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_myProgression_14", e);
}
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_37Params.setProperty("navpointId", "/ttsvr/n/myProgressions/skypepi-70");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_38Params.setProperty("navpointId", "/ttsvr/n/myProgressions/skypepi-70");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_48Params.setProperty("navpointId", "/ttsvr/n/myProgressions/skypepi-70");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_44Params.setProperty("currentNavpointId", "skypepi-70");
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-70";
...
%>
 ...
 <tr>
  <td  height='100%' valign='top'><%-- Widget skypepi.pages.portal_p_myProgression@14 (type=tooltwist.skypepi.widgets.BookingsWidgetWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_portal_p_myProgression_14;
	String snippetVar_previewReceiptNavpoint = "/ttsvr/n/View-Receipt/skypepi-76";
	String snippetVar_previewMarksGradesNavpoint = "/ttsvr/n/View-Marks-and-Grades/skypepi-80";
	String snippetVar_widgetName = "@14";
	String snippetVar_widgetPath = "skypepi.pages.portal_p_myProgression@14";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_myProgression@14 (type=tooltwist.skypepi.widgets.BookingsWidgetWidget)", e);
}
%>
</td>
 </tr>
