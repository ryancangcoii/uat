...
<%
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_codeOfConducts_16 = null;
try {
	...
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_codeOfConducts_16", e);
}
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_37Params.setProperty("navpointId", "/ttsvr/n/Code-of-Conduct/skypepi-74");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_38Params.setProperty("navpointId", "/ttsvr/n/Code-of-Conduct/skypepi-74");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_48Params.setProperty("navpointId", "/ttsvr/n/Code-of-Conduct/skypepi-74");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_44Params.setProperty("currentNavpointId", "skypepi-74");
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-74";
...
%>
 ...
 <tr>
  <td  height='100%' align='left' valign='top'><%-- Widget skypepi.pages.portal_p_codeOfConducts@16 (type=tooltwist.skypepi.widgets.CodeOfConductWidget) --%>
<%
try {
	...
	String snippetVar_widgetPath = "skypepi.pages.portal_p_codeOfConducts@16";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
<form id="frm-coc">
	...
	<div class="cocAccept" style="display: none;">
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_codeOfConducts@16 (type=tooltwist.skypepi.widgets.CodeOfConductWidget)", e);
}
%>
</td>
 </tr>
