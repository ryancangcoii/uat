...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_37Params.setProperty("navpointId", "/ttsvr/n/View-Receipt/skypepi-76");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_header_38Params.setProperty("navpointId", "/ttsvr/n/View-Receipt/skypepi-76");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooter_73Params.setProperty("currentNavpoint", "skypepi-76");
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13Params = new Properties();
	productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13 = new tooltwist.skypepi.productionHelpers.ViewReceiptsProductionHelper(productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13Params);
	productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_btstrap_myReceipt_13", e);
}
...
<div class='DivWidget page-content' style=""><div class='DivWidget standard-width' style=""><%-- Widget skypepi.pages.portal_p_btstrap_myReceipt@13 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget) --%>
<%
try {
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_btstrap_myReceipt@13 (type=tooltwist.skypepi.widgets.ViewReceiptsWidget)", e);
}
%>
</div>
</div>
