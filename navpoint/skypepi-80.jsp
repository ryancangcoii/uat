...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_37Params.setProperty("navpointId", "/ttsvr/n/View-Marks-and-Grades/skypepi-80");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_38Params.setProperty("navpointId", "/ttsvr/n/View-Marks-and-Grades/skypepi-80");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_48Params.setProperty("navpointId", "/ttsvr/n/View-Marks-and-Grades/skypepi-80");
...
try {
	...
	productionHelper_skypepi_zones_portal_z_headerNonRespo_44Params.setProperty("currentNavpointId", "skypepi-80");
	...
	WbdProductionHelper productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14 = null;
try {
	Properties productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14Params = new Properties();
	productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14 = new tooltwist.skypepi.productionHelpers.ViewMarksAndGradesProductionHelper(productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14Params);
	productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14.callPreFetch(jh);
} catch (Exception e) {
	WbdSession.addError(jh.getCredentials(), "Calling preFetch() for production helper productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14", e);
}
...
try {
	...
	String snippetVar_navpointId = "/ttsvr/n/View-Marks-and-Grades/skypepi-80";
...
try {
	...
	String snippetVar_currentNavpointId = "skypepi-80";
...
%>
 ...
 <tr>
  <td  height='100%' valign='top'><%-- Widget skypepi.pages.portal_p_viewMarksAndGrades@14 (type=tooltwist.skypepi.widgets.ViewMarksAndGradesWidget) --%>
<%
try {
	WbdProductionHelper helper = productionHelper_skypepi_pages_portal_p_viewMarksAndGrades_14;
	String snippetVar_targetPage = "/ttsvr/n/myCurrentEnrollment/skypepi-69";
	String snippetVar_widgetName = "@14";
	String snippetVar_widgetPath = "skypepi.pages.portal_p_viewMarksAndGrades@14";
	String snippetVar_elementId = "";
	String snippetVar_idDefinition = "";
%>
...
WbdSession.addError(jh.getCredentials(), "Rendering widget skypepi.pages.portal_p_viewMarksAndGrades@14 (type=tooltwist.skypepi.widgets.ViewMarksAndGradesWidget)", e);
}
%>
</td>
 </tr>
