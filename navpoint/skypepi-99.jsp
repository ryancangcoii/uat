...
try {
	...
	productionHelper_skypepi_zones_portal_z_responsiveFooterAdmin_72Params.setProperty("currentNavpoint", "skypepi-99");
...
%>
	...
	<%
		...
		BcCache.initialiseIfNecessary();
	%>
	<!-- ********** INSERT HTML HERE ********** -->
	<link rel="stylesheet" type="text/css" href="/ttsvr/blog/stylesheet/<%=BcCache.getProperty("blogCssFilename") %>" />
