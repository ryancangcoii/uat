...
var A_TCALDEF = {
	...
	'imgpath' : '/ttsvr/skypepi/scripts/tigra_calendar/img/' // directory with calendar images
};
...
function tcal (a_cfg, a_tpl) {
	...
	var self = this;
	$("#" + this.a_cfg.controlname).click(function() {
		window.A_TCALS[self.s_id].f_toggle();
	});
